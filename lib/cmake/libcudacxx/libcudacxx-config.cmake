...
if (CUDAToolkit_FOUND)
  find_library(_libcudacxx_cufilt_lib "cufilt" PATHS "${CUDAToolkit_LIBRARY_DIR}" NO_DEFAULT_PATH)
  if (_libcudacxx_cufilt_lib)
    target_link_libraries(_libcudacxx_libcudacxx INTERFACE "${_libcudacxx_cufilt_lib}")
  else()
    message(WARNING "libcudacxx: cu++filt library (libcufilt.a) not found. Some features may not work correctly.")
  endif()
endif()
