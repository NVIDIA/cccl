...
function(cccl_build_compiler_targets)
  ...
  list(APPEND cxx_compile_definitions "-Xcudafe=--display_error_number")
  list(APPEND cxx_compile_definitions "-Xcudafe=--promote_warnings")
  list(APPEND cxx_compile_definitions "-Wno-deprecated-gpu-targets")
