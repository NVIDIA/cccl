...
.. toctree::
   ...
   ${repo_docs_api_path}/class*unified__memory__resource*
...
The ``<cuda/experimental/memory_resource.cuh>`` header provides:
   ...
   -  :ref:`pinned_memory_resource <cudax-memory-resource-pinned-memory-resource>`
      A standard C++ interface for memory allocation of
      `pinned memory <https://developer.nvidia.com/blog/how-optimize-data-transfers-cuda-cc/>`__.
   -  :ref:`universal_memory_resource <cudax-memory-resource-unified-memory-resource>`
      A standard C++ interface for memory allocation of
      `unified memory <https://developer.nvidia.com/blog/unified-memory-cuda-beginners/>`__.
