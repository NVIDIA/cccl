...
<!-- provenance:
  #6465→#7151 (backport #7153) nested-namespace C++17 modernization sweep broke <nv/target> for C++11/14 consumers (pair auto-inferred as #7151→#7153)
-->
...
<!-- provenance:
  #8210→#8254 warp_shuffle static_assert(is_trivially_copyable_v<_Tp>) rejected __half/__nv_bfloat16 and composites, breaking CUB consumers;
  reverted
-->
