...
for the launch size when allocating registers. It can prevent a large block from
failing to launch because the generated code uses too many registers per thread.
