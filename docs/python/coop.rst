...
Store, plus physical and logical Warp Load and Store. The backend namespace
adds features specific to its compiler. See :ref:`Which namespace should I use? <coop-faq-namespaces>`.
