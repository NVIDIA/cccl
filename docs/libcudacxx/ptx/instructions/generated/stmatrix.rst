...
.. code-block:: cuda
   ...
   // stmatrix.sync.aligned.m16n8.x1.trans.shared.b8 [gmem_ptr], input_var; // PTX ISA 86, SM_100a, SM_100f, SM_103a, SM_103f, SM_107a, SM_107f, SM_110a, SM_110f, SM_120a, SM_120f, SM_121a, SM_121f
...
.. code-block:: cuda
   ...
   // stmatrix.sync.aligned.m16n8.x2.trans.shared.b8 [gmem_ptr], input_var; // PTX ISA 86, SM_100a, SM_100f, SM_103a, SM_103f, SM_107a, SM_107f, SM_110a, SM_110f, SM_120a, SM_120f, SM_121a, SM_121f
   template <typename B8, enable_if_t<sizeof(B8) == 1, bool> = true>
   __device__ static inline void stmatrix_m16n8_trans(
     B8* gmem_ptr,
     const uint32_t (&input_var)[2]);
...
.. code-block:: cuda
   ...
   // stmatrix.sync.aligned.m16n8.x4.trans.shared.b8 [gmem_ptr], input_var; // PTX ISA 86, SM_100a, SM_100f, SM_103a, SM_103f, SM_107a, SM_107f, SM_110a, SM_110f, SM_120a, SM_120f, SM_121a, SM_121f
   template <typename B8, enable_if_t<sizeof(B8) == 1, bool> = true>
   __device__ static inline void stmatrix_m16n8_trans(
     B8* gmem_ptr,
     const uint32_t (&input_var)[4]);
