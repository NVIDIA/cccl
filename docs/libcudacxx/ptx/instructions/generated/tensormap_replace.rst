...
tensormap.replace.tile.global_dim.assume_large.global.b1024.b32
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
.. code-block:: cuda

   // tensormap.replace.tile.global_dim.assume_large.space.b1024.b32 [tm_addr], ord, new_val; // PTX ISA 94, SM_90a, SM_100a, SM_100f, SM_103a, SM_103f, SM_107a, SM_107f, SM_110a, SM_110f, SM_120a, SM_120f, SM_121a, SM_121f
   // .space     = { .global }
   template <int N32, typename B32, enable_if_t<sizeof(B32) == 4, bool> = true>
...
tensormap.replace.tile.global_dim.assume_large.shared::cta.b1024.b32
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
.. code-block:: cuda
...
tensormap.replace.tile.global_stride.assume_large.global.b1024.b64
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
.. code-block:: cuda

   // tensormap.replace.tile.global_stride.assume_large.space.b1024.b64 [tm_addr], ord, new_val; // PTX ISA 94, SM_90a, SM_100a, SM_100f, SM_103a, SM_103f, SM_107a, SM_107f, SM_110a, SM_110f, SM_120a, SM_120f, SM_121a, SM_121f
   // .space     = { .global }
   template <int N32, typename B64, enable_if_t<sizeof(B64) == 8, bool> = true>
...
tensormap.replace.tile.global_stride.assume_large.shared::cta.b1024.b64
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
.. code-block:: cuda
...
tensormap.replace.tile.elemtype.assume_large.global.b1024.b32
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
.. code-block:: cuda

   // tensormap.replace.tile.elemtype.assume_large.space.b1024.b32 [tm_addr], new_val; // PTX ISA 94, SM_90a, SM_100a, SM_100f, SM_103a, SM_103f, SM_107a, SM_107f, SM_110a, SM_110f, SM_120a, SM_120f, SM_121a, SM_121f
   // .space     = { .global }
   template <int N32>
...
tensormap.replace.tile.elemtype.assume_large.shared::cta.b1024.b32
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
.. code-block:: cuda
...
tensormap.replace.tile.interleave_layout.assume_large.global.b1024.b32
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
.. code-block:: cuda

   // tensormap.replace.tile.interleave_layout.assume_large.space.b1024.b32 [tm_addr], new_val; // PTX ISA 94, SM_90a, SM_100a, SM_100f, SM_103a, SM_103f, SM_107a, SM_107f, SM_110a, SM_110f, SM_120a, SM_120f, SM_121a, SM_121f
   // .space     = { .global }
   template <int N32>
...
tensormap.replace.tile.interleave_layout.assume_large.shared::cta.b1024.b32
^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^^
.. code-block:: cuda
