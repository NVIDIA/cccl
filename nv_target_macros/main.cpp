...
// static_assert(__NV_TARGET_VERSION_03_00 == 300);
// static_assert(__NV_TARGET_VERSION_03_01 == 301);
// static_assert(__NV_TARGET_VERSION_03_02 == 302);
static_assert(__NV_TARGET_VERSION_MAX == 302);
