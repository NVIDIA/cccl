...
__host__ __device__ TEST_NODISCARD TEST_CONSTEXPR_CXX14 bool
...
template <class T, class U = T>
__host__ __device__ TEST_NODISCARD TEST_CONSTEXPR_CXX14 bool testComparisons(const T& t1, const U& t2, bool isEqual, bool isLess) {
...
__host__ __device__ TEST_NODISCARD TEST_CONSTEXPR_CXX14 bool testComparisonsValues(Param val1, Param val2)
{
...
template <class Order, class T, class U = T>
__host__ __device__ TEST_NODISCARD constexpr bool testOrder(const T& t1, const U& t2, Order order) {
...
template <class T, class Param>
__host__ __device__ TEST_NODISCARD constexpr bool testOrderValues(Param val1, Param val2) {
...
template <class T, class U = T>
__host__ __device__ TEST_NODISCARD TEST_CONSTEXPR_CXX14 bool testEquality(const T& t1, const U& t2, bool isEqual)
{
    if (isEqual)
        {
        if (!(t1 == t2)) return false;
...
//  Easy call when you can init from something already comparable.
template <class T, class Param>
__host__ __device__ TEST_NODISCARD TEST_CONSTEXPR_CXX14 bool testEqualityValues(Param val1, Param val2)
{
    const bool isEqual = val1 == val2;
