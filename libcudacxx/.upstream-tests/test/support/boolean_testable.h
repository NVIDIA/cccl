...
public:
  ...
  __host__ __device__ constexpr BooleanTestable(bool value) : value_{value} {}
...
public:
  ...
  __host__ __device__ constexpr StrictComparable(T value) : value_{value} {}

  __host__ __device__ friend constexpr BooleanTestable operator==(const StrictComparable& lhs, const StrictComparable& rhs) {
    return (lhs.value_ == rhs.value_);
  }
