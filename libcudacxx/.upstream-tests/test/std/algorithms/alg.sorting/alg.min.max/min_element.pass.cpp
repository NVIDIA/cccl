...
STATIC_TEST_GLOBAL_VAR TEST_CONSTEXPR_GLOBAL int il[] = { 2, 4, 6, 8, 7, 5, 3, 1 };

__host__ __device__ void constexpr_test()
{
    constexpr auto p = cuda::std::min_element(il, il+8);
    static_assert ( *p == 1, "" );
}
...
int main(int, char**)
{
 ...
 && !defined(TEST_COMPILER_NVCC_BELOW_11_3)
    constexpr_test();
#endif // TEST_STD_VER >= 14 && !defined(TEST_COMPILER_NVCC_BELOW_11_3)
