...
struct Base {
  ...
  __host__ __device__ constexpr auto end() { return sentinel_wrapper<int*>(nullptr); }
  __host__ __device__ constexpr char *begin() const { return nullptr; }
  __host__ __device__ constexpr auto end() const { return sentinel_wrapper<char*>(nullptr); }
};
