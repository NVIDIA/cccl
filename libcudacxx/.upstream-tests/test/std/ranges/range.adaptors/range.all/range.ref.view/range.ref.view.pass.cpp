...
struct Range {
  int start = 0;
  __host__ __device__ friend constexpr int* begin(Range const& range) { return globalBuff + range.start; }
  __host__ __device__ friend constexpr int* end(Range const&) { return globalBuff + 8; }
  __host__ __device__ friend constexpr int* begin(Range& range) { return globalBuff + range.start; }
  __host__ __device__ friend constexpr int* end(Range&) { return globalBuff + 8; }
};
...
static_assert(cuda::std::derived_from<cuda::std::ranges::ref_view<Range>, cuda::std::ranges::view_interface<cuda::std::ranges::ref_view<Range>>>);
...
struct Cpp17InputRange {
  struct sentinel {
    __host__ __device__ friend constexpr bool operator==(sentinel, cpp17_input_iterator<int*> iter) { return base(iter) == globalBuff + 8; }
#if TEST_STD_VER < 20
    __host__ __device__ friend constexpr bool operator==(cpp17_input_iterator<int*> iter, sentinel) { return base(iter) == globalBuff + 8; }
    __host__ __device__ friend constexpr bool operator!=(sentinel, cpp17_input_iterator<int*> iter) { return base(iter) != globalBuff + 8; }
    __host__ __device__ friend constexpr bool operator!=(cpp17_input_iterator<int*> iter, sentinel) { return base(iter) != globalBuff + 8; }
#endif
    __host__ __device__ friend constexpr cuda::std::ptrdiff_t operator-(sentinel, cpp17_input_iterator<int*>) { return -8; }
    __host__ __device__ friend constexpr cuda::std::ptrdiff_t operator-(cpp17_input_iterator<int*>, sentinel) { return 8; }
  };

  __host__ __device__ constexpr cpp17_input_iterator<int*> begin() const {
    return cpp17_input_iterator<int*>(globalBuff);
  }
  __host__ __device__ constexpr sentinel end() const { return {}; }
};

struct Cpp20InputRange {
  struct sentinel {
    __host__ __device__ friend constexpr bool operator==(sentinel, const cpp20_input_iterator<int*> &iter) { return base(iter) == globalBuff + 8; }
#if TEST_STD_VER < 20
    __host__ __device__ friend constexpr bool operator==(const cpp20_input_iterator<int*> &iter, sentinel) { return base(iter) == globalBuff + 8; }
    __host__ __device__ friend constexpr bool operator!=(sentinel, const cpp20_input_iterator<int*> &iter) { return base(iter) != globalBuff + 8; }
    __host__ __device__ friend constexpr bool operator!=(const cpp20_input_iterator<int*> &iter, sentinel) { return base(iter) != globalBuff + 8; }
#endif
    __host__ __device__ friend constexpr cuda::std::ptrdiff_t operator-(sentinel, const cpp20_input_iterator<int*>&) { return -8; }
  };
...
_LIBCUDACXX_CONCEPT_FRAGMENT(
  EmptyIsInvocable_, requires(cuda::std::ranges::ref_view<R> view)((view.empty())));
template<class R>
_LIBCUDACXX_CONCEPT EmptyIsInvocable = _LIBCUDACXX_FRAGMENT(EmptyIsInvocable_, R);

template<class R>
_LIBCUDACXX_CONCEPT_FRAGMENT(
  SizeIsInvocable_, requires(cuda::std::ranges::ref_view<R> view)((view.size())));
template<class R>
_LIBCUDACXX_CONCEPT SizeIsInvocable = _LIBCUDACXX_FRAGMENT(SizeIsInvocable_, R);

template<class R>
_LIBCUDACXX_CONCEPT_FRAGMENT(
  DataIsInvocable_, requires(cuda::std::ranges::ref_view<R> view)((view.data())));
template<class R>
