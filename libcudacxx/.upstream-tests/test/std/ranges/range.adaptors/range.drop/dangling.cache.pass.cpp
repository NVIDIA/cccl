...
struct ZeroOnDestroy : cuda::std::ranges::view_base {
  ...
  __host__ __device__ constexpr ForwardIter begin() { return ForwardIter(buff); }
  __host__ __device__ constexpr ForwardIter begin() const { return ForwardIter(); }
  __host__ __device__ constexpr ForwardIter end() { return ForwardIter(buff + 8); }
  __host__ __device__ constexpr ForwardIter end() const { return ForwardIter(); }
