...
struct BidirSizedRange : cuda::std::ranges::view_base {
  ...
  __host__ __device__ constexpr BidirSizedRange(int *ptr, size_t size) : ptr_(ptr), size_(size) {}
  ...
  __host__ __device__ constexpr bidirectional_iterator<int*> begin() { return bidirectional_iterator<int*>{ptr_}; }
  __host__ __device__ constexpr bidirectional_iterator<const int*> begin() const { return bidirectional_iterator<const int*>{ptr_}; }
  __host__ __device__ constexpr bidirectional_iterator<int*> end() { return bidirectional_iterator<int*>{ptr_ + 8}; }
  __host__ __device__ constexpr bidirectional_iterator<const int*> end() const { return bidirectional_iterator<const int*>{ptr_ + 8}; }

  __host__ __device__ constexpr size_t size() const { return size_; }
};
