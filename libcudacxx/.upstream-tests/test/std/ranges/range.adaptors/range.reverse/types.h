...
struct BidirRange : cuda::std::ranges::view_base {
  ...
  __host__ __device__ constexpr BidirRange(int* b, int* e) : begin_(b), end_(e) { }

  __host__ __device__ constexpr bidirectional_iterator<int*> begin() { return bidirectional_iterator<int*>{begin_}; }
  __host__ __device__ constexpr bidirectional_iterator<const int*> begin() const { return bidirectional_iterator<const int*>{begin_}; }
  __host__ __device__ constexpr bidirectional_iterator<int*> end() { return bidirectional_iterator<int*>{end_}; }
  __host__ __device__ constexpr bidirectional_iterator<const int*> end() const { return bidirectional_iterator<const int*>{end_}; }
};
...
struct BidirSentRangeBase {
  ...
  __host__ __device__ constexpr BidirSentRangeBase(int* b, int* e) : begin_(b), end_(e) { }
...
template<CopyCategory CC>
struct BidirSentRange : cuda::std::ranges::view_base, BidirSentRangeBase<CC> {
  ...
  __host__ __device__ constexpr bidirectional_iterator<int*> begin() { return bidirectional_iterator<int*>{this->begin_}; }
  __host__ __device__ constexpr bidirectional_iterator<const int*> begin() const { return bidirectional_iterator<const int*>{this->begin_}; }
  __host__ __device__ constexpr sent_t end() { return sent_t{bidirectional_iterator<int*>{this->end_}}; }
  __host__ __device__ constexpr sent_const_t end() const { return sent_const_t{bidirectional_iterator<const int*>{this->end_}}; }
};
