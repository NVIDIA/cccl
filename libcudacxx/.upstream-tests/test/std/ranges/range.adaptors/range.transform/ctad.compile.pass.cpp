...
using result_rvlaue_borrowed_range = cuda::std::ranges::transform_view<cuda::std::ranges::owning_view<BorrowedRange>, PlusOne>;
...
__host__ __device__ void testCTAD() {
    ...
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::transform_view(v, f)),
        cuda::std::ranges::transform_view<View, PlusOne>
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::transform_view(cuda::std::move(v), f)),
        cuda::std::ranges::transform_view<View, PlusOne>
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::transform_view(r, f)),
        cuda::std::ranges::transform_view<cuda::std::ranges::ref_view<Range>, PlusOne>
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::transform_view(cuda::std::move(r), f)),
        result_rvlaue_range
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::transform_view(br, f)),
        cuda::std::ranges::transform_view<cuda::std::ranges::ref_view<BorrowedRange>, PlusOne>
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::transform_view(cuda::std::move(br), f)),
