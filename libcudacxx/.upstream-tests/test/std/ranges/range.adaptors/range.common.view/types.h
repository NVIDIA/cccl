...
struct DefaultConstructibleView : cuda::std::ranges::view_base {
  ...
  __host__ __device__ constexpr auto end() const { return sentinel_wrapper<int*>(end_); }
};
...
struct MoveOnlyView : cuda::std::ranges::view_base {
  int* begin_;
  int* end_;
  __host__ __device__ constexpr explicit MoveOnlyView(int* b, int* e) : begin_(b), end_(e) { }
...
struct CopyableView : cuda::std::ranges::view_base {
  int* begin_;
  int* end_;
  __host__ __device__ constexpr explicit CopyableView(int* b, int* e) : begin_(b), end_(e) { }
  __host__ __device__ constexpr int *begin() const { return begin_; }
  __host__ __device__ constexpr auto end() const { return sentinel_wrapper<int*>(end_); }
};
...
struct SizedForwardView : cuda::std::ranges::view_base {
  int* begin_;
  int* end_;
  __host__ __device__ constexpr explicit SizedForwardView(int* b, int* e) : begin_(b), end_(e) { }
...
struct SizedRandomAccessView : cuda::std::ranges::view_base {
  int* begin_;
  int* end_;
  __host__ __device__ constexpr explicit SizedRandomAccessView(int* b, int* e) : begin_(b), end_(e) { }
  __host__ __device__ constexpr auto begin() const { return random_access_iterator<int*>(begin_); }
  __host__ __device__ constexpr auto end() const { return sized_sentinel<random_access_iterator<int*>>(random_access_iterator<int*>(end_)); }
};
...
struct CommonView : cuda::std::ranges::view_base {
  int* begin_;
  int* end_;
  __host__ __device__ constexpr explicit CommonView(int* b, int* e) : begin_(b), end_(e) { }
  __host__ __device__ constexpr int *begin() const { return begin_; }
...
struct NonCommonView : cuda::std::ranges::view_base {
  int* begin_;
  int* end_;
  __host__ __device__ constexpr explicit NonCommonView(int* b, int* e) : begin_(b), end_(e) { }
  __host__ __device__ constexpr int *begin() const { return begin_; }
  __host__ __device__ constexpr auto end() const { return sentinel_wrapper<int*>(end_); }
};
