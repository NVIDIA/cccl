...
using result_common_view_owning_borrowed = cuda::std::ranges::common_view<cuda::std::ranges::owning_view<BorrowedRange>>;
...
__host__ __device__ void testCTAD() {
    ...
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::common_view(v)),
        result_common_view
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::common_view(cuda::std::move(v))),
        result_common_view
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::common_view(r)),
        result_common_view_ref
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::common_view(cuda::std::move(r))),
        result_common_view_owning
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::common_view(br)),
        result_common_view_ref_borrowed
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::common_view(cuda::std::move(br))),
