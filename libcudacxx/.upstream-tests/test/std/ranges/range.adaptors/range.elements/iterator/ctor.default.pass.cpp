...
struct IterNoDefaultCtrView : cuda::std::ranges::view_base {
  __host__ __device__ cpp20_input_iterator<cuda::std::tuple<int>*> begin() const { return cpp20_input_iterator<cuda::std::tuple<int>*>{nullptr}; }
  __host__ __device__ sentinel_wrapper<cpp20_input_iterator<cuda::std::tuple<int>*>> end() const { return sentinel_wrapper<cpp20_input_iterator<cuda::std::tuple<int>*>>{}; }
};
