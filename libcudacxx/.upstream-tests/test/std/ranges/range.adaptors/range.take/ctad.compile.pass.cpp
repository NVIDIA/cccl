...
__host__ __device__ void testCTAD() {
    ...
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::take_view(v, 0)),
        result_take_view
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::take_view(cuda::std::move(v), 0)),
        result_take_view
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::take_view(r, 0)),
        result_take_view_ref
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::take_view(cuda::std::move(r), 0)),
        result_take_view_owning
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::take_view(br, 0)),
        result_take_view_ref_borrowed
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::take_view(cuda::std::move(br), 0)),
