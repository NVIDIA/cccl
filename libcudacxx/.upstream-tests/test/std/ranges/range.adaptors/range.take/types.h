...
struct MoveOnlyView : cuda::std::ranges::view_base {
  ...
  __host__ __device__ constexpr explicit MoveOnlyView(int* ptr) : ptr_(ptr) {}
  MoveOnlyView(MoveOnlyView&&) = default;
  MoveOnlyView& operator=(MoveOnlyView&&) = default;

  __host__ __device__ constexpr int* begin() const {return ptr_;}
  __host__ __device__ constexpr sentinel_wrapper<int*> end() const {return sentinel_wrapper<int*>{ptr_ + 8};}
};
...
struct CopyableView : cuda::std::ranges::view_base {
  int *ptr_;
  __host__ __device__ constexpr explicit CopyableView(int* ptr) : ptr_(ptr) {}
...
struct SizedForwardView : cuda::std::ranges::view_base {
  int *ptr_;
  __host__ __device__ constexpr explicit SizedForwardView(int* ptr) : ptr_(ptr) {}
  __host__ __device__ constexpr auto begin() const { return ForwardIter(ptr_); }
  __host__ __device__ constexpr auto end() const { return sized_sentinel<ForwardIter>(ForwardIter(ptr_ + 8)); }
};
...
struct SizedRandomAccessView : cuda::std::ranges::view_base {
  int *ptr_;
  __host__ __device__ constexpr explicit SizedRandomAccessView(int* ptr) : ptr_(ptr) {}
  __host__ __device__ constexpr auto begin() const { return RandomAccessIter(ptr_); }
  __host__ __device__ constexpr auto end() const { return sized_sentinel<RandomAccessIter>(RandomAccessIter(ptr_ + 8)); }
};
