...
__host__ __device__ void testCTAD() {
    ...
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::join_view(v)),
        result_join_view
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::join_view(cuda::std::move(v))),
        result_join_view
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::join_view(r)),
        result_join_view_ref
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::join_view(cuda::std::move(r))),
        result_join_view_owning
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::join_view(br)),
        result_join_view_ref_borrowed
    >);
    static_assert(cuda::std::same_as<
        decltype(cuda::std::ranges::join_view(cuda::std::move(br))),
        result_join_view_owning_borrowed
    >);
    unused(v);
    unused(r);
    unused(br);
