...
struct Copyable {
  __host__ __device__ constexpr Copyable() : val_(0) {}
  __host__ __device__ constexpr Copyable(const Copyable&) : val_(0) {}
  __host__ __device__ constexpr Copyable(Copyable&&) : val_(0) {}
