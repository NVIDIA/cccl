...
struct IterSwappingIt {
  ...
  __host__ __device__ constexpr explicit IterSwappingIt(int *swaps) : swaps_(swaps) {}
  ...
  __host__ __device__ constexpr IterSwappingIt& operator++() { return *this; }
...
#else
  __host__ __device__ friend bool operator==(const IterSwappingIt&, cuda::std::default_sentinel_t) { return true; }
  __host__ __device__ friend bool operator==(cuda::std::default_sentinel_t, const IterSwappingIt&) { return true; };
  __host__ __device__ friend bool operator!=(const IterSwappingIt&, cuda::std::default_sentinel_t) { return false; };
  __host__ __device__ friend bool operator!=(cuda::std::default_sentinel_t, const IterSwappingIt&) { return false; };
#endif
