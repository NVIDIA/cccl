...
public:
  ...
  __host__ __device__ __host__ __device__ explicit constexpr HasNoexceptIterSwap(int *it) : it_(it) {}

  __host__ __device__ constexpr reference operator*() const {return *it_;}

  __host__ __device__ constexpr HasNoexceptIterSwap& operator++() {++it_; return *this;}
  __host__ __device__ constexpr HasNoexceptIterSwap operator++(int)
      {HasNoexceptIterSwap tmp(*this); ++(*this); return tmp;}

  __host__ __device__ friend void iter_swap(
