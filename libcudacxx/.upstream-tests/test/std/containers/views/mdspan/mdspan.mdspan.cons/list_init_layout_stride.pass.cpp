...
int main(int, char**)
{
    ...
    cuda::std::mdspan< int
                     , cuda::std::extents<size_t, dyn, dyn>
                     , cuda::std::layout_stride
                     >
                     m { d.data()
                       , cuda::std::layout_stride::template mapping<cuda::std::dextents<size_t,2>>{cuda::std::dextents<size_t,2>{16, 32}, cuda::std::array<size_t, 2>{1, 128}}
                       };
