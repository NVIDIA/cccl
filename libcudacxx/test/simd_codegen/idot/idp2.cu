...
; SMXX-LABEL: {{[[:space:]]*}}Function : {{.*test_idot_s16_s8_x5.*}}
; SMXX: {{.*IDP\.2A\.LO\.S16\.S8.*}}
; SMXX: {{.*IDP\.2A\.HI\.S16\.S8.*}}
; SMXX: {{.*IDP\.2A\.LO\.S16\.S8.*}}

; SMXX-LABEL: {{[[:space:]]*}}Function : {{.*test_idot_u8_u16.*}}
; SMXX: {{.*IDP\.2A\.LO\.U16\.U8.*}}
; SMXX: {{.*IDP\.2A\.HI\.U16\.U8.*}}

; SMXX-LABEL: {{[[:space:]]*}}Function : {{.*test_idot_u16_u8.*}}
; SMXX: {{.*IDP\.2A\.LO\.U16\.U8.*}}
; SMXX: {{.*IDP\.2A\.HI\.U16\.U8.*}}

; SMXX-LABEL: {{[[:space:]]*}}Function : {{.*test_idot_s8_u16.*}}
; SMXX: {{.*IDP\.2A\.LO\.U16\.S8.*}}
; SMXX: {{.*IDP\.2A\.HI\.U16\.S8.*}}

; SMXX-LABEL: {{[[:space:]]*}}Function : {{.*test_idot_u16_s8.*}}
; SMXX: {{.*IDP\.2A\.LO\.U16\.S8.*}}
; SMXX: {{.*IDP\.2A\.HI\.U16\.S8.*}}

; SMXX-LABEL: {{[[:space:]]*}}Function : {{.*test_idot_u8_s16.*}}
; SMXX: {{.*IDP\.2A\.LO\.S16\.U8.*}}
; SMXX: {{.*IDP\.2A\.HI\.S16\.U8.*}}

; SMXX-LABEL: {{[[:space:]]*}}Function : {{.*test_idot_s16_u8.*}}
; SMXX: {{.*IDP\.2A\.LO\.S16\.U8.*}}
; SMXX: {{.*IDP\.2A\.HI\.S16\.U8.*}}

; SMXX-LABEL: {{[[:space:]]*}}Function : {{.*test_idot_s8_s16.*}}
; SMXX: {{.*IDP\.2A\.LO\.S16\.S8.*}}
; SMXX: {{.*IDP\.2A\.HI\.S16\.S8.*}}

; SMXX-LABEL: {{[[:space:]]*}}Function : {{.*test_idot_s16_s8.*}}
; SMXX: {{.*IDP\.2A\.LO\.S16\.S8.*}}
; SMXX: {{.*IDP\.2A\.HI\.S16\.S8.*}}
