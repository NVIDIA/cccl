...
__device__ void test_dims(const uint3 exp, const Level& level, const Args&... args)
{
...
template <class Level, class... Args>
__device__ void test_static_dims(const ulonglong3 exp, const Level& level, const Args&... args)
{
  test_result(level.static_dims(args...), exp);
}

template <class Exp, class Level, class... Args>
__device__ void test_extents(const Exp exp, const Level& level, const Args&... args)
{
...
template <class Level, class... Args>
__device__ void test_count(const cuda::std::size_t exp, const Level& level, const Args&... args)
{
...
template <class Level, class... Args>
__device__ void test_index(const uint3 exp, const Level& level, const Args&... args)
{
...
template <class Level, class... Args>
__device__ void test_rank(const cuda::std::size_t exp, const Level& level, const Args&... args)
{
