...
struct cpp03_friendly {
  TEST_HOST_DEVICE cpp03_friendly(cpp03_friendly const&);
  TEST_HOST_DEVICE cpp03_friendly& operator=(cpp03_friendly const&);
};

struct const_move_ctor {
  TEST_HOST_DEVICE const_move_ctor(const_move_ctor const&&);
  TEST_HOST_DEVICE const_move_ctor& operator=(const_move_ctor&&);
};

struct volatile_move_ctor {
  TEST_HOST_DEVICE volatile_move_ctor(volatile_move_ctor volatile&&);
  TEST_HOST_DEVICE volatile_move_ctor& operator=(volatile_move_ctor&&);
};

struct cv_move_ctor {
  TEST_HOST_DEVICE cv_move_ctor(cv_move_ctor const volatile&&);
  TEST_HOST_DEVICE cv_move_ctor& operator=(cv_move_ctor&&);
};

struct multi_param_move_ctor {
  TEST_HOST_DEVICE multi_param_move_ctor(multi_param_move_ctor&&, int = 0);
  TEST_HOST_DEVICE multi_param_move_ctor& operator=(multi_param_move_ctor&&);
};

struct not_quite_multi_param_move_ctor {
  TEST_HOST_DEVICE not_quite_multi_param_move_ctor(not_quite_multi_param_move_ctor&&, int);
  TEST_HOST_DEVICE not_quite_multi_param_move_ctor& operator=(not_quite_multi_param_move_ctor&&);
};

struct copy_with_mutable_parameter {
  TEST_HOST_DEVICE copy_with_mutable_parameter(copy_with_mutable_parameter&);
  TEST_HOST_DEVICE copy_with_mutable_parameter&
  operator=(copy_with_mutable_parameter&);
};

struct const_move_assignment {
  TEST_HOST_DEVICE const_move_assignment& operator=(const_move_assignment&&) const;
};

struct volatile_move_assignment {
  TEST_HOST_DEVICE const_move_assignment& operator=(const_move_assignment&&) volatile;
};

struct cv_move_assignment {
  TEST_HOST_DEVICE cv_move_assignment& operator=(cv_move_assignment&&) const volatile;
};

struct const_move_assign_and_traditional_move_assign {
  TEST_HOST_DEVICE const_move_assign_and_traditional_move_assign&
...
struct volatile_move_assign_and_traditional_move_assign {
  TEST_HOST_DEVICE volatile_move_assign_and_traditional_move_assign&
...
struct cv_move_assign_and_traditional_move_assign {
  TEST_HOST_DEVICE cv_move_assign_and_traditional_move_assign&
...
struct const_move_assign_and_default_ops {
  ...
  TEST_HOST_DEVICE const_move_assign_and_default_ops&
...
struct volatile_move_assign_and_default_ops {
  ...
  TEST_HOST_DEVICE volatile_move_assign_and_default_ops&
...
struct cv_move_assign_and_default_ops {
  ...
  TEST_HOST_DEVICE cv_move_assign_and_default_ops&
...
struct deleted_assignment_from_const_rvalue {
  TEST_HOST_DEVICE deleted_assignment_from_const_rvalue(
      deleted_assignment_from_const_rvalue const&);
  TEST_HOST_DEVICE deleted_assignment_from_const_rvalue(deleted_assignment_from_const_rvalue&&);
  TEST_HOST_DEVICE deleted_assignment_from_const_rvalue&
