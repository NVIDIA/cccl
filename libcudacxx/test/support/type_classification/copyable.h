...
struct const_copy_assignment {
  ...
  __host__ __device__ const_copy_assignment const&
  operator=(const_copy_assignment const&) const;
};
...
struct volatile_copy_assignment {
  ...
  __host__ __device__ volatile_copy_assignment&
  operator=(volatile_copy_assignment&&);
