...
struct non_copyable
{
  ...
  TEST_FUNC non_copyable(non_copyable&&) {}
  TEST_FUNC non_copyable& operator=(non_copyable&&)
  {
    return *this;
  }
...
struct const_copy_assignment
{
  ...
  TEST_FUNC const_copy_assignment(const_copy_assignment const&);
  TEST_FUNC const_copy_assignment(const_copy_assignment&&);

  TEST_FUNC const_copy_assignment& operator=(const_copy_assignment&&);
  TEST_FUNC const_copy_assignment const& operator=(const_copy_assignment const&) const;
};
...
struct volatile_copy_assignment
{
  ...
  TEST_FUNC volatile_copy_assignment(volatile_copy_assignment volatile&);
  TEST_FUNC volatile_copy_assignment(volatile_copy_assignment volatile&&);

  TEST_FUNC volatile_copy_assignment& operator=(volatile_copy_assignment&&);
  TEST_FUNC volatile_copy_assignment volatile& operator=(volatile_copy_assignment const&) volatile;
};
...
struct cv_copy_assignment
{
  ...
  TEST_FUNC cv_copy_assignment(cv_copy_assignment const volatile&);
  TEST_FUNC cv_copy_assignment(cv_copy_assignment const volatile&&);

  TEST_FUNC cv_copy_assignment const volatile& operator=(cv_copy_assignment const volatile&) const volatile;
  TEST_FUNC cv_copy_assignment const volatile& operator=(cv_copy_assignment const volatile&&) const volatile;
};
