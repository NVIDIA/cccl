...
public:
  ...
  typedef
      typename cuda::std::iterator_traits<It>::difference_type difference_type;
  typedef It pointer;
  ...
  cpp17_output_iterator(const cpp17_output_iterator<U>& u)
      : it_(u.it_) {}

  template <class U, class = typename cuda::std::enable_if<
                         cuda::std::is_default_constructible<U>::value>::type>
  __host__ __device__ TEST_CONSTEXPR_CXX14
  cpp17_output_iterator(cpp17_output_iterator<U>&& u)
      : it_(u.it_) {
    u.it_ = U();
  }
  ...
  __host__ __device__ TEST_CONSTEXPR_CXX14 cpp17_output_iterator
  operator++(int) {
    return cpp17_output_iterator(it_++);
  }

  __host__ __device__ friend TEST_CONSTEXPR It
  base(const cpp17_output_iterator& i) {
    return i.it_;
  }
...
public:
  ...
  template <class U, class T>
  __host__ __device__ TEST_CONSTEXPR
  cpp17_input_iterator(const cpp17_input_iterator<U, T>& u)
      : it_(u.it_) {}

  template <class U, class T,
            class = typename cuda::std::enable_if<
                cuda::std::is_default_constructible<U>::value>::type>
  __host__ __device__ TEST_CONSTEXPR_CXX14
  cpp17_input_iterator(cpp17_input_iterator<U, T>&& u)
      : it_(u.it_) {
    u.it_ = U();
  }
  ...
  __host__ __device__ TEST_CONSTEXPR_CXX14 cpp17_input_iterator
  operator++(int) {
  ...
  __host__ __device__ friend TEST_CONSTEXPR It
  base(const cpp17_input_iterator& i) {
    return i.it_;
  }
...
public:
  ...
  template <class U>
  __host__ __device__ TEST_CONSTEXPR
  forward_iterator(const forward_iterator<U>& u)
      : it_(u.it_) {}
...
public:
  ...
  template <class U, class = typename cuda::std::enable_if<
                         cuda::std::is_default_constructible<U>::value>::type>
  __host__ __device__ TEST_CONSTEXPR_CXX14
  bidirectional_iterator(bidirectional_iterator<U>&& u)
      : it_(u.it_) {
    u.it_ = U();
  }
  ...
  __host__ __device__ TEST_CONSTEXPR_CXX14 bidirectional_iterator&
  operator++() {
    ++it_;
    return *this;
  }
  ...
  __host__ __device__ friend TEST_CONSTEXPR It
  base(const bidirectional_iterator& i) {
    return i.it_;
  }
...
public:
  ...
  template <class U, class = typename cuda::std::enable_if<
                         cuda::std::is_default_constructible<U>::value>::type>
  __host__ __device__ TEST_CONSTEXPR_CXX14
  random_access_iterator(random_access_iterator<U>&& u)
      : it_(u.it_) {
    u.it_ = U();
  }
  ...
  __host__ __device__ TEST_CONSTEXPR_CXX14 reference
  operator[](difference_type n) const {
    return it_[n];
  }

  __host__ __device__ TEST_CONSTEXPR_CXX14 random_access_iterator&
  operator++() {
    ++it_;
    return *this;
  }
  ...
  __host__ __device__ friend TEST_CONSTEXPR difference_type
  ...
  __host__ __device__ friend TEST_CONSTEXPR It
  base(const random_access_iterator& i) {
    return i.it_;
  }
...
public:
  ...
  using difference_type =
      typename cuda::std::iterator_traits<It>::difference_type;
  ...
  cpp20_random_access_iterator(const cpp20_random_access_iterator<U>& u)
      : it_(u.it_) {}

  template <class U>
  __host__ __device__ constexpr
  cpp20_random_access_iterator(cpp20_random_access_iterator<U>&& u)
      : it_(u.it_) {
    u.it_ = U();
  }
  ...
  operator==(const cpp20_random_access_iterator& x,
             const cpp20_random_access_iterator& y) {
    return x.it_ == y.it_;
  }
  __host__ __device__ friend constexpr bool
  operator!=(const cpp20_random_access_iterator& x,
  ...
  __host__ __device__ friend constexpr It
  base(const cpp20_random_access_iterator& i) {
    return i.it_;
  }
...
static_assert(
    cuda::std::random_access_iterator<cpp20_random_access_iterator<int*> >, "");

template <class It>
class contiguous_iterator {
  static_assert(cuda::std::is_pointer_v<It>,
...
public:
  ...
  template <class U, class = cuda::std::enable_if_t<
                         cuda::std::is_constructible<It, const U&>::value> >
  __host__ __device__ TEST_CONSTEXPR_CXX14
  contiguous_iterator(const contiguous_iterator<U>& u)
      : it_(u.it_) {}

  template <class U, class = cuda::std::enable_if_t<
                         cuda::std::is_constructible<It, U>::value &&
  ...
  __host__ __device__ TEST_CONSTEXPR reference
  operator[](difference_type n) const {
    return it_[n];
  }
  ...
  __host__ __device__ friend TEST_CONSTEXPR_CXX14 contiguous_iterator
  operator+(contiguous_iterator x, difference_type n) {
    x += n;
    return x;
  }
  __host__ __device__ friend TEST_CONSTEXPR_CXX14 contiguous_iterator
  operator+(difference_type n, contiguous_iterator x) {
    x += n;
    return x;
  }
  __host__ __device__ friend TEST_CONSTEXPR_CXX14 contiguous_iterator
  ...
  __host__ __device__ friend TEST_CONSTEXPR difference_type
  operator-(contiguous_iterator x, contiguous_iterator y) {
    return x.it_ - y.it_;
  }

  __host__ __device__ friend TEST_CONSTEXPR bool
  operator==(const contiguous_iterator& x, const contiguous_iterator& y) {
    return x.it_ == y.it_;
  }
  __host__ __device__ friend TEST_CONSTEXPR bool
  operator!=(const contiguous_iterator& x, const contiguous_iterator& y) {
  ...
  __host__ __device__ friend TEST_CONSTEXPR It
  base(const contiguous_iterator& i) {
    return i.it_;
  }
...
public:
  ...
  template <class U>
  __host__ __device__ constexpr
  three_way_contiguous_iterator(const three_way_contiguous_iterator<U>& u)
      : it_(u.it_) {}

  template <class U, class = typename cuda::std::enable_if<
                         cuda::std::is_default_constructible<U>::value>::type>
  __host__ __device__ constexpr
  three_way_contiguous_iterator(three_way_contiguous_iterator<U>&& u)
      : it_(u.it_) {
    u.it_ = U();
  }
  ...
  __host__ __device__ friend constexpr auto operator<= >
      (const three_way_contiguous_iterator& x,
       const three_way_contiguous_iterator& y) {
    return x.it_ <= > y.it_;
  }
  __host__ __device__ friend constexpr bool
  operator==(const three_way_contiguous_iterator& x,
             const three_way_contiguous_iterator& y) {
    return x.it_ == y.it_;
  }
...
struct ThrowingIterator {
  ...
  __host__ __device__ TEST_CONSTEXPR ThrowingIterator()
      : begin_(nullptr), end_(nullptr), current_(nullptr),
        action_(TADereference), index_(0) {}
  __host__ __device__ TEST_CONSTEXPR explicit ThrowingIterator(
      const T* first, const T* last, int index = 0,
      ThrowingAction action = TADereference)
      : begin_(first), end_(last), current_(first), action_(action),
        index_(index) {}
  __host__ __device__ TEST_CONSTEXPR
  ThrowingIterator(const ThrowingIterator& rhs)
      : begin_(rhs.begin_), end_(rhs.end_), current_(rhs.current_),
        action_(rhs.action_), index_(rhs.index_) {}

  __host__ __device__ TEST_CONSTEXPR_CXX14 ThrowingIterator&
  ...
  operator==(const ThrowingIterator& a, const ThrowingIterator& b) {
  ...
  __host__ __device__ TEST_CONSTEXPR friend bool
  operator!=(const ThrowingIterator& a, const ThrowingIterator& b) {
    return !(a == b);
  }
...
struct NonThrowingIterator {
  ...
  __host__ __device__ NonThrowingIterator()
      : begin_(nullptr), end_(nullptr), current_(nullptr) {}
  __host__ __device__ explicit NonThrowingIterator(const T* first,
                                                   const T* last)
  ...
  __host__ __device__ NonThrowingIterator&
  operator=(const NonThrowingIterator& rhs) TEST_NOEXCEPT {
    begin_ = rhs.begin_;
    end_ = rhs.end_;
    current_ = rhs.current_;
    return *this;
  ...
  operator==(const NonThrowingIterator& a,
             const NonThrowingIterator& b) TEST_NOEXCEPT {
    bool atEndL = a.current_ == a.end_;
    bool atEndR = b.current_ == b.end_;
    if (atEndL != atEndR)
      return false; // one is at the end (or empty), the other is not.
...
template <class It>
struct iter_value_or_void<
    It, cuda::std::enable_if_t<cuda::std::input_or_output_iterator<It> &&
                               !cuda::std::input_iterator<It> > > {
  using type = void;
};

template <class It>
struct iter_value_or_void<
    It, cuda::std::enable_if_t<cuda::std::input_iterator<It> > > {
...
public:
  ...
  using iterator_concept = cuda::std::conditional_t<
      cuda::std::contiguous_iterator<It>, cuda::std::contiguous_iterator_tag,
  ...
  stride_counting_iterator() requires cuda::std::default_initializable<It> =
      default;
#else
  template <class It2 = It, cuda::std::enable_if_t<
                                cuda::std::default_initializable<It2>, int> = 0>
  ...
  __host__ __device__ friend constexpr It
  base(stride_counting_iterator const& it) {
    return It(it.base_);
  }
  ...
  template <
      class It2 = It,
      cuda::std::enable_if_t<cuda::std::random_access_iterator<It2>, int> = 0>
  __host__ __device__ constexpr decltype(auto)
  operator[](difference_type n) const {
    return It(base_)[n];
  }
  ...
  template <class It2 = It,
            cuda::std::enable_if_t<!cuda::std::forward_iterator<It2>, int> = 0>
  ...
  template <
      class It2 = It,
      cuda::std::enable_if_t<cuda::std::bidirectional_iterator<It2>, int> = 0>
  __host__ __device__ constexpr stride_counting_iterator& operator--() {
    It tmp(base_);
    base_ = base(--tmp);
    ++stride_count_;
  ...
  template <
      class It2 = It,
      cuda::std::enable_if_t<cuda::std::random_access_iterator<It2>, int> = 0>
  __host__ __device__ constexpr stride_counting_iterator&
  ...
  template <
      class It2 = It,
      cuda::std::enable_if_t<cuda::std::random_access_iterator<It2>, int> = 0>
  __host__ __device__ friend constexpr stride_counting_iterator
  ...
  template <
      class It2 = It,
      cuda::std::enable_if_t<cuda::std::sized_sentinel_for<It2, It2>, int> = 0>
  __host__ __device__ friend constexpr difference_type operator-(
      stride_counting_iterator const& x, stride_counting_iterator const& y) {
    return base(x) - base(y);
  }

  template <class It2 = It,
            cuda::std::enable_if_t<cuda::std::sentinel_for<It2, It2>, int> = 0>
  __host__ __device__ constexpr bool
  operator==(stride_counting_iterator const& other) const {
  ...
  template <
      ...
      cuda::std::enable_if_t<cuda::std::random_access_iterator<It2>, int> = 0>
  __host__ __device__ friend constexpr bool
  operator<(stride_counting_iterator const& x,
            stride_counting_iterator const& y) {
...
public:
  ...
  __host__ __device__ constexpr explicit sentinel_wrapper(const It& it)
      : base_(base(it)) {}
  __host__ __device__ friend constexpr bool
  operator==(const sentinel_wrapper& s, const It& i) {
    return s.base_ == base(i);
  }
#if TEST_STD_VER < 2020
  __host__ __device__ friend constexpr bool
  operator==(const It& i, const sentinel_wrapper& s) {
    return s.base_ == base(i);
  }
  __host__ __device__ friend constexpr bool
  operator!=(const sentinel_wrapper& s, const It& i) {
...
public:
  ...
  __host__ __device__ constexpr explicit sized_sentinel(const It& it)
      : base_(base(it)) {}
  __host__ __device__ friend constexpr bool operator==(const sized_sentinel& s,
                                                       const It& i) {
    return s.base_ == base(i);
  }
#if TEST_STD_VER < 2020
  __host__ __device__ friend constexpr bool
  operator==(const It& i, const sized_sentinel& s) {
    return s.base_ == base(i);
  }
  __host__ __device__ friend constexpr bool operator!=(const sized_sentinel& s,
                                                       const It& i) {
...
#endif
  __host__ __device__ friend constexpr auto operator-(const sized_sentinel& s,
                                                      const It& i) {
    return s.base_ - base(i);
  }
  __host__ __device__ friend constexpr auto operator-(const It& i,
                                                      const sized_sentinel& s) {
...
private:
  ...
  __host__ __device__ constexpr Iterator(int* p, int* iter_moves,
                                         int* iter_swaps)
      : ptr_(p), iter_moves_(iter_moves), iter_swaps_(iter_swaps) {}

public:
  constexpr Iterator() = default;
  __host__ __device__ static constexpr Iterator TrackMoves(int* p,
                                                           int& iter_moves) {
  ...
  __host__ __device__ static constexpr Iterator TrackSwaps(int* p,
                                                           int& iter_swaps) {
  ...
  __host__ __device__ friend constexpr Iterator operator+(Iterator i,
                                                          difference_type n) {
    return Iterator(i.ptr_ + n, i.iter_moves_, i.iter_swaps_);
  }
  __host__ __device__ friend constexpr Iterator operator+(difference_type n,
                                                          Iterator i) {
    return i + n;
  }
  ...
  __host__ __device__ TEST_CONSTEXPR_CXX20 friend void iter_swap(Iterator a,
                                                                 Iterator b) {
  ...
  __host__ __device__ constexpr friend bool operator==(const Iterator& lhs,
                                                       const Iterator& rhs) {
    return lhs.ptr_ == rhs.ptr_;
  }
#ifndef TEST_HAS_NO_SPACESHIP_OPERATOR
  __host__ __device__ constexpr friend auto operator<= >
...
struct Proxy {
  ...
  _LIBCUDACXX_REQUIRES(
      (IsProxy<cuda::std::decay_t<Other> > &&
       cuda::std::constructible_from<
           T, decltype(cuda::std::declval<Other>().getData())>))
  ...
  _LIBCUDACXX_REQUIRES((IsProxy<cuda::std::decay_t<Other> > &&
                        cuda::std::assignable_from<
                            cuda::std::__add_lvalue_reference_t<T>,
  ...
  TEST_NV_DIAG_SUPPRESS(
      1805) // MSVC complains that if we pass a pointer type, adding const is useless
  ...
  _LIBCUDACXX_REQUIRES((IsProxy<cuda::std::decay_t<Other> > &&
                        cuda::std::assignable_from<
                            const cuda::std::__add_lvalue_reference_t<T>,
                            decltype(cuda::std::declval<Other>().getData())>))
...
#if TEST_STD_VER > 2017
  __host__ __device__ friend constexpr bool operator==(const Proxy&,
                                                       const Proxy&)
      requires(cuda::std::equality_comparable<T> &&
               !cuda::std::is_reference_v<T>) = default;
#else
  _LIBCUDACXX_TEMPLATE(class T2 = T)
  _LIBCUDACXX_REQUIRES((cuda::std::equality_comparable<T2> &&
                        !cuda::std::is_reference_v<T2>))
  __host__ __device__ friend constexpr bool operator==(const Proxy& lhs,
                                                       const Proxy& rhs) {
  ...
  _LIBCUDACXX_TEMPLATE(class U)
  _LIBCUDACXX_REQUIRES((cuda::std::equality_comparable_with<
                        cuda::std::decay_t<T>, cuda::std::decay_t<U> >))
  __host__ __device__ friend constexpr bool operator==(const Proxy& lhs,
                                                       const Proxy<U>& rhs) {
    return lhs.data == rhs.data;
  }
  ...
  __host__ __device__ friend constexpr auto operator<= >
      (const Proxy&,
       const Proxy&)requires(cuda::std::three_way_comparable<T> &&
                             !cuda::std::is_reference_v<T>) = default;
  ...
  template <class U>
      __host__ __device__ friend constexpr auto operator<= >
      (const Proxy& lhs, const Proxy<U>& rhs)requires
      cuda::std::three_way_comparable_with<cuda::std::decay_t<T>,
                                           cuda::std::decay_t<U> > {
    return lhs.data <= > rhs.data;
  }
#endif // TEST_HAS_NO_SPACESHIP_OPERATOR
...
struct cuda::std::basic_common_reference<Proxy<T>, Proxy<U>, TQual, UQual>
    : public cuda::std::enable_if<
          cuda::std::__has_common_reference<TQual<T>, UQual<U> >,
          Proxy<cuda::std::common_reference_t<TQual<T>, UQual<U> > > > {};

template <class T, class U>
struct cuda::std::common_type<Proxy<T>, Proxy<U> >
    : public cuda::std::enable_if<cuda::std::__has_common_type<T, U>,
                                  Proxy<cuda::std::common_type_t<T, U> > > {};
...
template <class Base>
struct ProxyIteratorBase<
    Base, cuda::std::enable_if_t<cuda::std::derived_from<
...
template <class Base,
          cuda::std::enable_if_t<cuda::std::input_iterator<Base>, int> = 0>
...
struct ProxyIterator : ProxyIteratorBase<Base> {
...
#else
  template <class B2 = Base, cuda::std::enable_if_t<
                                 cuda::std::default_initializable<B2>, int> = 0>
  ...
  __host__ __device__ friend constexpr
      Proxy<cuda::std::iter_rvalue_reference_t<Base> >
  ...
  iter_swap(const ProxyIterator& x, const ProxyIterator& y) noexcept {
    cuda::std::ranges::iter_swap(x.base_, y.base_);
  }

  // to satisfy input_iterator
  __host__ __device__ constexpr Proxy<cuda::std::iter_reference_t<Base> >
  operator*() const {
    return {*base_};
  }
  ...
  __host__ __device__ friend constexpr bool operator==(const ProxyIterator& x,
                                                       const ProxyIterator& y) {
  ...
  _LIBCUDACXX_TEMPLATE(class B2 = Base)
  _LIBCUDACXX_REQUIRES(cuda::std::random_access_iterator<B2>&&
                           cuda::std::three_way_comparable<B2>)
  __host__ __device__ friend constexpr auto operator<= >
      (const ProxyIterator& x, const ProxyIterator& y) {
    return x.base_ <= > y.base_;
  }
#endif // TEST_HAS_NO_SPACESHIP_OPERATOR
  ...
  _LIBCUDACXX_TEMPLATE(class B2 = Base)
  _LIBCUDACXX_REQUIRES(cuda::std::random_access_iterator<B2>)
  __host__ __device__ friend constexpr ProxyIterator
  operator+(const ProxyIterator& x, difference_type n) {
  ...
  _LIBCUDACXX_REQUIRES(cuda::std::random_access_iterator<B2>)
  __host__ __device__ friend constexpr ProxyIterator
  operator+(difference_type n, const ProxyIterator& x) {
  ...
  _LIBCUDACXX_REQUIRES(cuda::std::random_access_iterator<B2>)
  __host__ __device__ friend constexpr difference_type
  operator-(const ProxyIterator& x, const ProxyIterator& y) {
    return x.base_ - y.base_;
  }
};
...
struct ProxySentinel {
  ...
  __host__ __device__ friend constexpr bool
  operator==(const ProxyIterator<Base>& p, const ProxySentinel& sent) {
...
requires cuda::std::ranges::view<Base> struct ProxyRange {
  Base base_;
  ...
  begin() const requires cuda::std::ranges::input_range<const Base> {
    return ProxyIterator{cuda::std::ranges::begin(base_)};
  }

  __host__ __device__ constexpr auto
  end() const requires cuda::std::ranges::input_range<const Base> {
    return ProxySentinel{cuda::std::ranges::end(base_)};
  }
};

template <cuda::std::ranges::input_range R>
requires cuda::std::ranges::viewable_range<R&&> ProxyRange(R&&)
    -> ProxyRange<cuda::std::views::all_t<R&&> >;
...
namespace types {
template <class Ptr>
using random_access_iterator_list = type_list<Ptr,
#if TEST_STD_VER >= 2017
...
template <class Ptr>
using cpp17_input_iterator_list =
    concatenate_t<forward_iterator_list<Ptr>,
                  type_list<cpp17_input_iterator<Ptr> > >;

#if TEST_STD_VER >= 2020
template <class Ptr>
using cpp20_input_iterator_list = concatenate_t<
    forward_iterator_list<Ptr>,
