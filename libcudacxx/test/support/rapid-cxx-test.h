...
#define TEST_SUITE(Name)                                                       \
  ...
  int main(int argc, char** argv) { return Name::unit_test_main(argc, argv); } \
  namespace Name { /* namespace closed in TEST_SUITE_END */
#
...
#define TEST_CASE(Name)                                                        \
  void Name();                                                                 \
  static void RAPID_CXX_TEST_PP_CAT(Name, _invoker)() { Name(); }              \
  static ::rapid_cxx_test::registrar RAPID_CXX_TEST_PP_CAT(                    \
      rapid_cxx_test_registrar_, Name)(                                        \
      get_test_suite(),                                                        \
      ::rapid_cxx_test::test_case(__FILE__, #Name, __LINE__,                   \
                                  &RAPID_CXX_TEST_PP_CAT(Name, _invoker)));    \
  void Name()
#
#else /* __clang__ */
#
#define TEST_CASE(Name)                                                        \
  ...
  _Pragma("clang diagnostic push")                                             \
      _Pragma("clang diagnostic ignored \"-Wglobal-constructors\"") static ::  \
          rapid_cxx_test::registrar RAPID_CXX_TEST_PP_CAT(                     \
              rapid_cxx_test_registrar_, Name)(                                \
              get_test_suite(), ::rapid_cxx_test::test_case(                   \
...
#define TEST_SET_CHECKPOINT()                                                  \
  ::rapid_cxx_test::set_checkpoint(__FILE__, TEST_FUNC_NAME(), __LINE__)
...
#define TEST_UNSUPPORTED()                                                     \
  do {                                                                         \
    ...
    ::rapid_cxx_test::test_outcome m_f(                                        \
        ::rapid_cxx_test::failure_type::unsupported, __FILE__,                 \
        TEST_FUNC_NAME(), __LINE__, "", "");                                   \
...
#define TEST_CHECK_NO_THROW(...)                                               \
  do {                                                                         \
    TEST_SET_CHECKPOINT();                                                     \
    ::rapid_cxx_test::test_outcome m_f(                                        \
        ::rapid_cxx_test::failure_type::none, __FILE__, TEST_FUNC_NAME(),      \
        __LINE__, "TEST_CHECK_NO_THROW(" #__VA_ARGS__ ")", "");                \
    try {                                                                      \
...
#define TEST_CHECK_THROW(Except, ...)                                          \
  do {                                                                         \
    ...
    ::rapid_cxx_test::test_outcome m_f(                                        \
        ::rapid_cxx_test::failure_type::none, __FILE__, TEST_FUNC_NAME(),      \
        __LINE__, "TEST_CHECK_THROW(" #Except "," #__VA_ARGS__ ")", "");       \
    try {                                                                      \
      (static_cast<void>(__VA_ARGS__));                                        \
      m_f.type = ::rapid_cxx_test::failure_type::check;                        \
    } catch (Except const&) {                                                  \
...
#define TEST_REQUIRE_NO_THROW(...)                                             \
  do {                                                                         \
    ...
    ::rapid_cxx_test::test_outcome m_f(                                        \
        ::rapid_cxx_test::failure_type::none, __FILE__, TEST_FUNC_NAME(),      \
        __LINE__, "TEST_REQUIRE_NO_THROW(" #__VA_ARGS__ ")", "");              \
    try {                                                                      \
      (static_cast<void>(__VA_ARGS__));                                        \
    } catch (...) {                                                            \
      m_f.type = ::rapid_cxx_test::failure_type::require;                      \
...
#define TEST_REQUIRE_THROW(Except, ...)                                        \
  do {                                                                         \
    ...
    ::rapid_cxx_test::test_outcome m_f(                                        \
        ::rapid_cxx_test::failure_type::none, __FILE__, TEST_FUNC_NAME(),      \
        __LINE__, "TEST_REQUIRE_THROW(" #Except "," #__VA_ARGS__ ")", "");     \
    try {                                                                      \
      (static_cast<void>(__VA_ARGS__));                                        \
      m_f.type = ::rapid_cxx_test::failure_type::require;                      \
    } catch (Except const&) {                                                  \
...
#define TEST_ASSERT_NO_THROW(...)                                              \
  do {                                                                         \
    ...
    ::rapid_cxx_test::test_outcome m_f(                                        \
        ::rapid_cxx_test::failure_type::none, __FILE__, TEST_FUNC_NAME(),      \
        __LINE__, "TEST_ASSERT_NO_THROW(" #__VA_ARGS__ ")", "");               \
    try {                                                                      \
      (static_cast<void>(__VA_ARGS__));                                        \
    } catch (...) {                                                            \
      m_f.type = ::rapid_cxx_test::failure_type::assert;                       \
...
#define TEST_ASSERT_THROW(Except, ...)                                         \
  do {                                                                         \
    ...
    ::rapid_cxx_test::test_outcome m_f(                                        \
        ::rapid_cxx_test::failure_type::none, __FILE__, TEST_FUNC_NAME(),      \
        __LINE__, "TEST_ASSERT_THROW(" #Except "," #__VA_ARGS__ ")", "");      \
    try {                                                                      \
      (static_cast<void>(__VA_ARGS__));                                        \
      m_f.type = ::rapid_cxx_test::failure_type::assert;                       \
    } catch (Except const&) {                                                  \
...
#define TEST_WARN_EQUAL_COLLECTIONS(...)                                       \
  do {                                                                         \
    ...
    ::rapid_cxx_test::test_outcome m_f(                                        \
        ::rapid_cxx_test::failure_type::none, __FILE__, TEST_FUNC_NAME(),      \
        __LINE__, "TEST_WARN_EQUAL_COLLECTIONS(" #__VA_ARGS__ ")", "");        \
...
#define TEST_CHECK_EQUAL_COLLECTIONS(...)                                      \
  do {                                                                         \
    ...
    ::rapid_cxx_test::test_outcome m_f(                                        \
        ::rapid_cxx_test::failure_type::none, __FILE__, TEST_FUNC_NAME(),      \
        __LINE__, "TEST_CHECK_EQUAL_COLLECTIONS(" #__VA_ARGS__ ")", "");       \
    if (not ::rapid_cxx_test::detail::check_equal_collections_impl(            \
            __VA_ARGS__)) {                                                    \
      m_f.type = ::rapid_cxx_test::failure_type::check;                        \
    }                                                                          \
...
#define TEST_REQUIRE_EQUAL_COLLECTIONS(...)                                    \
  do {                                                                         \
    ...
    ::rapid_cxx_test::test_outcome m_f(                                        \
        ::rapid_cxx_test::failure_type::none, __FILE__, TEST_FUNC_NAME(),      \
        __LINE__, "TEST_REQUIRE_EQUAL_COLLECTIONS(" #__VA_ARGS__ ")", "");     \
    if (not ::rapid_cxx_test::detail::check_equal_collections_impl(            \
            __VA_ARGS__)) {                                                    \
      m_f.type = ::rapid_cxx_test::failure_type::require;                      \
    }                                                                          \
...
#define TEST_ASSERT_EQUAL_COLLECTIONS(...)                                     \
  do {                                                                         \
    ...
    ::rapid_cxx_test::test_outcome m_f(                                        \
        ::rapid_cxx_test::failure_type::none, __FILE__, TEST_FUNC_NAME(),      \
        __LINE__, "TEST_ASSERT_EQUAL_COLLECTIONS(" #__VA_ARGS__ ")", "");      \
    if (not ::rapid_cxx_test::detail::check_equal_collections_impl(            \
            __VA_ARGS__)) {                                                    \
      m_f.type = ::rapid_cxx_test::failure_type::assert;                       \
    }                                                                          \
...
////////////////////////////////////////////////////////////////////////////
struct test_case {
  test_case() : file(""), func(""), line(0), invoke(NULL) {}
...
struct test_outcome {
  test_outcome()
      : type(failure_type::none), file(""), func(""), line(0), expression(""),
        message("") {}

  test_outcome(failure_type_t type1, const char* file1, const char* func1,
               std::size_t line1, const char* expression1, const char* message1)
...
////////////////////////////////////////////////////////////////////////////
inline void set_checkpoint(const char* file, const char* func,
                           std::size_t line) {
...
public:
  test_suite(const char* xname) : m_name(xname), m_tests(), m_size(0) {
    assert(xname);
  }
...
public:
  ...
  const_iterator begin() const { return m_tests; }

  const_iterator end() const { return m_tests + m_size; }
...
class registrar {
public:
  registrar(test_suite& st, test_case tc) { st.register_test(tc); }
};
...
#pragma GCC diagnostic pop
  ...
  test_outcome current_failure() const { return m_failure; }
  ...
  std::size_t test_case_count() const { return m_testcases; }

  std::size_t test_case_failure_count() const { return m_testcase_failures; }

  std::size_t unsupported_count() const { return m_unsupported; }

  std::size_t assertion_count() const { return m_assertions; }

  std::size_t warning_failure_count() const { return m_warning_failures; }

  std::size_t check_failure_count() const { return m_check_failures; }

  std::size_t require_failure_count() const { return m_require_failures; }
  ...
  void print_summary(const char* suitename) const {
    ...
    std::fprintf(out, "    %lu of %lu assertions passed.\n",
                 m_assertions - (m_warning_failures + m_check_failures +
                                 m_require_failures),
                 m_assertions);
...
private:
  ...
  void report_error(test_outcome o) const {
    std::fprintf(
        stderr, "In %s:%lu Assertion %s failed.\n    in file: %s\n    %s\n",
...
class test_runner {
public:
  test_runner(test_suite& ts) : m_ts(ts) {}

public:
  int run() {
    // for each testcase
    for (test_suite::const_iterator b = m_ts.begin(), e = m_ts.end(); b != e;
         ++b) {
    ...
    auto exit_code =
        get_reporter().failure_count() ? EXIT_FAILURE : EXIT_SUCCESS;
...
bool check_equal_collections_impl(Iter1 start1, Iter1 const end1, Iter2 start2,
                                  Iter2 const end2) {
