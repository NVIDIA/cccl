...
struct cxx20_friend_eq {
  __host__ __device__ friend bool operator==(cxx20_friend_eq const&,
...
struct friend_three_way_comparable {
  __host__ __device__ friend auto operator<= >
      (friend_three_way_comparable const&,
...
struct explicit_operators {
  __host__ __device__ friend bool operator==(explicit_operators,
  ...
  __host__ __device__ friend bool
  operator==(equality_comparable_with_ec1 const&,
...
struct different_return_types {
  ...
  __host__ __device__ friend signed char operator==(explicit_operators,
                                                    different_return_types);
  __host__ __device__ friend unsigned char operator==(different_return_types,
                                                      explicit_operators);
  __host__ __device__ friend float operator!=(explicit_operators,
                                              different_return_types);
  __host__ __device__ friend double operator!=(different_return_types,
                                               explicit_operators);
...
struct one_member_one_friend {
  __host__ __device__ friend boolean operator==(one_member_one_friend,
...
struct equality_comparable_with_ec1 {
  ...
  operator==(equality_comparable_with_ec1) const noexcept;
  __host__ __device__ bool
  operator!=(equality_comparable_with_ec1) const noexcept;
  __host__ __device__ operator explicit_operators() const noexcept;
};
...
struct member_three_way_comparable_with_deleted_eq {
  auto operator<= >
      (member_three_way_comparable_with_deleted_eq const&) const = default;
  __host__ __device__ bool
...
struct member_three_way_comparable_with_deleted_ne {
  auto operator<= >
      (member_three_way_comparable_with_deleted_ne const&) const = default;
  __host__ __device__ bool
...
struct friend_three_way_comparable_with_deleted_eq {
  __host__ __device__ friend auto operator<= >
      (friend_three_way_comparable_with_deleted_eq const&,
...
struct one_way_ne {
  ...
  __host__ __device__ friend bool operator!=(one_way_ne,
                                             explicit_operators) = delete;
...
struct no_lt_not_totally_ordered_with {
  ...
  __host__ __device__ auto operator<= >
      (totally_ordered_with_others const&) const;
...
struct partial_ordering_totally_ordered_with {
  ...
  __host__ __device__ std::partial_ordering operator<= >
      (totally_ordered_with_others const&) const noexcept;
...
struct weak_ordering_totally_ordered_with {
  ...
  __host__ __device__ std::weak_ordering operator<= >
      (totally_ordered_with_others const&) const noexcept;
...
struct strong_ordering_totally_ordered_with {
  ...
  __host__ __device__ std::strong_ordering operator<= >
      (totally_ordered_with_others const&) const noexcept;
...
struct eq_returns_explicit_bool {
  __host__ __device__ friend explicit_bool operator==(eq_returns_explicit_bool,
                                                      eq_returns_explicit_bool);
  __host__ __device__ friend bool operator!=(eq_returns_explicit_bool,
                                             eq_returns_explicit_bool);
  __host__ __device__ friend bool operator<(eq_returns_explicit_bool,
                                            eq_returns_explicit_bool);
  __host__ __device__ friend bool operator>(eq_returns_explicit_bool,
  ...
  __host__ __device__ friend explicit_bool
  operator==(eq_returns_explicit_bool, totally_ordered_with_others);
  __host__ __device__ friend explicit_bool
  operator==(totally_ordered_with_others, eq_returns_explicit_bool);
  __host__ __device__ friend bool operator!=(eq_returns_explicit_bool,
                                             totally_ordered_with_others);
  __host__ __device__ friend bool operator!=(totally_ordered_with_others,
                                             eq_returns_explicit_bool);
  __host__ __device__ friend bool operator<(eq_returns_explicit_bool,
                                            totally_ordered_with_others);
  __host__ __device__ friend bool operator<(totally_ordered_with_others,
...
struct ne_returns_explicit_bool {
  __host__ __device__ friend bool operator==(ne_returns_explicit_bool,
                                             ne_returns_explicit_bool);
  __host__ __device__ friend explicit_bool operator!=(ne_returns_explicit_bool,
                                                      ne_returns_explicit_bool);
  __host__ __device__ friend bool operator<(ne_returns_explicit_bool,
                                            ne_returns_explicit_bool);
  __host__ __device__ friend bool operator>(ne_returns_explicit_bool,
  ...
  __host__ __device__ friend bool operator==(ne_returns_explicit_bool,
                                             totally_ordered_with_others);
  __host__ __device__ friend explicit_bool
  operator!=(ne_returns_explicit_bool, totally_ordered_with_others);
  __host__ __device__ friend explicit_bool
  operator!=(totally_ordered_with_others, ne_returns_explicit_bool);
  __host__ __device__ friend bool operator<(ne_returns_explicit_bool,
                                            totally_ordered_with_others);
  __host__ __device__ friend bool operator<(totally_ordered_with_others,
                                            ne_returns_explicit_bool);
...
struct lt_returns_explicit_bool {
  __host__ __device__ friend bool operator==(lt_returns_explicit_bool,
                                             lt_returns_explicit_bool);
  __host__ __device__ friend bool operator!=(lt_returns_explicit_bool,
                                             lt_returns_explicit_bool);
  __host__ __device__ friend explicit_bool operator<(lt_returns_explicit_bool,
                                                     lt_returns_explicit_bool);
  __host__ __device__ friend bool operator>(lt_returns_explicit_bool,
                                            lt_returns_explicit_bool);
  __host__ __device__ friend bool operator<=(lt_returns_explicit_bool,
  ...
  __host__ __device__ friend bool operator!=(totally_ordered_with_others,
                                             lt_returns_explicit_bool);
  __host__ __device__ friend explicit_bool
  operator<(lt_returns_explicit_bool, totally_ordered_with_others);
  __host__ __device__ friend bool operator<(totally_ordered_with_others,
                                            lt_returns_explicit_bool);
  __host__ __device__ friend bool operator>(lt_returns_explicit_bool,
                                            totally_ordered_with_others);
...
struct gt_returns_explicit_bool {
  __host__ __device__ friend bool operator==(gt_returns_explicit_bool,
                                             gt_returns_explicit_bool);
  __host__ __device__ friend bool operator!=(gt_returns_explicit_bool,
                                             gt_returns_explicit_bool);
  __host__ __device__ friend bool operator<(gt_returns_explicit_bool,
                                            gt_returns_explicit_bool);
  __host__ __device__ friend explicit_bool operator>(gt_returns_explicit_bool,
                                                     gt_returns_explicit_bool);
  __host__ __device__ friend bool operator<=(gt_returns_explicit_bool,
                                             gt_returns_explicit_bool);
  __host__ __device__ friend bool operator>=(gt_returns_explicit_bool,
  ...
  __host__ __device__ friend bool operator<(totally_ordered_with_others,
                                            gt_returns_explicit_bool);
  __host__ __device__ friend explicit_bool
  operator>(gt_returns_explicit_bool, totally_ordered_with_others);
  __host__ __device__ friend bool operator>(totally_ordered_with_others,
                                            gt_returns_explicit_bool);
  __host__ __device__ friend bool operator<=(gt_returns_explicit_bool,
                                             totally_ordered_with_others);
...
struct le_returns_explicit_bool {
  __host__ __device__ friend bool operator==(le_returns_explicit_bool,
  ...
  __host__ __device__ friend bool operator>(le_returns_explicit_bool,
                                            le_returns_explicit_bool);
  __host__ __device__ friend explicit_bool operator<=(le_returns_explicit_bool,
                                                      le_returns_explicit_bool);
  __host__ __device__ friend bool operator>=(le_returns_explicit_bool,
                                             le_returns_explicit_bool);
  ...
  __host__ __device__ friend bool operator<=(le_returns_explicit_bool,
                                             totally_ordered_with_others);
  __host__ __device__ friend explicit_bool
  operator<=(totally_ordered_with_others, le_returns_explicit_bool);
  __host__ __device__ friend bool operator>=(le_returns_explicit_bool,
                                             totally_ordered_with_others);
  __host__ __device__ friend bool operator>=(totally_ordered_with_others,
                                             le_returns_explicit_bool);
...
struct ge_returns_explicit_bool {
  __host__ __device__ friend bool operator==(ge_returns_explicit_bool,
  ...
  __host__ __device__ friend bool operator<=(ge_returns_explicit_bool,
                                             ge_returns_explicit_bool);
  __host__ __device__ friend explicit_bool operator>=(ge_returns_explicit_bool,
                                                      ge_returns_explicit_bool);
  ...
  __host__ __device__ friend bool operator>=(ge_returns_explicit_bool,
                                             totally_ordered_with_others);
  __host__ __device__ friend explicit_bool
  operator>=(totally_ordered_with_others, ge_returns_explicit_bool);
};

struct returns_true_type {
  __host__ __device__ friend cuda::std::true_type operator==(returns_true_type,
                                                             returns_true_type);
  __host__ __device__ friend cuda::std::true_type operator!=(returns_true_type,
                                                             returns_true_type);
  __host__ __device__ friend cuda::std::true_type operator<(returns_true_type,
  ...
  __host__ __device__ friend cuda::std::true_type
  operator==(returns_true_type, totally_ordered_with_others);
  __host__ __device__ friend cuda::std::true_type
  operator==(totally_ordered_with_others, returns_true_type);
  __host__ __device__ friend cuda::std::true_type
  operator!=(returns_true_type, totally_ordered_with_others);
  __host__ __device__ friend cuda::std::true_type
  operator!=(totally_ordered_with_others, returns_true_type);
...
struct returns_int_ptr {
  ...
  __host__ __device__ friend int* operator==(returns_int_ptr,
                                             totally_ordered_with_others);
  __host__ __device__ friend int* operator==(totally_ordered_with_others,
                                             returns_int_ptr);
  __host__ __device__ friend int* operator!=(returns_int_ptr,
                                             totally_ordered_with_others);
  __host__ __device__ friend int* operator!=(totally_ordered_with_others,
...
struct ForwardingTestObject {
  ...
  operator<(const ForwardingTestObject&) const& {
    return false;
  }
