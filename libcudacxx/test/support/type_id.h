...
struct TypeID {
  __host__ __device__ friend bool operator==(TypeID const& LHS,
                                             TypeID const& RHS) {
...
#else
  __host__ __device__ const char* name() const { return m_id; }
#endif
...
__host__ __device__ inline bool CompareTypeIDVerbose(const char* LHSString,
                                                     TypeID const* LHS,
