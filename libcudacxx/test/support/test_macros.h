...
#define TEST_DIAG_SUPPRESS_CLANG(...) _CCCL_DIAG_SUPPRESS(CLANG, __VA_ARGS__)
#define TEST_DIAG_SUPPRESS_GCC(...)   _CCCL_DIAG_SUPPRESS(GCC, __VA_ARGS__)
#define TEST_DIAG_SUPPRESS_NVHPC(...) _CCCL_DIAG_SUPPRESS(NVHPC, __VA_ARGS__)
#define TEST_DIAG_SUPPRESS_MSVC(...)  _CCCL_DIAG_SUPPRESS(MSVC, __VA_ARGS__)
#define TEST_NV_DIAG_SUPPRESS(...)    _CCCL_DIAG_SUPPRESS(NV, __VA_ARGS__)
