...
#if defined(TEST_COMPILER_MSVC)
#define TEST_NV_DIAG_SUPPRESS(WARNING)                                         \
  __pragma(_TEST_TOSTRING(nv_diag_suppress WARNING))
#else // ^^^ MSVC ^^^ / vvv not MSVC vvv
#define TEST_NV_DIAG_SUPPRESS(WARNING)                                         \
  _Pragma(_TEST_TOSTRING(nv_diag_suppress WARNING))
#endif // not MSVC
#else // ^^^ __NVCC_DIAG_PRAGMA_SUPPORT__ ^^^ / vvv !__NVCC_DIAG_PRAGMA_SUPPORT__ vvv
#if defined(TEST_COMPILER_MSVC)
#define TEST_NV_DIAG_SUPPRESS(WARNING)                                         \
  __pragma(_TEST_TOSTRING(diag_suppress WARNING))
#else // ^^^ MSVC ^^^ / vvv not MSVC vvv
#define TEST_NV_DIAG_SUPPRESS(WARNING)                                         \
  _Pragma(_TEST_TOSTRING(diag_suppress WARNING))
#endif // not MSVC
#endif
