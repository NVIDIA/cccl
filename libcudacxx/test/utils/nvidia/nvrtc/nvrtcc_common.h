...
static void write_output_file(const char* data, size_t datasz,
...
static int parse_int_assignment(const std::string& input, std::string var,
                                int def) {
...
extern "C" __global__ void main_kernel() { fake_main(0, NULL); }
)program";
