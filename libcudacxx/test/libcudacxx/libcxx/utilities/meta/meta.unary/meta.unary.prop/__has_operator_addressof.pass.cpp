...
struct F {};
__host__ __device__ constexpr F* operator&(F const&) { return nullptr; }

struct G {};
__host__ __device__ constexpr G* operator&(G&&) { return nullptr; }

struct H {};
__host__ __device__ constexpr H* operator&(H const&&) { return nullptr; }
