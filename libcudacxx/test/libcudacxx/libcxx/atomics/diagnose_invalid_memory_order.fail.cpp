...
int main(int, char**) {
  ...
  {
    cuda::std::atomic_store_explicit(
        &x, 42,
        cuda::std::
            memory_order_consume); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_store_explicit(
  ...
  // compare exchange weak
  {
    x.compare_exchange_weak(
        val1, val2, cuda::std::memory_order_seq_cst,
        cuda::std::
            memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
    x.compare_exchange_weak(
        val1, val2, cuda::std::memory_order_seq_cst,
    ...
    vx.compare_exchange_weak(
        ...
        cuda::std::
            memory_order_acq_rel); // expected-warning {{memory order argument to atomic operation is invalid}}
    // valid memory orders
    x.compare_exchange_weak(val1, val2, cuda::std::memory_order_seq_cst,
                            cuda::std::memory_order_relaxed);
    x.compare_exchange_weak(val1, val2, cuda::std::memory_order_seq_cst,
                            cuda::std::memory_order_consume);
    x.compare_exchange_weak(val1, val2, cuda::std::memory_order_seq_cst,
  ...
  }
  {
    cuda::std::atomic_compare_exchange_weak_explicit(
        &x, &val1, val2, cuda::std::memory_order_seq_cst,
        cuda::std::
            memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_compare_exchange_weak_explicit(
        &x, &val1, val2, cuda::std::memory_order_seq_cst,
        cuda::std::
            memory_order_acq_rel); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_compare_exchange_weak_explicit(
        &vx, &val1, val2, cuda::std::memory_order_seq_cst,
        cuda::std::
            memory_order_release); // expected-warning {{memory order argument to atomic operation is invalid}}
    cuda::std::atomic_compare_exchange_weak_explicit(
        &vx, &val1, val2, cuda::std::memory_order_seq_cst,
  ...
  // compare exchange strong
  {
    ...
    vx.compare_exchange_strong(
        ...
        cuda::std::
            memory_order_acq_rel); // expected-warning {{memory order argument to atomic operation is invalid}}
    // valid memory orders
    x.compare_exchange_strong(val1, val2, cuda::std::memory_order_seq_cst,
                              cuda::std::memory_order_relaxed);
    x.compare_exchange_strong(val1, val2, cuda::std::memory_order_seq_cst,
                              cuda::std::memory_order_consume);
    x.compare_exchange_strong(val1, val2, cuda::std::memory_order_seq_cst,
