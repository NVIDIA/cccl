...
void test_construction() {
  ...
  { // explicit lvalue overloads
    ...
    const ::cuda::std::pair<explicitly_constructible<T1, T2>, U1>
        from_converting_first{converting_first};
    const ::cuda::std::pair<T1, explicitly_constructible<U1, U2> >
        from_converting_second{converting_second};
    const ::cuda::std::pair<explicitly_constructible<T1, T2>,
                            explicitly_constructible<U1, U2> >
        from_converting_both{converting_both};
  ...
  { // rvalue overloads
    const ::cuda::std::pair<T1, U1> from_matching{
        ::std::pair<T1, U1>{T1{42}, U1{1337}}};
    const ::cuda::std::pair<T1, U1> from_converting_first{
        ::std::pair<T2, U1>{T2{42}, U1{1337}}};
    const ::cuda::std::pair<T1, U1> from_converting_second{
        ::std::pair<T1, U2>{T1{42}, U2{1337}}};
    const ::cuda::std::pair<T1, U1> from_converting_both{
  ...
  { // explicit rvalue overloads
    const ::cuda::std::pair<explicitly_constructible<T1, T2>, U1>
        from_converting_first{::std::pair<T2, U1>{T2{42}, U1{1337}}};
    const ::cuda::std::pair<T1, explicitly_constructible<U1, U2> >
        from_converting_second{::std::pair<T1, U2>{T1{42}, U2{1337}}};
    const ::cuda::std::pair<explicitly_constructible<T1, T2>,
                            explicitly_constructible<U1, U2> >
        from_converting_both{::std::pair<T2, U2>{T2{42}, U2{1337}}};
