...
// friend constexpr bool operator==(const offset_iterator& x, const offset_iterator& y);
// friend constexpr bool operator==(const offset_iterator& x, default_sentinel_t);
...
__host__ __device__ constexpr bool test()
{
...

  {
    const int offset1 = 3;
    const int offset2 = 4;
    cuda::offset_iterator iter1(buffer, offset1);
    cuda::offset_iterator iter2(buffer, offset2);
