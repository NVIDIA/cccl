...
void test_basic()
{
  ...
  {
    // todo(dabayer): This seems to be failing as host-accessible and not device-accessible.
...
void test_multiple_devices()
{
  ...
  T* dev0_buffer2;
  {
    cuda::__ensure_current_context{dev0};
  ...
  {
    cuda::__ensure_current_context{dev1};
