...
{
  TEST_HOST_DEVICE_FUNC void sync() const {}
  TEST_HOST_DEVICE_FUNC T_size size() const
  {
    return 1;
  }
  TEST_HOST_DEVICE_FUNC T_thread_rank thread_rank() const
  {
    return 0;
  }
};
...
TEST_HOST_DEVICE_FUNC void test_fully_specialized()
{
...
TEST_HOST_DEVICE_FUNC void test_select_thread_rank_type()
{
...
TEST_HOST_DEVICE_FUNC void test_select_size_type()
{
