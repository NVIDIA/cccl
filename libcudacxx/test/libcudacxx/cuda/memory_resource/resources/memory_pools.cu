...
C2H_CCCLRT_TEST("device_memory_pool conversion to resource_ref", "[memory_resource]")
{
  ...
  cuda::mr::resource_ref<cuda::mr::device_accessible> ref1 = pool;

  // We cannot construct a resource_ref from a prvalue device_memory_pool_ref
...
C2H_CCCLRT_TEST("managed_memory_pool conversion to resource_ref", "[memory_resource]")
{
  ...
  { // host device accessible
    cuda::mr::resource_ref<cuda::mr::host_accessible, cuda::mr::device_accessible> ref1 = pool;

    // We cannot construct a resource_ref from a prvalue managed_memory_pool_ref
  ...
  { // host  accessible
    cuda::mr::resource_ref<cuda::mr::host_accessible> ref1 = pool;
