...
struct derived_plain
    : public cuda::forward_property<derived_plain<Upstream>, Upstream> {
...
static_assert(
    cuda::has_property<derived_plain<upstream_with_valueless_property>, prop>,
    "");
static_assert(
    !cuda::has_property<derived_plain<upstream_with_valueless_property>,
                        prop_with_value>,
    "");
...
static_assert(
    !cuda::has_property<derived_plain<upstream_with_stateful_property>, prop>,
    "");
static_assert(cuda::has_property<derived_plain<upstream_with_stateful_property>,
                                 prop_with_value>,
              "");
...
static_assert(
    cuda::has_property<derived_plain<upstream_with_both_properties>, prop>, "");
static_assert(cuda::has_property<derived_plain<upstream_with_both_properties>,
                                 prop_with_value>,
              "");

struct derived_override
    : public cuda::forward_property<derived_override,
                                    upstream_with_both_properties> {
  ...
  __host__ __device__ friend constexpr int get_property(const derived_override&,
                                                        prop_with_value) {
    return 1337;
  }
};
...
struct derived_with_converstin_upstream_resource
    : public cuda::forward_property<derived_with_converstin_upstream_resource,
                                    upstream_with_both_properties> {
  constexpr convertible_to_upstream upstream_resource() const noexcept {
    return convertible_to_upstream{};
  }
};
static_assert(!cuda::has_property<derived_with_converstin_upstream_resource,
                                  prop_with_value>,
              "");
