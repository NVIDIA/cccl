...
{
  using T = uint32_t;
  static_assert(cuda::bitfield_insert(int{0}, 0, 0));
  static_assert(cuda::bitfield_insert(T{0}, -1, 0));
  static_assert(cuda::bitfield_insert(T{0}, 0, -1));
  static_assert(cuda::bitfield_insert(T{0}, 0, 33));
  static_assert(cuda::bitfield_insert(T{0}, 32, 0));
  static_assert(cuda::bitfield_insert(T{0}, 20, 20));
