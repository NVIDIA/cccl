...
struct test_murmurhash3_x64_128
{
  ...
  TEST_FUNC constexpr __uint128_t make_result(cuda::std::array<cuda::std::uint64_t, 2> arr)
  {
...
static_assert((cuda::hash<cuda::std::uint32_t, cuda::hash_algorithm::murmurhash3_x64_128>{}(0u)
               == cuda::std::bit_cast<__uint128_t>(cuda::std::array<cuda::std::uint64_t, 2>{
                 14961230494313510588ull, 6383328099726337777ull})));
...
TEST_FUNC void test()
{
  ...
  test_empty_span<cuda::hash_algorithm::murmurhash3_x64_128>(__uint128_t{});
}
