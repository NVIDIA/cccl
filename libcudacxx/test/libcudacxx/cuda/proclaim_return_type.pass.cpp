...
__host__ __device__ void test_proclaim_return_type(Fn&& fn, T expected,
                                                   As... as) {
  {
  ...
  NV_IF_TARGET(
      ...
      (test_proclaim_return_type<double>([] __device__ { return 42.0; }, 42.0);
       test_proclaim_return_type<int>(
           [] __device__(const int v) { return v * 2; }, 42, 21);
       test_proclaim_return_type<int&>(
           [vp] __device__() -> int& { return *vp; }, v);

       test_proclaim_return_type<double>(
           [] __host__ __device__ { return 42.0; }, 42.0);
       test_proclaim_return_type<int>(
           [] __host__ __device__(const int v) { return v * 2; }, 42, 21);
       test_proclaim_return_type<int&>(
           [vp] __host__ __device__() -> int& { return *vp; }, v);))
