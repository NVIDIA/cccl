...
__global__ void test_mbarrier_test_wait_parity(void** fn_ptr)
{
  ...
  NV_IF_TARGET(
    NV_PROVIDES_SM_90,
    (
        // mbarrier.test_wait.parity.phase_type::primary.acquire.cta.shared::cta.b64 waitComplete|isReportSeen,
  ...
  NV_IF_TARGET(
    NV_PROVIDES_SM_90,
    (
        // mbarrier.test_wait.parity.phase_type::primary.relaxed.cta.shared::cta.b64 waitComplete|isReportSeen,
        // reportValue, [addr], phaseParity;
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<bool (*)(cuda::ptx::mbarrier_phase_primary_t,
                               cuda::ptx::sem_relaxed_t,
