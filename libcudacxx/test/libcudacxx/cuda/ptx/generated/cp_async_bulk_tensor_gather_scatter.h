...
__global__ void test_cp_async_bulk_tensor_gather_scatter(void** fn_ptr)
{
    ...
    (
        ...
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<void (*)(
            ...
            const cuda::std::int32_t (&)[5],
            cuda::std::uint64_t*,
            const cuda::std::uint32_t&)>(cuda::ptx::cp_async_bulk_tensor_tile_gather4_multicast_32b));));
    ...
    (
        ...
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<void (*)(cuda::ptx::space_shared_t,
                               ...
                               const void*,
                               const cuda::std::int32_t (&)[5],
                               cuda::std::uint64_t*)>(cuda::ptx::cp_async_bulk_tensor_tile_gather4_override));));
    ...
    (
        ...
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<void (*)(
            ...
            const cuda::std::int32_t (&)[5],
            cuda::std::uint64_t*,
            const cuda::std::uint32_t&)>(cuda::ptx::cp_async_bulk_tensor_tile_gather4_multicast_32b_override));));
  ...
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_107a,
    (
        // cp.async.bulk.tensor.2d.global.shared::cta.tile::scatter4.bulk_group.override::global_address [tensorMap,
        ...
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<void (*)(cuda::ptx::space_global_t,
                               ...
                               const void*,
                               const cuda::std::int32_t (&)[5],
                               const void*)>(cuda::ptx::cp_async_bulk_tensor_tile_scatter4_override));));
