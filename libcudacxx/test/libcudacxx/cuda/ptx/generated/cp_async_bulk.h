...
__global__ void test_cp_async_bulk(void ** fn_ptr) {
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<void (*)(cuda::ptx::space_shared_t, cuda::ptx::space_global_t, void* , const void* , const uint32_t& , uint64_t* )>(cuda::ptx::cp_async_bulk));
  ));
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_100, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<void (*)(cuda::ptx::space_global_t, cuda::ptx::space_shared_t, void* , const void* , const uint32_t& , const uint16_t& )>(cuda::ptx::cp_async_bulk_cp_mask));
  ));
#endif // __cccl_ptx_isa >= 860
}
