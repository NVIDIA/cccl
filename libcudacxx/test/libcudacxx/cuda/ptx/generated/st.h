...
__global__ void test_st(void** fn_ptr)
{
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_100,
               (
                   ...
                   * fn_ptr++ = reinterpret_cast<void*>(
                     static_cast<void (*)(cuda::ptx::space_global_t, longlong4_32a*, longlong4_32a)>(cuda::ptx::st));));
  ...
  NV_IF_TARGET(
    ...
    (
        ...
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<void (*)(cuda::ptx::space_global_t, longlong4_32a*, longlong4_32a, uint64_t)>(
            cuda::ptx::st_L2_cache_hint));));
#endif // __cccl_ptx_isa >= 880
  ...
  NV_IF_TARGET(
    ...
    (
        ...
        * fn_ptr++ =
          reinterpret_cast<void*>(static_cast<void (*)(cuda::ptx::space_global_t, longlong4_32a*, longlong4_32a)>(
