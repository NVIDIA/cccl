...
__global__ void test_tensormap_replace(void** fn_ptr)
{
  ...
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_90a,
    (
        // tensormap.replace.tile.global_dim.assume_large.global.b1024.b32 [tm_addr], ord, new_val;
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<void (*)(cuda::ptx::space_global_t, void*, cuda::ptx::n32_t<0>, cuda::std::int32_t)>(
            cuda::ptx::tensormap_replace_global_dim_assume_large));));
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_100a,
    (
        // tensormap.replace.tile.global_dim.assume_large.global.b1024.b32 [tm_addr], ord, new_val;
  ...
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_90a,
    (
        // tensormap.replace.tile.global_dim.assume_large.shared::cta.b1024.b32 [tm_addr], ord, new_val;
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<void (*)(cuda::ptx::space_shared_t, void*, cuda::ptx::n32_t<0>, cuda::std::int32_t)>(
            cuda::ptx::tensormap_replace_global_dim_assume_large));));
  NV_IF_TARGET(
  ...
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_90a,
    (
        // tensormap.replace.tile.global_stride.assume_large.global.b1024.b64 [tm_addr], ord, new_val;
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<void (*)(cuda::ptx::space_global_t, void*, cuda::ptx::n32_t<0>, cuda::std::int64_t)>(
            cuda::ptx::tensormap_replace_global_stride_assume_large));));
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_100a,
    (
        // tensormap.replace.tile.global_stride.assume_large.global.b1024.b64 [tm_addr], ord, new_val;
  ...
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_90a,
    (
        // tensormap.replace.tile.global_stride.assume_large.shared::cta.b1024.b64 [tm_addr], ord, new_val;
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<void (*)(cuda::ptx::space_shared_t, void*, cuda::ptx::n32_t<0>, cuda::std::int64_t)>(
            cuda::ptx::tensormap_replace_global_stride_assume_large));));
  NV_IF_TARGET(
  ...
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_90a,
    (
        // tensormap.replace.tile.elemtype.assume_large.global.b1024.b32 [tm_addr], new_val;
        * fn_ptr++ =
          reinterpret_cast<void*>(static_cast<void (*)(cuda::ptx::space_global_t, void*, cuda::ptx::n32_t<0>)>(
            cuda::ptx::tensormap_replace_elemtype_assume_large));));
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_100a,
    (
        // tensormap.replace.tile.elemtype.assume_large.global.b1024.b32 [tm_addr], new_val;
  ...
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_90a,
    (
        // tensormap.replace.tile.elemtype.assume_large.shared::cta.b1024.b32 [tm_addr], new_val;
        * fn_ptr++ =
          reinterpret_cast<void*>(static_cast<void (*)(cuda::ptx::space_shared_t, void*, cuda::ptx::n32_t<0>)>(
            cuda::ptx::tensormap_replace_elemtype_assume_large));));
  NV_IF_TARGET(
  ...
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_90a,
    (
        // tensormap.replace.tile.interleave_layout.assume_large.global.b1024.b32 [tm_addr], new_val;
        * fn_ptr++ =
          reinterpret_cast<void*>(static_cast<void (*)(cuda::ptx::space_global_t, void*, cuda::ptx::n32_t<0>)>(
            cuda::ptx::tensormap_replace_interleave_layout_assume_large));));
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_100a,
    (
        // tensormap.replace.tile.interleave_layout.assume_large.global.b1024.b32 [tm_addr], new_val;
  ...
  NV_IF_TARGET(
    NV_HAS_FEATURE_SM_90a,
    (
        // tensormap.replace.tile.interleave_layout.assume_large.shared::cta.b1024.b32 [tm_addr], new_val;
        * fn_ptr++ =
          reinterpret_cast<void*>(static_cast<void (*)(cuda::ptx::space_shared_t, void*, cuda::ptx::n32_t<0>)>(
            cuda::ptx::tensormap_replace_interleave_layout_assume_large));));
  NV_IF_TARGET(
