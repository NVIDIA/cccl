...
__global__ void test_tcgen05_st(void** fn_ptr)
{
  ...
  NV_DISPATCH_TARGET(
    ...
    (
        ...
        * fn_ptr++ = reinterpret_cast<void*>(static_cast<void (*)(cuda::std::uint32_t, const cuda::std::int32_t(&)[16])>(
          cuda::ptx::tcgen05_st_16x64b_unpack_16b));),
    NV_HAS_FEATURE_SM_103a,
    (
        // tcgen05.st.sync.aligned.16x64b.x16.unpack::16b.b32 [taddr], values;
  ...
  NV_DISPATCH_TARGET(
    ...
    (
        ...
        * fn_ptr++ = reinterpret_cast<void*>(static_cast<void (*)(cuda::std::uint32_t, const cuda::std::int32_t(&)[32])>(
          cuda::ptx::tcgen05_st_16x64b_unpack_16b));),
    NV_HAS_FEATURE_SM_103a,
    (
        // tcgen05.st.sync.aligned.16x64b.x32.unpack::16b.b32 [taddr], values;
  ...
  NV_DISPATCH_TARGET(
    ...
    (
        ...
        * fn_ptr++ = reinterpret_cast<void*>(static_cast<void (*)(cuda::std::uint32_t, const cuda::std::int32_t(&)[64])>(
          cuda::ptx::tcgen05_st_16x64b_unpack_16b));),
    NV_HAS_FEATURE_SM_103a,
    (
        // tcgen05.st.sync.aligned.16x64b.x64.unpack::16b.b32 [taddr], values;
  ...
  NV_DISPATCH_TARGET(
    ...
    (
        ...
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<void (*)(cuda::std::uint32_t, const cuda::std::int32_t(&)[128])>(cuda::ptx::tcgen05_st_16x128b));),
    NV_HAS_FEATURE_SM_103a,
    (
        // tcgen05.st.sync.aligned.16x128b.x64.b32 [taddr], values;
        * fn_ptr++ = reinterpret_cast<void*>(
  ...
  NV_DISPATCH_TARGET(
    ...
    (
        ...
        * fn_ptr++ = reinterpret_cast<void*>(
          static_cast<void (*)(cuda::std::uint32_t, const cuda::std::int32_t(&)[128])>(cuda::ptx::tcgen05_st_16x256b));),
    NV_HAS_FEATURE_SM_103a,
    (
        // tcgen05.st.sync.aligned.16x256b.x32.b32 [taddr], values;
        * fn_ptr++ = reinterpret_cast<void*>(
