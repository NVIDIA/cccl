...
__global__ void test_mbarrier_test_wait(void ** fn_ptr) {
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_80, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<bool (*)(uint64_t* , const uint64_t& )>(cuda::ptx::mbarrier_test_wait));
  ));
  ...
  NV_IF_TARGET(NV_PROVIDES_SM_90, (
    ...
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<bool (*)(cuda::ptx::sem_acquire_t, cuda::ptx::scope_cta_t, uint64_t* , const uint64_t& )>(cuda::ptx::mbarrier_test_wait));
    // mbarrier.test_wait.acquire.cluster.shared::cta.b64        waitComplete, [addr], state;                        // 2.
    *fn_ptr++ = reinterpret_cast<void*>(static_cast<bool (*)(cuda::ptx::sem_acquire_t, cuda::ptx::scope_cluster_t, uint64_t* , const uint64_t& )>(cuda::ptx::mbarrier_test_wait));
  ));
