  ...
  NV_IF_TARGET(
      ...
      (
              ...
              * fn_ptr++ = reinterpret_cast<void*>(
                  static_cast<void (*)(cuda::ptx::sem_sc_t,
                  ...
                  // fence.acq_rel.cta; // 1.
                      * fn_ptr++ = reinterpret_cast<void*>(
                          static_cast<void (*)(cuda::ptx::sem_acq_rel_t,
                                               cuda::ptx::scope_cta_t)>(
                              cuda::ptx::fence));
                  // fence.acq_rel.gpu; // 1.
                      * fn_ptr++ = reinterpret_cast<void*>(
...
__global__ void test_fence_proxy_alias(void** fn_ptr) {
  ...
  NV_IF_TARGET(
      ...
      (
              // fence.proxy.alias; // 4.
              * fn_ptr++ = reinterpret_cast<void*>(
                  static_cast<void (*)()>(cuda::ptx::fence_proxy_alias));));
...
__global__ void test_fence_proxy_async(void** fn_ptr) {
  ...
  NV_IF_TARGET(
      ...
      (
              // fence.proxy.async; // 5.
              * fn_ptr++ = reinterpret_cast<void*>(
                  static_cast<void (*)()>(cuda::ptx::fence_proxy_async));));
#endif // __cccl_ptx_isa >= 800
...
__global__ void test_fence_proxy_tensormap_generic(void** fn_ptr) {
  ...
  NV_IF_TARGET(
      ...
      (
              ...
              * fn_ptr++ = reinterpret_cast<void*>(
                  static_cast<void (*)(cuda::ptx::sem_acquire_t,
                                       cuda::ptx::scope_cta_t, const void*,
                                       cuda::ptx::n32_t<128>)>(
                      cuda::ptx::fence_proxy_tensormap_generic));
                  ...
                  // fence.proxy.tensormap::generic.acquire.gpu [addr], size; // 8.
                      * fn_ptr++ = reinterpret_cast<void*>(
                          static_cast<void (*)(
                              cuda::ptx::sem_acquire_t, cuda::ptx::scope_gpu_t,
                              const void*, cuda::ptx::n32_t<128>)>(
                              cuda::ptx::fence_proxy_tensormap_generic));
                  // fence.proxy.tensormap::generic.acquire.sys [addr], size; // 8.
                      * fn_ptr++ = reinterpret_cast<void*>(
                          static_cast<void (*)(
                              cuda::ptx::sem_acquire_t, cuda::ptx::scope_sys_t,
                              const void*, cuda::ptx::n32_t<128>)>(
                              cuda::ptx::fence_proxy_tensormap_generic));));
#endif // __cccl_ptx_isa >= 830
}
