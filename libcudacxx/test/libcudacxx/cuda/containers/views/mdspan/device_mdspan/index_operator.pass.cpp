...
__device__ constexpr void test_iteration(Mapping m)
{
...
__device__ constexpr void test_layout()
{
  ...
  {
    static_assert(
      !check_operator_constraints(cuda::device_mdspan(data, construct_mapping(Layout(), cuda::std::extents<int, D>(1))),
...
int main(int, char**)
{
  NV_IF_TARGET(NV_IS_DEVICE, test_device();)
