...
{
  using MDS = cuda::restrict_mdspan<T, E, L, A>;
  ...
  static_assert(cuda::std::is_same_v<typename MDS::accessor_type, cuda::restrict_accessor<A>>);
  ...
  static_assert(
    cuda::std::is_same_v<cuda::restrict_mdspan<T, E>,
                         cuda::restrict_mdspan<T, E, cuda::std::layout_right, cuda::std::default_accessor<T>>>);
  static_assert(cuda::std::is_same_v<cuda::restrict_mdspan<T, E, L>,
                                     cuda::restrict_mdspan<T, E, L, cuda::std::default_accessor<T>>>);
...
__host__ __device__ constexpr bool test()
{
  ...
  check_triviality<cuda::restrict_mdspan<int, cuda::std::extents<int>>, false, true, true, true, true, true>();
  check_triviality<cuda::restrict_mdspan<int, cuda::std::dextents<int, 1>>, false, true, true, true, true, true>();
