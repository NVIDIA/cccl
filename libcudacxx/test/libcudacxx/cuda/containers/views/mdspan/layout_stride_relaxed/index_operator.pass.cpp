...
__host__ __device__ constexpr cuda::std::intptr_t get_expected_index(
  const cuda::std::array<cuda::std::intptr_t, M::extents_type::rank()>& strides,
  cuda::std::intptr_t offset,
  cuda::std::index_sequence<Pos...>,
  Args... args)
{
  return offset + (static_cast<cuda::std::intptr_t>(0) + ... + (static_cast<cuda::std::intptr_t>(args) * strides[Pos]));
}
  ...
  Args... args)
{
  ...
  const cuda::std::intptr_t expected_val =
    get_expected_index<M>(strides, offset, cuda::std::make_index_sequence<M::extents_type::rank()>(), args...);
  assert(expected_val == static_cast<cuda::std::intptr_t>(m(args...)));
}
...
test_iteration(cuda::std::array<cuda::std::intptr_t, E::rank()> strides, cuda::std::intptr_t offset, Args... args)
{
...
__host__ __device__ constexpr bool test()
{
  ...
  test_iteration<cuda::std::extents<int>>(cuda::std::array<cuda::std::intptr_t, 0>{}, 0);
  test_iteration<cuda::std::extents<unsigned, D>>(cuda::std::array<cuda::std::intptr_t, 1>{2}, 0, 1);
  ...
  test_iteration<cuda::std::extents<unsigned, D>>(cuda::std::array<cuda::std::intptr_t, 1>{2}, 10, 1);
  test_iteration<cuda::std::extents<unsigned, 7>>(cuda::std::array<cuda::std::intptr_t, 1>{4}, 20);
  test_iteration<cuda::std::extents<unsigned, 7, 8>>(cuda::std::array<cuda::std::intptr_t, 2>{25, 3}, 100);
  ...
  test_iteration<cuda::std::extents<int, 4>>(cuda::std::array<cuda::std::intptr_t, 1>{-1}, 3);

  // Check operator constraint for number of arguments
  static_assert(check_operator_constraints(
    cuda::layout_stride_relaxed::mapping<cuda::std::extents<int, D>>(
      cuda::std::extents<int, D>(1), cuda::std::array<cuda::std::intptr_t, 1>{1}),
    0));
  static_assert(!check_operator_constraints(
    cuda::layout_stride_relaxed::mapping<cuda::std::extents<int, D>>(
      cuda::std::extents<int, D>(1), cuda::std::array<cuda::std::intptr_t, 1>{1}),
  ...
  static_assert(!check_operator_constraints(
    cuda::layout_stride_relaxed::mapping<cuda::std::extents<unsigned, D>>(
      cuda::std::extents<unsigned, D>(1), cuda::std::array<cuda::std::intptr_t, 1>{1}),
    IntType(0)));
  ...
  static_assert(!check_operator_constraints(
    cuda::layout_stride_relaxed::mapping<cuda::std::extents<unsigned char, D>>(
      cuda::std::extents<unsigned char, D>(1), cuda::std::array<cuda::std::intptr_t, 1>{1}),
    IntType(0)));
...
{
  [[maybe_unused]] constexpr size_t D = cuda::std::dynamic_extent;
  test_iteration<cuda::std::extents<int64_t, D, 8, D, D>>(
    cuda::std::array<cuda::std::intptr_t, 4>{2000, 2, 20, 200}, 0, 7, 9, 10);
  test_iteration<cuda::std::extents<int64_t, D, 8, 1, D>>(
    cuda::std::array<cuda::std::intptr_t, 4>{2000, 20, 20, 200}, 0, 7, 10);
  return true;
}
