...
TEST_FUNC constexpr bool test()
{
  ...
  [[maybe_unused]] constexpr size_t D = cuda::std::dynamic_extent;
  using mds_t                         = cuda::host_mdspan<float, cuda::std::extents<unsigned, 3, D, D>>;
  // sanity check
  ...
  using mds_uchar_t = cuda::host_mdspan<float, cuda::std::extents<unsigned char, 3, D, D>>;
  ...
  using mds_int_t = cuda::host_mdspan<float, cuda::std::extents<int, 3, D, D>>;
