...
TEST_TILE_DEVICE_FUNC constexpr void test_implicit_conversion(ToMDS to_mds, FromMDS from_mds)
{
...
TEST_TILE_DEVICE_FUNC constexpr void test_conversion_impl(FromMDS)
{
...
TEST_TILE_DEVICE_FUNC constexpr void test_conversion_impl(FromMDS from_mds)
{
...
template <class ToMDS, class FromMDS>
TEST_TILE_DEVICE_FUNC constexpr void test_conversion(FromMDS from_mds)
{
...
TEST_TILE_DEVICE_FUNC constexpr void mixin_extents(const FromH& handle, const FromL& layout, const FromA& acc)
{
...
TEST_TILE_DEVICE_FUNC constexpr void mixin_layout(const FromH& handle, const FromA& acc)
{
...
template <class ToA,
          ...
          cuda::std::enable_if_t<!cuda::std::is_same_v<typename FromA::element_type, MinimalElementType>
                                 ...
                                 int> = 0>
TEST_TILE_DEVICE_FUNC constexpr void test_impl(FromA from_acc)
{
...
template <class ToA,
          ...
          cuda::std::enable_if_t<cuda::std::is_same_v<typename FromA::element_type, MinimalElementType>
                                   || cuda::std::is_same_v<typename ToA::element_type, MinimalElementType>,
                                 int> = 0>
TEST_TILE_DEVICE_FUNC void test_impl(FromA from_acc)
{
...
template <bool constructible_constref_acc,
          ...
          class ToA,
          class FromA>
TEST_TILE_DEVICE_FUNC void test(FromA from_acc)
{
...
TEST_TILE_DEVICE_FUNC void run_conversion_tests()
{
