...
TEST_HOST_DEVICE constexpr bool check_equivalence_relation_subsumes_relation() {
  return false;
}
...
TEST_HOST_DEVICE constexpr bool check_relation_subsumes_equivalence_relation() {
  return true;
}
...
TEST_HOST_DEVICE constexpr bool check_equivalence_relation_subsumes_itself() {
  return false;
}
