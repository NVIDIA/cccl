...
TEST_HOST_DEVICE constexpr bool check_strict_weak_order_subsumes_relation() {
  return false;
}
...
TEST_HOST_DEVICE constexpr bool check_relation_subsumes_strict_weak_order() {
  return true;
}
...
TEST_HOST_DEVICE constexpr bool check_strict_weak_order_subsumes_itself() {
  return false;
}
