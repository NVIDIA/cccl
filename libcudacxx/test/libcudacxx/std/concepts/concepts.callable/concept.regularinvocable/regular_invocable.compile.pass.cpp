...
static_assert(!regular_invocable<const_function_object const volatile, int>);
static_assert(regular_invocable<const_function_object&, int>);
static_assert(regular_invocable<const_function_object const&, int>);
static_assert(!regular_invocable<const_function_object volatile&, int>);
static_assert(!regular_invocable<const_function_object const volatile&, int>);
...
static_assert(!regular_invocable<volatile_function_object const, int, int>);
static_assert(regular_invocable<volatile_function_object volatile, int, int>);
static_assert(!regular_invocable<volatile_function_object const volatile, int, int>);
static_assert(regular_invocable<volatile_function_object&, int, int>);
static_assert(!regular_invocable<volatile_function_object const&, int, int>);
static_assert(regular_invocable<volatile_function_object volatile&, int, int>);
static_assert(!regular_invocable<volatile_function_object const volatile&, int, int>);
...
static_assert(!regular_invocable<lvalue_const_function_object volatile, int>);
static_assert(!regular_invocable<lvalue_const_function_object const volatile, int>);
static_assert(regular_invocable<lvalue_const_function_object&, int>);
static_assert(regular_invocable<lvalue_const_function_object const&, int>);
static_assert(!regular_invocable<lvalue_const_function_object volatile&, int>);
static_assert(!regular_invocable<lvalue_const_function_object const volatile&, int>);
...
static_assert(!regular_invocable<lvalue_volatile_function_object, int, int>);
static_assert(!regular_invocable<lvalue_volatile_function_object const, int, int>);
static_assert(!regular_invocable<lvalue_volatile_function_object volatile, int, int>);
static_assert(!regular_invocable<lvalue_volatile_function_object const volatile, int, int>);
static_assert(regular_invocable<lvalue_volatile_function_object&, int, int>);
static_assert(!regular_invocable<lvalue_volatile_function_object const&, int, int>);
static_assert(regular_invocable<lvalue_volatile_function_object volatile&, int, int>);
static_assert(!regular_invocable<lvalue_volatile_function_object const volatile&, int, int>);
...
static_assert(!regular_invocable<lvalue_cv_function_object volatile, int*>);
static_assert(!regular_invocable<lvalue_cv_function_object const volatile, int*>);
static_assert(regular_invocable<lvalue_cv_function_object&, int*>);
static_assert(regular_invocable<lvalue_cv_function_object const&, int*>);
static_assert(regular_invocable<lvalue_cv_function_object volatile&, int*>);
static_assert(regular_invocable<lvalue_cv_function_object const volatile&, int*>);
...
static_assert(!regular_invocable<rvalue_const_function_object volatile, int>);
static_assert(!regular_invocable<rvalue_const_function_object const volatile, int>);
static_assert(!regular_invocable<rvalue_const_function_object&, int>);
static_assert(!regular_invocable<rvalue_const_function_object const&, int>);
static_assert(!regular_invocable<rvalue_const_function_object volatile&, int>);
static_assert(!regular_invocable<rvalue_const_function_object const volatile&, int>);
...
static_assert(regular_invocable<rvalue_volatile_function_object, int, int>);
static_assert(!regular_invocable<rvalue_volatile_function_object const, int, int>);
static_assert(regular_invocable<rvalue_volatile_function_object volatile, int, int>);
static_assert(!regular_invocable<rvalue_volatile_function_object const volatile, int, int>);
static_assert(!regular_invocable<rvalue_volatile_function_object&, int, int>);
static_assert(!regular_invocable<rvalue_volatile_function_object const&, int, int>);
static_assert(!regular_invocable<rvalue_volatile_function_object volatile&, int, int>);
static_assert(!regular_invocable<rvalue_volatile_function_object const volatile&, int, int>);
...
static_assert(regular_invocable<rvalue_cv_function_object const volatile, int*>);
static_assert(!regular_invocable<rvalue_cv_function_object&, int*>);
static_assert(!regular_invocable<rvalue_cv_function_object const&, int*>);
static_assert(!regular_invocable<rvalue_cv_function_object volatile&, int*>);
static_assert(!regular_invocable<rvalue_cv_function_object const volatile&, int*>);
...
TEST_FUNC constexpr bool is_regular_invocable(F, Args&&...)
{
  return false;
}
