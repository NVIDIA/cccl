...
static_assert(
    !regular_invocable<lvalue_volatile_function_object volatile, int, int>, "");
static_assert(!regular_invocable<lvalue_volatile_function_object const volatile,
                                 int, int>,
              "");
static_assert(regular_invocable<lvalue_volatile_function_object&, int, int>,
              "");
...
static_assert(!regular_invocable<rvalue_volatile_function_object const volatile,
                                 int, int>,
              "");
static_assert(!regular_invocable<rvalue_volatile_function_object&, int, int>,
              "");
...
__host__ __device__ constexpr bool check_member_is_invocable() {
  ...
  static_assert(regular_invocable<Member, cuda::std::reference_wrapper<uncv_t>,
                                  Args...> == result,
                "");
...
template <class F, class... Args>
requires cuda::std::invocable<F, Args...> __host__ __device__ constexpr bool
is_regular_invocable(F, Args&&...) {
  return false;
}

template <class F, class... Args>
    requires cuda::std::regular_invocable<F, Args...> &&
    true __host__ __device__ constexpr bool is_regular_invocable(F, Args&&...) {
  return true;
}
#else
template <class F, class... Args>
