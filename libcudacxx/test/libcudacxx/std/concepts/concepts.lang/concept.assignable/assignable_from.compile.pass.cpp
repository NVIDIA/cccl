...
static_assert(!cuda::std::assignable_from<NoCommonRef&, const int&>,
              ""); // no common reference type
...
static_assert(
    cuda::std::is_assignable_v<VoidResultType&, const VoidResultType&>, "");
static_assert(
    !cuda::std::assignable_from<VoidResultType&, const VoidResultType&>, "");

struct ValueResultType {
  __host__ __device__ ValueResultType operator=(const ValueResultType&);
};
static_assert(
    cuda::std::is_assignable_v<ValueResultType&, const ValueResultType&>, "");
static_assert(
    !cuda::std::assignable_from<ValueResultType&, const ValueResultType&>, "");
