...
check_swappable_with_including_lvalue_ref_to_volatile() {
...
static_assert(!check_swappable_with_including_lvalue_ref_to_volatile<int, S>(),
              "");
static_assert(
    check_swappable_with_including_lvalue_ref_to_volatile<int S::*, int S::*>(),
    "");
static_assert(
...
static_assert(
    ...
    "");
static_assert(
    !check_swappable_with_including_lvalue_ref_to_volatile<int[5], double[5]>(),
    "");
static_assert(
    !check_swappable_with_including_lvalue_ref_to_volatile<int[5], double[6]>(),
    "");
static_assert(
    !check_swappable_with_including_lvalue_ref_to_volatile<int[5][6], int[5]>(),
    "");
static_assert(
    !check_swappable_with_including_lvalue_ref_to_volatile<int[5][6], int[6]>(),
    "");
static_assert(!check_swappable_with_including_lvalue_ref_to_volatile<
                  int[5][6], double[5]>(),
              "");
...
namespace adl {
    ...
    TEST_STD_VER >                                                             \
        2017 // MSVC ignores the rvalue/lvalue distinction in the swap definitions
static_assert(
...
struct one_way_swappable_with_s1_other_way {
  __host__ __device__ friend void swap(one_way_swappable_with_s1_other_way&,
                                       s1&);
  __host__ __device__ operator s1();
};
static_assert(
...
struct can_swap_with_s1_but_not_swappable {
  can_swap_with_s1_but_not_swappable(can_swap_with_s1_but_not_swappable&&) =
      delete;
  __host__ __device__ friend void swap(s1&,
                                       can_swap_with_s1_but_not_swappable&);
  __host__ __device__ friend void swap(can_swap_with_s1_but_not_swappable&,
                                       s1&);
...
struct swappable_with_const_s1_but_not_swappable {
  ...
  swap(s1 const&, swappable_with_const_s1_but_not_swappable const&);
  __host__ __device__ friend void
  swap(swappable_with_const_s1_but_not_swappable const&, s1 const&);

  __host__ __device__ operator s1 const&() const;
};
static_assert(!swappable<swappable_with_const_s1_but_not_swappable const&>, "");
static_assert(!swappable_with<swappable_with_const_s1_but_not_swappable const&,
                              s1 const&>,
              "");
...
struct swappable_with_volatile_s1_but_not_swappable {
  ...
  __host__ __device__ friend void
  swap(s1 volatile&, swappable_with_volatile_s1_but_not_swappable volatile&);
  __host__ __device__ friend void
  swap(swappable_with_volatile_s1_but_not_swappable volatile&, s1 volatile&);
...
struct swappable_with_cv_s1_but_not_swappable {
  ...
  swap(s1 const volatile&,
       swappable_with_cv_s1_but_not_swappable const volatile&);
  __host__ __device__ friend void
  swap(swappable_with_cv_s1_but_not_swappable const volatile&,
       s1 const volatile&);
...
struct swappable_with_const_s2 {
  ...
  __host__ __device__ swappable_with_const_s2(swappable_with_const_s2 const&&);
  __host__ __device__ swappable_with_const_s2&
  operator=(swappable_with_const_s2 const&);
  __host__ __device__ swappable_with_const_s2&
  operator=(swappable_with_const_s2 const&&);

  __host__ __device__ friend void swap(swappable_with_const_s2 const&,
                                       swappable_with_const_s2 const&);
  __host__ __device__ friend void swap(s2 const&,
                                       swappable_with_const_s2 const&);
  __host__ __device__ friend void swap(swappable_with_const_s2 const&,
                                       s2 const&);
...
struct swappable_with_volatile_s2 {
  ...
  __host__ __device__
  swappable_with_volatile_s2(swappable_with_volatile_s2 volatile&&);
  __host__ __device__ swappable_with_volatile_s2&
  operator=(swappable_with_volatile_s2 volatile&);
  __host__ __device__ swappable_with_volatile_s2&
  operator=(swappable_with_volatile_s2 volatile&&);

  __host__ __device__ friend void swap(swappable_with_volatile_s2 volatile&,
                                       swappable_with_volatile_s2 volatile&);
  __host__ __device__ friend void swap(s2 volatile&,
                                       swappable_with_volatile_s2 volatile&);
  __host__ __device__ friend void swap(swappable_with_volatile_s2 volatile&,
                                       s2 volatile&);
...
using test = cuda::std::common_reference_t<swappable_with_volatile_s2 volatile&,
                                           s2 volatile&>;
using test2 =
    cuda::std::common_reference_t<s2 volatile&,
                                  swappable_with_volatile_s2 volatile&>;
static_assert(
...
struct swappable_with_cv_s2 {
  ...
  __host__ __device__
  swappable_with_cv_s2(swappable_with_cv_s2 const volatile&&);
  __host__ __device__ swappable_with_cv_s2&
  operator=(swappable_with_cv_s2 const volatile&);
  __host__ __device__ swappable_with_cv_s2&
  operator=(swappable_with_cv_s2 const volatile&&);

  __host__ __device__ friend void swap(swappable_with_cv_s2 const volatile&,
                                       swappable_with_cv_s2 const volatile&);
  __host__ __device__ friend void swap(s2 const volatile&,
                                       swappable_with_cv_s2 const volatile&);
  __host__ __device__ friend void swap(swappable_with_cv_s2 const volatile&,
                                       s2 const volatile&);
...
static_assert(
    swappable_with<swappable_with_cv_s2 const volatile&, s2 const volatile&>,
    "");
#endif // !TEST_COMPILER_MSVC_2017

struct swappable_with_rvalue_ref_to_s1_but_not_swappable {
  __host__ __device__ friend void
  swap(swappable_with_rvalue_ref_to_s1_but_not_swappable&&,
       swappable_with_rvalue_ref_to_s1_but_not_swappable&&);
  __host__ __device__ friend void
  swap(s1&&, swappable_with_rvalue_ref_to_s1_but_not_swappable&&);
  __host__ __device__ friend void
  swap(swappable_with_rvalue_ref_to_s1_but_not_swappable&&, s1&&);
...
static_assert(
    !swappable_with<swappable_with_rvalue_ref_to_s1_but_not_swappable const&&,
                    s1 const&&>,
    "");
...
static_assert(
    !swappable<swappable_with_rvalue_ref_to_const_s1_but_not_swappable const&&>,
    "");
static_assert(
    !swappable_with<
        swappable_with_rvalue_ref_to_const_s1_but_not_swappable const&&,
...
struct swappable_with_rvalue_ref_to_volatile_s1_but_not_swappable {
  ...
  swappable_with_rvalue_ref_to_volatile_s1_but_not_swappable(
      swappable_with_rvalue_ref_to_volatile_s1_but_not_swappable volatile&&);
  __host__
      __device__ swappable_with_rvalue_ref_to_volatile_s1_but_not_swappable&
      operator=(
          swappable_with_rvalue_ref_to_volatile_s1_but_not_swappable volatile&);
...
struct s3 {
  ...
  __host__ __device__ friend void swap(s3 const volatile&&,
                                       s3 const volatile&&);
};
...
struct swappable_with_rvalue_ref_to_const_s3 {
  __host__ __device__ swappable_with_rvalue_ref_to_const_s3(
  ...
  __host__ __device__ friend void
  swap(swappable_with_rvalue_ref_to_const_s3 const&&,
       swappable_with_rvalue_ref_to_const_s3 const&&);
  __host__ __device__ friend void
  swap(s3 const&&, swappable_with_rvalue_ref_to_const_s3 const&&);
  __host__ __device__ friend void
  swap(swappable_with_rvalue_ref_to_const_s3 const&&, s3 const&&);

  __host__ __device__ operator s3() const;
};
static_assert(
    swappable_with<swappable_with_rvalue_ref_to_const_s3 const&&, s3 const&&>,
    "");
#endif // !TEST_COMPILER_MSVC_2017
...
struct swappable_with_rvalue_ref_to_volatile_s3 {
  ...
  __host__ __device__ friend void
  swap(swappable_with_rvalue_ref_to_volatile_s3 volatile&&,
       swappable_with_rvalue_ref_to_volatile_s3 volatile&&);
  __host__ __device__ friend void
  swap(s3 volatile&&, swappable_with_rvalue_ref_to_volatile_s3 volatile&&);
  __host__ __device__ friend void
  swap(swappable_with_rvalue_ref_to_volatile_s3 volatile&&, s3 volatile&&);
...
struct swappable_with_rvalue_ref_to_cv_s3 {
  __host__ __device__ swappable_with_rvalue_ref_to_cv_s3(
  ...
  __host__ __device__ friend void
  swap(swappable_with_rvalue_ref_to_cv_s3 const volatile&&,
       swappable_with_rvalue_ref_to_cv_s3 const volatile&&);
  __host__ __device__ friend void
  swap(s3 const volatile&&,
       swappable_with_rvalue_ref_to_cv_s3 const volatile&&);
  __host__ __device__ friend void
  swap(swappable_with_rvalue_ref_to_cv_s3 const volatile&&,
       s3 const volatile&&);
...
#if !defined(TEST_COMPILER_MSVC)
static_assert(cuda::std::common_reference_with<
                  swappable_with_rvalue_ref_to_cv_s3 const volatile&&,
                  s3 const volatile&&>,
              "");
static_assert(
...
#if !defined(TEST_COMPILER_MSVC) ||                                            \
    TEST_STD_VER > 2017 // MSVC does not like to swap the arrays
static_assert(check_swappable_with<cuda::std::array<int, 10>,
                                   cuda::std::array<int, 10> >(),
              "");
#endif // !defined(TEST_COMPILER_MSVC) || TEST_STD_VER > 2017
static_assert(!check_swappable_with<cuda::std::array<int, 10>,
                                    cuda::std::array<double, 10> >(),
              "");
} // namespace standard_types
...
struct Proxy {
  A* a;
  __host__ __device__ constexpr Proxy(A& a_) : a{&a_} {}
  __host__ __device__ friend constexpr void swap(Proxy x, Proxy y) {
    cuda::std::ranges::swap(*x.a, *y.a);
  }
};
__host__ __device__ constexpr Proxy proxy(A& a) { return Proxy{a}; }
} // namespace N
