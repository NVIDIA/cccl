...
static_assert(!check_equality_comparable_with<int (S::*)() const&,
              ...
              "");
static_assert(
    !check_equality_comparable_with<int (S::*)() const&,
                                    int (S::*)() const volatile & noexcept>(),
    "");
static_assert(
    !check_equality_comparable_with<int (S::*)() const&, int (S::*)() &&>(),
...
static_assert(check_equality_comparable_with<nullptr_t, int (S::*)() const>(),
              "");
static_assert(
    check_equality_comparable_with<nullptr_t, int (S::*)() const noexcept>(),
    "");
static_assert(
    check_equality_comparable_with<nullptr_t, int (S::*)() volatile>(), "");
static_assert(
    check_equality_comparable_with<nullptr_t, int (S::*)() volatile noexcept>(),
    "");
static_assert(
    check_equality_comparable_with<nullptr_t, int (S::*)() const volatile>(),
    "");
static_assert(check_equality_comparable_with<
