...
STATIC_TEST_GLOBAL_VAR TEST_CONSTEXPR_GLOBAL int host_reservoir_sample1[sample_size]   = {10, 5, 9, 4};
STATIC_TEST_GLOBAL_VAR TEST_CONSTEXPR_GLOBAL int device_reservoir_sample1[sample_size] = {10, 5, 9, 4};
STATIC_TEST_GLOBAL_VAR TEST_CONSTEXPR_GLOBAL int host_reservoir_sample2[sample_size]   = {5, 2, 10, 4};
STATIC_TEST_GLOBAL_VAR TEST_CONSTEXPR_GLOBAL int device_reservoir_sample2[sample_size] = {5, 2, 10, 4};

struct ReservoirSampleExpectations
{
  __host__ __device__ static TEST_CONSTEXPR_CXX14 const int* get_sample1() noexcept
  {
  ...
  __host__ __device__ static TEST_CONSTEXPR_CXX14 const int* get_sample2() noexcept
  {
...
STATIC_TEST_GLOBAL_VAR TEST_CONSTEXPR_GLOBAL int host_selection_sample1[sample_size]   = {1, 4, 6, 7};
STATIC_TEST_GLOBAL_VAR TEST_CONSTEXPR_GLOBAL int device_selection_sample1[sample_size] = {1, 4, 6, 7};
STATIC_TEST_GLOBAL_VAR TEST_CONSTEXPR_GLOBAL int host_selection_sample2[sample_size]   = {1, 2, 6, 8};
STATIC_TEST_GLOBAL_VAR TEST_CONSTEXPR_GLOBAL int device_selection_sample2[sample_size] = {1, 2, 6, 8};
...
__host__ __device__ void test()
{
  ...
  const int* oa1 = Expectations::get_sample1();
  ((void) oa1); // Prevent unused warning
  const int* oa2 = Expectations::get_sample2();
