...
struct NonTrivialMove {
  ...
  TEST_HOST_DEVICE TEST_CONSTEXPR_CXX20 NonTrivialMove&
...
TEST_CONSTEXPR_CXX20 TEST_HOST_DEVICE bool test() {
...
#if defined(_LIBCUDACXX_HAS_MEMORY)
  test1<cpp17_input_iterator<cuda::std::unique_ptr<int>*>,
        cpp17_output_iterator<cuda::std::unique_ptr<int>*> >();
  test1<cpp17_input_iterator<cuda::std::unique_ptr<int>*>,
        cpp17_input_iterator<cuda::std::unique_ptr<int>*> >();
  test1<cpp17_input_iterator<cuda::std::unique_ptr<int>*>,
        forward_iterator<cuda::std::unique_ptr<int>*> >();
  test1<cpp17_input_iterator<cuda::std::unique_ptr<int>*>,
        bidirectional_iterator<cuda::std::unique_ptr<int>*> >();
  test1<cpp17_input_iterator<cuda::std::unique_ptr<int>*>,
        random_access_iterator<cuda::std::unique_ptr<int>*> >();
  test1<cpp17_input_iterator<cuda::std::unique_ptr<int>*>,
        cuda::std::unique_ptr<int>*>();

  test1<forward_iterator<cuda::std::unique_ptr<int>*>,
        cpp17_output_iterator<cuda::std::unique_ptr<int>*> >();
  test1<forward_iterator<cuda::std::unique_ptr<int>*>,
        cpp17_input_iterator<cuda::std::unique_ptr<int>*> >();
  test1<forward_iterator<cuda::std::unique_ptr<int>*>,
  ...
  test1<random_access_iterator<cuda::std::unique_ptr<int>*>,
        cpp17_output_iterator<cuda::std::unique_ptr<int>*> >();
  test1<random_access_iterator<cuda::std::unique_ptr<int>*>,
        cpp17_input_iterator<cuda::std::unique_ptr<int>*> >();
  test1<random_access_iterator<cuda::std::unique_ptr<int>*>,
