...
struct TrivialSortable {
  ...
  __host__ __device__ constexpr TrivialSortable() : value(0) {}
  __host__ __device__ constexpr TrivialSortable(int v) : value(v) {}
  __host__ __device__ friend constexpr bool
  operator<(const TrivialSortable& a, const TrivialSortable& b) {
    return a.value / 10 < b.value / 10;
  }
  __host__ __device__ static constexpr bool less(const TrivialSortable& a,
                                                 const TrivialSortable& b) {
...
struct NonTrivialSortable {
  int value;
  __host__ __device__ constexpr NonTrivialSortable() : value(0) {}
  __host__ __device__ constexpr NonTrivialSortable(int v) : value(v) {}
  __host__ __device__ constexpr
  NonTrivialSortable(const NonTrivialSortable& rhs)
      : value(rhs.value) {}
  __host__ __device__ TEST_CONSTEXPR_CXX14 NonTrivialSortable&
  operator=(const NonTrivialSortable& rhs) {
    value = rhs.value;
    return *this;
  }
  __host__ __device__ friend constexpr bool
  operator<(const NonTrivialSortable& a, const NonTrivialSortable& b) {
    return a.value / 10 < b.value / 10;
  }
  __host__ __device__ static constexpr bool less(const NonTrivialSortable& a,
                                                 const NonTrivialSortable& b) {
    return a.value < b.value;
  }
};
...
struct TrivialSortableWithComp {
  int value;
  __host__ __device__ constexpr TrivialSortableWithComp() : value(0) {}
  __host__ __device__ constexpr TrivialSortableWithComp(int v) : value(v) {}
  struct Comparator {
    __host__ __device__ constexpr bool
    operator()(const TrivialSortableWithComp& a,
               const TrivialSortableWithComp& b) const {
      return a.value / 10 < b.value / 10;
    }
  };
  static __host__ __device__ constexpr bool
  less(const TrivialSortableWithComp& a, const TrivialSortableWithComp& b) {
    return a.value < b.value;
  }
};
...
struct NonTrivialSortableWithComp {
  int value;
  __host__ __device__ constexpr NonTrivialSortableWithComp() : value(0) {}
  __host__ __device__ constexpr NonTrivialSortableWithComp(int v) : value(v) {}
  __host__ __device__ constexpr
  NonTrivialSortableWithComp(const NonTrivialSortableWithComp& rhs)
      : value(rhs.value) {}
  __host__ __device__ TEST_CONSTEXPR_CXX14 NonTrivialSortableWithComp&
  operator=(const NonTrivialSortableWithComp& rhs) {
    value = rhs.value;
    return *this;
  }
  struct Comparator {
    __host__ __device__ constexpr bool
    operator()(const NonTrivialSortableWithComp& a,
               const NonTrivialSortableWithComp& b) const {
      return a.value / 10 < b.value / 10;
    }
  };
  static __host__ __device__ constexpr bool
  less(const NonTrivialSortableWithComp& a,
       const NonTrivialSortableWithComp& b) {
    return a.value < b.value;
  }
};
...
static_assert(
    !cuda::std::is_trivially_copyable<NonTrivialSortableWithComp>::value, "");
...
struct TracedCopy {
  ...
  __host__ __device__ constexpr TracedCopy(int i) : data(i) {}
  ...
  __host__ __device__ constexpr bool copiedOnce() const { return copied == 1; }
