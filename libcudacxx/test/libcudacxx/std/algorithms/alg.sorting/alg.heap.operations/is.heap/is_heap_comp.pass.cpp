...
__host__ __device__ TEST_CONSTEXPR_CXX14 bool test() {
  ...
  assert(cuda::std::is_heap(i4, i4 + 3, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i4, i4 + 3, cuda::std::greater<int>()) ==
          i4 + 3));
  assert(cuda::std::is_heap(i5, i5 + 3, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i5, i5 + 3, cuda::std::greater<int>()) ==
          i5 + 3));
  assert(cuda::std::is_heap(i6, i6 + 3, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i6, i6 + 3, cuda::std::greater<int>()) ==
          i6 + 3));
  assert(cuda::std::is_heap(i7, i7 + 3, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i7, i7 + 3, cuda::std::greater<int>()) ==
          i7 + 3));
  assert(cuda::std::is_heap(i8, i8 + 3, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i8, i8 + 3, cuda::std::greater<int>()) ==
          i8 + 3));
  assert(cuda::std::is_heap(i9, i9 + 3, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i9, i9 + 3, cuda::std::greater<int>()) ==
          i9 + 3));
  assert(cuda::std::is_heap(i10, i10 + 3, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i10, i10 + 3, cuda::std::greater<int>()) ==
          i10 + 3));
  int i11[] = {0, 0, 0, 0};
  int i12[] = {0, 0, 0, 1};
  int i13[] = {0, 0, 1, 0};
  ...
  assert(cuda::std::is_heap(i11, i11 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i11, i11 + 4, cuda::std::greater<int>()) ==
          i11 + 4));
  assert(cuda::std::is_heap(i12, i12 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i12, i12 + 4, cuda::std::greater<int>()) ==
          i12 + 4));
  assert(cuda::std::is_heap(i13, i13 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i13, i13 + 4, cuda::std::greater<int>()) ==
          i13 + 4));
  assert(cuda::std::is_heap(i14, i14 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i14, i14 + 4, cuda::std::greater<int>()) ==
          i14 + 4));
  assert(cuda::std::is_heap(i15, i15 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i15, i15 + 4, cuda::std::greater<int>()) ==
          i15 + 4));
  assert(cuda::std::is_heap(i16, i16 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i16, i16 + 4, cuda::std::greater<int>()) ==
          i16 + 4));
  assert(cuda::std::is_heap(i17, i17 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i17, i17 + 4, cuda::std::greater<int>()) ==
          i17 + 4));
  assert(cuda::std::is_heap(i18, i18 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i18, i18 + 4, cuda::std::greater<int>()) ==
          i18 + 4));
  assert(cuda::std::is_heap(i19, i19 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i19, i19 + 4, cuda::std::greater<int>()) ==
          i19 + 4));
  assert(cuda::std::is_heap(i20, i20 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i20, i20 + 4, cuda::std::greater<int>()) ==
          i20 + 4));
  assert(cuda::std::is_heap(i21, i21 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i21, i21 + 4, cuda::std::greater<int>()) ==
          i21 + 4));
  assert(cuda::std::is_heap(i22, i22 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i22, i22 + 4, cuda::std::greater<int>()) ==
          i22 + 4));
  assert(cuda::std::is_heap(i23, i23 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i23, i23 + 4, cuda::std::greater<int>()) ==
          i23 + 4));
  assert(cuda::std::is_heap(i24, i24 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i24, i24 + 4, cuda::std::greater<int>()) ==
          i24 + 4));
  assert(cuda::std::is_heap(i25, i25 + 4, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i25, i25 + 4, cuda::std::greater<int>()) ==
          i25 + 4));
  int i26[] = {0, 0, 0, 0, 0};
  int i27[] = {0, 0, 0, 0, 1};
  int i28[] = {0, 0, 0, 1, 0};
  ...
  assert(cuda::std::is_heap(i26, i26 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i26, i26 + 5, cuda::std::greater<int>()) ==
          i26 + 5));
  assert(cuda::std::is_heap(i27, i27 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i27, i27 + 5, cuda::std::greater<int>()) ==
          i27 + 5));
  assert(cuda::std::is_heap(i28, i28 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i28, i28 + 5, cuda::std::greater<int>()) ==
          i28 + 5));
  assert(cuda::std::is_heap(i29, i29 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i29, i29 + 5, cuda::std::greater<int>()) ==
          i29 + 5));
  assert(cuda::std::is_heap(i30, i30 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i30, i30 + 5, cuda::std::greater<int>()) ==
          i30 + 5));
  assert(cuda::std::is_heap(i31, i31 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i31, i31 + 5, cuda::std::greater<int>()) ==
          i31 + 5));
  assert(cuda::std::is_heap(i32, i32 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i32, i32 + 5, cuda::std::greater<int>()) ==
          i32 + 5));
  assert(cuda::std::is_heap(i33, i33 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i33, i33 + 5, cuda::std::greater<int>()) ==
          i33 + 5));
  assert(cuda::std::is_heap(i34, i34 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i34, i34 + 5, cuda::std::greater<int>()) ==
          i34 + 5));
  assert(cuda::std::is_heap(i35, i35 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i35, i35 + 5, cuda::std::greater<int>()) ==
          i35 + 5));
  assert(cuda::std::is_heap(i36, i36 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i36, i36 + 5, cuda::std::greater<int>()) ==
          i36 + 5));
  assert(cuda::std::is_heap(i37, i37 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i37, i37 + 5, cuda::std::greater<int>()) ==
          i37 + 5));
  assert(cuda::std::is_heap(i38, i38 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i38, i38 + 5, cuda::std::greater<int>()) ==
          i38 + 5));
  assert(cuda::std::is_heap(i39, i39 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i39, i39 + 5, cuda::std::greater<int>()) ==
          i39 + 5));
  assert(cuda::std::is_heap(i40, i40 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i40, i40 + 5, cuda::std::greater<int>()) ==
          i40 + 5));
  assert(cuda::std::is_heap(i41, i41 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i41, i41 + 5, cuda::std::greater<int>()) ==
          i41 + 5));
  assert(cuda::std::is_heap(i42, i42 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i42, i42 + 5, cuda::std::greater<int>()) ==
          i42 + 5));
  assert(cuda::std::is_heap(i43, i43 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i43, i43 + 5, cuda::std::greater<int>()) ==
          i43 + 5));
  assert(cuda::std::is_heap(i44, i44 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i44, i44 + 5, cuda::std::greater<int>()) ==
          i44 + 5));
  assert(cuda::std::is_heap(i45, i45 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i45, i45 + 5, cuda::std::greater<int>()) ==
          i45 + 5));
  assert(cuda::std::is_heap(i46, i46 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i46, i46 + 5, cuda::std::greater<int>()) ==
          i46 + 5));
  assert(cuda::std::is_heap(i47, i47 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i47, i47 + 5, cuda::std::greater<int>()) ==
          i47 + 5));
  assert(cuda::std::is_heap(i48, i48 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i48, i48 + 5, cuda::std::greater<int>()) ==
          i48 + 5));
  assert(cuda::std::is_heap(i49, i49 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i49, i49 + 5, cuda::std::greater<int>()) ==
          i49 + 5));
  assert(cuda::std::is_heap(i50, i50 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i50, i50 + 5, cuda::std::greater<int>()) ==
          i50 + 5));
  assert(cuda::std::is_heap(i51, i51 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i51, i51 + 5, cuda::std::greater<int>()) ==
          i51 + 5));
  assert(cuda::std::is_heap(i52, i52 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i52, i52 + 5, cuda::std::greater<int>()) ==
          i52 + 5));
  assert(cuda::std::is_heap(i53, i53 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i53, i53 + 5, cuda::std::greater<int>()) ==
          i53 + 5));
  assert(cuda::std::is_heap(i54, i54 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i54, i54 + 5, cuda::std::greater<int>()) ==
          i54 + 5));
  assert(cuda::std::is_heap(i55, i55 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i55, i55 + 5, cuda::std::greater<int>()) ==
          i55 + 5));
  assert(cuda::std::is_heap(i56, i56 + 5, cuda::std::greater<int>()) ==
         (cuda::std::is_heap_until(i56, i56 + 5, cuda::std::greater<int>()) ==
          i56 + 5));
  int i57[] = {0, 0, 0, 0, 0, 0};
  int i58[] = {0, 0, 0, 0, 0, 1};
  int i59[] = {0, 0, 0, 0, 1, 0};
