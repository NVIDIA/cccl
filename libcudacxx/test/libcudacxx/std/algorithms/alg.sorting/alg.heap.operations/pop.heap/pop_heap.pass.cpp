...
__host__ __device__ TEST_CONSTEXPR_CXX14 void test()
{
...

    {
        ...
        cuda::std::pop_heap(Iter(input), Iter(input + 5)); assert(input[4] == 5);
        cuda::std::pop_heap(Iter(input), Iter(input + 4)); assert(input[3] == 4);
        cuda::std::pop_heap(Iter(input), Iter(input + 3)); assert(input[2] == 3);
        cuda::std::pop_heap(Iter(input), Iter(input + 2)); assert(input[1] == 2);
        cuda::std::pop_heap(Iter(input), Iter(input + 1)); assert(input[0] == 1);
    }
}
