...
__host__ __device__ TEST_CONSTEXPR_CXX14 void test() {
  ...
  C c{};
  assert(!cuda::std::lexicographical_compare(Iter1(ia), Iter1(ia + sa),
                                             Iter2(ib), Iter2(ib + 2), c));
  assert(cuda::std::lexicographical_compare(Iter1(ib), Iter1(ib + 2), Iter2(ia),
                                            Iter2(ia + sa), c));
  assert(!cuda::std::lexicographical_compare(Iter1(ia), Iter1(ia + sa),
                                             Iter2(ib), Iter2(ib + 3), c));
  assert(cuda::std::lexicographical_compare(Iter1(ib), Iter1(ib + 3), Iter2(ia),
                                            Iter2(ia + sa), c));
  assert(!cuda::std::lexicographical_compare(Iter1(ia), Iter1(ia + sa),
                                             Iter2(ib + 1), Iter2(ib + 3), c));
  assert(cuda::std::lexicographical_compare(Iter1(ib + 1), Iter1(ib + 3),
                                            Iter2(ia), Iter2(ia + sa), c));
}
