...
__host__ __device__ TEST_CONSTEXPR_CXX14 void test() {
  ...
  assert(cuda::std::includes(Iter1(ia), Iter1(ia + 1), Iter2(ib), Iter2(ib),
                             cuda::std::greater<int>()));
  assert(cuda::std::includes(Iter1(ia), Iter1(ia + sa), Iter2(ia),
                             Iter2(ia + sa), cuda::std::greater<int>()));

  assert(cuda::std::includes(Iter1(ia), Iter1(ia + sa), Iter2(ib),
                             Iter2(ib + sb), cuda::std::greater<int>()));
  assert(!cuda::std::includes(Iter1(ib), Iter1(ib + sb), Iter2(ia),
                              Iter2(ia + sa), cuda::std::greater<int>()));

  assert(cuda::std::includes(Iter1(ia + 8), Iter1(ia + sa), Iter2(ic),
                             Iter2(ic + sc), cuda::std::greater<int>()));
  assert(!cuda::std::includes(Iter1(ia + 8), Iter1(ia + sa), Iter2(ib),
                              Iter2(ib + sb), cuda::std::greater<int>()));

  assert(cuda::std::includes(Iter1(ia), Iter1(ia + sa), Iter2(id),
                             Iter2(id + 1), cuda::std::greater<int>()));
  assert(cuda::std::includes(Iter1(ia), Iter1(ia + sa), Iter2(id),
                             Iter2(id + 2), cuda::std::greater<int>()));
  assert(cuda::std::includes(Iter1(ia), Iter1(ia + sa), Iter2(id),
                             Iter2(id + 3), cuda::std::greater<int>()));
  assert(!cuda::std::includes(Iter1(ia), Iter1(ia + sa), Iter2(id),
                              Iter2(id + 4), cuda::std::greater<int>()));
}
