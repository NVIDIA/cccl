...
__host__ __device__ TEST_CONSTEXPR_CXX14 void test() {
  ...
  assert(
      cuda::std::includes(Iter1(ia), Iter1(ia + 2), Iter2(ic), Iter2(ic + 2)));
  assert(
      !cuda::std::includes(Iter1(ia), Iter1(ia + 2), Iter2(ib), Iter2(ib + 2)));

  assert(
      cuda::std::includes(Iter1(ia), Iter1(ia + sa), Iter2(id), Iter2(id + 1)));
  assert(
      cuda::std::includes(Iter1(ia), Iter1(ia + sa), Iter2(id), Iter2(id + 2)));
  assert(
      cuda::std::includes(Iter1(ia), Iter1(ia + sa), Iter2(id), Iter2(id + 3)));
