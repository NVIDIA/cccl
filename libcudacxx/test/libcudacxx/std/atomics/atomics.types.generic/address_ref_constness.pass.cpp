...
int main(int, char**) {
  NV_DISPATCH_TARGET(
      ...
      (test<const cuda::std::atomic_ref<int*>, int*, local_memory_selector>();
       test<const cuda::atomic_ref<int*, cuda::thread_scope_system>, int*,
            local_memory_selector>();
       test<const cuda::atomic_ref<int*, cuda::thread_scope_device>, int*,
            local_memory_selector>();
       test<const cuda::atomic_ref<int*, cuda::thread_scope_block>, int*,
            local_memory_selector>();),
      NV_PROVIDES_SM_70,
      (test<const cuda::std::atomic_ref<int*>, int*, local_memory_selector>();
       test<const cuda::atomic_ref<int*, cuda::thread_scope_system>, int*,
