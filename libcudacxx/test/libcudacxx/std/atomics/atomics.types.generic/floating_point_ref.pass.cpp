...
// template <>
// struct atomic_ref<floating_point>
// {
...
//
//     atomic_ref() = delete;
//     constexpr atomic_ref(floating_point& desr);
...
int main(int, char**) {
  ...
  NV_DISPATCH_TARGET(
      NV_IS_HOST,
      (test_for_all_types<cuda_std_atomic_ref, cuda::thread_scope_block,
                          local_memory_selector>();
       test_for_all_types<cuda_atomic_ref, cuda::thread_scope_block,
                          local_memory_selector>();),
      NV_PROVIDES_SM_70,
      (test_for_all_types<cuda_std_atomic_ref, cuda::thread_scope_block,
                          local_memory_selector>();
  ...
  NV_IF_TARGET(
      ...
      (test_for_all_types<cuda_std_atomic_ref, cuda::thread_scope_block,
       ...
       test_for_all_types<cuda_std_atomic_ref, cuda::thread_scope_device,
                          global_memory_selector>();
       test_for_all_types<cuda_atomic_ref, cuda::thread_scope_device,
                          global_memory_selector>();))
