...
int main(int, char**) {
  NV_DISPATCH_TARGET(
      ...
      (test<cuda::std::atomic_ref<int*>, int*, local_memory_selector>();
       test<cuda::atomic_ref<int*, cuda::thread_scope_system>, int*,
            local_memory_selector>();
       test<cuda::atomic_ref<int*, cuda::thread_scope_device>, int*,
            local_memory_selector>();
       test<cuda::atomic_ref<int*, cuda::thread_scope_block>, int*,
            local_memory_selector>();),
      NV_PROVIDES_SM_70,
      (test<cuda::std::atomic_ref<int*>, int*, local_memory_selector>();
       test<cuda::atomic_ref<int*, cuda::thread_scope_system>, int*,
