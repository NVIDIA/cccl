...
template <bool Disable = NeedWorkaroundForPR31864,
          cuda::std::enable_if_t<!Disable>* = nullptr, class LLong = long long,
          class ULLong = unsigned long long>
__host__ __device__ void checkLongLongTypes() {
  static_assert(cuda::std::atomic<LLong>::is_always_lock_free ==
                    (2 == ATOMIC_LLONG_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<ULLong>::is_always_lock_free ==
                    (2 == ATOMIC_LLONG_LOCK_FREE),
                "");
}
...
template <bool Enable = NeedWorkaroundForPR31864,
          cuda::std::enable_if_t<Enable>* = nullptr, class LLong = long long,
          class ULLong = unsigned long long>
__host__ __device__ void checkLongLongTypes() {
  constexpr bool ExpectLockFree =
      __atomic_always_lock_free(getSizeOf<LLong>(), 0);
  static_assert(cuda::std::atomic<LLong>::is_always_lock_free == ExpectLockFree,
                "");
  static_assert(
      cuda::std::atomic<ULLong>::is_always_lock_free == ExpectLockFree, "");
...
#define CHECK_ALWAYS_LOCK_FREE(T)                                              \
  ...
  CHECK_ALWAYS_LOCK_FREE(float
                         __attribute__((vector_size(32 * sizeof(float)))));
  CHECK_ALWAYS_LOCK_FREE(double
                         __attribute__((vector_size(1 * sizeof(double)))));
  CHECK_ALWAYS_LOCK_FREE(double
  ...
  CHECK_ALWAYS_LOCK_FREE(double
                         __attribute__((vector_size(32 * sizeof(double)))));
  ...
  static_assert(cuda::std::atomic<bool>::is_always_lock_free ==
                    (2 == ATOMIC_BOOL_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<char>::is_always_lock_free ==
                    (2 == ATOMIC_CHAR_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<signed char>::is_always_lock_free ==
                    (2 == ATOMIC_CHAR_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<unsigned char>::is_always_lock_free ==
                    (2 == ATOMIC_CHAR_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<char16_t>::is_always_lock_free ==
                    (2 == ATOMIC_CHAR16_T_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<char32_t>::is_always_lock_free ==
                    (2 == ATOMIC_CHAR32_T_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<wchar_t>::is_always_lock_free ==
                    (2 == ATOMIC_WCHAR_T_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<short>::is_always_lock_free ==
                    (2 == ATOMIC_SHORT_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<unsigned short>::is_always_lock_free ==
                    (2 == ATOMIC_SHORT_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<int>::is_always_lock_free ==
                    (2 == ATOMIC_INT_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<unsigned int>::is_always_lock_free ==
                    (2 == ATOMIC_INT_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<long>::is_always_lock_free ==
                    (2 == ATOMIC_LONG_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<unsigned long>::is_always_lock_free ==
                    (2 == ATOMIC_LONG_LOCK_FREE),
                "");
  checkLongLongTypes();
  static_assert(cuda::std::atomic<void*>::is_always_lock_free ==
                    (2 == ATOMIC_POINTER_LOCK_FREE),
                "");
  static_assert(cuda::std::atomic<cuda::std::nullptr_t>::is_always_lock_free ==
                    (2 == ATOMIC_POINTER_LOCK_FREE),
                "");
}
