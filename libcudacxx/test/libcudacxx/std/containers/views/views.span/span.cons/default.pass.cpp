...
int main(int, char**) {
  ...
  static_assert(cuda::std::is_default_constructible<
                    cuda::std::span<int, cuda::std::dynamic_extent> >::value,
                "");
  static_assert(
      cuda::std::is_default_constructible<cuda::std::span<int, 0> >::value, "");
  static_assert(
      !cuda::std::is_default_constructible<cuda::std::span<int, 2> >::value,
      "");
