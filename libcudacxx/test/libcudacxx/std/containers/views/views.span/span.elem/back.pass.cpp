...
int main(int, char**) {
  ...
  STATIC_ASSERT_CXX14(
      testConstexprSpan(cuda::std::span<const int, 1>(iArr1, 1)));
  STATIC_ASSERT_CXX14(
      testConstexprSpan(cuda::std::span<const int, 2>(iArr1, 2)));
  STATIC_ASSERT_CXX14(
      testConstexprSpan(cuda::std::span<const int, 3>(iArr1, 3)));
  STATIC_ASSERT_CXX14(
      testConstexprSpan(cuda::std::span<const int, 4>(iArr1, 4)));
