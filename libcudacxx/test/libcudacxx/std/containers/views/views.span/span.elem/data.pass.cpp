...
int main(int, char**) {
  ...
  static_assert(
      testConstexprSpan(cuda::std::span<const int>(iArr1 + 1, 1), iArr1 + 1),
      "");
  static_assert(
      testConstexprSpan(cuda::std::span<const int>(iArr1 + 2, 2), iArr1 + 2),
      "");
  static_assert(
      testConstexprSpan(cuda::std::span<const int>(iArr1 + 3, 3), iArr1 + 3),
      "");
  static_assert(
      testConstexprSpan(cuda::std::span<const int>(iArr1 + 4, 4), iArr1 + 4),
      "");
  ...
  static_assert(
      testConstexprSpan(cuda::std::span<const int, 1>(iArr1, 1), iArr1), "");
  static_assert(
      testConstexprSpan(cuda::std::span<const int, 2>(iArr1, 2), iArr1), "");
  static_assert(
      testConstexprSpan(cuda::std::span<const int, 3>(iArr1, 3), iArr1), "");
  static_assert(
      testConstexprSpan(cuda::std::span<const int, 4>(iArr1, 4), iArr1), "");

  static_assert(
      testConstexprSpan(cuda::std::span<const int, 1>(iArr1 + 1, 1), iArr1 + 1),
      "");
  static_assert(
      testConstexprSpan(cuda::std::span<const int, 2>(iArr1 + 2, 2), iArr1 + 2),
      "");
  static_assert(
      testConstexprSpan(cuda::std::span<const int, 3>(iArr1 + 3, 3), iArr1 + 3),
      "");
  static_assert(
      testConstexprSpan(cuda::std::span<const int, 4>(iArr1 + 4, 4), iArr1 + 4),
      "");
