...
int main(int, char**) {
...

  {
    ...
    cuda::std::layout_stride::mapping<cuda::std::extents<index_t, dyn, dyn> >
        m_stride{cuda::std::dextents<index_t, 2>{16, 32}, a};
  ...
  {
    using mapping0_t =
        cuda::std::layout_stride::mapping<cuda::std::extents<index_t, 16, 32> >;
    using mapping1_t =
        cuda::std::layout_left ::mapping<cuda::std::extents<index_t, 16, 16> >;
    using mappingd_t =
        cuda::std::layout_left::mapping<cuda::std::dextents<index_t, 2> >;
