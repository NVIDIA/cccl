...
struct is_copy_cons_avail<
    T1, T0,
    cuda::std::enable_if_t<
        cuda::std::is_same<decltype(T1{cuda::std::declval<T0>()}), T1>::value> >
    : cuda::std::true_type {};
...
int main(int, char**) {
  ...
  {
    cuda::std::array<int, 1> d{42};
    cuda::std::mdspan<int, cuda::std::extents<int, 64, 128> > m0{
        d.data(), cuda::std::extents<int, 64, 128>{}};
  ...
  {
    using mdspan1_t = cuda::std::mdspan<int, cuda::std::extents<int, dyn, dyn>,
                                        cuda::std::layout_left>;
    using mdspan0_t = cuda::std::mdspan<int, cuda::std::extents<int, dyn, dyn>,
  ...
  {
    using mdspan1_t =
        cuda::std::mdspan<int, cuda::std::extents<int, dyn, dyn>,
