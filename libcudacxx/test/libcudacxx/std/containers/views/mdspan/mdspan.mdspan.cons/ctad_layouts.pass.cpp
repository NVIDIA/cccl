...
int main(int, char**) {
  ...
  // TEST(TestMdspanCTAD, layout_left)
  {
    ...
    cuda::std::mdspan m0{
        d.data(), cuda::std::layout_left::mapping{cuda::std::extents{16, 32}}};
  ...
  // TEST(TestMdspanCTAD, layout_right)
  {
    cuda::std::array<int, 1> d{42};
    cuda::std::mdspan m0{
        d.data(), cuda::std::layout_right::mapping{cuda::std::extents{16, 32}}};
  ...
  // TEST(TestMdspanCTAD, layout_stride)
  {
    cuda::std::array<int, 1> d{42};
    cuda::std::mdspan m0{
        d.data(), cuda::std::layout_stride::mapping{cuda::std::extents{16, 32},
                                                    cuda::std::array{1, 128}}};
