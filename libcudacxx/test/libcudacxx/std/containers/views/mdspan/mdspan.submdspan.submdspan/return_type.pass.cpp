...
using submdspan_test_types = cuda::std::tuple<
    ...
    cuda::std::tuple<cuda::std::layout_left, cuda::std::layout_left,
    ...
    cuda::std::tuple<cuda::std::layout_left, cuda::std::layout_left,
                     ...
                     cuda::std::dextents<size_t, 2>, cuda::std::full_extent_t,
    ...
    cuda::std::tuple<cuda::std::layout_left, cuda::std::layout_left,
                     ...
                     cuda::std::dextents<size_t, 3>, cuda::std::full_extent_t,
                     cuda::std::full_extent_t, cuda::std::pair<int, int> >,
    cuda::std::tuple<cuda::std::layout_left, cuda::std::layout_left,
                     cuda::std::dextents<size_t, 3>,
                     cuda::std::dextents<size_t, 2>, cuda::std::full_extent_t,
                     cuda::std::pair<int, int>, int>,
    cuda::std::tuple<cuda::std::layout_left, cuda::std::layout_left,
                     cuda::std::dextents<size_t, 3>,
                     cuda::std::dextents<size_t, 1>, cuda::std::full_extent_t,
                     int, int>,
    ...
    cuda::std::tuple<cuda::std::layout_left, cuda::std::layout_left,
                     ...
                     cuda::std::dextents<size_t, 3>, cuda::std::full_extent_t,
                     cuda::std::full_extent_t, cuda::std::pair<int, int>, int,
                     int, int>,
    cuda::std::tuple<cuda::std::layout_left, cuda::std::layout_left,
                     cuda::std::dextents<size_t, 6>,
                     cuda::std::dextents<size_t, 2>, cuda::std::full_extent_t,
                     cuda::std::pair<int, int>, int, int, int, int>,
    cuda::std::tuple<cuda::std::layout_left, cuda::std::layout_left,
                     cuda::std::dextents<size_t, 6>,
                     cuda::std::dextents<size_t, 1>, cuda::std::full_extent_t,
                     int, int, int, int, int>,
    ...
    ,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::dextents<size_t, 1>,
                     cuda::std::dextents<size_t, 1>, cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::dextents<size_t, 1>,
    ...
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::dextents<size_t, 2>,
                     cuda::std::dextents<size_t, 2>, cuda::std::pair<int, int>,
                     cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::dextents<size_t, 2>,
                     cuda::std::dextents<size_t, 1>, int,
                     cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::dextents<size_t, 3>,
                     cuda::std::dextents<size_t, 3>, cuda::std::pair<int, int>,
                     cuda::std::full_extent_t, cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::dextents<size_t, 3>,
                     cuda::std::dextents<size_t, 2>, int,
                     cuda::std::pair<int, int>, cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::dextents<size_t, 3>,
                     cuda::std::dextents<size_t, 1>, int, int,
                     cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::dextents<size_t, 6>,
                     cuda::std::dextents<size_t, 3>, int, int, int,
                     cuda::std::pair<int, int>, cuda::std::full_extent_t,
                     cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::dextents<size_t, 6>,
                     cuda::std::dextents<size_t, 2>, int, int, int, int,
                     cuda::std::pair<int, int>, cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::dextents<size_t, 6>,
                     cuda::std::dextents<size_t, 1>, int, int, int, int, int,
                     cuda::std::full_extent_t>
    ...
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     ...
                     cuda::std::pair<int, int> >,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::extents<size_t, 1>, cuda::std::extents<size_t>,
                     int>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::extents<size_t, 1, 2>,
                     cuda::std::extents<size_t, 1, 2>, cuda::std::full_extent_t,
                     cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::extents<size_t, 1, 2>,
    ...
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::extents<size_t, 1, 2, 3>,
                     cuda::std::extents<size_t, dyn, 3>, int,
                     cuda::std::pair<int, int>, cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::extents<size_t, 1, 2, 3>,
                     cuda::std::extents<size_t, 3>, int, int,
                     cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::extents<size_t, 1, 2, 3, 4, 5, 6>,
                     cuda::std::extents<size_t, dyn, 5, 6>, int, int, int,
                     cuda::std::pair<int, int>, cuda::std::full_extent_t,
                     cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::extents<size_t, 1, 2, 3, 4, 5, 6>,
                     cuda::std::extents<size_t, dyn, 6>, int, int, int, int,
                     cuda::std::pair<int, int>, cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_right,
                     cuda::std::extents<size_t, 1, 2, 3, 4, 5, 6>,
                     cuda::std::extents<size_t, 6>, int, int, int, int, int,
                     cuda::std::full_extent_t>

    ,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_stride,
                     cuda::std::extents<size_t, 1, 2, 3, 4, 5, 6>,
                     cuda::std::extents<size_t, 1, dyn, 6>,
                     cuda::std::full_extent_t, int, cuda::std::pair<int, int>,
                     int, int, cuda::std::full_extent_t>,
    cuda::std::tuple<cuda::std::layout_right, cuda::std::layout_stride,
                     cuda::std::extents<size_t, 1, 2, 3, 4, 5, 6>,
                     cuda::std::extents<size_t, 2, dyn, 5>, int,
                     cuda::std::full_extent_t, cuda::std::pair<int, int>, int,
...
template <class LayoutOrg, class LayoutSub, class ExtentsOrg, class ExtentsSub,
          class... SubArgs>
struct TestSubMDSpan<cuda::std::tuple<LayoutOrg, LayoutSub, ExtentsOrg,
                                      ExtentsSub, SubArgs...> > {
  ...
  using mds_sub_deduced_t =
      decltype(cuda::std::submdspan(mds_org_t(nullptr, map_t()), SubArgs()...));
...
__host__ __device__ void test_submdspan() {
  ...
  static_assert(
      cuda::std::is_same<typename TestFixture::mds_sub_t,
