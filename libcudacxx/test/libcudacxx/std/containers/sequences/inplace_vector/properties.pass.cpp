...
TEST_FUNC void test()
{
  ...
  static_assert(
    sizeof(cuda::std::inplace_vector<char, uint32_t_max>) == uint32_t_max + 1 + sizeof(cuda::std::uint32_t));
  static_assert(
  ...
  static_assert(
    cuda::std::is_same<cuda::std::reverse_iterator<int*>, typename inplace_vector::reverse_iterator>::value);
  static_assert(
  ...
  static_assert(
    !cuda::std::is_trivially_copy_constructible<cuda::std::inplace_vector<NonTrivialDestructor, 42>>::value);
  ...
  static_assert(
    !cuda::std::is_trivially_move_constructible<cuda::std::inplace_vector<NonTrivialDestructor, 42>>::value);
  ...
  // assignment operator
  static_assert(
    cuda::std::is_trivially_copy_assignable<cuda::std::inplace_vector<ThrowingDefaultConstruct, 42>>::value);
  static_assert(
    !cuda::std::is_trivially_copy_assignable<cuda::std::inplace_vector<ThrowingCopyConstructor, 42>>::value);
  ...
  // assignment operator
  static_assert(
    cuda::std::is_trivially_move_assignable<cuda::std::inplace_vector<ThrowingDefaultConstruct, 42>>::value);
  static_assert(cuda::std::is_trivially_move_assignable<cuda::std::inplace_vector<ThrowingCopyConstructor, 42>>::value);
  static_assert(
    !cuda::std::is_trivially_move_assignable<cuda::std::inplace_vector<ThrowingMoveConstructor, 42>>::value);
