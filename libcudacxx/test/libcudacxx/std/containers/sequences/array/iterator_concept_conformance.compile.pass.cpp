...
using const_reverse_iterator =
    cuda::std::array<int, 10>::const_reverse_iterator;
...
static_assert(
    !cuda::std::indirectly_movable_storable<iterator, const_iterator>);
static_assert(cuda::std::indirectly_movable<iterator, reverse_iterator>);
static_assert(
    cuda::std::indirectly_movable_storable<iterator, reverse_iterator>);
static_assert(!cuda::std::indirectly_movable<iterator, const_reverse_iterator>);
static_assert(
    !cuda::std::indirectly_movable_storable<iterator, const_reverse_iterator>);
...
static_assert(
    !cuda::std::indirectly_copyable_storable<iterator, const_iterator>);
static_assert(cuda::std::indirectly_copyable<iterator, reverse_iterator>);
static_assert(
    cuda::std::indirectly_copyable_storable<iterator, reverse_iterator>);
static_assert(
    !cuda::std::indirectly_copyable<iterator, const_reverse_iterator>);
static_assert(
    !cuda::std::indirectly_copyable_storable<iterator, const_reverse_iterator>);
...
static_assert(
    !cuda::std::sized_sentinel_for<const_iterator, const_reverse_iterator>);
...
static_assert(
    !cuda::std::indirectly_movable_storable<const_iterator, const_iterator>);
static_assert(cuda::std::indirectly_movable<const_iterator, reverse_iterator>);
static_assert(
    cuda::std::indirectly_movable_storable<const_iterator, reverse_iterator>);
static_assert(
    !cuda::std::indirectly_movable<const_iterator, const_reverse_iterator>);
static_assert(!cuda::std::indirectly_movable_storable<const_iterator,
                                                      const_reverse_iterator>);
static_assert(cuda::std::indirectly_copyable<const_iterator, iterator>);
static_assert(
    cuda::std::indirectly_copyable_storable<const_iterator, iterator>);
static_assert(!cuda::std::indirectly_copyable<const_iterator, const_iterator>);
static_assert(
    !cuda::std::indirectly_copyable_storable<const_iterator, const_iterator>);
static_assert(cuda::std::indirectly_copyable<const_iterator, reverse_iterator>);
static_assert(
    cuda::std::indirectly_copyable_storable<const_iterator, reverse_iterator>);
static_assert(
    !cuda::std::indirectly_copyable<const_iterator, const_reverse_iterator>);
static_assert(!cuda::std::indirectly_copyable_storable<const_iterator,
                                                       const_reverse_iterator>);
