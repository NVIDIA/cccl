...
__host__ __device__ void test_iterators() {
  ...
  static_assert(
      (cuda::std::is_same<typename ItT::iterator_category,
                          cuda::std::random_access_iterator_tag>::value),
      "");
  static_assert((cuda::std::is_same<typename ItT::value_type,
                                    typename C::value_type>::value),
                "");
  static_assert((cuda::std::is_same<typename ItT::reference,
                                    typename C::reference>::value),
                "");
  static_assert(
      (cuda::std::is_same<typename ItT::pointer, typename C::pointer>::value),
      "");
  static_assert((cuda::std::is_same<typename ItT::difference_type,
                                    typename C::difference_type>::value),
                "");

  static_assert(
      (cuda::std::is_same<typename CItT::iterator_category,
                          cuda::std::random_access_iterator_tag>::value),
      "");
  static_assert((cuda::std::is_same<typename CItT::value_type,
                                    typename C::value_type>::value),
                "");
  static_assert((cuda::std::is_same<typename CItT::reference,
                                    typename C::const_reference>::value),
                "");
  static_assert((cuda::std::is_same<typename CItT::pointer,
                                    typename C::const_pointer>::value),
                "");
  static_assert((cuda::std::is_same<typename CItT::difference_type,
                                    typename C::difference_type>::value),
                "");
}
...
int main(int, char**) {
  {
    ...
    LIBCPP_STATIC_ASSERT(
        (cuda::std::is_same<C::const_iterator, const T*>::value), "");
    test_iterators<C>();
    ...
    static_assert((cuda::std::is_same<C::size_type, cuda::std::size_t>::value),
                  "");
    static_assert(
        (cuda::std::is_same<C::difference_type, cuda::std::ptrdiff_t>::value),
        "");
    static_assert(
        (cuda::std::is_same<C::reverse_iterator,
                            cuda::std::reverse_iterator<C::iterator> >::value),
        "");
    static_assert((cuda::std::is_same<
                      C::const_reverse_iterator,
                      cuda::std::reverse_iterator<C::const_iterator> >::value),
                  "");
