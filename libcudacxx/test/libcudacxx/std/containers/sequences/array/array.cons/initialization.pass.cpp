...
struct test_default_initialization {
    ...
    __host__ __device__ void operator()() const
    {
        ...
        cuda::std::array<T, 2> a2; unused(a2);
        cuda::std::array<T, 3> a3; unused(a3);
...
struct test_nondefault_initialization {
    ...
    __host__ __device__ TEST_CONSTEXPR_CXX14 void operator()() const
    {
        // Check direct-list-initialization syntax (introduced in C++11)
        {
            ...
            {
                cuda::std::array<T, 1> a1_0{}; unused(a1_0);
                cuda::std::array<T, 1> a1_1{T()}; unused(a1_1);
            }
            {
                cuda::std::array<T, 2> a2_0{}; unused(a2_0);
                cuda::std::array<T, 2> a2_1{T()}; unused(a2_1);
                cuda::std::array<T, 2> a2_2{T(), T()}; unused(a2_2);
            }
            {
                cuda::std::array<T, 3> a3_0{}; unused(a3_0);
                cuda::std::array<T, 3> a3_1{T()}; unused(a3_1);
                cuda::std::array<T, 3> a3_2{T(), T()}; unused(a3_2);
                cuda::std::array<T, 3> a3_3{T(), T(), T()}; unused(a3_3);
            }
