...
TEST_FUNC constexpr cuda::std::div_t div_overload(I x, I y)
{
...
TEST_FUNC constexpr cuda::std::ldiv_t div_overload(IL x, IL y)
{
...
TEST_FUNC constexpr cuda::std::lldiv_t div_overload(ILL x, ILL y)
{
...
template <class T>
TEST_FUNC constexpr void test_div(T x_in, T y_in, T x_ref, T r_ref, T zero_value)
{
...
TEST_FUNC constexpr bool test_div(T zero_value)
{
