...
__host__ __device__ void test()
{
  ...
  cuda::std::array<P, 5> params              = {P(0, 1), P(5, 2), P(-3, 0.5), P(10, 3), P(100, 10)};
  test_distribution<D, true, G, test_constexpr>(params, extreme_value_cdf<T>{});
}
