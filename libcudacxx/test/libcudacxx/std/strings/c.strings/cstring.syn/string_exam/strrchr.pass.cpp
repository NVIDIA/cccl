...
{
  static_assert(cuda::std::is_same_v<char*, decltype(cuda::std::strrchr((char*) {}, int{}))>);
  static_assert(cuda::std::is_same_v<const char*, decltype(cuda::std::strrchr((const char*) {}, int{}))>);
