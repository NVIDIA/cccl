...
TEST_FUNC constexpr void test_copy_constructor()
{
  ...
  static_assert(cuda::std::is_trivially_copyable_v<SV>);
...
TEST_FUNC constexpr bool test()
{
  ...
  test_copy_constructor<cuda::std::u8string_view>();
#endif // _CCCL_HAS_CHAR8_T()
  test_copy_constructor<cuda::std::u16string_view>();
  test_copy_constructor<cuda::std::u32string_view>();
#if _CCCL_HAS_WCHAR_T()
  test_copy_constructor<cuda::std::wstring_view>();
