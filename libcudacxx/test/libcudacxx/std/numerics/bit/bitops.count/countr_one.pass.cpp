...
__host__ __device__ constexpr bool constexpr_test() {
  return cuda::std::countr_one(T(0)) == 0 && cuda::std::countr_one(T(1)) == 1 &&
         cuda::std::countr_one(T(2)) == 0 && cuda::std::countr_one(T(3)) == 2 &&
         cuda::std::countr_one(T(4)) == 0 && cuda::std::countr_one(T(5)) == 1 &&
         cuda::std::countr_one(T(6)) == 0 && cuda::std::countr_one(T(7)) == 3 &&
         cuda::std::countr_one(T(8)) == 0 && cuda::std::countr_one(T(9)) == 1 &&
         cuda::std::countr_one(cuda::std::numeric_limits<T>::max()) ==
             cuda::std::numeric_limits<T>::digits;
}
