...
__host__ __device__ constexpr bool constexpr_test() {
  return cuda::std::popcount(T(0)) == 0 && cuda::std::popcount(T(1)) == 1 &&
         cuda::std::popcount(T(2)) == 1 && cuda::std::popcount(T(3)) == 2 &&
         cuda::std::popcount(T(4)) == 1 && cuda::std::popcount(T(5)) == 2 &&
         cuda::std::popcount(T(6)) == 2 && cuda::std::popcount(T(7)) == 3 &&
         cuda::std::popcount(T(8)) == 1 && cuda::std::popcount(T(9)) == 2 &&
         cuda::std::popcount(cuda::std::numeric_limits<T>::max()) ==
