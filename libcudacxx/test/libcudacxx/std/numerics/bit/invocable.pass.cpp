...
{
  template <typename T>
  TEST_FUNC constexpr auto operator()(T x) const -> decltype(cuda::std::rotr(x, 1U));
};
...
{
  template <typename T>
  TEST_FUNC constexpr auto operator()(T x) const -> decltype(cuda::std::rotl(x, 1U));
};
...
{
  template <typename T>
  TEST_FUNC constexpr auto operator()(T x) const -> decltype(cuda::std::popcount(x));
};
...
{
  template <typename T>
  TEST_FUNC constexpr auto operator()(T x) const -> decltype(cuda::std::countr_zero(x));
};
...
{
  template <typename T>
  TEST_FUNC constexpr auto operator()(T x) const -> decltype(cuda::std::countr_one(x));
};
...
{
  template <typename T>
  TEST_FUNC constexpr auto operator()(T x) const -> decltype(cuda::std::countl_zero(x));
};
...
{
  template <typename T>
  TEST_FUNC constexpr auto operator()(T x) const -> decltype(cuda::std::countl_one(x));
};
...
{
  template <typename T>
  TEST_FUNC constexpr auto operator()(T x) const -> decltype(cuda::std::bit_width(x));
};
...
{
  template <typename T>
  TEST_FUNC constexpr auto operator()(T x) const -> decltype(cuda::std::has_single_bit(x));
};
...
{
  template <typename T>
  TEST_FUNC constexpr auto operator()(T x) const -> decltype(cuda::std::bit_floor(x));
};
...
{
  template <typename T>
  TEST_FUNC constexpr auto operator()(T x) const -> decltype(cuda::std::bit_ceil(x));
};

template <typename L>
TEST_FUNC void test_invocable()
{
