...
{
  assert(cuda::std::saturating_div(static_cast<I>(zero_value + x), static_cast<I>(zero_value + y)) == res);
}
...
__host__ __device__ constexpr void test_signed(int zero_value)
{
  ...
  static_assert(cuda::std::is_same_v<I, decltype(cuda::std::saturating_div(I{}, I{}))>);
  static_assert(noexcept(cuda::std::saturating_div(I{}, I{})));

  // Limit values (-1, 0, 1, min, max)

  test<I>(I{-1}, I{-1}, I{1}, zero_value);
  test<I>(I{-1}, I{1}, I{-1}, zero_value);
  test<I>(I{-1}, minVal, I{0}, zero_value);
  test<I>(I{-1}, maxVal, I{0}, zero_value);
  ...
  test<I>(minVal, minVal, I{1}, zero_value);
  test<I>(minVal, maxVal, (minVal / maxVal), zero_value);
  test<I>(maxVal, I{-1}, -maxVal, zero_value);
  test<I>(maxVal, I{1}, maxVal, zero_value);
  test<I>(maxVal, minVal, I{0}, zero_value);
  test<I>(maxVal, maxVal, I{1}, zero_value);

  // No saturation (no limit values)

  test<I>(I{27}, I{28}, I{0}, zero_value);
  test<I>(I{28}, I{27}, I{1}, zero_value);
  {
    constexpr I lesserVal = minVal / I{2} + I{-28};
    constexpr I biggerVal = minVal / I{2} + I{-27};
    test<I>(lesserVal, biggerVal, I{1}, zero_value);
    test<I>(biggerVal, lesserVal, I{0}, zero_value);
  }
  {
    constexpr I lesserVal = minVal / I{2} + I{-27};
    constexpr I biggerVal = maxVal / I{2} + I{28};
    test<I>(lesserVal, biggerVal, I{-1}, zero_value);
    test<I>(biggerVal, lesserVal, I{-1}, zero_value);
  }
  {
    constexpr I lesserVal = maxVal / I{2} + I{27};
    constexpr I biggerVal = maxVal / I{2} + I{28};
    test<I>(lesserVal, biggerVal, I{0}, zero_value);
    test<I>(biggerVal, lesserVal, I{1}, zero_value);
  }
}
...
__host__ __device__ constexpr void test_unsigned(int zero_value)
{
  ...
  test<I>(minVal, I{1}, minVal, zero_value);
  test<I>(minVal, maxVal, I{0}, zero_value);
