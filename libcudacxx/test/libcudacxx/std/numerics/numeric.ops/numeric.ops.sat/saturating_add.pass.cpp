...
TEST_FUNC constexpr void test_signed(int zero_value)
{
  ...
  test<I>(I{-1}, minVal, minVal, zero_value); // saturated
...
TEST_FUNC constexpr void test_unsigned(int zero_value)
{
  ...
  test<I>(minVal, I{1}, I{1}, zero_value);
  test<I>(minVal, minVal, minVal, zero_value);
  test<I>(minVal, maxVal, maxVal, zero_value);
  test<I>(maxVal, I{0}, maxVal, zero_value);
  test<I>(maxVal, I{1}, maxVal, zero_value);
  test<I>(maxVal, minVal, maxVal, zero_value);
  test<I>(maxVal, maxVal, maxVal, zero_value);
...

  {
    ...
    constexpr I y = maxVal / I{2} + I{28};
    test<I>(x, y, maxVal, zero_value); // saturated
    test<I>(x, maxVal, maxVal, zero_value); // saturated
    test<I>(maxVal, y, maxVal, zero_value); // saturated
  }
}
