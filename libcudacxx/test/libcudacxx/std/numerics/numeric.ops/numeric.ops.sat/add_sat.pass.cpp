...
template <class I>
__host__ __device__ constexpr void test_add_sat(I x, I y, I res)
{
  auto retval = cuda::std::add_sat(x, y);
  printf("TEST: %d   %d\n", (int) retval, (int) res);
  assert(retval == res);
}
...
template <class I>
__host__ __device__ constexpr void test_unsigned()
{
  constexpr auto minVal = cuda::std::numeric_limits<I>::min();
  constexpr auto maxVal = cuda::std::numeric_limits<I>::max();
  ...
  printf("%d\n", __LINE__);
  test_add_sat<I>(I{0}, I{0}, I{0});
  printf("%d\n", __LINE__);
  test_add_sat<I>(I{0}, I{1}, I{1});
  printf("%d\n", __LINE__);
  test_add_sat<I>(I{0}, minVal, I{0});
  printf("%d\n", __LINE__);
  test_add_sat<I>(I{0}, maxVal, maxVal);
  printf("%d\n", __LINE__);
  test_add_sat<I>(I{1}, I{0}, I{1});
  printf("%d\n", __LINE__);
  test_add_sat<I>(I{1}, I{1}, I{2});
  printf("%d\n", __LINE__);
  test_add_sat<I>(I{1}, minVal, I{1});
  printf("%d\n", __LINE__);
  test_add_sat<I>(I{1}, maxVal, maxVal);
  printf("%d\n", __LINE__); // saturated
  test_add_sat<I>(minVal, I{0}, I{0});
  printf("%d\n", __LINE__);
  test_add_sat<I>(minVal, I{1}, I{1});
  printf("%d\n", __LINE__);
  test_add_sat<I>(minVal, minVal, minVal);
  printf("%d\n", __LINE__);
  test_add_sat<I>(minVal, maxVal, maxVal);
  printf("%d\n", __LINE__);
  test_add_sat<I>(maxVal, I{0}, maxVal);
  test_add_sat<I>(maxVal, I{1}, maxVal);
  printf("%d\n", __LINE__); // saturated
  test_add_sat<I>(maxVal, minVal, maxVal);
  printf("%d\n", __LINE__);
  test_add_sat<I>(maxVal, maxVal, maxVal);
  printf("%d\n", __LINE__); // saturated

  // No saturation (no limit values)

  test_add_sat<I>(I{27}, I{28}, I{55});
...

  {
    ...
    constexpr I y = maxVal / I{2} + I{28};
    printf("%d\n", __LINE__); // saturated
    test_add_sat<I>(x, y, maxVal); // saturated
    printf("%d\n", __LINE__); // saturated
    test_add_sat<I>(x, maxVal, maxVal); // saturated
    printf("%d\n", __LINE__); // saturated
    test_add_sat<I>(maxVal, y, maxVal); // saturated
  }
}
