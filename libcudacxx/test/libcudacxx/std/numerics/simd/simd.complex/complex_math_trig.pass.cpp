...
// precision issues with __nv_bfloat16
#if _LIBCUDACXX_HAS_NVBF16() && !TEST_CUDA_COMPILER(NVCC, <, 13) && !TEST_COMPILER(NVRTC, <, 13)
  test_type<__nv_bfloat16, 1>();
  test_type<__nv_bfloat16, 4>();
#endif // _LIBCUDACXX_HAS_NVBF16()&& !TEST_CUDA_COMPILER(NVCC, <, 13) && !TEST_COMPILER(NVRTC, <, 13)
  return true;
}
