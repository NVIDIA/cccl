...
struct _testcases {
  ...
  static constexpr size_t count =
      sizeof(testcases_t<T>) / sizeof(cuda::std::complex<T>);
  ...
  __host__ __device__ cuda::std::complex<T>* begin() { return &_cases[0]; }
  ...
  __host__ __device__ cuda::std::complex<T>* end() { return &_cases[count]; }
...
__host__ __device__ _testcases<T> get_testcases() {
  _testcases<T> tc{cuda::std::complex<T>(1.e-2, 1.e-2),
