...
struct NonT {
  __host__ __device__ NonT(int v) : value(v) {}
  __host__ __device__ NonT(const NonT& o) : value(o.value) {}
  int value;
};
...
struct NTCopy {
  __host__ __device__ constexpr NTCopy(int v) : value(v) {}
  __host__ __device__ NTCopy(const NTCopy& that) : value(that.value) {}
...
struct TCopy {
  __host__ __device__ constexpr TCopy(int v) : value(v) {}
...
struct TCopyNTMove {
  __host__ __device__ constexpr TCopyNTMove(int v) : value(v) {}
  TCopyNTMove(const TCopyNTMove&) = default;
  __host__ __device__ TCopyNTMove(TCopyNTMove&& that) : value(that.value) {
    that.value = -1;
  }
  int value;
};
...
__host__ __device__ void test_copy_ctor_basic() {
  ...
  {
    constexpr cuda::std::variant<int, TCopy> v(cuda::std::in_place_index<1>,
                                               42);
    static_assert(v.index() == 1, "");
  ...
  {
    constexpr cuda::std::variant<TCopyNTMove> v(cuda::std::in_place_index<0>,
                                                42);
    static_assert(v.index() == 0, "");
  ...
  {
    constexpr cuda::std::variant<int, TCopyNTMove> v(
...
template <size_t Idx>
__host__ __device__ constexpr bool test_constexpr_copy_ctor_imp(
    cuda::std::variant<long, void*, const int> const& v) {
  auto v2 = v;
