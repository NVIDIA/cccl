...
int main(int, char**) {
  ...
  static_assert(
      !cuda::std::is_constructible<cuda::std::variant<int, int>, int>::value,
      "");
#endif // !gcc-6
  static_assert(
      !cuda::std::is_constructible<cuda::std::variant<long, long long>,
                                   int>::value,
      "");
  static_assert(
      cuda::std::is_constructible<cuda::std::variant<char>, int>::value ==
  ...
  static_assert(!cuda::std::is_constructible<cuda::std::variant<int, bool>,
                                             decltype("meow")>::value,
                "");
  static_assert(
      !cuda::std::is_constructible<cuda::std::variant<int, const bool>,
                                   decltype("meow")>::value,
      "");
  static_assert(
      !cuda::std::is_constructible<cuda::std::variant<int, const volatile bool>,
                                   decltype("meow")>::value,
      "");

  static_assert(!cuda::std::is_constructible<cuda::std::variant<bool>,
