...
int main(int, char**) {
  ...
  static_assert(
      check_width<cuda::std::chrono::duration<int, cuda::std::ratio<1, 2> >,
                  1>(),
      "");
  static_assert(
      check_width<cuda::std::chrono::duration<int, cuda::std::ratio<1, 3> >,
                  6>(),
      "");
  static_assert(
      check_width<cuda::std::chrono::duration<int, cuda::std::ratio<1, 4> >,
                  2>(),
      "");
  static_assert(
      check_width<cuda::std::chrono::duration<int, cuda::std::ratio<1, 5> >,
                  1>(),
      "");
  static_assert(
      check_width<cuda::std::chrono::duration<int, cuda::std::ratio<1, 6> >,
                  6>(),
      "");
  static_assert(
      check_width<cuda::std::chrono::duration<int, cuda::std::ratio<1, 7> >,
                  6>(),
      "");
  static_assert(
      check_width<cuda::std::chrono::duration<int, cuda::std::ratio<1, 8> >,
                  3>(),
      "");
  static_assert(
      check_width<cuda::std::chrono::duration<int, cuda::std::ratio<1, 9> >,
                  6>(),
      "");
  static_assert(
      check_width<cuda::std::chrono::duration<int, cuda::std::ratio<1, 10> >,
                  1>(),
      "");
