...
__host__ __device__ constexpr long long check_duration(Duration d) {
  ...
  ASSERT_SAME_TYPE(typename HMS::precision,
                   decltype(cuda::std::declval<HMS>().to_duration()));
...
int main(int, char**) {
  ...
  assert(check_duration(cuda::std::chrono::milliseconds(123456789LL)) ==
         123456789LL);
  assert(check_duration(cuda::std::chrono::milliseconds(-123456789LL)) ==
         -123456789LL);
  assert(check_duration(cuda::std::chrono::microseconds(123456789LL)) ==
         123456789LL);
  assert(check_duration(cuda::std::chrono::microseconds(-123456789LL)) ==
         -123456789LL);
  assert(check_duration(cuda::std::chrono::nanoseconds(123456789LL)) ==
         123456789LL);
  assert(check_duration(cuda::std::chrono::nanoseconds(-123456789LL)) ==
         -123456789LL);
