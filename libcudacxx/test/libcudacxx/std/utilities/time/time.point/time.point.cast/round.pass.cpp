...
int main(int, char**) {
  ...
  test(cuda::std::chrono::milliseconds(-7290000), cuda::std::chrono::hours(-2));
  test(cuda::std::chrono::milliseconds(7290000),
       cuda::std::chrono::minutes(122));
  test(cuda::std::chrono::milliseconds(-7290000),
       cuda::std::chrono::minutes(-122));

  //  9000000ms is 2 hours and 30 minutes
  test_constexpr<cuda::std::chrono::milliseconds, 9000000,
                 cuda::std::chrono::hours, 2>();
  test_constexpr<cuda::std::chrono::milliseconds, -9000000,
                 cuda::std::chrono::hours, -2>();
  test_constexpr<cuda::std::chrono::milliseconds, 9000001,
                 cuda::std::chrono::minutes, 150>();
  test_constexpr<cuda::std::chrono::milliseconds, -9000001,
                 cuda::std::chrono::minutes, -150>();

  test_constexpr<cuda::std::chrono::milliseconds, 9000000,
                 cuda::std::chrono::seconds, 9000>();
  test_constexpr<cuda::std::chrono::milliseconds, -9000000,
                 cuda::std::chrono::seconds, -9000>();
