...
int main(int, char**) {
  ...
  test(cuda::std::chrono::milliseconds(7265000),
       cuda::std::chrono::minutes(121));
  test(cuda::std::chrono::milliseconds(7265000),
       cuda::std::chrono::seconds(7265));
  test(cuda::std::chrono::milliseconds(7265000),
       cuda::std::chrono::milliseconds(7265000));
  test(cuda::std::chrono::milliseconds(7265000),
       cuda::std::chrono::microseconds(7265000000LL));
  test(cuda::std::chrono::milliseconds(7265000),
       cuda::std::chrono::nanoseconds(7265000000000LL));
  test(cuda::std::chrono::milliseconds(7265000),
       cuda::std::chrono::duration<double, cuda::std::ratio<3600> >(7265. /
                                                                    3600));
  test(cuda::std::chrono::duration<int, cuda::std::ratio<2, 3> >(9),
       cuda::std::chrono::duration<int, cuda::std::ratio<3, 5> >(10));
#if TEST_STD_VER > 2011
  {
    test_constexpr<cuda::std::chrono::milliseconds, 7265000,
                   cuda::std::chrono::hours, 2>();
    test_constexpr<cuda::std::chrono::milliseconds, 7265000,
                   cuda::std::chrono::minutes, 121>();
    test_constexpr<cuda::std::chrono::milliseconds, 7265000,
                   cuda::std::chrono::seconds, 7265>();
    ...
    test_constexpr<cuda::std::chrono::duration<int, cuda::std::ratio<2, 3> >, 9,
                   T1, 10>();
  }
#endif
