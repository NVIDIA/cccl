...
__host__ __device__ void RunTheExample() {
  ...
  static_assert(year_month_day{local_days{year{2017} / January / 0}} ==
                    year{2016} / December / 31,
                "");
  static_assert(year_month_day{local_days{year{2017} / January / 31}} ==
                    year{2017} / January / 31,
                "");
  static_assert(year_month_day{local_days{year{2017} / January / 32}} ==
                    year{2017} / February / 1,
                "");
}
