...
int main(int, char**) {
  ...
  ASSERT_SAME_TYPE(const cuda::std::chrono::month,
                   decltype(cuda::std::chrono::January));
  ASSERT_SAME_TYPE(const cuda::std::chrono::month,
                   decltype(cuda::std::chrono::February));
  ASSERT_SAME_TYPE(const cuda::std::chrono::month,
                   decltype(cuda::std::chrono::March));
  ASSERT_SAME_TYPE(const cuda::std::chrono::month,
                   decltype(cuda::std::chrono::April));
  ASSERT_SAME_TYPE(const cuda::std::chrono::month,
                   decltype(cuda::std::chrono::May));
  ASSERT_SAME_TYPE(const cuda::std::chrono::month,
                   decltype(cuda::std::chrono::June));
  ASSERT_SAME_TYPE(const cuda::std::chrono::month,
                   decltype(cuda::std::chrono::July));
  ASSERT_SAME_TYPE(const cuda::std::chrono::month,
                   decltype(cuda::std::chrono::August));
  ASSERT_SAME_TYPE(const cuda::std::chrono::month,
                   decltype(cuda::std::chrono::September));
  ASSERT_SAME_TYPE(const cuda::std::chrono::month,
                   decltype(cuda::std::chrono::October));
  ASSERT_SAME_TYPE(const cuda::std::chrono::month,
                   decltype(cuda::std::chrono::November));
  ASSERT_SAME_TYPE(const cuda::std::chrono::month,
                   decltype(cuda::std::chrono::December));
