...
int main(int, char**) {
  ...
  static_assert(testEquality(month_weekday_last{cuda::std::chrono::January,
                                                weekday_last{Tuesday}},
                             month_weekday_last{cuda::std::chrono::January,
                                                weekday_last{Wednesday}},
                             false),
                "");
  ...
  for (unsigned i = 0; i < 6; ++i)
    for (unsigned j = 0; j < 6; ++j)
      assert((testEquality(
          ...
          month_weekday_last{January, weekday_last{weekday{j}}}, i == j)));
