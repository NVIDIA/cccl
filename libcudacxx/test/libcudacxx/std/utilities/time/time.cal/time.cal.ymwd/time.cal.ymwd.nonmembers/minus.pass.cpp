...
__host__ __device__ constexpr bool testConstexprYears() {
  cuda::std::chrono::year_month_weekday ym0{
      cuda::std::chrono::year{1234}, cuda::std::chrono::January,
      cuda::std::chrono::weekday_indexed{cuda::std::chrono::Tuesday, 1}};
  cuda::std::chrono::year_month_weekday ym1 =
      ym0 - cuda::std::chrono::years{10};
  return ym1.year() == cuda::std::chrono::year{1234 - 10} &&
...
__host__ __device__ constexpr bool testConstexprMonths() {
  cuda::std::chrono::year_month_weekday ym0{
      cuda::std::chrono::year{1234}, cuda::std::chrono::November,
      cuda::std::chrono::weekday_indexed{cuda::std::chrono::Tuesday, 1}};
  cuda::std::chrono::year_month_weekday ym1 =
      ym0 - cuda::std::chrono::months{6};
  return ym1.year() == cuda::std::chrono::year{1234} &&
...
int main(int, char**) {
  ...
  { // year_month_weekday - years
    ASSERT_NOEXCEPT(cuda::std::declval<year_month_weekday>() -
                    cuda::std::declval<years>());
    ASSERT_SAME_TYPE(year_month_weekday,
                     decltype(cuda::std::declval<year_month_weekday>() -
                              cuda::std::declval<years>()));
