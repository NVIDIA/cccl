...
int main(int, char**) {
  ...
  static_assert(testEquality(month_weekday{cuda::std::chrono::January,
                                           weekday_indexed{Sunday, 1}},
                             month_weekday{cuda::std::chrono::February,
                                           weekday_indexed{Sunday, 1}},
                             false),
                "");
  ...
  for (unsigned i = 0; i < 6; ++i)
    for (unsigned j = 0; j < 6; ++j)
      assert((testEquality(
          ...
          month_weekday{month{2}, weekday_indexed{weekday{j}, 2}}, i == j)));
