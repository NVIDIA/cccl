...
int main(int, char**) {
  ...
  ASSERT_SAME_TYPE(const cuda::std::chrono::weekday,
                   decltype(cuda::std::chrono::Sunday));
  ASSERT_SAME_TYPE(const cuda::std::chrono::weekday,
                   decltype(cuda::std::chrono::Monday));
  ASSERT_SAME_TYPE(const cuda::std::chrono::weekday,
                   decltype(cuda::std::chrono::Tuesday));
  ASSERT_SAME_TYPE(const cuda::std::chrono::weekday,
                   decltype(cuda::std::chrono::Wednesday));
  ASSERT_SAME_TYPE(const cuda::std::chrono::weekday,
                   decltype(cuda::std::chrono::Thursday));
  ASSERT_SAME_TYPE(const cuda::std::chrono::weekday,
                   decltype(cuda::std::chrono::Friday));
  ASSERT_SAME_TYPE(const cuda::std::chrono::weekday,
                   decltype(cuda::std::chrono::Saturday));
