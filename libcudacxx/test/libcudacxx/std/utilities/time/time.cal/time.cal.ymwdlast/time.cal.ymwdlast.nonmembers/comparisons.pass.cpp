...
int main(int, char**) {
  ...
  static_assert(testEquality(year_month_weekday_last{year{1234}, January,
  ...
  static_assert(testEquality(year_month_weekday_last{year{1234}, February,
                                                     weekday_last{Wednesday}},
                             year_month_weekday_last{year{1235}, January,
                                                     weekday_last{Tuesday}},
                             false),
                "");
  ...
  for (unsigned i = 1; i < 28; ++i)
    for (unsigned j = 1; j < 28; ++j)
      assert((testEquality(year_month_weekday_last{year{1234}, January,
