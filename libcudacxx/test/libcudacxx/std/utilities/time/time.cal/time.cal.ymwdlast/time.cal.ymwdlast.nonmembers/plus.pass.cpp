...
testConstexprYears(cuda::std::chrono::year_month_weekday_last ym) {
...
__host__ __device__ constexpr bool
testConstexprMonths(cuda::std::chrono::year_month_weekday_last ym) {
...
int main(int, char**) {
  ...
  { // year_month_weekday_last + months
    ASSERT_NOEXCEPT(cuda::std::declval<year_month_weekday_last>() +
                    cuda::std::declval<months>());
    ASSERT_NOEXCEPT(cuda::std::declval<months>() +
                    cuda::std::declval<year_month_weekday_last>());

    ASSERT_SAME_TYPE(year_month_weekday_last,
                     decltype(cuda::std::declval<year_month_weekday_last>() +
                              cuda::std::declval<months>()));
    ASSERT_SAME_TYPE(year_month_weekday_last,
                     decltype(cuda::std::declval<months>() +
                              cuda::std::declval<year_month_weekday_last>()));

    static_assert(testConstexprMonths(year_month_weekday_last{
                      year{1}, January, weekday_last{Tuesday}}),
                  "");
  ...
  { // year_month_weekday_last + years
    ...
    ASSERT_NOEXCEPT(cuda::std::declval<years>() +
                    cuda::std::declval<year_month_weekday_last>());
    ...
    ASSERT_SAME_TYPE(year_month_weekday_last,
                     decltype(cuda::std::declval<year_month_weekday_last>() +
                              cuda::std::declval<years>()));
    ASSERT_SAME_TYPE(year_month_weekday_last,
                     decltype(cuda::std::declval<years>() +
                              cuda::std::declval<year_month_weekday_last>()));

    static_assert(testConstexprYears(year_month_weekday_last{
                      year{1}, January, weekday_last{Tuesday}}),
                  "");

    year_month_weekday_last ym{year{1234}, cuda::std::chrono::January,
