...
int main(int, char**) {
  {
    ...
    const T t(3);
    static_assert(
        cuda::std::is_same<const int&&, decltype(cuda::std::get<0>(
                                            cuda::std::move(t)))>::value,
        "");
...

  {
    ...
    static_assert(cuda::std::is_same<int&, decltype(cuda::std::get<0>(
                                               cuda::std::move(p)))>::value,
                  "");
    static_assert(noexcept(cuda::std::get<0>(cuda::std::move(p))), "");
    static_assert(
        cuda::std::is_same<int const&, decltype(cuda::std::get<1>(
                                           cuda::std::move(p)))>::value,
        "");
...

  {
    int x = 42;
    int const y = 43;
    cuda::std::tuple<int&&, int const&&> const p(cuda::std::move(x),
                                                 cuda::std::move(y));
    static_assert(cuda::std::is_same<int&&, decltype(cuda::std::get<0>(
                                                cuda::std::move(p)))>::value,
                  "");
