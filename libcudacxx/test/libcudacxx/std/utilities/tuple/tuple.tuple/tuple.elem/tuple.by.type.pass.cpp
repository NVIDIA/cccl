...
//  get<int> would fail!
    ...
    */
  {
    constexpr cuda::std::tuple<int, const int, double, double> p5{1, 2, 3.4,
                                                                  5.6};
...

  {
    int x = 42;
    int y = 43;
    cuda::std::tuple<int&&, int const&&> const t(cuda::std::move(x),
                                                 cuda::std::move(y));
    static_assert(cuda::std::is_same<int&&, decltype(cuda::std::get<int&&>(
                                                cuda::std::move(t)))>::value,
                  "");
  ...
  {
    constexpr const cuda::std::tuple<int, const int, double, double> t{
        1, 2, 3.4, 5.6};
