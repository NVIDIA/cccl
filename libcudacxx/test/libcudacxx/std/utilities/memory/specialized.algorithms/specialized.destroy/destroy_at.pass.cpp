...
struct TEST_HOST_DEVICE_FUNC : VirtualCounted
{
  TEST_HOST_DEVICE_FUNC constexpr TEST_HOST_DEVICE_FUNC(int* counter)
      : VirtualCounted(counter)
  {}
  TEST_HOST_DEVICE_FUNC TEST_CONSTEXPR_CXX20 ~TEST_HOST_DEVICE_FUNC() override {}
};
