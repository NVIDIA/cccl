...
struct D {
  __host__ __device__ static int allocator_type() { return 0; }
};
...
test()
{
    ...
    static_assert(cuda::std::is_base_of<cuda::std::integral_constant<bool, Expected>, cuda::std::uses_allocator<T, A> >::value, "");
