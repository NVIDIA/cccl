...
TEST_FUNC constexpr int pass(const int n)
{
  return n;
}

TEST_FUNC int simple(int n)
{
  return n;
}

template <class T>
TEST_FUNC T do_nothing(T t)
{
  return t;
}
...
struct NotMoveConst
{
  ...
  TEST_FUNC NotMoveConst(int) {}
};

TEST_FUNC void testNotMoveConst(NotMoveConst) {}
