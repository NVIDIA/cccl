...
struct A {
  __host__ __device__ char test0() const volatile { return 'a'; }
  __host__ __device__ char test1(int) const volatile { return 'b'; }
  __host__ __device__ char test2(int, double) const volatile { return 'c'; }
};
