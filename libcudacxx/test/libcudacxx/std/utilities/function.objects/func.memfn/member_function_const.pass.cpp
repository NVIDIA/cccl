...
struct A {
  __host__ __device__ char test0() const { return 'a'; }
  __host__ __device__ char test1(int) const { return 'b'; }
  __host__ __device__ char test2(int, double) const { return 'c'; }
};
