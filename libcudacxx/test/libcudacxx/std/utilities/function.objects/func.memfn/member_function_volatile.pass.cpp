...
struct A {
  __host__ __device__ char test0() volatile { return 'a'; }
  __host__ __device__ char test1(int) volatile { return 'b'; }
  __host__ __device__ char test2(int, double) volatile { return 'c'; }
};
