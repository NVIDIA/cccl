...
__host__ __device__ bool returns_true() { return true; }
...
struct MoveOnlyCallable {
  ...
  __host__ __device__ explicit MoveOnlyCallable(bool x) : value(x) {}
  Ret value;
};
...
struct CopyCallable {
  ...
  __host__ __device__ CopyCallable(CopyCallable&& other) : value(other.value) {
    other.value = !other.value;
  }
  ...
  __host__ __device__ explicit CopyCallable(bool x) : value(x) {}
  Ret value;
};
...
struct ConstCallable {
  ...
  __host__ __device__ explicit ConstCallable(bool x) : value(x) {}
  Ret value;
};
...
struct NoExceptCallable {
  ...
  __host__ __device__ explicit NoExceptCallable(bool x) : value(x) {}
  Ret value;
};
...
struct CopyAssignableWrapper {
  ...
  __host__ __device__ explicit CopyAssignableWrapper(bool x) : value(x) {}
  bool value;
};
...
struct MoveAssignableWrapper {
  ...
  __host__ __device__ explicit MoveAssignableWrapper(bool x) : value(x) {}
  bool value;
};

struct MemFunCallable {
  __host__ __device__ explicit MemFunCallable(bool x) : value(x) {}

  __host__ __device__ bool return_value() const { return value; }
  __host__ __device__ bool return_value_nc() { return value; }
  bool value;
};
...
private:
  ...
  __host__ __device__ explicit EvilBool(bool x) : value(x) {}
...
struct ExplicitBool {
  ...
  __host__ __device__ explicit operator bool() const { return value; }

private:
  friend struct MoveOnlyCallable<ExplicitBool>;
  friend struct CopyCallable<ExplicitBool>;

  __host__ __device__ explicit ExplicitBool(bool x) : value(x) {}
...
struct NoExceptEvilBool {
  ...
  __host__ __device__ explicit NoExceptEvilBool(bool x) : value(x) {}
...
__host__ __device__ void throws_in_constructor_test() {
...
__host__ __device__ void test_lwg2767() {
  ...
  struct F {
    __host__ __device__ bool operator()(Abstract&&) { return false; }
  };
  {
    Derived d;
    Abstract& a = d;
