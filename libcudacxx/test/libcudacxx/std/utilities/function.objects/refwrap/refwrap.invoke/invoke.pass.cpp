...
__host__ __device__ void f_void_1(int i) { count += i; }

struct A_void_1 {
  __host__ __device__ void operator()(int i) { count += i; }
...
__host__ __device__ int f_int_1(int i) { return i + 1; }

struct A_int_1 {
  __host__ __device__ A_int_1() : data_(5) {}
  __host__ __device__ int operator()(int i) { return i - 1; }
...
__host__ __device__ void f_void_2(int i, int j) { count += i + j; }

struct A_void_2 {
  __host__ __device__ void operator()(int i, int j) { count += i + j; }
...
__host__ __device__ int f_int_2(int i, int j) { return i + j; }

struct A_int_2 {
  __host__ __device__ int operator()(int i, int j) { return i + j; }
