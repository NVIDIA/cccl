...
int main(int, char**)
{
    static_assert((cuda::std::is_same<cuda::std::reference_wrapper<functor1>::result_type,
                                char>::value), "");
    static_assert((cuda::std::is_same<cuda::std::reference_wrapper<functor2>::result_type,
                                double>::value), "");
    static_assert((cuda::std::is_same<cuda::std::reference_wrapper<functor3>::result_type,
                                float>::value), "");
    static_assert((cuda::std::is_same<cuda::std::reference_wrapper<void()>::result_type,
                                void>::value), "");
    static_assert((cuda::std::is_same<cuda::std::reference_wrapper<int*(double*)>::result_type,
                                int*>::value), "");
    static_assert((cuda::std::is_same<cuda::std::reference_wrapper<void(*)()>::result_type,
                                void>::value), "");
    static_assert((cuda::std::is_same<cuda::std::reference_wrapper<int*(*)(double*)>::result_type,
                                int*>::value), "");
    static_assert((cuda::std::is_same<cuda::std::reference_wrapper<int*(C::*)(double*)>::result_type,
                                int*>::value), "");
    static_assert((cuda::std::is_same<cuda::std::reference_wrapper<int (C::*)(double*) const volatile>::result_type,
                                int>::value), "");
    static_assert((cuda::std::is_same<cuda::std::reference_wrapper<C()>::result_type,
                                C>::value), "");
