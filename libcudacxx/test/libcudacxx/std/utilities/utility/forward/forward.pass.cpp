...
int main(int, char**) {
  ...
  static_assert(
      cuda::std::is_same<decltype(cuda::std::forward<A&>(a)), A&>::value, "");
  static_assert(
      cuda::std::is_same<decltype(cuda::std::forward<A>(a)), A&&>::value, "");
  static_assert(
      cuda::std::is_same<decltype(cuda::std::forward<A>(source())), A&&>::value,
      "");
  ASSERT_NOEXCEPT(cuda::std::forward<A&>(a));
  ASSERT_NOEXCEPT(cuda::std::forward<A>(a));
  ASSERT_NOEXCEPT(cuda::std::forward<A>(source()));

  static_assert(cuda::std::is_same<decltype(cuda::std::forward<const A&>(a)),
                                   const A&>::value,
                "");
  static_assert(cuda::std::is_same<decltype(cuda::std::forward<const A>(a)),
                                   const A&&>::value,
                "");
  static_assert(
      cuda::std::is_same<decltype(cuda::std::forward<const A>(source())),
                         const A&&>::value,
      "");
  ...
  static_assert(cuda::std::is_same<decltype(cuda::std::forward<const A&>(ca)),
                                   const A&>::value,
                "");
  static_assert(cuda::std::is_same<decltype(cuda::std::forward<const A>(ca)),
                                   const A&&>::value,
                "");
  static_assert(
      cuda::std::is_same<decltype(cuda::std::forward<const A>(csource())),
                         const A&&>::value,
      "");
