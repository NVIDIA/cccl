...
using DependantIsDefault =
    DependantType<cuda::std::is_default_constructible<T>, Val>;
...
__host__ __device__ void test_illformed_default() {
  {
    ...
    static_assert(
        (cuda::std::is_constructible<P, IllFormedDefault, int>::value), "");
  ...
  }
  {
    ...
    static_assert(
        (cuda::std::is_constructible<P, int, IllFormedDefault>::value), "");
  ...
  }
  {
    ...
    static_assert((cuda::std::is_constructible<P, IllFormedDefault,
                                               IllFormedDefault>::value),
                  "");
