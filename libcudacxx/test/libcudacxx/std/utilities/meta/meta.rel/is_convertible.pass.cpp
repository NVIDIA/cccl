...
int main(int, char**) {
  ...
  static_assert((!cuda::std::is_convertible<Function&, ConstFunction>::value),
                "");
  static_assert(
      (!cuda::std::is_convertible<ConstFunction, ConstFunction>::value), "");
  ...
  static_assert(
      (!cuda::std::is_convertible<Array, const volatile Array&>::value), "");
#endif
  ...
  static_assert((cuda::std::is_convertible<NonCopyable&, NonCopyable&>::value),
                "");
  static_assert(
      (cuda::std::is_convertible<NonCopyable&, const NonCopyable&>::value), "");
  static_assert((cuda::std::is_convertible<NonCopyable&,
                                           const volatile NonCopyable&>::value),
                "");
  static_assert(
      (cuda::std::is_convertible<NonCopyable&, volatile NonCopyable&>::value),
      "");
  static_assert((cuda::std::is_convertible<const NonCopyable&,
                                           const NonCopyable&>::value),
                "");
  static_assert((cuda::std::is_convertible<const NonCopyable&,
                                           const volatile NonCopyable&>::value),
                "");
  static_assert((cuda::std::is_convertible<volatile NonCopyable&,
                                           const volatile NonCopyable&>::value),
                "");
  static_assert((cuda::std::is_convertible<const volatile NonCopyable&,
                                           const volatile NonCopyable&>::value),
                "");
  static_assert(
      (!cuda::std::is_convertible<const NonCopyable&, NonCopyable&>::value),
      "");
  ...
  static_assert((cuda::std::is_convertible<CannotInstantiate<int>*,
