...
int main(int, char**) {
  ...
  static_assert(
      (cuda::std::is_same<cuda::std::false_type::value_type, bool>::value), "");
  static_assert((cuda::std::is_same<cuda::std::false_type::type,
                                    cuda::std::false_type>::value),
                "");

  static_assert(cuda::std::true_type::value == true, "");
  static_assert(
      (cuda::std::is_same<cuda::std::true_type::value_type, bool>::value), "");
  static_assert((cuda::std::is_same<cuda::std::true_type::type,
