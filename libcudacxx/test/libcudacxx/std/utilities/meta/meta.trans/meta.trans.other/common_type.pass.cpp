...
using no_common_type =
    cuda::std::integral_constant<bool, no_common_type_imp<Args...>(0)>;

template <class T1, class T2>
struct TernaryOp {
  static_assert(
      (cuda::std::is_same<typename cuda::std::decay<T1>::type, T1>::value),
      "must be same");
  static_assert(
      (cuda::std::is_same<typename cuda::std::decay<T2>::type, T2>::value),
      "must be same");
  typedef typename cuda::std::decay<decltype(
      false ? cuda::std::declval<T1>() : cuda::std::declval<T2>())>::type type;
};
...
__host__ __device__ void test_bullet_two() {
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<void>::type, void>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<int>::type, int>::value), "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<int const>::type, int>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<int volatile[]>::type,
                          int volatile*>::value),
      "");
  static_assert((cuda::std::is_same<cuda::std::common_type<void (&)()>::type,
                                    void (*)()>::value),
                "");
...
__host__ __device__ void test_bullet_three_one_imp() {
  ...
  static_assert(
      (!cuda::std::is_same<T, DT>::value || !cuda::std::is_same<U, DU>::value),
      "");
  static_assert((cuda::std::is_same<typename cuda::std::common_type<T, U>::type,
                                    Expect>::value),
                "");
  static_assert((cuda::std::is_same<typename cuda::std::common_type<U, T>::type,
                                    Expect>::value),
                "");
...
__host__ __device__ void test_bullet_three_one() {
  ...
  // same.
  {
    ...
    typedef void Expect;
    static_assert((cuda::std::is_same<cuda::std::common_type<T1, T1>::type,
                                      Expect>::value),
                  "");
    static_assert((cuda::std::is_same<cuda::std::common_type<T1, T1>::type,
                                      cuda::std::common_type<T1>::type>::value),
                  "");
  }
  {
...
__host__ __device__ void test_bullet_three_three() {
  {
    ...
    static_assert((cuda::std::is_same<cuda::std::common_type<T1, T2>::type,
                                      Expect>::value),
                  "");
    static_assert((cuda::std::is_same<cuda::std::common_type<T2, T1>::type,
                                      Expect>::value),
                  "");
  }
...
__host__ __device__ void test_bullet_three_four() {
  ...
  static_assert(
      cuda::std::is_same_v<
          cuda::std::common_type_t<int, bad_reference_wrapper<int> >, int>,
      "");
  static_assert(
      cuda::std::is_same_v<
          cuda::std::common_type_t<bad_reference_wrapper<double>, double>,
          double>,
      "");
  static_assert(
      cuda::std::is_same_v<
          cuda::std::common_type_t<const bad_reference_wrapper<double>, double>,
          double>,
      "");
  static_assert(
      cuda::std::is_same_v<cuda::std::common_type_t<
                               volatile bad_reference_wrapper<double>, double>,
                           double>,
      "");
  static_assert(
      cuda::std::is_same_v<
          cuda::std::common_type_t<const volatile bad_reference_wrapper<double>,
                                   double>,
          double>,
      "");
  ...
  static_assert(
      cuda::std::is_same_v<
          cuda::std::common_type_t<bad_reference_wrapper<double>, const double>,
          double>,
      "");
  static_assert(
      cuda::std::is_same_v<cuda::std::common_type_t<
                               bad_reference_wrapper<double>, volatile double>,
                           double>,
      "");
  static_assert(cuda::std::is_same_v<
                    cuda::std::common_type_t<bad_reference_wrapper<double>,
...
int main(int, char**) {
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<int>::type, int>::value), "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<char>::type, char>::value),
      "");
#if TEST_STD_VER > 2011
  static_assert((cuda::std::is_same<cuda::std::common_type_t<int>, int>::value),
                "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type_t<char>, char>::value), "");
#endif

  static_assert(
      (cuda::std::is_same<cuda::std::common_type<int>::type, int>::value), "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<const int>::type, int>::value),
      "");
  static_assert((cuda::std::is_same<cuda::std::common_type<volatile int>::type,
                                    int>::value),
                "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<const volatile int>::type,
                          int>::value),
      "");

  static_assert(
      (cuda::std::is_same<cuda::std::common_type<int, int>::type, int>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<int, const int>::type,
                          int>::value),
      "");

  static_assert(
      (cuda::std::is_same<cuda::std::common_type<long, const int>::type,
                          long>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<const long, int>::type,
                          long>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<long, volatile int>::type,
                          long>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<volatile long, int>::type,
                          long>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<const long, const int>::type,
                          long>::value),
      "");

  static_assert((cuda::std::is_same<cuda::std::common_type<double, char>::type,
                                    double>::value),
                "");
  static_assert((cuda::std::is_same<cuda::std::common_type<short, char>::type,
                                    int>::value),
                "");
#if TEST_STD_VER > 2011
  static_assert((cuda::std::is_same<cuda::std::common_type_t<double, char>,
                                    double>::value),
                "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type_t<short, char>, int>::value),
      "");
#endif

  static_assert(
      (cuda::std::is_same<cuda::std::common_type<double, char, long long>::type,
                          double>::value),
      "");
  static_assert((cuda::std::is_same<
                    cuda::std::common_type<unsigned, char, long long>::type,
                    long long>::value),
                "");
#if TEST_STD_VER > 2011
  static_assert(
      (cuda::std::is_same<cuda::std::common_type_t<double, char, long long>,
                          double>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type_t<unsigned, char, long long>,
                          long long>::value),
      "");
#endif
  ...
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<void>::type, void>::value),
      "");
  static_assert((cuda::std::is_same<cuda::std::common_type<const void>::type,
                                    void>::value),
                "");
  static_assert((cuda::std::is_same<cuda::std::common_type<volatile void>::type,
                                    void>::value),
                "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<const volatile void>::type,
                          void>::value),
      "");

  static_assert(
      (cuda::std::is_same<cuda::std::common_type<void, const void>::type,
                          void>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<const void, void>::type,
                          void>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<void, volatile void>::type,
                          void>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<volatile void, void>::type,
                          void>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<const void, const void>::type,
                          void>::value),
      "");

  static_assert((cuda::std::is_same<cuda::std::common_type<int, S<int> >::type,
                                    S<int> >::value),
                "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<int, S<int>, S<int> >::type,
                          S<int> >::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<int, int, S<int> >::type,
                          S<int> >::value),
      "");
  ...
  // P0548
  static_assert((cuda::std::is_same<cuda::std::common_type<S<int> >::type,
                                    S<int> >::value),
                "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<S<int>, S<int> >::type,
                          S<int> >::value),
      "");
  ...
  static_assert(
      ...
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<const int, int>::type,
                          int>::value),
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<int, const int>::type,
      ...
      "");
  static_assert(
      (cuda::std::is_same<cuda::std::common_type<const int, const int>::type,
                          int>::value),
      "");
  ...
  static_assert(
      cuda::std::is_same<
          cuda::std::common_type<int, int, int, int, int, int, int, int>::type,
          int>::value,
      "");
