...
struct wat {
  __host__ __device__ wat& operator*() { return *this; }
...
int main(int, char**) {
  {
    ...
    test_result_of_imp<PMD(cuda::std::reference_wrapper<F const>),
                       const char&>();
    test_result_of_imp<PMD(cuda::std::reference_wrapper<FD>), char&>();
    test_result_of_imp<PMD(cuda::std::reference_wrapper<FD const>),
                       const char&>();
  }
  {
  ...
  }
  {
    ...
    test_result_of_imp<
        int (F::*(cuda::std::reference_wrapper<const F>))() const, int>();
#ifdef _LIBCUDACXX_HAS_MEMORY
    test_result_of_imp<int (F::*(cuda::std::unique_ptr<F>))(), int>();
    test_result_of_imp<int (F::*(cuda::std::unique_ptr<const F>))() const,
                       int>();
#endif // _LIBCUDACXX_HAS_MEMORY
  }
