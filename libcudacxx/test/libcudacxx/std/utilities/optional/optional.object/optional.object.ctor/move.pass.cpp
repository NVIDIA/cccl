...
__host__ __device__ void test_reference_extension() {
  ...
  {
    static_assert(
        !cuda::std::is_copy_constructible<cuda::std::optional<T&&> >::value,
        "");
    static_assert(!cuda::std::is_copy_constructible<
                      cuda::std::optional<T const&&> >::value,
                  "");
  }
#endif
}
...
int main(int, char**) {
  ...
  { test_throwing_ctor(); }
  {
    ...
    static_assert(
        !cuda::std::is_nothrow_move_constructible<optional<ThrowsMove> >::value,
        "");
    ...
    static_assert(
        cuda::std::is_nothrow_move_constructible<optional<NoThrowMove> >::value,
        "");
  }
