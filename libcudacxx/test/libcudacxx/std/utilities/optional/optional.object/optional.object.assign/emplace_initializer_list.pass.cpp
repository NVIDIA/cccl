...
public:
  __host__ __device__ constexpr X(bool& dtor_called)
      : i_(0), dtor_called_(&dtor_called) {}
  __host__ __device__ constexpr X(int i, bool& dtor_called)
      : i_(i), dtor_called_(&dtor_called) {}
  __host__ __device__ constexpr X(cuda::std::initializer_list<int> il,
                                  bool& dtor_called)
      : i_(il.begin()[0]), j_(il.begin()[1]), dtor_called_(&dtor_called) {}
  __host__ __device__ TEST_CONSTEXPR_CXX20 ~X() { *dtor_called_ = true; }
...
public:
  __host__ __device__ constexpr Y() : i_(0) {}
  __host__ __device__ constexpr Y(int i) : i_(i) {}
...
public:
  ...
  __host__ __device__ ~Z() { dtor_called() = true; }
