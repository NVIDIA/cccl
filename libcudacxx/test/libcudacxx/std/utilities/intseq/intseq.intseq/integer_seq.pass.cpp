...
int main(int, char**) {
  ...
  static_assert(cuda::std::is_same<size1::value_type, cuda::std::size_t>::value,
                "size1 type wrong");
  static_assert(size1::size() == 1, "size1 size wrong");

  static_assert(
      cuda::std::is_same<ushortseq2::value_type, unsigned short>::value,
      "ushortseq2 type wrong");
  static_assert(ushortseq2::size() == 2, "ushortseq2 size wrong");

  static_assert(cuda::std::is_same<bool0::value_type, bool>::value,
                "bool0 type wrong");
