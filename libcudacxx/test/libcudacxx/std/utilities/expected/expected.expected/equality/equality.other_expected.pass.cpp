...
static_assert(
    CanCompare<cuda::std::expected<int, int>, cuda::std::expected<int, int> >,
    "");
static_assert(CanCompare<cuda::std::expected<int, int>,
                         cuda::std::expected<short, short> >,
              "");

// Note this is true because other overloads are unconstrained
static_assert(
    CanCompare<cuda::std::expected<int, int>, cuda::std::expected<void, int> >,
    "");
