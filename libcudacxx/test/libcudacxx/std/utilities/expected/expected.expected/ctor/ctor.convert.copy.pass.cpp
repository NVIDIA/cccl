...
static_assert(cuda::std::is_constructible_v<cuda::std::expected<CtorFrom<int>, int>, const cuda::std::expected<int, int>&>, "");
static_assert(!cuda::std::is_convertible_v<const cuda::std::expected<int, int>&, cuda::std::expected<CtorFrom<int>, int>>, "");

// !is_convertible_v<GF, E>.
static_assert(cuda::std::is_constructible_v<cuda::std::expected<int, CtorFrom<int>>, const cuda::std::expected<int, int>&>, "");
static_assert(!cuda::std::is_convertible_v<const cuda::std::expected<int, int>&, cuda::std::expected<int, CtorFrom<int>>>, "");

struct Data {
  int i;
  TEST_HOST_DEVICE constexpr Data(int ii) : i(ii) {}
};
