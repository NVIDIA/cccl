...
// Test Constraints:
#if defined(_LIBCUDACXX_HAS_VECTOR)
static_assert(cuda::std::is_constructible_v<cuda::std::expected<cuda::std::vector<int>, int>,
                                            cuda::std::in_place_t,
...
#if defined(_LIBCUDACXX_HAS_VECTOR)
static_assert(!ImplicitlyConstructible<cuda::std::expected<cuda::std::vector<int>, int>,
                                       cuda::std::in_place_t,
                                       cuda::std::initializer_list<int>>,
              "");
#endif
