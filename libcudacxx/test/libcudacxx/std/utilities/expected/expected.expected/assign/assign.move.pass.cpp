...
static_assert(!cuda::std::is_move_assignable_v<
                  cuda::std::expected<NotMoveAssignable, int> >,
              "");

// !is_move_constructible_v<T>
static_assert(!cuda::std::is_move_assignable_v<
                  cuda::std::expected<NotMoveConstructible, int> >,
              "");

// !is_move_assignable_v<E>
static_assert(!cuda::std::is_move_assignable_v<
                  cuda::std::expected<int, NotMoveAssignable> >,
              "");

// !is_move_constructible_v<E>
static_assert(!cuda::std::is_move_assignable_v<
                  cuda::std::expected<int, NotMoveConstructible> >,
              "");

// !is_nothrow_move_constructible_v<T> && is_nothrow_move_constructible_v<E>
static_assert(cuda::std::is_move_assignable_v<
                  cuda::std::expected<MoveCtorMayThrow, int> >,
              "");

// is_nothrow_move_constructible_v<T> && !is_nothrow_move_constructible_v<E>
static_assert(cuda::std::is_move_assignable_v<
                  cuda::std::expected<int, MoveCtorMayThrow> >,
              "");

#ifndef TEST_COMPILER_ICC
// !is_nothrow_move_constructible_v<T> && !is_nothrow_move_constructible_v<E>
static_assert(!cuda::std::is_move_assignable_v<
                  cuda::std::expected<MoveCtorMayThrow, MoveCtorMayThrow> >,
              "");
#endif // TEST_COMPILER_ICC

struct MoveAssignMayThrow {
  MoveAssignMayThrow(MoveAssignMayThrow&&) noexcept = default;
  __host__ __device__ MoveAssignMayThrow& operator=(MoveAssignMayThrow&&)
      noexcept(false) {
    return *this;
  }
};
...
// Test noexcept
static_assert(
    cuda::std::is_nothrow_move_assignable_v<cuda::std::expected<int, int> >,
    "");

#ifndef TEST_COMPILER_ICC
// !is_nothrow_move_assignable_v<T>
static_assert(!cuda::std::is_nothrow_move_assignable_v<
                  cuda::std::expected<MoveAssignMayThrow, int> >,
              "");
...
static_assert(!cuda::std::is_nothrow_move_assignable_v<
                  cuda::std::expected<int, MoveAssignMayThrow> >,
              "");
...
__host__ __device__ TEST_CONSTEXPR_CXX20 bool test() {
  ...
  //
  {
    ...
    cuda::std::expected<TracedNoexcept, Traced> e1(cuda::std::in_place,
                                                   oldState, 5);
    cuda::std::expected<TracedNoexcept, Traced> e2(cuda::std::unexpect,
                                                   newState, 10);
  ...
  //
  {
    ...
    cuda::std::expected<Traced, TracedNoexcept> e1(cuda::std::in_place,
                                                   oldState, 5);
    cuda::std::expected<Traced, TracedNoexcept> e2(cuda::std::unexpect,
                                                   newState, 10);
  ...
  //
  {
    ...
    cuda::std::expected<Traced, TracedNoexcept> e1(cuda::std::unexpect,
                                                   oldState, 5);
    cuda::std::expected<Traced, TracedNoexcept> e2(cuda::std::in_place,
                                                   newState, 10);
  ...
  //
  {
    ...
    cuda::std::expected<TracedNoexcept, Traced> e1(cuda::std::unexpect,
                                                   oldState, 5);
    cuda::std::expected<TracedNoexcept, Traced> e2(cuda::std::in_place,
                                                   newState, 10);
