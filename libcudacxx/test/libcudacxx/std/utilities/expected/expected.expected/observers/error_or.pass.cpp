...
TEST_FUNC constexpr bool test_default_template_arg()
{
  // const &, has_value()
  {
    const cuda::std::expected<int, ConstructFromInt> e(5);
  ...
  // const &, !has_value()
  {
    const cuda::std::expected<int, ConstructFromInt> e(cuda::std::unexpect, 5);
    decltype(auto) x = e.error_or(10);
    static_assert(cuda::std::same_as<ConstructFromInt, decltype(x)>);
    assert(x.value == 5);
  }
  ...
  // &&, has_value()
  {
    cuda::std::expected<int, ConstructFromInt> e(5);
  ...
  // &&, !has_value()
  {
    cuda::std::expected<int, ConstructFromInt> e(cuda::std::unexpect, 5);
    decltype(auto) x = cuda::std::move(e).error_or(10);
    static_assert(cuda::std::same_as<ConstructFromInt, decltype(x)>);
    assert(x.value == 5);
  }
