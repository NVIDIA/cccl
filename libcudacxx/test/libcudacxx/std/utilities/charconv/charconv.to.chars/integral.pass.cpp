...
__host__ __device__ constexpr void test_to_chars(const TestItem& item)
{
  ...
  static_assert(
    cuda::std::is_same_v<cuda::std::to_chars_result, decltype(cuda::std::to_chars((char*) {}, (char*) {}, T{}, Base))>);
  static_assert(noexcept(cuda::std::to_chars((char*) {}, (char*) {}, T{}, Base)));

  // std::in_range accepts integer types only
  using RangeT = std::conditional_t<cuda::std::is_same_v<T, char>,
...
__host__ __device__ constexpr void test_base()
{
  ...
  static_assert(cuda::std::is_same_v<cuda::std::to_chars_result,
                                     decltype(cuda::std::to_chars((char*) {}, (char*) {}, char{}, Base))>);
  static_assert(noexcept(cuda::std::to_chars((char*) {}, (char*) {}, char{}, Base)));
