...
TEST_FUNC constexpr void test()
{
  ...
  static_assert(
    cuda::std::is_same_v<
      void,
      decltype(formatter.set_brackets(cuda::std::basic_string_view<CharT>{}, cuda::std::basic_string_view<CharT>{}))>);
  static_assert(
    noexcept(formatter.set_brackets(cuda::std::basic_string_view<CharT>{}, cuda::std::basic_string_view<CharT>{})));

  formatter.set_brackets(cuda::std::basic_string_view{TEST_STRLIT(CharT, "open")},
                         cuda::std::basic_string_view{TEST_STRLIT(CharT, "close")});
