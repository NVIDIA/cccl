...
static_assert(cuda::std::is_same_v<wchar_t*, decltype(cuda::std::format_to(cuda::std::declval<wchar_t*>(), L""))>);
static_assert(!noexcept(cuda::std::format_to(cuda::std::declval<wchar_t*>(), L"")));
