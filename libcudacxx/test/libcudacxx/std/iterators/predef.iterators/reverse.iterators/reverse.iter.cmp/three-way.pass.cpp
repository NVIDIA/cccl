...
private:
  __host__ __device__ friend constexpr bool operator==(const Iter& l,
                                                       const Iter& r) = default;
  __host__ __device__ friend constexpr cuda::std::partial_ordering operator<= >
      (const Iter& l, const Iter& r) = default;
};
...
private:
  ...
  __host__ __device__ friend constexpr cuda::std::partial_ordering operator<= >
      (const ConstIter& l, const ConstIter& r) = default;
};
