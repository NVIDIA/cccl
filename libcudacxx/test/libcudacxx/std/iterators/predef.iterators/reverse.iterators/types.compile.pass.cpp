...
__host__ __device__ constexpr void test_iter_category() {
  static_assert((cuda::std::is_same<
                    typename cuda::std::move_iterator<It>::iterator_category,
...
__host__ __device__ void test() {
  ...
  static_assert((cuda::std::is_same<typename R::difference_type,
                ...
                "");
  static_assert(
      (cuda::std::is_same<typename R::reference, typename T::reference>::value),
      "");
  static_assert((cuda::std::is_same<
                    typename R::pointer,
                    typename cuda::std::iterator_traits<It>::pointer>::value),
                "");

#if TEST_STD_VER <= 2014
  typedef cuda::std::iterator<typename T::iterator_category,
...
static_assert(
    cuda::std::is_same_v<
        typename cuda::std::reverse_iterator<FooIter>::value_type, int>,
    "");
// Not using `FooIter::difference_type`.
static_assert(
    cuda::std::is_same_v<
        typename cuda::std::reverse_iterator<FooIter>::difference_type, char>,
    "");
...
static_assert(
    cuda::std::is_same_v<
        typename cuda::std::reverse_iterator<BarIter>::reference, bool&>,
    "");
#else
static_assert(
    cuda::std::is_same<typename cuda::std::reverse_iterator<BarIter>::reference,
                       char&>::value,
    "");
#endif
...
__host__ __device__ void test_all() {
  ...
  static_assert(cuda::std::is_same_v<
                    typename cuda::std::reverse_iterator<
  ...
  static_assert(cuda::std::is_same_v<
                    typename cuda::std::reverse_iterator<
                        cpp20_random_access_iterator<char*> >::iterator_concept,
                    cuda::std::random_access_iterator_tag>,
                "");
  static_assert(
      cuda::std::is_same_v<typename cuda::std::reverse_iterator<
                               contiguous_iterator<char*> >::iterator_concept,
                           cuda::std::random_access_iterator_tag>,
      "");
  static_assert(
      cuda::std::is_same_v<
          typename cuda::std::reverse_iterator<char*>::iterator_concept,
          cuda::std::random_access_iterator_tag>,
      "");
#endif
}
