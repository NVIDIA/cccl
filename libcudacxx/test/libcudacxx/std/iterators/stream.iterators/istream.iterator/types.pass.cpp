...
int main(int, char**) {
  typedef cuda::std::istream_iterator<double>
      I1; // double is trivially destructible
#if TEST_STD_VER <= 2014
  static_assert(
      (cuda::std::is_convertible<
          I1, cuda::std::iterator<cuda::std::input_iterator_tag, double,
                                  cuda::std::ptrdiff_t, const double*,
                                  const double&> >::value),
      "");
#else
  ...
  static_assert(
      (cuda::std::is_same<I1::difference_type, cuda::std::ptrdiff_t>::value),
      "");
  ...
  typedef cuda::std::istream_iterator<unsigned, wchar_t>
      I2; // unsigned is trivially destructible
#if TEST_STD_VER <= 2014
  static_assert(
      (cuda::std::is_convertible<
          I2, cuda::std::iterator<cuda::std::input_iterator_tag, unsigned,
                                  cuda::std::ptrdiff_t, const unsigned*,
  ...
  static_assert(
      (cuda::std::is_same<I2::difference_type, cuda::std::ptrdiff_t>::value),
      "");
  ...
  typedef cuda::std::istream_iterator<cuda::std::string>
