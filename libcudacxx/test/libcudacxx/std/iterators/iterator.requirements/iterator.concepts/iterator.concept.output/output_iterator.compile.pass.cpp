...
static_assert(
    cuda::std::output_iterator<cpp17_output_iterator<T*>, DerivedFromT>);
static_assert(
    !cuda::std::output_iterator<cpp17_output_iterator<DerivedFromT*>, T>);
...
static_assert(
    cuda::std::output_iterator<cpp20_output_iterator<T*>, DerivedFromT>);
static_assert(
    !cuda::std::output_iterator<cpp20_output_iterator<DerivedFromT*>, T>);
