...
struct not_forward_iterator {
  ...
  TEST_HOST_DEVICE not_forward_iterator& operator++();
  TEST_HOST_DEVICE not_forward_iterator operator++(int);
...
struct wrong_iterator_category {
  ...
  TEST_HOST_DEVICE wrong_iterator_category& operator++();
  TEST_HOST_DEVICE wrong_iterator_category operator++(int);
...
#else
  TEST_HOST_DEVICE bool operator==(const wrong_iterator_category&) const { return true; };
  TEST_HOST_DEVICE bool operator!=(const wrong_iterator_category&) const { return false; };
#endif
};
...
struct wrong_iterator_concept {
  ...
  TEST_HOST_DEVICE wrong_iterator_concept& operator++();
  TEST_HOST_DEVICE wrong_iterator_concept operator++(int);
...
#else
  TEST_HOST_DEVICE bool operator==(const wrong_iterator_concept&) const { return true; };
  TEST_HOST_DEVICE bool operator!=(const wrong_iterator_concept&) const { return false; };
#endif
};
...
struct no_predecrement {
  ...
  TEST_HOST_DEVICE no_predecrement& operator++();
  TEST_HOST_DEVICE no_predecrement operator++(int);
...
#else
  TEST_HOST_DEVICE bool operator==(const no_predecrement&) const { return true; };
  TEST_HOST_DEVICE bool operator!=(const no_predecrement&) const { return false; };
#endif
};
...
struct bad_predecrement {
  ...
  TEST_HOST_DEVICE bad_predecrement& operator++();
  TEST_HOST_DEVICE bad_predecrement operator++(int);
...
#else
  TEST_HOST_DEVICE bool operator==(const bad_predecrement&) const { return true; };
  TEST_HOST_DEVICE bool operator!=(const bad_predecrement&) const { return false; };
#endif
};
...
struct no_postdecrement {
  ...
  TEST_HOST_DEVICE no_postdecrement& operator++();
  TEST_HOST_DEVICE no_postdecrement operator++(int);

  TEST_HOST_DEVICE no_postdecrement& operator--();
#if defined(TEST_COMPILER_MSVC) //  single-argument function used for postfix "--" (anachronism)
  TEST_HOST_DEVICE no_postdecrement& operator--(int) = delete;
#endif // TEST_COMPILER_MSVC

#if TEST_STD_VER > 2017
  bool operator==(no_postdecrement const&) const = default;
#else
  TEST_HOST_DEVICE bool operator==(const no_postdecrement&) const { return true; };
  TEST_HOST_DEVICE bool operator!=(const no_postdecrement&) const { return false; };
#endif
};
...
struct bad_postdecrement {
  ...
  TEST_HOST_DEVICE bad_postdecrement& operator++();
  TEST_HOST_DEVICE bad_postdecrement operator++(int);
...
#else
  TEST_HOST_DEVICE bool operator==(const bad_postdecrement&) const { return true; };
  TEST_HOST_DEVICE bool operator!=(const bad_postdecrement&) const { return false; };
#endif
};
