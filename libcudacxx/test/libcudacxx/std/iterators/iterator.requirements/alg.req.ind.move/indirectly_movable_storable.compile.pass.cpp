...
static_assert(cuda::std::indirectly_movable_storable<PointerTo<MoveOnly>,
                                                     PointerTo<MoveOnly> >);
...
static_assert(cuda::std::indirectly_writable<
              NoAssignment, cuda::std::iter_rvalue_reference_t<NoAssignment> >);
static_assert(!cuda::std::indirectly_writable<
              NoAssignment, cuda::std::iter_value_t<NoAssignment> >);
static_assert(
    !cuda::std::indirectly_movable_storable<NoAssignment, NoAssignment>);
...
static_assert(!cuda::std::indirectly_movable_storable<DeletedMoveCtor*,
                                                      DeletedMoveCtor*>);
static_assert(!cuda::std::indirectly_movable_storable<DeletedMoveAssignment*,
...
static_assert(cuda::std::indirectly_movable_storable<InconsistentIterator,
...
struct cuda::std::basic_common_reference<
...
static_assert(
    cuda::std::indirectly_movable_storable<int*, AssignableFromAnything*>);
static_assert(!cuda::std::indirectly_movable_storable<NotConstructibleFromRefIn,
                                                      AssignableFromAnything*>);
...
struct cuda::std::basic_common_reference<NotAssignableFromRefIn::ValueType,
                                         NotAssignableFromRefIn::ReferenceType,
                                         X, Y> {
...
struct cuda::std::basic_common_reference<NotAssignableFromRefIn::ReferenceType,
                                         NotAssignableFromRefIn::ValueType, X,
                                         Y> {
  using type = NotAssignableFromRefIn::CommonType&;
};

static_assert(
    cuda::std::common_reference_with<NotAssignableFromRefIn::ValueType&,
                                     NotAssignableFromRefIn::ReferenceType&>);

// A type that can't be assigned from its own reference isn't `indirectly_movable_storable`, even when assigning it
// to a type that can be assigned from anything.
static_assert(!cuda::std::indirectly_movable_storable<NotAssignableFromRefIn,
                                                      AssignableFromAnything*>);
