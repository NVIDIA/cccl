...
struct A {
  __host__ __device__ friend void iter_swap(const PointerTo<A>&,
                                            const PointerTo<A>&);
};

// Is indirectly swappable.
struct B {
  __host__ __device__ friend void iter_swap(const PointerTo<B>&,
                                            const PointerTo<B>&);
  __host__ __device__ friend void iter_swap(const PointerTo<A>&,
                                            const PointerTo<B>&);
  __host__ __device__ friend void iter_swap(const PointerTo<B>&,
...
struct C {
  __host__ __device__ friend void iter_swap(const PointerTo<C>&,
                                            const PointerTo<C>&);
  __host__ __device__ friend void iter_swap(const PointerTo<A>&,
                                            const PointerTo<C>&);
  __host__ __device__ friend void iter_swap(const PointerTo<C>&,
                                            const PointerTo<A>&) = delete;
};

// Valid except ranges::iter_swap(i1, i2).
struct D {
  __host__ __device__ friend void iter_swap(const PointerTo<D>&,
                                            const PointerTo<D>&);
  __host__ __device__ friend void iter_swap(const PointerTo<A>&,
                                            const PointerTo<D>&) = delete;
  __host__ __device__ friend void iter_swap(const PointerTo<D>&,
                                            const PointerTo<A>&);
};
...
struct E {
  ...
  __host__ __device__ friend void iter_swap(const PointerTo<E>&,
                                            const PointerTo<E>&) = delete;
  __host__ __device__ friend void iter_swap(const PointerTo<A>&,
                                            const PointerTo<E>&);
  __host__ __device__ friend void iter_swap(const PointerTo<E>&,
                                            const PointerTo<A>&);
...
struct F {
  __host__ __device__ friend void iter_swap(const PointerTo<F>&,
                                            const PointerTo<F>&) = delete;
};

// Valid except ranges::iter_swap(i1, i1).
struct G {
  __host__ __device__ friend void iter_swap(const PointerTo<G>&,
                                            const PointerTo<G>&);
  __host__ __device__ friend void iter_swap(const PointerTo<F>&,
                                            const PointerTo<G>&);
  __host__ __device__ friend void iter_swap(const PointerTo<G>&,
