...
static_assert(!cuda::std::indirectly_copyable_storable<PointerTo<MoveOnly>,
                                                       PointerTo<MoveOnly> >);
...
static_assert(!cuda::std::indirectly_copyable_storable<PointerTo<CopyOnly>,
                                                       PointerTo<CopyOnly> >);
...
static_assert(
    cuda::std::indirectly_writable<
        NoLvalueAssignment, cuda::std::iter_reference_t<NoLvalueAssignment> >);
static_assert(
    !cuda::std::indirectly_writable<
        NoLvalueAssignment, cuda::std::iter_value_t<NoLvalueAssignment>&>);
static_assert(cuda::std::indirectly_writable<
              NoLvalueAssignment,
              const cuda::std::iter_value_t<NoLvalueAssignment>&>);
static_assert(
    cuda::std::indirectly_writable<
        NoLvalueAssignment, cuda::std::iter_value_t<NoLvalueAssignment>&&>);
static_assert(cuda::std::indirectly_writable<
              NoLvalueAssignment,
              const cuda::std::iter_value_t<NoLvalueAssignment>&&>);
static_assert(!cuda::std::indirectly_copyable_storable<NoLvalueAssignment,
                                                       NoLvalueAssignment>);
...
static_assert(cuda::std::indirectly_writable<
              NoConstLvalueAssignment,
              cuda::std::iter_reference_t<NoConstLvalueAssignment> >);
static_assert(cuda::std::indirectly_writable<
              NoConstLvalueAssignment,
              cuda::std::iter_value_t<NoConstLvalueAssignment>&>);
static_assert(!cuda::std::indirectly_writable<
              NoConstLvalueAssignment,
              const cuda::std::iter_value_t<NoConstLvalueAssignment>&>);
static_assert(cuda::std::indirectly_writable<
              NoConstLvalueAssignment,
              cuda::std::iter_value_t<NoConstLvalueAssignment>&&>);
static_assert(cuda::std::indirectly_writable<
...
static_assert(!cuda::std::indirectly_copyable_storable<
              NoConstLvalueAssignment, NoConstLvalueAssignment>);
...
static_assert(
    cuda::std::indirectly_writable<
        NoRvalueAssignment, cuda::std::iter_reference_t<NoRvalueAssignment> >);
static_assert(
    cuda::std::indirectly_writable<
        NoRvalueAssignment, cuda::std::iter_value_t<NoRvalueAssignment>&>);
static_assert(cuda::std::indirectly_writable<
              NoRvalueAssignment,
              const cuda::std::iter_value_t<NoRvalueAssignment>&>);
static_assert(
    !cuda::std::indirectly_writable<
        NoRvalueAssignment, cuda::std::iter_value_t<NoRvalueAssignment>&&>);
static_assert(cuda::std::indirectly_writable<
              NoRvalueAssignment,
              const cuda::std::iter_value_t<NoRvalueAssignment>&&>);
static_assert(!cuda::std::indirectly_copyable_storable<NoRvalueAssignment,
                                                       NoRvalueAssignment>);
...
static_assert(cuda::std::indirectly_writable<
              NoConstRvalueAssignment,
              cuda::std::iter_reference_t<NoConstRvalueAssignment> >);
static_assert(cuda::std::indirectly_writable<
              NoConstRvalueAssignment,
              cuda::std::iter_value_t<NoConstRvalueAssignment>&>);
static_assert(cuda::std::indirectly_writable<
              NoConstRvalueAssignment,
              const cuda::std::iter_value_t<NoConstRvalueAssignment>&>);
static_assert(cuda::std::indirectly_writable<
              NoConstRvalueAssignment,
              cuda::std::iter_value_t<NoConstRvalueAssignment>&&>);
static_assert(!cuda::std::indirectly_writable<
...
struct DeletedCopyCtor {
  ...
  DeletedCopyCtor& operator=(DeletedCopyCtor const&) = default;
    ...
    !defined(                                                                  \
        TEST_COMPILER_MSVC) //  multiple versions of a defaulted special member functions are not allowed
...
static_assert(!cuda::std::indirectly_copyable_storable<
              DeletedNonconstCopyCtor*, DeletedNonconstCopyCtor*>);
...
static_assert(!cuda::std::indirectly_copyable_storable<DeletedConstMoveCtor*,
...
struct DeletedNonconstCopyAssignment {
  ...
  operator=(DeletedNonconstCopyAssignment const&) = default;
  DeletedNonconstCopyAssignment&
  operator=(DeletedNonconstCopyAssignment&) = delete;
};
static_assert(!cuda::std::indirectly_copyable_storable<
...
static_assert(!cuda::std::indirectly_copyable_storable<DeletedCopyCtor*,
                                                       DeletedCopyCtor*>);
static_assert(!cuda::std::indirectly_copyable_storable<DeletedMoveCtor*,
                                                       DeletedMoveCtor*>);
static_assert(!cuda::std::indirectly_copyable_storable<DeletedCopyAssignment*,
                                                       DeletedCopyAssignment*>);
static_assert(!cuda::std::indirectly_copyable_storable<DeletedMoveAssignment*,
                                                       DeletedMoveAssignment*>);
static_assert(!cuda::std::indirectly_copyable_storable<
              DeletedConstMoveAssignment*, DeletedConstMoveAssignment*>);
...
static_assert(cuda::std::indirectly_copyable_storable<InconsistentIterator,
...
// to a type that can be assigned from anything.
static_assert(!cuda::std::indirectly_copyable_storable<
              NotAssignableFromRefIn, AssignableFromAnything*>);
