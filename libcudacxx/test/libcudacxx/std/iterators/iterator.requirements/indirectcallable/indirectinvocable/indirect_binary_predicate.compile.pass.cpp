...
static_assert(
    cuda::std::indirect_binary_predicate<GoodPredicate<It1, It2>, It1, It2>);
static_assert(
    cuda::std::indirect_binary_predicate<bool (*)(int, float), int*, float*>);
...
static_assert(
    cuda::std::indirect_binary_predicate<decltype(lambda), int*, int*>);
#endif
...
static_assert(
    !cuda::std::indirect_binary_predicate<
        GoodPredicate<It1, NotIndirectlyReadable>, It1, NotIndirectlyReadable>);
static_assert(
    !cuda::std::indirect_binary_predicate<
        GoodPredicate<NotIndirectlyReadable, It2>, NotIndirectlyReadable, It2>);
#endif
