...
struct GoodPredicate {
  ...
  operator()(cuda::std::iter_common_reference_t<I>) const;
};
...
static_assert(!cuda::std::indirect_unary_predicate<
              GoodPredicate<NotIndirectlyReadable>, NotIndirectlyReadable>);
#endif
