...
struct GoodPredicate {
    TEST_HOST_DEVICE bool operator()(cuda::std::iter_reference_t<I>) const;
    TEST_HOST_DEVICE bool operator()(cuda::std::iter_value_t<I>&) const;
    TEST_HOST_DEVICE bool operator()(cuda::std::iter_common_reference_t<I>) const;
};
...
struct BadPredicate1 {
    ...
    template <class T>
    TEST_HOST_DEVICE bool operator()(T const&) const;
};
