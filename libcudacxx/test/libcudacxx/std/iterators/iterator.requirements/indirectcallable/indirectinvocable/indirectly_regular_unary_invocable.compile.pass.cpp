...
struct GoodInvocable {
  ...
  __host__ __device__ R2
  operator()(cuda::std::iter_common_reference_t<I>) const;
};

// Should work when all constraints are satisfied
static_assert(
    cuda::std::indirectly_regular_unary_invocable<GoodInvocable<It>, It>);

// Should fail when the iterator is not indirectly_readable
#if TEST_STD_VER > 2017
struct NotIndirectlyReadable {};
static_assert(!cuda::std::indirectly_regular_unary_invocable<
              GoodInvocable<NotIndirectlyReadable>, NotIndirectlyReadable>);
#endif
...
static_assert(
    !cuda::std::indirectly_regular_unary_invocable<BadInvocable1, It>);
...
static_assert(
    !cuda::std::indirectly_regular_unary_invocable<BadInvocable2, It>);
...
static_assert(
    !cuda::std::indirectly_regular_unary_invocable<BadInvocable3, It>);
...
static_assert(
    !cuda::std::indirectly_regular_unary_invocable<BadInvocable4, It>);
...
struct BadInvocable5 {
  ...
  struct Unrelated {};
  __host__ __device__ Unrelated
  operator()(cuda::std::iter_reference_t<It>) const;
  __host__ __device__ R1
  operator()(cuda::std::iter_common_reference_t<It>) const;
};
static_assert(
    !cuda::std::indirectly_regular_unary_invocable<BadInvocable5, It>);

// Various tests with callables
struct S {};
static_assert(
    cuda::std::indirectly_regular_unary_invocable<int (*)(int), int*>);
static_assert(
    cuda::std::indirectly_regular_unary_invocable<int (&)(int), int*>);
static_assert(cuda::std::indirectly_regular_unary_invocable<int S::*, S*>);
static_assert(cuda::std::indirectly_regular_unary_invocable<int (S::*)(), S*>);
static_assert(
    cuda::std::indirectly_regular_unary_invocable<int (S::*)() const, S*>);
static_assert(
    cuda::std::indirectly_regular_unary_invocable<void (*)(int), int*>);

static_assert(!cuda::std::indirectly_regular_unary_invocable<
              int(int), int*>); // not move constructible
static_assert(
    !cuda::std::indirectly_regular_unary_invocable<int (*)(int*, int*), int*>);
static_assert(
    !cuda::std::indirectly_regular_unary_invocable<int (&)(int*, int*), int*>);
static_assert(
    !cuda::std::indirectly_regular_unary_invocable<int (S::*)(int*), S*>);
static_assert(
    !cuda::std::indirectly_regular_unary_invocable<int (S::*)(int*) const, S*>);
