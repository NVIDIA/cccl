...
static_assert(!cuda::std::indirectly_unary_invocable<
...
static_assert(
    !cuda::std::indirectly_unary_invocable<int (*)(int*, int*), int*>);
static_assert(
    !cuda::std::indirectly_unary_invocable<int (&)(int*, int*), int*>);
static_assert(!cuda::std::indirectly_unary_invocable<int (S::*)(int*), S*>);
static_assert(
    !cuda::std::indirectly_unary_invocable<int (S::*)(int*) const, S*>);
