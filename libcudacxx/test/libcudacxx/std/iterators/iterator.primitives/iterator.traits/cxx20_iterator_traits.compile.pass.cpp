...
inline constexpr bool has_iterator_concept_v<
    Traits, cuda::std::void_t<typename Traits::iterator_concept> > = true;

template <class It, class Traits,
          cuda::std::enable_if_t<cuda::std::is_pointer_v<It>, int> = 0>
__host__ __device__ constexpr void test_iter_concept() {
  static_assert(cuda::std::same_as<typename Traits::iterator_concept,
...
template <class Iter, class Category, class ValueType, class DiffType,
          class RefType, class PtrType>
__host__ __device__ constexpr bool test() {
  using Traits = cuda::std::iterator_traits<Iter>;
  static_assert(
      cuda::std::same_as<typename Traits::iterator_category, Category>);
...
__host__ __device__ constexpr bool testConst() {
  return test<Iter, Category, ValueType, cuda::std::ptrdiff_t, const ValueType&,
              const ValueType*>();
}

template <class Iter, class Category, class ValueType>
__host__ __device__ constexpr bool testMutable() {
  return test<Iter, Category, ValueType, cuda::std::ptrdiff_t, ValueType&,
              ValueType*>();
}
...
// only for pointers.
//
static_assert(testMutable<cuda::std::array<int, 10>::iterator,
                          cuda::std::random_access_iterator_tag, int>());
static_assert(testConst<cuda::std::array<int, 10>::const_iterator,
                        cuda::std::random_access_iterator_tag, int>());
...
static_assert(cuda::std::same_as<AllMembersTraits::iterator_category,
                                 AllMembers::iterator_category>);
static_assert(
    cuda::std::same_as<AllMembersTraits::value_type, AllMembers::value_type>);
static_assert(cuda::std::same_as<AllMembersTraits::difference_type,
                                 AllMembers::difference_type>);
static_assert(
    cuda::std::same_as<AllMembersTraits::reference, AllMembers::reference>);
static_assert(
    cuda::std::same_as<AllMembersTraits::pointer, AllMembers::pointer>);
...
static_assert(cuda::std::same_as<NoPointerMemberTraits::iterator_category,
                                 NoPointerMember::iterator_category>);
static_assert(cuda::std::same_as<NoPointerMemberTraits::value_type,
                                 NoPointerMember::value_type>);
static_assert(cuda::std::same_as<NoPointerMemberTraits::difference_type,
                                 NoPointerMember::difference_type>);
static_assert(cuda::std::same_as<NoPointerMemberTraits::reference,
                                 NoPointerMember::reference>);
...
static_assert(cuda::std::same_as<IterConceptTraits::iterator_category,
                                 IterConcept::iterator_category>);
static_assert(
    cuda::std::same_as<IterConceptTraits::value_type, IterConcept::value_type>);
static_assert(cuda::std::same_as<IterConceptTraits::difference_type,
                                 IterConcept::difference_type>);
static_assert(
    cuda::std::same_as<IterConceptTraits::reference, IterConcept::reference>);
static_assert(
    cuda::std::same_as<IterConceptTraits::pointer, IterConcept::pointer>);
...
static_assert(cuda::std::same_as<LegacyInputTraits::iterator_category,
                                 LegacyInput::iterator_category>);
static_assert(
    cuda::std::same_as<LegacyInputTraits::value_type, LegacyInput::value_type>);
static_assert(cuda::std::same_as<LegacyInputTraits::difference_type, short>);
static_assert(
    cuda::std::same_as<LegacyInputTraits::reference, LegacyInput::reference>);
...
struct LegacyInputNoValueType {
  ...
  __host__ __device__ friend bool operator==(LegacyInputNoValueType,
...
using LegacyInputNoValueTypeTraits =
    cuda::std::iterator_traits<LegacyInputNoValueType>;
static_assert(
    cuda::std::same_as<LegacyInputNoValueTypeTraits::iterator_category,
                       cuda::std::input_iterator_tag>);
static_assert(cuda::std::same_as<LegacyInputNoValueTypeTraits::value_type,
                                 LegacyInputNoValueType::not_value_type>);
static_assert(
    cuda::std::same_as<LegacyInputNoValueTypeTraits::difference_type, int>);
static_assert(cuda::std::same_as<LegacyInputNoValueTypeTraits::reference,
...
static_assert(cuda::std::same_as<LegacyForwardTraits::iterator_category,
                                 cuda::std::forward_iterator_tag>);
static_assert(cuda::std::same_as<LegacyForwardTraits::value_type,
                                 LegacyForward::not_value_type>);
static_assert(cuda::std::same_as<LegacyForwardTraits::difference_type, short>);
static_assert(cuda::std::same_as<LegacyForwardTraits::reference,
...
struct LegacyBidirectional {
  ...
  __host__ __device__ friend bool operator==(LegacyBidirectional,
                                             LegacyBidirectional);
#if TEST_STD_VER < 2020
  __host__ __device__ friend bool operator!=(LegacyBidirectional,
                                             LegacyBidirectional);
  ...
  __host__ __device__ LegacyBidirectional& operator--();
  __host__ __device__ LegacyBidirectional operator--(int);
  __host__ __device__ friend short operator-(LegacyBidirectional,
                                             LegacyBidirectional);
};
using LegacyBidirectionalTraits =
    cuda::std::iterator_traits<LegacyBidirectional>;
static_assert(cuda::std::same_as<LegacyBidirectionalTraits::iterator_category,
                                 cuda::std::bidirectional_iterator_tag>);
static_assert(cuda::std::same_as<LegacyBidirectionalTraits::value_type,
                                 LegacyBidirectional::value_type>);
static_assert(
    cuda::std::same_as<LegacyBidirectionalTraits::difference_type, short>);
static_assert(cuda::std::same_as<LegacyBidirectionalTraits::reference,
...
struct MinusNotDeclaredIter {
  ...
  auto operator<= >
      (const MinusNotDeclaredIter&) const = default; // nvbug3908399
#else
  __host__ __device__ friend bool
  operator==(const MinusNotDeclaredIter&,
             const MinusNotDeclaredIter&) noexcept {
    return true;
  }
  __host__ __device__ friend bool
  operator!=(const MinusNotDeclaredIter&,
  ...
  __host__ __device__ friend MinusNotDeclaredIter
  operator-(MinusNotDeclaredIter, int);
  __host__ __device__ friend MinusNotDeclaredIter
  operator+(MinusNotDeclaredIter, int);
  __host__ __device__ friend MinusNotDeclaredIter
  operator+(int, MinusNotDeclaredIter);
};
template <>
struct cuda::std::incrementable_traits<MinusNotDeclaredIter> {
  using difference_type = short;
};
using MinusNotDeclaredIterTraits =
    cuda::std::iterator_traits<MinusNotDeclaredIter>;
static_assert(cuda::std::same_as<MinusNotDeclaredIterTraits::iterator_category,
                                 cuda::std::bidirectional_iterator_tag>);
static_assert(cuda::std::same_as<MinusNotDeclaredIterTraits::value_type,
                                 MinusNotDeclaredIter::value_type>);
static_assert(
    cuda::std::same_as<MinusNotDeclaredIterTraits::difference_type, short>);
static_assert(cuda::std::same_as<MinusNotDeclaredIterTraits::reference,
...
struct WrongSubscriptReturnType {
...
#ifndef TEST_HAS_NO_SPACESHIP_OPERATOR
  auto operator<= >
      (const WrongSubscriptReturnType&) const = default; // nvbug3908399
#else
  __host__ __device__ friend bool
  operator==(const WrongSubscriptReturnType&,
             const WrongSubscriptReturnType&) noexcept {
    return true;
  }
  __host__ __device__ friend bool
  operator!=(const WrongSubscriptReturnType&,
  ...
  __host__ __device__ WrongSubscriptReturnType& operator-=(long);
  __host__ __device__ friend short operator-(WrongSubscriptReturnType,
                                             WrongSubscriptReturnType);
  __host__ __device__ friend WrongSubscriptReturnType
  operator-(WrongSubscriptReturnType, int);
  __host__ __device__ friend WrongSubscriptReturnType
  operator+(WrongSubscriptReturnType, int);
  __host__ __device__ friend WrongSubscriptReturnType
  operator+(int, WrongSubscriptReturnType);
};
using WrongSubscriptReturnTypeTraits =
    cuda::std::iterator_traits<WrongSubscriptReturnType>;
static_assert(
    cuda::std::same_as<WrongSubscriptReturnTypeTraits::iterator_category,
                       cuda::std::bidirectional_iterator_tag>);
static_assert(cuda::std::same_as<WrongSubscriptReturnTypeTraits::value_type,
                                 WrongSubscriptReturnType::value_type>);
static_assert(
    cuda::std::same_as<WrongSubscriptReturnTypeTraits::difference_type, short>);
static_assert(cuda::std::same_as<WrongSubscriptReturnTypeTraits::reference,
                                 WrongSubscriptReturnType::value_type&>);
static_assert(
    cuda::std::same_as<WrongSubscriptReturnTypeTraits::pointer, void>);
static_assert(!has_iterator_concept_v<WrongSubscriptReturnTypeTraits>);

struct LegacyRandomAccess {
  struct value_type {};

  __host__ __device__ friend bool operator==(LegacyRandomAccess,
                                             LegacyRandomAccess);
#if TEST_STD_VER < 2020
  __host__ __device__ friend bool operator!=(LegacyRandomAccess,
                                             LegacyRandomAccess);
  ...
  __host__ __device__ LegacyRandomAccess& operator-=(long);
  __host__ __device__ friend short operator-(LegacyRandomAccess,
                                             LegacyRandomAccess);
  __host__ __device__ friend LegacyRandomAccess operator-(LegacyRandomAccess,
                                                          int);
  __host__ __device__ friend LegacyRandomAccess operator+(LegacyRandomAccess,
                                                          int);
  __host__ __device__ friend LegacyRandomAccess operator+(int,
                                                          LegacyRandomAccess);
};
using LegacyRandomAccessTraits = cuda::std::iterator_traits<LegacyRandomAccess>;
static_assert(cuda::std::same_as<LegacyRandomAccessTraits::iterator_category,
                                 cuda::std::random_access_iterator_tag>);
static_assert(cuda::std::same_as<LegacyRandomAccessTraits::value_type,
                                 LegacyRandomAccess::value_type>);
static_assert(
    cuda::std::same_as<LegacyRandomAccessTraits::difference_type, short>);
static_assert(cuda::std::same_as<LegacyRandomAccessTraits::reference,
...
struct LegacyRandomAccessSpaceship {
...
#ifndef TEST_HAS_NO_SPACESHIP_OPERATOR
  auto operator<= >
      (const LegacyRandomAccessSpaceship&) const = default; // nvbug3908399
#else
  __host__ __device__ friend bool
  operator==(const LegacyRandomAccessSpaceship&,
             const LegacyRandomAccessSpaceship&) noexcept {
    return true;
  }
  __host__ __device__ friend bool
  operator!=(const LegacyRandomAccessSpaceship&,
  ...
  __host__ __device__ LegacyRandomAccessSpaceship& operator-=(long);
  __host__ __device__ friend short operator-(LegacyRandomAccessSpaceship,
                                             LegacyRandomAccessSpaceship);
  __host__ __device__ friend LegacyRandomAccessSpaceship
  operator-(LegacyRandomAccessSpaceship, int);
  __host__ __device__ friend LegacyRandomAccessSpaceship
  operator+(LegacyRandomAccessSpaceship, int);
  __host__ __device__ friend LegacyRandomAccessSpaceship
  operator+(int, LegacyRandomAccessSpaceship);
};
template <>
...
using LegacyRandomAccessSpaceshipTraits =
    cuda::std::iterator_traits<LegacyRandomAccessSpaceship>;
static_assert(
    cuda::std::same_as<LegacyRandomAccessSpaceshipTraits::iterator_category,
                       cuda::std::random_access_iterator_tag>);
static_assert(cuda::std::same_as<LegacyRandomAccessSpaceshipTraits::value_type,
                                 LegacyRandomAccessSpaceship::not_value_type>);
static_assert(cuda::std::same_as<
              LegacyRandomAccessSpaceshipTraits::difference_type, short>);
static_assert(cuda::std::same_as<LegacyRandomAccessSpaceshipTraits::reference,
                                 LegacyRandomAccessSpaceship::not_value_type&>);
static_assert(
    cuda::std::same_as<LegacyRandomAccessSpaceshipTraits::pointer, void>);
...
static_assert(cuda::std::same_as<BareLegacyOutputTraits::iterator_category,
                                 cuda::std::output_iterator_tag>);
static_assert(cuda::std::same_as<BareLegacyOutputTraits::value_type, void>);
static_assert(
    cuda::std::same_as<BareLegacyOutputTraits::difference_type, void>);
...
struct LegacyOutputWithMinus {
  ...
  __host__ __device__ friend short operator-(LegacyOutputWithMinus,
                                             LegacyOutputWithMinus);
  // Lacking operator==, this is a LegacyIterator but not a LegacyInputIterator.
};
using LegacyOutputWithMinusTraits =
    cuda::std::iterator_traits<LegacyOutputWithMinus>;
static_assert(cuda::std::same_as<LegacyOutputWithMinusTraits::iterator_category,
                                 cuda::std::output_iterator_tag>);
static_assert(
    cuda::std::same_as<LegacyOutputWithMinusTraits::value_type, void>);
static_assert(
    cuda::std::same_as<LegacyOutputWithMinusTraits::difference_type, short>);
...
struct LegacyOutputWithMemberTypes {
  ...
  __host__ __device__ friend bool operator==(LegacyOutputWithMemberTypes,
  ...
  __host__ __device__ friend short
  operator-(LegacyOutputWithMemberTypes,
...
using LegacyOutputWithMemberTypesTraits =
    cuda::std::iterator_traits<LegacyOutputWithMemberTypes>;
static_assert(
    cuda::std::same_as<LegacyOutputWithMemberTypesTraits::iterator_category,
                       cuda::std::output_iterator_tag>);
static_assert(
    cuda::std::same_as<LegacyOutputWithMemberTypesTraits::value_type, void>);
static_assert(cuda::std::same_as<
              LegacyOutputWithMemberTypesTraits::difference_type, long>);
static_assert(
    cuda::std::same_as<LegacyOutputWithMemberTypesTraits::reference, void>);
static_assert(
    cuda::std::same_as<LegacyOutputWithMemberTypesTraits::pointer, void>);
...
struct LegacyRandomAccessSpecialized {
...
#ifndef TEST_HAS_NO_SPACESHIP_OPERATOR
  auto operator<= >
      (const LegacyRandomAccessSpecialized&) const = default; // nvbug3908399
#else
  __host__ __device__ friend bool
  operator==(const LegacyRandomAccessSpecialized&,
             const LegacyRandomAccessSpecialized&) noexcept {
    return true;
  }
  __host__ __device__ friend bool
  operator!=(const LegacyRandomAccessSpecialized&,
  ...
  __host__ __device__ LegacyRandomAccessSpecialized& operator-=(long);
  __host__ __device__ friend long operator-(LegacyRandomAccessSpecialized,
                                            LegacyRandomAccessSpecialized);
  __host__ __device__ friend LegacyRandomAccessSpecialized
  operator-(LegacyRandomAccessSpecialized, int);
  __host__ __device__ friend LegacyRandomAccessSpecialized
  operator+(LegacyRandomAccessSpecialized, int);
  __host__ __device__ friend LegacyRandomAccessSpecialized
  operator+(int, LegacyRandomAccessSpecialized);
};
template <>
...
using LegacyRandomAccessSpecializedTraits =
    cuda::std::iterator_traits<LegacyRandomAccessSpecialized>;
static_assert(
    cuda::std::same_as<LegacyRandomAccessSpecializedTraits::iterator_category,
                       cuda::std::output_iterator_tag>);
static_assert(
    cuda::std::same_as<LegacyRandomAccessSpecializedTraits::value_type, short>);
static_assert(cuda::std::same_as<
              LegacyRandomAccessSpecializedTraits::difference_type, short>);
static_assert(
    cuda::std::same_as<LegacyRandomAccessSpecializedTraits::reference, short&>);
static_assert(
    cuda::std::same_as<LegacyRandomAccessSpecializedTraits::pointer, short*>);
static_assert(!has_iterator_concept_v<LegacyRandomAccessSpecializedTraits>);

// Other test iterators.

using InputTestIteratorTraits =
    cuda::std::iterator_traits<cpp17_input_iterator<int*> >;
static_assert(cuda::std::same_as<InputTestIteratorTraits::iterator_category,
                                 cuda::std::input_iterator_tag>);
static_assert(cuda::std::same_as<InputTestIteratorTraits::value_type, int>);
static_assert(cuda::std::same_as<InputTestIteratorTraits::difference_type,
                                 cuda::std::ptrdiff_t>);
...
using OutputTestIteratorTraits =
    cuda::std::iterator_traits<cpp17_output_iterator<int*> >;
static_assert(cuda::std::same_as<OutputTestIteratorTraits::iterator_category,
                                 cuda::std::output_iterator_tag>);
static_assert(cuda::std::same_as<OutputTestIteratorTraits::value_type, void>);
static_assert(cuda::std::same_as<OutputTestIteratorTraits::difference_type,
                                 cuda::std::ptrdiff_t>);
...
using ForwardTestIteratorTraits =
    cuda::std::iterator_traits<forward_iterator<int*> >;
static_assert(cuda::std::same_as<ForwardTestIteratorTraits::iterator_category,
                                 cuda::std::forward_iterator_tag>);
static_assert(cuda::std::same_as<ForwardTestIteratorTraits::value_type, int>);
static_assert(cuda::std::same_as<ForwardTestIteratorTraits::difference_type,
                                 cuda::std::ptrdiff_t>);
...
using BidirectionalTestIteratorTraits =
    cuda::std::iterator_traits<bidirectional_iterator<int*> >;
static_assert(
    cuda::std::same_as<BidirectionalTestIteratorTraits::iterator_category,
                       cuda::std::bidirectional_iterator_tag>);
static_assert(
    cuda::std::same_as<BidirectionalTestIteratorTraits::value_type, int>);
static_assert(
    cuda::std::same_as<BidirectionalTestIteratorTraits::difference_type,
                       cuda::std::ptrdiff_t>);
static_assert(
    cuda::std::same_as<BidirectionalTestIteratorTraits::reference, int&>);
static_assert(
    cuda::std::same_as<BidirectionalTestIteratorTraits::pointer, int*>);
static_assert(!has_iterator_concept_v<BidirectionalTestIteratorTraits>);

using RandomAccessTestIteratorTraits =
    cuda::std::iterator_traits<random_access_iterator<int*> >;
static_assert(
    cuda::std::same_as<RandomAccessTestIteratorTraits::iterator_category,
                       cuda::std::random_access_iterator_tag>);
static_assert(
    cuda::std::same_as<RandomAccessTestIteratorTraits::value_type, int>);
static_assert(
    cuda::std::same_as<RandomAccessTestIteratorTraits::difference_type,
                       cuda::std::ptrdiff_t>);
static_assert(
    cuda::std::same_as<RandomAccessTestIteratorTraits::reference, int&>);
static_assert(
    cuda::std::same_as<RandomAccessTestIteratorTraits::pointer, int*>);
static_assert(!has_iterator_concept_v<RandomAccessTestIteratorTraits>);

using ContiguousTestIteratorTraits =
    cuda::std::iterator_traits<contiguous_iterator<int*> >;
static_assert(
    cuda::std::same_as<ContiguousTestIteratorTraits::iterator_category,
                       cuda::std::contiguous_iterator_tag>);
static_assert(
    cuda::std::same_as<ContiguousTestIteratorTraits::value_type, int>);
static_assert(cuda::std::same_as<ContiguousTestIteratorTraits::difference_type,
                                 cuda::std::ptrdiff_t>);
static_assert(
    cuda::std::same_as<ContiguousTestIteratorTraits::reference, int&>);
...
using Cpp17BasicIteratorTraits =
    cuda::std::iterator_traits<iterator_traits_cpp17_iterator>;
static_assert(cuda::std::same_as<Cpp17BasicIteratorTraits::iterator_category,
                                 cuda::std::output_iterator_tag>);
static_assert(cuda::std::same_as<Cpp17BasicIteratorTraits::value_type, void>);
static_assert(
    cuda::std::same_as<Cpp17BasicIteratorTraits::difference_type, void>);
...
using Cpp17InputIteratorTraits =
    cuda::std::iterator_traits<iterator_traits_cpp17_input_iterator>;
static_assert(cuda::std::same_as<Cpp17InputIteratorTraits::iterator_category,
                                 cuda::std::input_iterator_tag>);
static_assert(cuda::std::same_as<Cpp17InputIteratorTraits::value_type, long>);
static_assert(
    cuda::std::same_as<Cpp17InputIteratorTraits::difference_type, int>);
...
using Cpp17ForwardIteratorTraits =
    cuda::std::iterator_traits<iterator_traits_cpp17_forward_iterator>;
static_assert(cuda::std::same_as<Cpp17ForwardIteratorTraits::iterator_category,
                                 cuda::std::forward_iterator_tag>);
static_assert(cuda::std::same_as<Cpp17ForwardIteratorTraits::value_type, int>);
static_assert(
    cuda::std::same_as<Cpp17ForwardIteratorTraits::difference_type, int>);
