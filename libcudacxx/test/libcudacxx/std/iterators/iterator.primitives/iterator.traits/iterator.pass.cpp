...
int main(int, char**) {
  {
    ...
    static_assert((cuda::std::is_same<It::iterator_category,
  ...
  { // std::vector
    ...
    static_assert(
        (cuda::std::is_same<It::difference_type, std::ptrdiff_t>::value), "");
    ...
    static_assert(cuda::std::__is_cpp17_random_access_iterator<
