...
public:
  ...
  __host__ __device__ constexpr explicit distance_apriori_sentinel(
      cuda::std::ptrdiff_t const count)
      : count_(count) {}
  ...
  operator==(distance_apriori_sentinel const, It const&) {
  ...
  template <class It, cuda::std::enable_if_t<
                          cuda::std::input_or_output_iterator<It>, int> = 0>
  __host__ __device__ friend constexpr bool
  operator==(It const&, distance_apriori_sentinel const) {
    assert(false && "difference op should take precedence");
    return false;
  }
  ...
  operator-(It const&, distance_apriori_sentinel const y) {
    return -y.count_;
  }
  ...
  template <class It, cuda::std::enable_if_t<
                          cuda::std::input_or_output_iterator<It>, int> = 0>
  __host__ __device__ friend constexpr cuda::std::ptrdiff_t
  operator-(distance_apriori_sentinel const x, It const&) {
    return x.count_;
  }
...
public:
  ...
  __host__ __device__ friend constexpr bool
  operator==(const assignable_sentinel& s, const It& other) {
    return s.base_ == base(other);
  }
#if TEST_STD_VER < 2020
  __host__ __device__ friend constexpr bool
  operator==(const It& other, const assignable_sentinel& s) {
    return s.base_ == base(other);
  }
  __host__ __device__ friend constexpr bool
  operator!=(const assignable_sentinel& s, const It& other) {
