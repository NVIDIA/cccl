...
__host__ __device__ constexpr void test_unsized() {
  static_assert(cuda::std::sentinel_for<Sent, It> &&
                !cuda::std::sized_sentinel_for<Sent, It>);
  int a[3] = {1, 2, 3};
  {
    It first = It(a);
    auto last = Sent(It(a));
    ...
    ASSERT_SAME_TYPE(decltype(cuda::std::ranges::distance(It(a), Sent(It(a)))),
                     cuda::std::iter_difference_t<It>);
  }
  {
    It first = It(a);
    ...
    assert(cuda::std::ranges::distance(static_cast<It&>(first),
                                       static_cast<Sent&>(last)) == 3);
    assert(cuda::std::ranges::distance(static_cast<It&>(first),
                                       static_cast<Sent&&>(last)) == 3);
    assert(cuda::std::ranges::distance(static_cast<It&>(first),
                                       static_cast<const Sent&>(last)) == 3);
    assert(cuda::std::ranges::distance(static_cast<It&>(first),
                                       static_cast<const Sent&&>(last)) == 3);
    assert(cuda::std::ranges::distance(static_cast<It&&>(first),
                                       static_cast<Sent&>(last)) == 3);
    ...
    assert(cuda::std::ranges::distance(static_cast<It&&>(first),
                                       static_cast<const Sent&&>(last)) == 3);
    assert(cuda::std::ranges::distance(static_cast<const It&>(first),
                                       static_cast<Sent&>(last)) == 3);
    assert(cuda::std::ranges::distance(static_cast<const It&>(first),
                                       static_cast<Sent&&>(last)) == 3);
    assert(cuda::std::ranges::distance(static_cast<const It&>(first),
...
static_assert(
    cuda::std::sized_sentinel_for<SizedStrideCounter, SizedStrideCounter>);
...
__host__ __device__ constexpr bool test() {
  ...
  test_unsized<cpp17_input_iterator<int*>,
               sentinel_wrapper<cpp17_input_iterator<int*> > >();
  test_unsized<cpp17_output_iterator<int*>,
               sentinel_wrapper<cpp17_output_iterator<int*> > >();
  test_unsized<forward_iterator<int*>,
               sentinel_wrapper<forward_iterator<int*> > >();
  test_unsized<bidirectional_iterator<int*>,
               sentinel_wrapper<bidirectional_iterator<int*> > >();
  test_unsized<random_access_iterator<int*>,
               sentinel_wrapper<random_access_iterator<int*> > >();
  test_unsized<contiguous_iterator<int*>,
  ...
  test_sized<cpp17_input_iterator<int*>,
             sized_sentinel<cpp17_input_iterator<int*> > >();
  test_sized<cpp20_input_iterator<int*>,
             sized_sentinel<cpp20_input_iterator<int*> > >();
  test_sized<cpp17_output_iterator<int*>,
             sized_sentinel<cpp17_output_iterator<int*> > >();
  test_sized<forward_iterator<int*>,
             sized_sentinel<forward_iterator<int*> > >();
  test_sized<bidirectional_iterator<int*>,
             sized_sentinel<bidirectional_iterator<int*> > >();
  test_sized<random_access_iterator<int*>,
             sized_sentinel<random_access_iterator<int*> > >();
  test_sized<contiguous_iterator<int*>,
             sized_sentinel<contiguous_iterator<int*> > >();
  ...
  {
    using It = cpp20_input_iterator<
        int*>; // non-copyable, thus not a sentinel for itself
    static_assert(!cuda::std::is_copy_constructible_v<It>);
    static_assert(!cuda::std::sentinel_for<It, It>);
    static_assert(
        !cuda::std::is_invocable_v<decltype(cuda::std::ranges::distance), It&,
                                   It&>);
    static_assert(
        !cuda::std::is_invocable_v<decltype(cuda::std::ranges::distance), It&,
                                   It&&>);
  ...
  static_assert(
      !cuda::std::is_invocable_v<decltype(cuda::std::ranges::distance), int,
                                 int>);
  static_assert(
      !cuda::std::is_invocable_v<decltype(cuda::std::ranges::distance), int*,
                                 int>);
