...
using ForwardSubrange =
    cuda::std::ranges::subrange<ForwardIter, ForwardIter,
                                cuda::std::ranges::subrange_kind::unsized>;
using SizedIntPtrSubrange =
...
struct MoveOnlyForwardIter {
  ...
  __host__ __device__ friend constexpr bool operator==(const self& lhs,
                                                       int* rhs) {
    return lhs.base == rhs;
  }
#if TEST_STD_VER < 2020 || defined(TEST_COMPILER_CLANG) ||                     \
    defined(TEST_COMPILER_NVRTC) || defined(TEST_COMPILER_MSVC)
  __host__ __device__ friend constexpr bool operator==(int* rhs,
                                                       const self& lhs) {
    return lhs.base == rhs;
  }
  __host__ __device__ friend constexpr bool operator!=(const self& lhs,
...
struct SizedSentinelForwardIter {
  ...
  __host__ __device__ constexpr explicit SizedSentinelForwardIter(
      int* ptr, bool* minusWasCalled)
  ...
  __host__ __device__ friend constexpr difference_type operator-(
      SizedSentinelForwardIter const& a, SizedSentinelForwardIter const& b) {
...
static_assert(cuda::std::sized_sentinel_for<SizedSentinelForwardIter,
...
struct ConvertibleForwardIter {
  ...
  operator-(int*, self const&) = delete;
  __host__ __device__ friend constexpr difference_type operator-(self const&,
                                                                 int*) = delete;
};
using ConvertibleForwardSubrange =
    cuda::std::ranges::subrange<ConvertibleForwardIter, int*,
                                cuda::std::ranges::subrange_kind::unsized>;
...
#else
  __host__ __device__ friend bool operator==(const self&,
                                             const self&) = default;
#endif
  __host__ __device__ reference operator*() const;
  __host__ __device__ pointer operator->() const;
...
using SizedSentinelForwardSubrange =
    cuda::std::ranges::subrange<ConditionallyConvertibleIter,
...
using ConvertibleSizedSentinelForwardSubrange =
    cuda::std::ranges::subrange<ConvertibleSizedSentinelForwardIter, int*,
                                cuda::std::ranges::subrange_kind::sized>;
...
_LIBCUDACXX_INLINE_VAR constexpr bool
    enable_borrowed_range<ForwardBorrowedRange> = true;
}
} // namespace std
} // namespace cuda
...
template <>
_LIBCUDACXX_INLINE_VAR constexpr bool
    enable_borrowed_range<ConvertibleForwardBorrowedRange> = true;
}
} // namespace std
} // namespace cuda
...
template <>
_LIBCUDACXX_INLINE_VAR constexpr bool
    enable_borrowed_range<ForwardBorrowedRangeDifferentSentinel> = true;
}
} // namespace std
} // namespace cuda

using DifferentSentinelSubrange =
    cuda::std::ranges::subrange<ForwardIter,
...
template <>
_LIBCUDACXX_INLINE_VAR constexpr bool
    enable_borrowed_range<DifferentSentinelWithSizeMember> = true;
}
} // namespace std
} // namespace cuda

using DifferentSentinelWithSizeMemberSubrange =
    cuda::std::ranges::subrange<ForwardIter,
