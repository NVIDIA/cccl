...
static_assert(cuda::std::is_constructible_v<
              SizedSentinelForwardSubrange, ConditionallyConvertibleIter,
              ConditionallyConvertibleIter,
              ConditionallyConvertibleIter::udifference_type>); // Default case.
static_assert(!cuda::std::is_constructible_v<
              SizedSentinelForwardSubrange, Empty, ConditionallyConvertibleIter,
              ConditionallyConvertibleIter::udifference_type>); // 1.
static_assert(cuda::std::is_constructible_v<
              ConvertibleSizedSentinelForwardSubrange,
              ConvertibleSizedSentinelForwardIter, int*,
              ConvertibleSizedSentinelForwardIter::udifference_type>); // 2.
static_assert(cuda::std::is_constructible_v<
              SizedSentinelForwardSubrange, ConditionallyConvertibleIter,
              ConditionallyConvertibleIter,
              ConditionallyConvertibleIter::
                  udifference_type>); // 3. (Same as default case.)
static_assert(!cuda::std::is_constructible_v<SizedIntPtrSubrange, long*, int*,
                                             size_t>); // 4.
static_assert(cuda::std::is_constructible_v<SizedIntPtrSubrange, int*, int*,
                                            size_t>); // 5.

__host__ __device__ constexpr bool test() {
  SizedSentinelForwardSubrange a(ConditionallyConvertibleIter(globalBuff),
                                 ConditionallyConvertibleIter(globalBuff + 8),
                                 8);
  ...
  ConvertibleSizedSentinelForwardSubrange b(
      ConvertibleSizedSentinelForwardIter(globalBuff),
      ConvertibleSizedSentinelForwardIter(globalBuff + 8), 8);
