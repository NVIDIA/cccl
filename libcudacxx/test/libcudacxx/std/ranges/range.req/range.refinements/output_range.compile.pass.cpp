...
static_assert(
    cuda::std::output_iterator<cuda::std::ranges::iterator_t<GoodRange>, T>);
...
static_assert(
    cuda::std::output_iterator<cuda::std::ranges::iterator_t<NotRange>, T>);
...
static_assert(!cuda::std::output_iterator<
              cuda::std::ranges::iterator_t<RangeWithBadIterator>, T>);
...
static_assert(
    !cuda::std::ranges::output_range<Holder<Incomplete>*, Holder<Incomplete>*>);
static_assert(!cuda::std::ranges::output_range<Holder<Incomplete>*&,
                                               Holder<Incomplete>*>);
static_assert(!cuda::std::ranges::output_range<Holder<Incomplete>*&&,
                                               Holder<Incomplete>*>);
static_assert(!cuda::std::ranges::output_range<Holder<Incomplete>* const,
                                               Holder<Incomplete>*>);
static_assert(!cuda::std::ranges::output_range<Holder<Incomplete>* const&,
                                               Holder<Incomplete>*>);
static_assert(!cuda::std::ranges::output_range<Holder<Incomplete>* const&&,
...
static_assert(cuda::std::ranges::output_range<Holder<Incomplete>* [10],
                                              Holder<Incomplete>*>);
static_assert(cuda::std::ranges::output_range<Holder<Incomplete>* (&)[10],
                                              Holder<Incomplete>*>);
static_assert(cuda::std::ranges::output_range<Holder<Incomplete>* (&&)[10],
                                              Holder<Incomplete>*>);
static_assert(!cuda::std::ranges::output_range<Holder<Incomplete>* const[10],
                                               Holder<Incomplete>*>);
static_assert(!cuda::std::ranges::output_range<
              Holder<Incomplete>* const (&)[10], Holder<Incomplete>*>);
static_assert(!cuda::std::ranges::output_range<
              Holder<Incomplete>* const (&&)[10], Holder<Incomplete>*>);
#endif
