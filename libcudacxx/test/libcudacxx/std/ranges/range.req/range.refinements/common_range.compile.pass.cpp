...
static_assert(
    !cuda::std::ranges::common_range<
        Common<cpp17_input_iterator<int*> > >); // not a sentinel for itself
static_assert(
    !cuda::std::ranges::common_range<
        Common<cpp20_input_iterator<int*> > >); // not a sentinel for itself
static_assert(
    cuda::std::ranges::common_range<Common<forward_iterator<int*> > >);
static_assert(
    cuda::std::ranges::common_range<Common<bidirectional_iterator<int*> > >);
static_assert(
    cuda::std::ranges::common_range<Common<random_access_iterator<int*> > >);
static_assert(
    cuda::std::ranges::common_range<Common<contiguous_iterator<int*> > >);
static_assert(cuda::std::ranges::common_range<Common<int*> >);

static_assert(
    !cuda::std::ranges::common_range<NonCommon<cpp17_input_iterator<int*> > >);
static_assert(
    !cuda::std::ranges::common_range<NonCommon<cpp20_input_iterator<int*> > >);
static_assert(
    !cuda::std::ranges::common_range<NonCommon<forward_iterator<int*> > >);
static_assert(!cuda::std::ranges::common_range<
              NonCommon<bidirectional_iterator<int*> > >);
static_assert(!cuda::std::ranges::common_range<
              NonCommon<random_access_iterator<int*> > >);
static_assert(
    !cuda::std::ranges::common_range<NonCommon<contiguous_iterator<int*> > >);
...
static_assert(
    !cuda::std::ranges::common_range<Range<int*, sized_sentinel<int*> > >);

// Make sure cv-qualification doesn't impact the concept when begin() and end() have matching qualifiers.
static_assert(
    cuda::std::ranges::common_range<Common<forward_iterator<int*> > const>);
static_assert(
    !cuda::std::ranges::common_range<NonCommon<forward_iterator<int*> > const>);
...
static_assert(
    cuda::std::ranges::common_range<Holder<Incomplete>* const (&)[10]>);
static_assert(
    cuda::std::ranges::common_range<Holder<Incomplete>* const (&&)[10]>);
#endif
