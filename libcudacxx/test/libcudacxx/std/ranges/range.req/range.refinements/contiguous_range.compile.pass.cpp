...
__host__ __device__ constexpr bool check_range() {
  ...
  static_assert(ranges::contiguous_range<test_non_const_common_range<I> > ==
                result);
  ...
  static_assert(
      !ranges::contiguous_range<test_non_const_common_range<I> const>);
...
static_assert(
    cuda::std::ranges::random_access_range<const ContiguousWhenNonConst>);
static_assert(
    !cuda::std::ranges::contiguous_range<const ContiguousWhenNonConst>);
...
static_assert(
    cuda::std::ranges::random_access_range<DataFunctionWrongReturnType>);
static_assert(
    !cuda::std::ranges::contiguous_range<DataFunctionWrongReturnType>);
...
static_assert(!cuda::std::ranges::contiguous_range<Holder<Incomplete>* const&>);
static_assert(
    !cuda::std::ranges::contiguous_range<Holder<Incomplete>* const&&>);

static_assert(cuda::std::ranges::contiguous_range<Holder<Incomplete>* [10]>);
static_assert(cuda::std::ranges::contiguous_range<Holder<Incomplete>* (&)[10]>);
static_assert(
    cuda::std::ranges::contiguous_range<Holder<Incomplete>* (&&)[10]>);
static_assert(
    cuda::std::ranges::contiguous_range<Holder<Incomplete>* const[10]>);
static_assert(
    cuda::std::ranges::contiguous_range<Holder<Incomplete>* const (&)[10]>);
static_assert(
    cuda::std::ranges::contiguous_range<Holder<Incomplete>* const (&&)[10]>);
