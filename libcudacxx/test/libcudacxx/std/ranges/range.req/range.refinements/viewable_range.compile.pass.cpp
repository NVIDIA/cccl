...
static_assert(!cuda::std::constructible_from<
              cuda::std::remove_cvref_t<T4 const&>, T4 const&>);
...
static_assert(cuda::std::constructible_from<cuda::std::initializer_list<int>,
                                            cuda::std::initializer_list<int> >);
static_assert(cuda::std::movable<cuda::std::initializer_list<int> >);

static_assert(
    !cuda::std::ranges::viewable_range<cuda::std::initializer_list<int> >);
static_assert(
    cuda::std::ranges::viewable_range<cuda::std::initializer_list<int>&>);
static_assert(
    !cuda::std::ranges::viewable_range<cuda::std::initializer_list<int>&&>);
static_assert(
    !cuda::std::ranges::viewable_range<cuda::std::initializer_list<int> const>);
static_assert(
    cuda::std::ranges::viewable_range<cuda::std::initializer_list<int> const&>);
static_assert(!cuda::std::ranges::viewable_range<
              cuda::std::initializer_list<int> const&&>);
...
static_assert(
    !cuda::std::constructible_from<cuda::std::remove_cvref_t<T7&>, T7&>);
...
static_assert(!cuda::std::ranges::viewable_range<Holder<Incomplete>* (&&)[10]>);
static_assert(
    !cuda::std::ranges::viewable_range<Holder<Incomplete>* const[10]>);
static_assert(
    cuda::std::ranges::viewable_range<Holder<Incomplete>* const (&)[10]>);
static_assert(
    !cuda::std::ranges::viewable_range<Holder<Incomplete>* const (&&)[10]>);
