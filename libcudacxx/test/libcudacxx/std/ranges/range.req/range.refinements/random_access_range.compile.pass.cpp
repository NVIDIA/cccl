...
__host__ __device__ constexpr bool check_range() {
  ...
  static_assert(ranges::random_access_range<test_non_const_common_range<I> > ==
                result);
  static_assert(ranges::random_access_range<test_non_const_range<I> > ==
                result);
  static_assert(ranges::random_access_range<test_common_range<I> > == result);
  static_assert(ranges::random_access_range<test_common_range<I> const> ==
                result);
  static_assert(
      !ranges::random_access_range<test_non_const_common_range<I> const>);
...
static_assert(!cuda::std::ranges::random_access_range<Holder<Incomplete>*&&>);
static_assert(
    !cuda::std::ranges::random_access_range<Holder<Incomplete>* const>);
static_assert(
    !cuda::std::ranges::random_access_range<Holder<Incomplete>* const&>);
static_assert(
    !cuda::std::ranges::random_access_range<Holder<Incomplete>* const&&>);
...
static_assert(
    cuda::std::ranges::random_access_range<Holder<Incomplete>* (&)[10]>);
static_assert(
    cuda::std::ranges::random_access_range<Holder<Incomplete>* (&&)[10]>);
static_assert(
    cuda::std::ranges::random_access_range<Holder<Incomplete>* const[10]>);
static_assert(
    cuda::std::ranges::random_access_range<Holder<Incomplete>* const (&)[10]>);
static_assert(
    cuda::std::ranges::random_access_range<Holder<Incomplete>* const (&&)[10]>);
