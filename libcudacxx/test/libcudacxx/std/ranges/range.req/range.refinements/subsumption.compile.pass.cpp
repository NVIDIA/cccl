...
requires true __host__ __device__ constexpr bool
check_input_range_subsumption() {
  return true;
}
...
requires true __host__ __device__ constexpr bool
check_forward_range_subsumption() {
  return true;
}
...
requires true __host__ __device__ constexpr bool
check_bidirectional_range_subsumption() {
  return true;
}
...
requires true __host__ __device__ constexpr bool
check_random_access_range_subsumption() {
  return true;
}
...
requires true __host__ __device__ constexpr bool
check_contiguous_range_subsumption() {
  return true;
}
