...
template <class T>
concept has_range_size_t = requires {
  typename cuda::std::ranges::range_size_t<T>;
};
#else
...
template <class T>
constexpr bool has_range_size_t<
    T, cuda::std::void_t<cuda::std::ranges::range_size_t<T> > > = true;
#endif
...
static_assert(
    cuda::std::same_as<cuda::std::ranges::range_size_t<B>, cuda::std::size_t>);
static_assert(
    cuda::std::same_as<cuda::std::ranges::range_size_t<B&>, cuda::std::size_t>);
static_assert(cuda::std::same_as<cuda::std::ranges::range_size_t<B&&>,
                                 cuda::std::size_t>);
