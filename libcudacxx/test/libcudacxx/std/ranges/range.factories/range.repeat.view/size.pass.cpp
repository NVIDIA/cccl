...
_LIBCUDACXX_INLINE_VAR constexpr bool has_size = false;

template <class T>
_LIBCUDACXX_INLINE_VAR constexpr bool has_size<T, cuda::std::void_t<decltype(cuda::std::declval<T>().size())>> = true;
