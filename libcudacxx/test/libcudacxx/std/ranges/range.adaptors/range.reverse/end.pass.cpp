...
__host__ __device__ constexpr bool test()
{
  ...
  // Common bidirectional range.
  {
    ...
    static_assert(cuda::std::is_same_v<decltype(rev.end()), cuda::std::reverse_iterator<bidirectional_iterator<int*>>>);
    static_assert(cuda::std::is_same_v<decltype(cuda::std::move(rev).end()),
  ...
  // Const common bidirectional range.
  {
    ...
    static_assert(
      cuda::std::is_same_v<decltype(rev.end()), cuda::std::reverse_iterator<bidirectional_iterator<const int*>>>);
    static_assert(cuda::std::is_same_v<decltype(cuda::std::move(rev).end()),
