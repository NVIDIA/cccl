...
_CCCL_CONCEPT implicitly_constructible_from = cuda::std::invocable<decltype(&conversion_test<T>), Args...>;
...
TEST_FUNC constexpr void constructorTest(Input1&& buffer1, Input2&& buffer2)
{
