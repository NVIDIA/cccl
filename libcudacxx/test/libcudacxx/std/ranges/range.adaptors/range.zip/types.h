...
static_assert(cuda::std::ranges::random_access_range<NonSizedRandomAccessView>);
...
static_assert(cuda::std::ranges::input_range<NonSimpleInputNonCommonView>);
static_assert(!cuda::std::ranges::forward_range<NonSimpleInputNonCommonView>);
static_assert(!cuda::std::ranges::common_range<NonSimpleInputNonCommonView>);
