...
TEST_FUNC void testConceptPair()
{
  int buffer1[2] = {1, 2};
  int buffer2[3] = {1, 2, 3};
  {
...
TEST_FUNC void testConceptTuple()
{
  int buffer1[2] = {1, 2};
  int buffer2[3] = {1, 2, 3};
...
{
  TEST_FUNC OutputIter begin() const;
  TEST_FUNC sentinel_wrapper<OutputIter> end() const;
};
...
#else
template <class... Ts>
inline constexpr bool zippable = cuda::std::invocable<decltype(cuda::std::ranges::views::zip), Ts...>;
