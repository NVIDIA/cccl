...
struct MoveOnlyView : cuda::std::ranges::view_base
{
  int* begin_;
  int* end_;
  TEST_FUNC constexpr explicit MoveOnlyView(int* b, int* e)
      : begin_(b)
      , end_(e)
  {}
...
struct CopyableView : cuda::std::ranges::view_base
{
  int* begin_;
  int* end_;
  TEST_FUNC constexpr explicit CopyableView(int* b, int* e)
      : begin_(b)
      , end_(e)
  {}
  TEST_FUNC constexpr int* begin() const
...
struct SizedForwardView : cuda::std::ranges::view_base
{
  int* begin_;
  int* end_;
  TEST_FUNC constexpr explicit SizedForwardView(int* b, int* e)
      : begin_(b)
      , end_(e)
  {}
...
struct SizedRandomAccessView : cuda::std::ranges::view_base
{
  int* begin_;
  int* end_;
  TEST_FUNC constexpr explicit SizedRandomAccessView(int* b, int* e)
      : begin_(b)
      , end_(e)
  {}
  TEST_FUNC constexpr auto begin() const
...
struct CommonView : cuda::std::ranges::view_base
{
  int* begin_;
  int* end_;
  TEST_FUNC constexpr explicit CommonView(int* b, int* e)
      : begin_(b)
      , end_(e)
  {}
  TEST_FUNC constexpr int* begin() const
...
struct NonCommonView : cuda::std::ranges::view_base
{
  int* begin_;
  int* end_;
  TEST_FUNC constexpr explicit NonCommonView(int* b, int* e)
      : begin_(b)
      , end_(e)
  {}
  TEST_FUNC constexpr int* begin() const
