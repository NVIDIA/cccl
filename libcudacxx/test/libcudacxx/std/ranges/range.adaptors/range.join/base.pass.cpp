...
__host__ __device__ constexpr bool test()
{
...

  {
    ...
    static_assert(cuda::std::is_same_v<decltype(cuda::std::move(jv).base()), ParentView<ChildView>>);
  }

  {
    ...
    static_assert(hasLValueQualifiedBase(jv));
    static_assert(cuda::std::is_same_v<decltype(jv.base()), cuda::std::ranges::ref_view<int[4][4]>>);
  }
