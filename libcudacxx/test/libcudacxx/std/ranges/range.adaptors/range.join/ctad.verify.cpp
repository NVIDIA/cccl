...
struct Range
{
  TEST_FUNC friend T* begin(Range&)
  {
    return nullptr;
  }
  TEST_FUNC friend T* begin(Range const&)
  {
    return nullptr;
  }
  TEST_FUNC friend sentinel_wrapper<T*> end(Range&)
  {
    return sentinel_wrapper<T*>(nullptr);
  }
  TEST_FUNC friend sentinel_wrapper<T*> end(Range const&)
  {
    return sentinel_wrapper<T*>(nullptr);
  }
};

TEST_FUNC void testExplicitCTAD()
{
  Range<Range<int>> r;
