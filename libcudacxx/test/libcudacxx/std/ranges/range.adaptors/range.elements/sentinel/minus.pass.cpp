...
struct SizedSent
{
  ...
  TEST_FUNC friend constexpr bool operator==(const SizedSent& s, const Iter<Const>& i)
  {
    return i.it_ == s.end_;
  }
#if TEST_STD_VER <= 2017
  TEST_FUNC friend constexpr bool operator==(const Iter<Const>& i, const SizedSent& s)
  {
    return i.it_ == s.end_;
  }
  TEST_FUNC friend constexpr bool operator!=(const SizedSent& s, const Iter<Const>& i)
...
#endif // TEST_STD_VER <= 2017
  TEST_FUNC friend constexpr intptr_t operator-(const SizedSent& st, const Iter<Const>& it)
  {
    return st.end_ - it.it_;
  }
  TEST_FUNC friend constexpr intptr_t operator-(const Iter<Const>& it, const SizedSent& st)
  {
...
struct CrossSizedSent
{
  ...
  template <bool C>
  TEST_FUNC friend constexpr bool operator==(const CrossSizedSent& s, const Iter<C>& i)
  {
    return i.it_ == s.end_;
  }
#if TEST_STD_VER <= 2017
  template <bool C>
  TEST_FUNC friend constexpr bool operator==(const Iter<C>& i, const CrossSizedSent& s)
  {
    return i.it_ == s.end_;
  }
  template <bool C>
...
#endif // TEST_STD_VER <= 2017
  template <bool C>
  TEST_FUNC friend constexpr intptr_t operator-(const CrossSizedSent& st, const Iter<C>& it)
  {
    return st.end_ - it.it_;
  }
  template <bool C>
  TEST_FUNC friend constexpr intptr_t operator-(const Iter<C>& it, const CrossSizedSent& st)
  {
    return it.it_ - st.end_;
  }
};
...
TEST_FUNC constexpr void testConstraints()
{
  // base is not sized
  {
