...
struct ConstSent
{
  ...
  TEST_FUNC constexpr ConstSent(const Sent& s)
      : i(s.i)
  {}
  TEST_FUNC friend constexpr bool operator==(cuda::std::tuple<int>*, const ConstSent&)
  {
    return true;
  }
#if TEST_STD_VER <= 2017
  TEST_FUNC friend constexpr bool operator==(const ConstSent&, cuda::std::tuple<int>*)
  {
    return true;
  }
  TEST_FUNC friend constexpr bool operator!=(cuda::std::tuple<int>*, const ConstSent&)
...
struct NonConvertConstSent
{
  ...
  TEST_FUNC constexpr NonConvertConstSent(int ii)
      : i(ii)
  {}
  TEST_FUNC friend constexpr bool operator==(cuda::std::tuple<int>*, const NonConvertConstSent&)
  {
    return true;
  }
#if TEST_STD_VER <= 2017
  TEST_FUNC friend constexpr bool operator==(const NonConvertConstSent&, cuda::std::tuple<int>*)
  {
    return true;
  }
  TEST_FUNC friend constexpr bool operator!=(cuda::std::tuple<int>*, const NonConvertConstSent&)
