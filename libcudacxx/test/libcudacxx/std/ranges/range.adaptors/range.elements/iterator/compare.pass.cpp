...
TEST_FUNC constexpr void compareOperatorTest(const Iter1& iter1, const Iter2& iter2)
{
  assert(!(iter1 < iter1));
  assert(iter1 < iter2);
  assert(!(iter2 < iter1));
...
template <class Iter1, class Iter2>
TEST_FUNC constexpr void inequalityOperatorsDoNotExistTest(const Iter1& iter1, const Iter2& iter2)
{
