...
_CCCL_GLOBAL_VARIABLE struct NoThrowMemberEnd
{
...
_CCCL_GLOBAL_VARIABLE struct NoThrowADLEnd
{
  __host__ __device__ ThrowingIterator<int> begin() const;
...
_CCCL_GLOBAL_VARIABLE struct NoThrowMemberEndReturnsRef
{
  __host__ __device__ ThrowingIterator<int> begin() const;
...
_CCCL_GLOBAL_VARIABLE struct EndReturnsArrayRef
{
