...
{
  int x;
  TEST_FUNC const int* rbegin() const;
  TEST_FUNC constexpr const int* rend() const
  {
    return &x;
  }
};
...
struct Different
{
  TEST_FUNC char* rbegin();
  TEST_FUNC sentinel_wrapper<char*>& rend();
  TEST_FUNC short* rbegin() const;
  TEST_FUNC sentinel_wrapper<short*>& rend() const;
};
...
TEST_FUNC constexpr bool testArray()
{
  int a[2] = {};
...
{
  TEST_FUNC int rbegin() const;
  TEST_FUNC int rend() const;
};
static_assert(!cuda::std::is_invocable_v<RangeREndT, REndMemberReturnsInt const&>);

struct REndMemberReturnsVoidPtr
{
  TEST_FUNC const void* rbegin() const;
  TEST_FUNC const void* rend() const;
};
...
{
  TEST_FUNC PtrConvertible rbegin() const;
  TEST_FUNC PtrConvertible rend() const;
};
static_assert(!cuda::std::is_invocable_v<RangeREndT, PtrConvertibleREndMember const&>);

struct NoRBeginMember
{
  TEST_FUNC constexpr const int* rend();
};
...
{
  int x;
  TEST_FUNC constexpr int* rbegin()
  {
    return nullptr;
  }
  TEST_FUNC constexpr int* rend()
  {
    return &x;
  }
};
...
{
  TEST_FUNC constexpr int* rbegin() const
  {
    return nullptr;
  }
  TEST_FUNC constexpr int* rend() const
  {
    return &globalBuff[0];
  }
};
...
{
  int x;
  TEST_FUNC constexpr const int* rbegin() const
  {
    return nullptr;
  }
  TEST_FUNC constexpr const int* rend() const
  ...
  TEST_FUNC friend constexpr int* rend(REndMemberFunction const&);
};
...
{
  TEST_FUNC Empty rbegin() const;
  TEST_FUNC Empty rend() const;
};
...
{
  Empty x;
  TEST_FUNC constexpr const Empty* rbegin() const
  {
    return nullptr;
  }
  TEST_FUNC constexpr const Empty* rend() const
  {
    return &x;
  }
};

TEST_FUNC constexpr bool testREndMember()
{
  REndMember a{};
...
{
  int x;
  TEST_FUNC friend constexpr const int* rbegin(REndFunction const&)
  {
    return nullptr;
  }
  TEST_FUNC friend constexpr const int* rend(REndFunction const& bf)
  {
    return &bf.x;
  }
};
...
{
  TEST_FUNC friend constexpr int rbegin(REndFunctionReturnsInt const&);
  TEST_FUNC friend constexpr int rend(REndFunctionReturnsInt const&);
};
static_assert(!cuda::std::is_invocable_v<RangeREndT, REndFunctionReturnsInt const&>);

struct REndFunctionReturnsVoidPtr
{
  TEST_FUNC friend constexpr void* rbegin(REndFunctionReturnsVoidPtr const&);
  TEST_FUNC friend constexpr void* rend(REndFunctionReturnsVoidPtr const&);
};
static_assert(!cuda::std::is_invocable_v<RangeREndT, REndFunctionReturnsVoidPtr const&>);

struct REndFunctionReturnsEmpty
{
  TEST_FUNC friend constexpr Empty rbegin(REndFunctionReturnsEmpty const&);
  TEST_FUNC friend constexpr Empty rend(REndFunctionReturnsEmpty const&);
};
static_assert(!cuda::std::is_invocable_v<RangeREndT, REndFunctionReturnsEmpty const&>);

struct REndFunctionReturnsPtrConvertible
{
  TEST_FUNC friend constexpr PtrConvertible rbegin(REndFunctionReturnsPtrConvertible const&);
  TEST_FUNC friend constexpr PtrConvertible rend(REndFunctionReturnsPtrConvertible const&);
};
static_assert(!cuda::std::is_invocable_v<RangeREndT, REndFunctionReturnsPtrConvertible const&>);

struct NoRBeginFunction
{
  TEST_FUNC friend constexpr const int* rend(NoRBeginFunction const&);
};
static_assert(!cuda::std::is_invocable_v<RangeREndT, NoRBeginFunction const&>);

struct REndFunctionByValue
{
  TEST_FUNC friend constexpr int* rbegin(REndFunctionByValue)
  {
    return nullptr;
  }
  TEST_FUNC friend constexpr int* rend(REndFunctionByValue)
  {
    return &globalBuff[1];
  }
};
...
{
  TEST_FUNC friend constexpr int* rbegin(REndFunctionEnabledBorrowing)
  {
    return nullptr;
  }
  TEST_FUNC friend constexpr int* rend(REndFunctionEnabledBorrowing)
  {
    return &globalBuff[2];
  }
};
...
{
  Empty x;
  TEST_FUNC friend constexpr const Empty* rbegin(REndFunctionReturnsEmptyPtr const&)
  {
    return nullptr;
  }
  TEST_FUNC friend constexpr const Empty* rend(REndFunctionReturnsEmptyPtr const& bf)
  {
    return &bf.x;
  }
};
...
struct REndFunctionWithDataMember
{
  int x;
  int rend;
  TEST_FUNC friend constexpr const int* rbegin(REndFunctionWithDataMember const&)
  {
    return nullptr;
  }
  TEST_FUNC friend constexpr const int* rend(REndFunctionWithDataMember const& bf)
  {
    return &bf.x;
  }
};
...
{
  int y;
  TEST_FUNC friend constexpr const int* rbegin(REndFunctionWithPrivateEndMember const&)
  {
    return nullptr;
  }
  TEST_FUNC friend constexpr const int* rend(REndFunctionWithPrivateEndMember const& bf)
  {
    return &bf.y;
  }
};
...
struct RBeginMemberEndFunction
{
  ...
  TEST_FUNC friend constexpr const int* rend(RBeginMemberEndFunction const& bf)
  {
    return &bf.x;
  }
};

TEST_FUNC constexpr bool testREndFunction()
{
...
struct MemberBeginEnd
{
  ...
  TEST_FUNC constexpr bidirectional_iterator<const char*> begin() const
  {
    return bidirectional_iterator<const char*>(&cb);
  }
  TEST_FUNC constexpr bidirectional_iterator<const char*> end() const
  {
...
struct FunctionBeginEnd
{
  int b, e;
  char cb, ce;
  TEST_FUNC friend constexpr bidirectional_iterator<int*> begin(FunctionBeginEnd& v)
  {
    return bidirectional_iterator<int*>(&v.b);
  }
  TEST_FUNC friend constexpr bidirectional_iterator<int*> end(FunctionBeginEnd& v)
  {
    return bidirectional_iterator<int*>(&v.e);
  }
  TEST_FUNC friend constexpr bidirectional_iterator<const char*> begin(const FunctionBeginEnd& v)
  {
    return bidirectional_iterator<const char*>(&v.cb);
  }
  TEST_FUNC friend constexpr bidirectional_iterator<const char*> end(const FunctionBeginEnd& v)
  {
...
struct MemberBeginFunctionEnd
{
  ...
  TEST_FUNC friend constexpr bidirectional_iterator<int*> end(MemberBeginFunctionEnd& v)
  {
    return bidirectional_iterator<int*>(&v.e);
  }
  TEST_FUNC constexpr bidirectional_iterator<const char*> begin() const
  ...
  TEST_FUNC friend constexpr bidirectional_iterator<const char*> end(const MemberBeginFunctionEnd& v)
  {
    return bidirectional_iterator<const char*>(&v.ce);
  }
};
...
struct FunctionBeginMemberEnd
{
  int b, e;
  char cb, ce;
  TEST_FUNC friend constexpr bidirectional_iterator<int*> begin(FunctionBeginMemberEnd& v)
  {
    return bidirectional_iterator<int*>(&v.b);
  }
  TEST_FUNC constexpr bidirectional_iterator<int*> end()
  ...
  TEST_FUNC friend constexpr bidirectional_iterator<const char*> begin(const FunctionBeginMemberEnd& v)
  {
    return bidirectional_iterator<const char*>(&v.cb);
  }
  TEST_FUNC constexpr bidirectional_iterator<const char*> end() const
...
struct MemberBeginEndDifferentTypes
{
  ...
  TEST_FUNC bidirectional_iterator<const int*> end();
};
...
{
  TEST_FUNC friend bidirectional_iterator<int*> begin(FunctionBeginEndDifferentTypes&);
  TEST_FUNC friend bidirectional_iterator<const int*> end(FunctionBeginEndDifferentTypes&);
};
...
{
  TEST_FUNC friend forward_iterator<int*> begin(FunctionBeginEndForwardIterators&);
  TEST_FUNC friend forward_iterator<int*> end(FunctionBeginEndForwardIterators&);
};
...
{
  TEST_FUNC bidirectional_iterator<int*> begin() const;
};
...
{
  TEST_FUNC friend bidirectional_iterator<int*> begin(FunctionBeginOnly&);
};
...
{
  TEST_FUNC bidirectional_iterator<int*> end() const;
};
...
{
  TEST_FUNC friend bidirectional_iterator<int*> end(FunctionEndOnly&);
};
...
TEST_FUNC constexpr bool testBeginEnd()
{
  MemberBeginEnd a{};
...
_CCCL_GLOBAL_CONSTANT struct NoThrowADLREnd
{
  ...
  TEST_FUNC friend ThrowingIterator<int> rend(const NoThrowADLREnd&) noexcept;
} ntare;
