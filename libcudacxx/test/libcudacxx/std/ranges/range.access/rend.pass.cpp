...
_CCCL_GLOBAL_VARIABLE struct NoThrowMemberREnd
{
...
_CCCL_GLOBAL_VARIABLE struct NoThrowADLREnd
{
  __host__ __device__ ThrowingIterator<int> rbegin() const;
...
_CCCL_GLOBAL_VARIABLE struct NoThrowMemberREndReturnsRef
{
  __host__ __device__ ThrowingIterator<int> rbegin() const;
...
_CCCL_GLOBAL_VARIABLE struct REndReturnsArrayRef
{
...
_CCCL_GLOBAL_VARIABLE struct NoThrowBeginThrowingEnd
{
...
#if !defined(TEST_COMPILER_ICC)
_CCCL_GLOBAL_VARIABLE struct NoThrowEndThrowingBegin
{
  __host__ __device__ int* begin() const;
