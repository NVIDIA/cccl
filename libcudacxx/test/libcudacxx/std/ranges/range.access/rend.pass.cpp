...
struct REndMember {
  ...
  __host__ __device__ constexpr const int* rend() const { return &x; }
};
...
__host__ __device__ constexpr bool testReturnTypes() {
  {
    int* x[2] = {};
    unused(x);
    ASSERT_SAME_TYPE(decltype(cuda::std::ranges::rend(x)),
                     cuda::std::reverse_iterator<int**>);
    ASSERT_SAME_TYPE(decltype(cuda::std::ranges::crend(x)),
                     cuda::std::reverse_iterator<int* const*>);
  }

  {
    ...
    unused(x);
    ASSERT_SAME_TYPE(decltype(cuda::std::ranges::rend(x)),
                     cuda::std::reverse_iterator<int(*)[2]>);
    ASSERT_SAME_TYPE(decltype(cuda::std::ranges::crend(x)),
                     cuda::std::reverse_iterator<const int(*)[2]>);
  }

  {
    ...
    unused(x);
    ASSERT_SAME_TYPE(decltype(cuda::std::ranges::rend(x)),
                     sentinel_wrapper<char*>);
    ASSERT_SAME_TYPE(decltype(cuda::std::ranges::crend(x)),
                     sentinel_wrapper<short*>);
  }
...
static_assert(
    !cuda::std::is_invocable_v<RangeREndT, REndMemberReturnsInt const&>);
...
static_assert(
    !cuda::std::is_invocable_v<RangeREndT, REndMemberReturnsVoidPtr const&>);
...
static_assert(
    !cuda::std::is_invocable_v<RangeREndT, PtrConvertibleREndMember const&>);
...
struct NonConstREndMember {
  int x;
  __host__ __device__ constexpr int* rbegin() { return nullptr; }
  __host__ __device__ constexpr int* rend() { return &x; }
};
static_assert(cuda::std::is_invocable_v<RangeREndT, NonConstREndMember&>);
static_assert(
    !cuda::std::is_invocable_v<RangeREndT, NonConstREndMember const&>);
static_assert(!cuda::std::is_invocable_v<RangeCREndT, NonConstREndMember&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCREndT, NonConstREndMember const&>);

struct EnabledBorrowingREndMember {
  __host__ __device__ constexpr int* rbegin() const { return nullptr; }
  __host__ __device__ constexpr int* rend() const { return &globalBuff[0]; }
};
template <>
inline constexpr bool
    cuda::std::ranges::enable_borrowed_range<EnabledBorrowingREndMember> = true;

struct REndMemberFunction {
  int x;
  __host__ __device__ constexpr const int* rbegin() const { return nullptr; }
  __host__ __device__ constexpr const int* rend() const { return &x; }
...
struct EmptyPtrREndMember {
  Empty x;
  __host__ __device__ constexpr const Empty* rbegin() const { return nullptr; }
  __host__ __device__ constexpr const Empty* rend() const { return &x; }
};
...
struct REndFunctionReturnsInt {
  __host__ __device__ friend constexpr int
  rbegin(REndFunctionReturnsInt const&);
  __host__ __device__ friend constexpr int rend(REndFunctionReturnsInt const&);
};
static_assert(
    !cuda::std::is_invocable_v<RangeREndT, REndFunctionReturnsInt const&>);

struct REndFunctionReturnsVoidPtr {
  __host__ __device__ friend constexpr void*
  rbegin(REndFunctionReturnsVoidPtr const&);
  __host__ __device__ friend constexpr void*
  rend(REndFunctionReturnsVoidPtr const&);
};
static_assert(
    !cuda::std::is_invocable_v<RangeREndT, REndFunctionReturnsVoidPtr const&>);

struct REndFunctionReturnsEmpty {
  __host__ __device__ friend constexpr Empty
  rbegin(REndFunctionReturnsEmpty const&);
  __host__ __device__ friend constexpr Empty
  rend(REndFunctionReturnsEmpty const&);
};
static_assert(
    !cuda::std::is_invocable_v<RangeREndT, REndFunctionReturnsEmpty const&>);

struct REndFunctionReturnsPtrConvertible {
  __host__ __device__ friend constexpr PtrConvertible
  rbegin(REndFunctionReturnsPtrConvertible const&);
  __host__ __device__ friend constexpr PtrConvertible
  rend(REndFunctionReturnsPtrConvertible const&);
};
static_assert(!cuda::std::is_invocable_v<
              RangeREndT, REndFunctionReturnsPtrConvertible const&>);
...
struct REndFunctionEnabledBorrowing {
  __host__ __device__ friend constexpr int*
  rbegin(REndFunctionEnabledBorrowing) {
    return nullptr;
  }
...
template <>
inline constexpr bool
    cuda::std::ranges::enable_borrowed_range<REndFunctionEnabledBorrowing> =
        true;

struct REndFunctionReturnsEmptyPtr {
  Empty x;
  __host__ __device__ friend constexpr const Empty*
  rbegin(REndFunctionReturnsEmptyPtr const&) {
    return nullptr;
  }
  __host__ __device__ friend constexpr const Empty*
  rend(REndFunctionReturnsEmptyPtr const& bf) {
    return &bf.x;
  }
};
...
struct REndFunctionWithDataMember {
  ...
  rbegin(REndFunctionWithDataMember const&) {
    return nullptr;
  }
  __host__ __device__ friend constexpr const int*
  rend(REndFunctionWithDataMember const& bf) {
    return &bf.x;
  }
};
...
struct REndFunctionWithPrivateEndMember : private REndMember {
  int y;
  __host__ __device__ friend constexpr const int*
  rbegin(REndFunctionWithPrivateEndMember const&) {
    return nullptr;
  }
  __host__ __device__ friend constexpr const int*
  rend(REndFunctionWithPrivateEndMember const& bf) {
    return &bf.y;
  }
};
...
struct RBeginMemberEndFunction {
  ...
  __host__ __device__ constexpr const int* rbegin() const { return nullptr; }
  __host__ __device__ friend constexpr const int*
  rend(RBeginMemberEndFunction const& bf) {
    return &bf.x;
  }
};
...
struct MemberBeginEnd {
  ...
  __host__ __device__ constexpr bidirectional_iterator<const char*>
  begin() const {
...
struct FunctionBeginEnd {
  int b, e;
  char cb, ce;
  __host__ __device__ friend constexpr bidirectional_iterator<int*>
  begin(FunctionBeginEnd& v) {
    return bidirectional_iterator<int*>(&v.b);
  }
  __host__ __device__ friend constexpr bidirectional_iterator<int*>
  end(FunctionBeginEnd& v) {
    return bidirectional_iterator<int*>(&v.e);
  }
  __host__ __device__ friend constexpr bidirectional_iterator<const char*>
  begin(const FunctionBeginEnd& v) {
    return bidirectional_iterator<const char*>(&v.cb);
  }
  __host__ __device__ friend constexpr bidirectional_iterator<const char*>
  end(const FunctionBeginEnd& v) {
...
struct MemberBeginFunctionEnd {
  ...
  __host__ __device__ friend constexpr bidirectional_iterator<const char*>
  end(const MemberBeginFunctionEnd& v) {
    return bidirectional_iterator<const char*>(&v.ce);
  }
};
static_assert(cuda::std::is_invocable_v<RangeREndT, MemberBeginFunctionEnd&>);
static_assert(
    cuda::std::is_invocable_v<RangeREndT, MemberBeginFunctionEnd const&>);
static_assert(
    cuda::std::is_invocable_v<RangeCREndT, MemberBeginFunctionEnd const&>);

struct FunctionBeginMemberEnd {
  int b, e;
  char cb, ce;
  __host__ __device__ friend constexpr bidirectional_iterator<int*>
  begin(FunctionBeginMemberEnd& v) {
    return bidirectional_iterator<int*>(&v.b);
  }
  __host__ __device__ constexpr bidirectional_iterator<int*> end() {
    return bidirectional_iterator<int*>(&e);
  ...
  __host__ __device__ friend constexpr bidirectional_iterator<const char*>
  begin(const FunctionBeginMemberEnd& v) {
    return bidirectional_iterator<const char*>(&v.cb);
  }
  __host__ __device__ constexpr bidirectional_iterator<const char*>
  end() const {
...
static_assert(
    cuda::std::is_invocable_v<RangeREndT, FunctionBeginMemberEnd const&>);
static_assert(
    cuda::std::is_invocable_v<RangeCREndT, FunctionBeginMemberEnd const&>);
...
static_assert(
    !cuda::std::is_invocable_v<RangeREndT, MemberBeginEndDifferentTypes&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCREndT, MemberBeginEndDifferentTypes&>);

struct FunctionBeginEndDifferentTypes {
  __host__ __device__ friend bidirectional_iterator<int*>
  begin(FunctionBeginEndDifferentTypes&);
  __host__ __device__ friend bidirectional_iterator<const int*>
  end(FunctionBeginEndDifferentTypes&);
};
static_assert(
    !cuda::std::is_invocable_v<RangeREndT, FunctionBeginEndDifferentTypes&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCREndT, FunctionBeginEndDifferentTypes&>);
...
static_assert(
    !cuda::std::is_invocable_v<RangeREndT, MemberBeginEndForwardIterators&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCREndT, MemberBeginEndForwardIterators&>);

struct FunctionBeginEndForwardIterators {
  __host__ __device__ friend forward_iterator<int*>
  begin(FunctionBeginEndForwardIterators&);
  __host__ __device__ friend forward_iterator<int*>
  end(FunctionBeginEndForwardIterators&);
};
static_assert(
    !cuda::std::is_invocable_v<RangeREndT, FunctionBeginEndForwardIterators&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCREndT, FunctionBeginEndForwardIterators&>);
...
static_assert(
    cuda::std::same_as<
        cuda::std::invoke_result_t<RangeREndT, MemberBeginAndRBegin&>, int*>);
static_assert(
    cuda::std::same_as<
        cuda::std::invoke_result_t<RangeCREndT, MemberBeginAndRBegin&>, int*>);
...
_LIBCUDACXX_CPO_ACCESSIBILITY struct NoThrowMemberREnd {
  ...
  rend() const noexcept; // auto(t.rend()) doesn't throw
} ntmre;
...
_LIBCUDACXX_CPO_ACCESSIBILITY struct NoThrowADLREnd {
  ...
  rend(NoThrowADLREnd&) noexcept; // auto(rend(t)) doesn't throw
  __host__ __device__ friend ThrowingIterator<int>
  rend(const NoThrowADLREnd&) noexcept;
} ntare;
