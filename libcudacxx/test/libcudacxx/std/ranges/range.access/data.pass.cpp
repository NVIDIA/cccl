...
__host__ __device__ constexpr bool testReturnTypes() {
  ...
  {
    ASSERT_SAME_TYPE(
        decltype(cuda::std::ranges::data(cuda::std::declval<D&>())), char*);
    static_assert(!cuda::std::is_invocable_v<RangeDataT, D&&>);
    ASSERT_SAME_TYPE(
        decltype(cuda::std::ranges::data(cuda::std::declval<const D&>())),
        short*);
    static_assert(!cuda::std::is_invocable_v<RangeDataT, const D&&>);
    ASSERT_SAME_TYPE(
        decltype(cuda::std::ranges::cdata(cuda::std::declval<D&>())), short*);
    static_assert(!cuda::std::is_invocable_v<RangeCDataT, D&&>);
    ASSERT_SAME_TYPE(
        decltype(cuda::std::ranges::cdata(cuda::std::declval<const D&>())),
        short*);
  ...
  }
  {
    ...
    ASSERT_SAME_TYPE(
        decltype(cuda::std::ranges::data(cuda::std::declval<NC&>())), int*);
    static_assert(!cuda::std::is_invocable_v<RangeDataT, NC&&>);
    ASSERT_SAME_TYPE(
        decltype(cuda::std::ranges::data(cuda::std::declval<const NC&>())),
        char*);
    static_assert(!cuda::std::is_invocable_v<RangeDataT, const NC&&>);
    ASSERT_SAME_TYPE(
        decltype(cuda::std::ranges::cdata(cuda::std::declval<NC&>())), char*);
    static_assert(!cuda::std::is_invocable_v<RangeCDataT, NC&&>);
    ASSERT_SAME_TYPE(
        decltype(cuda::std::ranges::cdata(cuda::std::declval<const NC&>())),
        char*);
...
static_assert(
    !cuda::std::is_invocable_v<RangeDataT, PtrConvertibleDataMember const&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, PtrConvertibleDataMember const&>);
...
inline constexpr bool
    cuda::std::ranges::enable_borrowed_range<EnabledBorrowingDataMember> = true;
...
__host__ __device__ constexpr bool testDataMember() {
  ...
  static_assert(
      !cuda::std::is_invocable_v<RangeCDataT, decltype(cuda::std::move(c))>);
...
static_assert(
    cuda::std::is_invocable_v<RangeDataT, BeginMemberContiguousIterator&>);
static_assert(
    !cuda::std::is_invocable_v<RangeDataT, BeginMemberContiguousIterator&&>);
static_assert(cuda::std::is_invocable_v<RangeDataT,
                                        BeginMemberContiguousIterator const&>);
static_assert(!cuda::std::is_invocable_v<
              RangeDataT, BeginMemberContiguousIterator const&&>);
static_assert(
    cuda::std::is_invocable_v<RangeCDataT, BeginMemberContiguousIterator&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, BeginMemberContiguousIterator&&>);
static_assert(cuda::std::is_invocable_v<RangeCDataT,
                                        BeginMemberContiguousIterator const&>);
static_assert(!cuda::std::is_invocable_v<
              RangeCDataT, BeginMemberContiguousIterator const&&>);
...
static_assert(
    !cuda::std::is_invocable_v<RangeDataT, BeginMemberRandomAccess&&>);
static_assert(
    !cuda::std::is_invocable_v<RangeDataT, const BeginMemberRandomAccess&>);
static_assert(
    !cuda::std::is_invocable_v<RangeDataT, const BeginMemberRandomAccess&&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, BeginMemberRandomAccess&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, BeginMemberRandomAccess&&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, const BeginMemberRandomAccess&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, const BeginMemberRandomAccess&&>);
...
struct BeginFriendContiguousIterator {
  ...
  __host__ __device__ friend constexpr ContiguousIter
  begin(const BeginFriendContiguousIterator& iter) {
...
struct BeginFriendRandomAccess {
  __host__ __device__ friend random_access_iterator<const int*>
  begin(const BeginFriendRandomAccess iter);
};
static_assert(!cuda::std::is_invocable_v<RangeDataT, BeginFriendRandomAccess&>);
static_assert(
    !cuda::std::is_invocable_v<RangeDataT, BeginFriendRandomAccess&&>);
static_assert(
    !cuda::std::is_invocable_v<RangeDataT, const BeginFriendRandomAccess&>);
static_assert(
    !cuda::std::is_invocable_v<RangeDataT, const BeginFriendRandomAccess&&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, BeginFriendRandomAccess&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, BeginFriendRandomAccess&&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, const BeginFriendRandomAccess&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, const BeginFriendRandomAccess&&>);
...
static_assert(
    !cuda::std::is_invocable_v<RangeDataT, BeginMemberRvalue const&&>);
static_assert(!cuda::std::is_invocable_v<RangeCDataT, BeginMemberRvalue&>);
static_assert(!cuda::std::is_invocable_v<RangeCDataT, BeginMemberRvalue&&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, BeginMemberRvalue const&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, BeginMemberRvalue const&&>);
...
template <>
inline constexpr bool
    cuda::std::ranges::enable_borrowed_range<BeginMemberBorrowingEnabled> =
        true;

static_assert(
    cuda::std::is_invocable_v<RangeDataT, BeginMemberBorrowingEnabled&>);
static_assert(
    cuda::std::is_invocable_v<RangeDataT, BeginMemberBorrowingEnabled&&>);
static_assert(
    !cuda::std::is_invocable_v<RangeDataT, BeginMemberBorrowingEnabled const&>);
static_assert(!cuda::std::is_invocable_v<RangeDataT,
                                         BeginMemberBorrowingEnabled const&&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, BeginMemberBorrowingEnabled&>);
static_assert(
    !cuda::std::is_invocable_v<RangeCDataT, BeginMemberBorrowingEnabled&&>);
static_assert(!cuda::std::is_invocable_v<RangeCDataT,
                                         BeginMemberBorrowingEnabled const&>);
