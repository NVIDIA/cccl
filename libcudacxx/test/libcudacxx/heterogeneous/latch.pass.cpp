...
using r5_cd1_aw2_w_cd2 =
    performer_list<reset<5>, count_down<1>, arrive_and_wait<2>, latch_wait,
                   count_down<2> >;

using r3_aw1_aw1_aw1 = performer_list<reset<3>, arrive_and_wait<1>,
                                      arrive_and_wait<1>, arrive_and_wait<1> >;
...
void kernel_invoker() {
  ...
  validate_not_movable<cuda::latch<cuda::thread_scope_system>,
                       r5_cd1_aw2_w_cd2>(0);

  validate_not_movable<cuda::std::latch, r3_aw1_aw1_aw1>(0);
  validate_not_movable<cuda::latch<cuda::thread_scope_system>, r3_aw1_aw1_aw1>(
      0);
}
