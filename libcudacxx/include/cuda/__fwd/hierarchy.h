...
template <class _Level, class _Extents>
class hierarchy_level_desc_base;

template <class _Exts>
struct cluster_level_desc;
template <class _Exts>
struct block_level_desc;
template <class _Exts>
struct thread_level_desc;

template <class _Tp>
inline constexpr bool __is_hierarch_level_desc_v = false;
template <class _Tp, class _Extents>
inline constexpr bool __is_hierarchy_level_desc_v =
  ::cuda::std::is_base_of_v<hierarchy_level_desc_base<_Tp, _Extents>, _Tp>;

// hierarchy

// template <class _TopLevel, class... _LevelDescs>
// class hierarchy;

// template <class... _LevelDescs>
// class grid_hierarchy;
// template <class... _LevelDescs>
// class cluster_hierarchy;
// template <class... _LevelDescs>
// class block_hierarchy;
// template <class... _LevelDescs>
