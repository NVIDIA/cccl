  ...
  NV_DISPATCH_TARGET(
    ...
    (switch (_Scope) {
      case thread_scope::thread_scope_system:
        ::cuda::std::__atomic_thread_fence_dispatch(__m, __thread_scope_system_tag{});
        break;
      case thread_scope::thread_scope_device:
        ::cuda::std::__atomic_thread_fence_dispatch(__m, __thread_scope_device_tag{});
        break;
      case thread_scope::thread_scope_cluster:
        ::cuda::std::__atomic_thread_fence_dispatch(__m, __thread_scope_cluster_tag{});
        break;
      case thread_scope::thread_scope_block:
        ::cuda::std::__atomic_thread_fence_dispatch(__m, __thread_scope_block_tag{});
        break;
