...
#if _CCCL_HAS_INT128()
  static constexpr bool __is_volatile_int128 =
    ::cuda::std::is_volatile_v<_Tp>
    && (::cuda::std::is_same_v<value_type, __int128> || ::cuda::std::is_same_v<value_type, unsigned __int128>);
#else // ^^^ _CCCL_HAS_INT128() ^^^ / vvv !_CCCL_HAS_INT128() vvv
  static constexpr bool __is_volatile_int128 = false;
#endif // !_CCCL_HAS_INT128()

  static_assert(!::cuda::std::is_volatile_v<_Tp> || is_always_lock_free || __is_volatile_int128,
