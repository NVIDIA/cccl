...
_CCCL_DEVICE static inline void stmatrix_m8n8(_B16* __gmem_ptr, const ::cuda::std::uint32_t (&__data)[1])
{
  asm volatile("stmatrix.sync.aligned.m8n8.x1.shared.b16 [%0], {%1};"
               :
               : "r"(__as_ptr_smem(__gmem_ptr)), "r"(__data[0])
               : "memory");
}
...
#if __cccl_ptx_isa >= 780
template <typename _B16, ::cuda::std::enable_if_t<sizeof(_B16) == 2, bool> = true>
_CCCL_DEVICE static inline void stmatrix_m8n8(_B16* __gmem_ptr, const ::cuda::std::uint32_t (&__data)[2])
{
  asm volatile("stmatrix.sync.aligned.m8n8.x2.shared.b16 [%0], {%1, %2};"
               :
               : "r"(__as_ptr_smem(__gmem_ptr)), "r"(__data[0]), "r"(__data[1])
               : "memory");
}
#endif // __cccl_ptx_isa >= 780
...
#if __cccl_ptx_isa >= 780
template <typename _B16, ::cuda::std::enable_if_t<sizeof(_B16) == 2, bool> = true>
_CCCL_DEVICE static inline void stmatrix_m8n8(_B16* __gmem_ptr, const ::cuda::std::uint32_t (&__data)[4])
{
  asm volatile("stmatrix.sync.aligned.m8n8.x4.shared.b16 [%0], {%1, %2, %3, %4};"
               :
               : "r"(__as_ptr_smem(__gmem_ptr)), "r"(__data[0]), "r"(__data[1]), "r"(__data[2]), "r"(__data[3])
               : "memory");
}
#endif // __cccl_ptx_isa >= 780
...
#if __cccl_ptx_isa >= 780
template <typename _B16, ::cuda::std::enable_if_t<sizeof(_B16) == 2, bool> = true>
_CCCL_DEVICE static inline void stmatrix_m8n8_trans(_B16* __gmem_ptr, const ::cuda::std::uint32_t (&__data)[1])
{
...
#if __cccl_ptx_isa >= 780
template <typename _B16, ::cuda::std::enable_if_t<sizeof(_B16) == 2, bool> = true>
_CCCL_DEVICE static inline void stmatrix_m8n8_trans(_B16* __gmem_ptr, const ::cuda::std::uint32_t (&__data)[2])
{
...
#if __cccl_ptx_isa >= 780
template <typename _B16, ::cuda::std::enable_if_t<sizeof(_B16) == 2, bool> = true>
_CCCL_DEVICE static inline void stmatrix_m8n8_trans(_B16* __gmem_ptr, const ::cuda::std::uint32_t (&__data)[4])
{
...
SM_107a, SM_107f, SM_110a, SM_110f, SM_120a, SM_120f, SM_121a, SM_121f template <typename B8, enable_if_t<sizeof(B8) ==
1, bool> = true>
...
_CCCL_DEVICE static inline void stmatrix_m16n8_trans(_B8* __gmem_ptr, const ::cuda::std::uint32_t (&__data)[1])
{
...
#if __cccl_ptx_isa >= 860
template <typename _B8, ::cuda::std::enable_if_t<sizeof(_B8) == 1, bool> = true>
_CCCL_DEVICE static inline void stmatrix_m16n8_trans(_B8* __gmem_ptr, const ::cuda::std::uint32_t (&__data)[2])
{
...
#if __cccl_ptx_isa >= 860
template <typename _B8, ::cuda::std::enable_if_t<sizeof(_B8) == 1, bool> = true>
_CCCL_DEVICE static inline void stmatrix_m16n8_trans(_B8* __gmem_ptr, const ::cuda::std::uint32_t (&__data)[4])
{
