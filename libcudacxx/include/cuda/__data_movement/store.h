...
template <typename _Tp, _CacheReuseEnum _L1, typename _AccessProperty>
_CCCL_DEVICE_API void __store_arch_dispatch(
  _Tp* __ptr,
  _Tp __data,
...
// _Ip> _CCCL_DEVICE_API void __unroll_store(
...
template <size_t _MaxPtxAccessSize, typename _Tp, size_t _Align, _CacheReuseEnum _L1, typename _AccessProperty>
_CCCL_DEVICE_API void __store_impl(
  _Tp* __ptr,
  _Tp __data,
  ...
  __l2_hint_t<_AccessProperty> __l2_hint) noexcept
{
  ...
  ::cuda::static_for<__num_unroll>([&](auto index) {
    _CUDA_DEVICE::__store_arch_dispatch(__ptr_gmem + index, __data_tmp[index], __l1_reuse, __l2_hint);
  });
  //_CUDA_DEVICE::__unroll_store(__ptr_gmem, __data_tmp, __l1_reuse, __l2_reuse, __index_seq);
}

template <typename _Tp, size_t _Align, _CacheReuseEnum _L1, typename _AccessProperty>
  ...
  __l2_hint_t<_AccessProperty> __l2_hint) noexcept
{
  if constexpr (__cccl_ptx_isa >= 880)
  {
    NV_IF_ELSE_TARGET(
      NV_PROVIDES_SM_100,
      (return _CUDA_DEVICE::__store_impl<32>(__ptr, __data, __align, __l1_reuse, __l2_hint);),
      (return _CUDA_DEVICE::__store_impl<__max_ptx_access_size>(__ptr, __data, __align, __l1_reuse, __l2_hint);))
  }
  else
  {
    return _CUDA_DEVICE::__store_impl<__max_ptx_access_size>(__ptr, __data, __align, __l1_reuse, __l2_hint);
...
template <size_t _Np, typename _Tp, size_t _Align, _CacheReuseEnum _L1, typename _AccessProperty>
_CCCL_DEVICE_API void __store_array(
  _Tp* __ptr,
  ...
  __l2_hint_t<_AccessProperty> __l2_hint) noexcept
{
  ...
  return _CUDA_DEVICE::__store_ptx_isa_dispatch(__ptr1, __data, __align, __l1_reuse, __l2_hint);
}
      ...
      _AccessProperty __l2_hint       = access_property::global{}) noexcept
{
  ...
  _CUDA_DEVICE::__store_ptx_isa_dispatch(__ptr, __data, __align, __l1_reuse, __l2_hint_t{__l2_hint});
}

template <typename _Tp, typename _Prop, _CacheReuseEnum _L1 = _CacheReuseEnum::_Unchanged>
_CCCL_DEVICE_API void
store(annotated_ptr<_Tp, _Prop> __ptr, _Tp __data, __cache_reuse_t<_L1> __l1_reuse = cache_reuse_unchanged) noexcept
{
  _CUDA_DEVICE::store(__ptr.__get_raw_ptr(), __data, __l1_reuse, __ptr.__property());
}
...
store(_Tp* __ptr,
      ...
      _AccessProperty __l2_hint       = access_property::global{}) noexcept
{
  _CUDA_DEVICE::__store_array<_Np>(__ptr, __data, __align, __l1_reuse, __l2_hint_t{__l2_hint});
}
...
store(annotated_ptr<_Tp, _Prop> __ptr,
      const _CUDA_VSTD::array<_Tp, _Np>& __data,
      aligned_size_t<_Align> __align  = aligned_size_t<_Align>{sizeof(_Tp)},
      __cache_reuse_t<_L1> __l1_reuse = cache_reuse_unchanged) noexcept
{
  _CUDA_DEVICE::__store_array<_Np>(__ptr.__get_raw_ptr(), __data, __align, __l1_reuse, __ptr.__property());
}
