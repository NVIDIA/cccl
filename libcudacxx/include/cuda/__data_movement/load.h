  ...
  __l2_prefetch_t<_Pp> __l2_prefetch) noexcept
{
  ...
  {
    _CCCL_LOAD_ADD_L1_POLICY(, __l1_reuse, __l2_prefetch, , __ptr);
  }
  else
  {
    _CCCL_LOAD_ADD_L1_POLICY(_nc, __l1_reuse, __l2_prefetch, , __ptr);
  }
}
  ...
  __l2_prefetch_t<_Pp> __l2_prefetch) noexcept
{
  ...
  {
    _CCCL_LOAD_ADD_L1_POLICY(, __l1_reuse, __l2_prefetch, _L2_cache_hint, __ptr, __l2_hint.__property);
  }
  else // __memory_access == read_only
  {
    _CCCL_LOAD_ADD_L1_POLICY(_nc, __l1_reuse, __l2_prefetch, _L2_cache_hint, __ptr, __l2_hint.__property);
  }
}
  ...
  __l2_prefetch_t<_Pp> __l2_prefetch) noexcept
{
  ...
  else
  {
    ...
    //{
    //   _CCCL_LOAD_ADD_L1_POLICY(, __l1_reuse, __l2_reuse, __l2_prefetch, _L2_cache_hint, __ptr, __l2_hint.__property);
    // }
    // else
    //{
    //   _CCCL_LOAD_ADD_L1_POLICY(_nc, __l1_reuse, __l2_reuse, __l2_prefetch, _L2_cache_hint, __ptr,
    //   __l2_hint.__property);
    // }
  }
}
  ...
  __l2_prefetch_t<_Pp> __l2_prefetch) noexcept
{
  ...
  auto __tmp                   = _CUDA_VDEV::__unroll_load(
    __ptr_gmem2, __memory_access, __l1_reuse, __l2_reuse, __l2_hint, __l2_prefetch, __index_seq);
  ...
  __l2_prefetch_t<_Pp> __l2_prefetch) noexcept
{
  ...
  constexpr bool __is_default_access =
    __memory_access == read_write && __l1_reuse == cache_reuse_unchanged && __l2_reuse == cache_reuse_unchanged
  ...
  __l2_prefetch_t<_Pp> __l2_prefetch     = L2_prefetch_none) noexcept
{
  return _CUDA_VDEV::__load_element(
    __ptr, __memory_access, __l1_reuse, __l2_reuse, __l2_hint_t{__l2_hint}, __l2_prefetch);
}
...
{
  return _CUDA_VDEV::__load_element(
    __ptr.__get_raw_ptr(), __memory_access, __l1_reuse, __l2_reuse, __ptr.__property(), __l2_prefetch);
}
