    ...
    , __basic_any_reference_conversion_base<_Interface>
{
  ...
  [[nodiscard]] _CCCL_NODEBUG_HOST_DEVICE_API static constexpr auto has_value() noexcept -> bool
  {
    return true;
  }
...
private:
  ...
  //! \brief No-op.
  _CCCL_NODEBUG_HOST_DEVICE_API void reset() noexcept {}

  //! \brief No-op.
  _CCCL_NODEBUG_HOST_DEVICE_API void __release_() noexcept {}
  ...
  _CCCL_NODEBUG_HOST_DEVICE_API auto __get_optr() const noexcept -> ::cuda::std::__maybe_const<__is_const_ref, void>*
  {
    return __optr_;
  }

  _CCCL_NODEBUG_HOST_DEVICE_API auto __get_vptr() const noexcept -> __vptr_for<interface_type>
  {
    return __vptr_;
  }

  _CCCL_NODEBUG_HOST_DEVICE_API auto __get_rtti() const noexcept -> __rtti const*
  {
...
struct _CCCL_TYPE_VISIBILITY_DEFAULT __basic_any<_Interface&> : __basic_any<__ireference<_Interface>>
{
  ...
  _CCCL_NODEBUG_HOST_DEVICE_API __basic_any(__basic_any&& __other) noexcept
  ...
  _CCCL_NODEBUG_HOST_DEVICE_API auto move() & noexcept -> __basic_any<__ireference<_Interface>>&&
  {
