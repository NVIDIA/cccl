...
struct __basic_any_access
{
  ...
  _CCCL_NODEBUG_HOST_DEVICE_API static auto __make() noexcept -> __basic_any<_Interface>
  {
  ...
  _CCCL_NODEBUG_HOST_DEVICE_API static auto __cast_to(_SrcCvAny&& __from, __basic_any<_DstInterface>& __to) noexcept(
  ...
  _CCCL_TEMPLATE(class _SrcCvAny, class _DstInterface)
  _CCCL_REQUIRES(__any_castable_to<_SrcCvAny*, __basic_any<_DstInterface>>)
  _CCCL_NODEBUG_HOST_DEVICE_API static auto
  ...
  template <class _Interface>
  _CCCL_NODEBUG_HOST_DEVICE_API static auto __get_vptr(__basic_any<_Interface> const& __self) noexcept
  ...
  template <class _Interface>
  _CCCL_NODEBUG_HOST_DEVICE_API static auto __get_optr(__basic_any<_Interface>& __self) noexcept -> void*
  {
    return __self.__get_optr();
  }

  template <class _Interface>
  _CCCL_NODEBUG_HOST_DEVICE_API static auto __get_optr(__basic_any<_Interface> const& __self) noexcept -> void const*
  {
    return __self.__get_optr();
  }
};
