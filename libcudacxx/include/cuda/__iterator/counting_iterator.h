...
template <class _Start,
          ::cuda::std::enable_if_t<__arithmetic_or_weakly_incrementable_v<_Start>, int>,
...
advance(::cuda::counting_iterator<_Start>& __iter, _Diff __diff) noexcept(::cuda::std::is_arithmetic_v<_Start>)
{
...
distance(::cuda::counting_iterator<_Start> __first,
         ::cuda::counting_iterator<_Start> __last) noexcept(::cuda::std::is_arithmetic_v<_Start>)
{
...
next(::cuda::counting_iterator<_Start> __iter,
     ::cuda::_IotaDiffT<_Start> __n = 1) noexcept(::cuda::std::is_arithmetic_v<_Start>)
{
