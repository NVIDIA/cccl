...
private:
  ...
  template <class _Iter2, class _Offset2>
  static constexpr bool __nothrow_incrementable =
    noexcept(_CUDA_VSTD::declval<const _Iter2&>() + *_CUDA_VSTD::declval<const _Offset2&>());

  template <class _Iter1, class _Iter2>
  static constexpr bool __nothrow_difference = noexcept(_CUDA_VSTD::declval<_Iter1>() - _CUDA_VSTD::declval<_Iter2>());
...
public:
  ...
  _CCCL_EXEC_CHECK_DISABLE
  _LIBCUDACXX_HIDE_FROM_ABI constexpr permutation_iterator(_Iter __iter, _Offset __offset) noexcept(
  ...
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr const _Offset& offset() const& noexcept
  {
    return __offset_;
  }
  ...
  //! @brief Extracts the stored iterator we are offsetting from
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr _Offset
  offset() && noexcept(_CUDA_VSTD::is_nothrow_move_constructible_v<_Offset>)
  {
  ...
  _CCCL_EXEC_CHECK_DISABLE
  _LIBCUDACXX_HIDE_FROM_ABI constexpr permutation_iterator& operator++() noexcept(noexcept(++__offset_))
  {
    ++__offset_;
    return *this;
  }
  ...
  //! @brief Increments the stored offset iterator
  _CCCL_EXEC_CHECK_DISABLE
  _LIBCUDACXX_HIDE_FROM_ABI constexpr permutation_iterator operator++(int) noexcept(
    noexcept(++__offset_)
    && _CUDA_VSTD::is_nothrow_copy_constructible_v<_Iter> && _CUDA_VSTD::is_nothrow_copy_constructible_v<_Offset>)
  {
  ...
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr permutation_iterator operator+(difference_type __n) const
  ...
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr permutation_iterator
  ...
  //! @param __n The number of elements to advance
  _CCCL_EXEC_CHECK_DISABLE
  _LIBCUDACXX_HIDE_FROM_ABI constexpr permutation_iterator&
  ...
  //! @brief Returns the difference in offset between two \c permutation_iterators
  _CCCL_EXEC_CHECK_DISABLE
  ...
  operator-(const permutation_iterator& __lhs, const permutation_iterator<_OtherIter, _OtherOffset>& __rhs) noexcept(
    __nothrow_incrementable<_Iter, _Offset> && __nothrow_incrementable<_OtherIter, _OtherOffset>
    && __nothrow_difference<_Iter, _OtherIter>)
  {
    return (__rhs.base() + *__rhs.offset()) - (__lhs.__iter_ + *__lhs.__offset_);
  }
  ...
  operator==(const permutation_iterator& __lhs, const permutation_iterator<_OtherIter, _OtherOffset>& __rhs) noexcept(
    __nothrow_incrementable<_Iter, _Offset> && __nothrow_incrementable<_OtherIter, _OtherOffset>
    && __nothrow_equality<_Iter, _OtherIter>)
  {
    return (__lhs.__iter_ + *__lhs.__offset_) == (__rhs.base() + *__rhs.offset());
  }
  ...
  _CCCL_EXEC_CHECK_DISABLE
  _CCCL_TEMPLATE(class _OtherIter, class _OtherOffset)
  _CCCL_REQUIRES(_CUDA_VSTD::three_way_comparable_with<_Iter, _OtherIter>)
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr strong_ordering
  operator<=>(const permutation_iterator& __lhs, const permutation_iterator<_OtherIter, _OtherOffset>& __rhs) noexcept(
    __nothrow_incrementable<_Iter, _Offset> && __nothrow_incrementable<_OtherIter, _OtherOffset>
    && __nothrow_three_way<_Iter, _OtherIter>)
  {
    return (__lhs.__iter_ + *__lhs.__offset_) <=> (__rhs.base() + *__rhs.offset());
  }
#endif // _LIBCUDACXX_HAS_SPACESHIP_OPERATOR()
  ...
  operator<(const permutation_iterator& __lhs, const permutation_iterator<_OtherIter, _OtherOffset>& __rhs) noexcept(
    __nothrow_incrementable<_Iter, _Offset> && __nothrow_incrementable<_OtherIter, _OtherOffset>
    && __nothrow_less_than<_Iter, _OtherIter>)
  {
    return (__lhs.__iter_ + *__lhs.__offset_) < (__rhs.base() + *__rhs.offset());
  }
  ...
  operator<=(const permutation_iterator& __lhs, const permutation_iterator<_OtherIter, _OtherOffset>& __rhs) noexcept(
    __nothrow_incrementable<_Iter, _Offset> && __nothrow_incrementable<_OtherIter, _OtherOffset>
    && __nothrow_less_equal<_Iter, _OtherIter>)
  {
    return (__lhs.__iter_ + *__lhs.__offset_) <= (__rhs.base() + *__rhs.offset());
  }
  ...
  operator>(const permutation_iterator& __lhs, const permutation_iterator<_OtherIter, _OtherOffset>& __rhs) noexcept(
    __nothrow_incrementable<_Iter, _Offset> && __nothrow_incrementable<_OtherIter, _OtherOffset>
    && __nothrow_greater_than<_Iter, _OtherIter>)
  {
    return (__lhs.__iter_ + *__lhs.__offset_) > (__rhs.base() + *__rhs.offset());
  }
  ...
  operator>=(const permutation_iterator& __lhs, const permutation_iterator<_OtherIter, _OtherOffset>& __rhs) noexcept(
    __nothrow_incrementable<_Iter, _Offset> && __nothrow_incrementable<_OtherIter, _OtherOffset>
    && __nothrow_greater_equal<_Iter, _OtherIter>)
  {
    return (__lhs.__iter_ + *__lhs.__offset_) >= (__rhs.base() + *__rhs.offset());
  }
};
...
_CCCL_TEMPLATE(class _Iter, class _Offset)
_CCCL_REQUIRES(_CUDA_VSTD::random_access_iterator<_Iter> _CCCL_AND _CUDA_VSTD::random_access_iterator<_Offset>)
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr permutation_iterator<_Iter, _Offset>
