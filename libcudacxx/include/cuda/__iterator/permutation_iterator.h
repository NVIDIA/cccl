...
public:
  ...
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr difference_type operator-(
  ...
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr bool operator==(
  ...
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr strong_ordering operator<=>(
    const permutation_iterator& __lhs,
