...
public:
  ...
  //! @return __rhs.offset() - __lhs.offset()
  ...
  //! @brief Compares two \c offset_iterator \p __lhs and \p __rhs for equality
  //! @param __lhs The left \c offset_iterator
  //! @param __rhs The right \c offset_iterator
  //! @return true if both iterators point at the same location
  _CCCL_EXEC_CHECK_DISABLE
  ...
  //! @brief Compares two \c offset_iterator \p __lhs and \p __rhs for inequality
  //! @param __lhs The left \c offset_iterator
  //! @param __rhs The right \c offset_iterator
  //! @return true if both iterators point at different location
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr bool
  operator!=(const offset_iterator& __lhs, const offset_iterator& __rhs) noexcept
  {
  ...
  //! @brief Compares a \c offset_iterator \p __lhs with \p default_sentinel for equality
  //! @param __lhs The left \c offset_iterator
  //! @return true if the offset of \p __lhs is zero
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr bool
...
#if _CCCL_STD_VER <= 2017
  //! @brief Compares a \c offset_iterator \p __rhs with \p default_sentinel for equality
  //! @param __rhs The right \c offset_iterator
  //! @return true if the offset of \p __rhs is zero
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr bool
  ...
  //! @brief Compares a \c offset_iterator \p __lhs with \p default_sentinel for inequality
  //! @param __lhs The left \c offset_iterator
  //! @return true if the offset of \p __lhs is not zero
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr bool
  operator!=(const offset_iterator& __lhs, _CUDA_VSTD::default_sentinel_t) noexcept
  {
  ...
  //! @brief Compares a \c offset_iterator \p __rhs with \p default_sentinel for inequality
  //! @param __rhs The right \c offset_iterator
  //! @return true if the offset of \p __rhs is not zero
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr bool
  operator!=(_CUDA_VSTD::default_sentinel_t, const offset_iterator& __lhs) noexcept
  {
...
#if _LIBCUDACXX_HAS_SPACESHIP_OPERATOR()
  //! @brief Three-way-compares two \c offset_iterator \p __lhs and \p __rhs
  //! @param __lhs The left \c offset_iterator
  //! @param __rhs The right \c offset_iterator
  //! @return the three-way ordering of the memory locations pointed at by \p __lhs and \p __rhs
  _CCCL_EXEC_CHECK_DISABLE
...
#endif // _LIBCUDACXX_HAS_SPACESHIP_OPERATOR()
  //! @brief Compares two \c offset_iterator \p __lhs and \p __rhs for less than
  //! @param __lhs The left \c offset_iterator
  //! @param __rhs The right \c offset_iterator
  //! @return true if the memory location pointed to by \p __lhs compares less than the one pointed to by \p __rhs
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr bool
  operator<(const offset_iterator& __lhs, const offset_iterator& __rhs) noexcept
  {
  ...
  //! @brief Compares two \c offset_iterator \p __lhs and \p __rhs for less equal
  //! @param __lhs The left \c offset_iterator
  //! @param __rhs The right \c offset_iterator
  //! @return true if the memory location pointed to by \p __lhs compares less or equal the one pointed to by \p __rhs
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr bool
  operator<=(const offset_iterator& __lhs, const offset_iterator& __rhs) noexcept
  {
  ...
  //! @brief Compares two \c offset_iterator \p __lhs and \p __rhs for greater than
  //! @param __lhs The left \c offset_iterator
  //! @param __rhs The right \c offset_iterator
  //! @return true if the memory location pointed to by \p __lhs compares greater than the one pointed to by \p __rhs
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr bool
  operator>(const offset_iterator& __lhs, const offset_iterator& __rhs) noexcept
  {
  ...
  //! @brief Compares two \c offset_iterator \p __lhs and \p __rhs for greater equal
  //! @param __lhs The left \c offset_iterator
  //! @param __rhs The right \c offset_iterator
  //! @return true if the memory location pointed to by \p __lhs compares greater or equal than the one pointed to by
  //! \p __rhs
  _CCCL_EXEC_CHECK_DISABLE
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr bool
  operator>=(const offset_iterator& __lhs, const offset_iterator& __rhs) noexcept
