...
public:
  ...
  //! @brief Subscripts the stored base iterator with a given offset
  ...
  //! @brief Increments the stored base iterator by the new stride
  ...
  //! @brief Decrements the stored base iterator by the new stride
  _CCCL_EXEC_CHECK_DISABLE
  _CCCL_API constexpr strided_iterator& operator--() noexcept(__noexcept_stride && noexcept(__iter_ -= 1))
  {
    __iter_ -= stride();
  ...
  //! @brief Returns a copy of a @c strided_iterator advanced by a given number of steps
  ...
  //! @brief Returns distance between two @c strided_iterator's in units of the new stride
  _CCCL_EXEC_CHECK_DISABLE
  ...
  //! @brief Compares two @c strided_iterator's for equality, compares the stored iterators
  _CCCL_EXEC_CHECK_DISABLE
  _CCCL_TEMPLATE(class _OtherIter, class _OtherStride)
  ...
  //! @brief Compares two @c strided_iterator's for inequality, compares the stored iterators
  _CCCL_EXEC_CHECK_DISABLE
  _CCCL_TEMPLATE(class _OtherIter, class _OtherStride)
  _CCCL_REQUIRES(::cuda::std::equality_comparable_with<_Iter, _OtherIter>)
  [[nodiscard]] _CCCL_API friend constexpr bool
...
#if _LIBCUDACXX_HAS_SPACESHIP_OPERATOR()
  //! @brief Threeway-compares two @c strided_iterator's, compares the stored iterators
  _CCCL_TEMPLATE(class _OtherIter, class _OtherStride)
  ...
  //! @brief Compares two @c strided_iterator's for less than, compares the stored iterators
  _CCCL_EXEC_CHECK_DISABLE
  _CCCL_TEMPLATE(class _OtherIter, class _OtherStride)
  _CCCL_REQUIRES(::cuda::std::totally_ordered_with<_Iter, _OtherIter>)
  [[nodiscard]] _CCCL_API friend constexpr bool
  ...
  //! @brief Compares two @c strided_iterator's for greater than, compares the stored iterators
  _CCCL_EXEC_CHECK_DISABLE
  _CCCL_TEMPLATE(class _OtherIter, class _OtherStride)
  _CCCL_REQUIRES(::cuda::std::totally_ordered_with<_Iter, _OtherIter>)
  [[nodiscard]] _CCCL_API friend constexpr bool
  ...
  //! @brief Compares two @c strided_iterator's for less equal, compares the stored iterators
  _CCCL_EXEC_CHECK_DISABLE
  _CCCL_TEMPLATE(class _OtherIter, class _OtherStride)
  _CCCL_REQUIRES(::cuda::std::totally_ordered_with<_Iter, _OtherIter>)
  [[nodiscard]] _CCCL_API friend constexpr bool
  ...
  //! @brief Compares two @c strided_iterator's for greater equal, compares the stored iterators
  _CCCL_EXEC_CHECK_DISABLE
  _CCCL_TEMPLATE(class _OtherIter, class _OtherStride)
  _CCCL_REQUIRES(::cuda::std::totally_ordered_with<_Iter, _OtherIter>)
  [[nodiscard]] _CCCL_API friend constexpr bool
