...
#  define _CCCL_TRY_DRIVER_API(_FN, _MSG, ...)                                                           \
    do                                                                                                   \
    {                                                                                                    \
      auto __cccl_try_driver_api_status = _FN(__VA_ARGS__);                                              \
      static_assert(::cuda::std::is_same_v<decltype(__cccl_try_driver_api_status), ::CUresult>           \
