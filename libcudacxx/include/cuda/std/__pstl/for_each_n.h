...
_CCCL_HOST_API _Iter for_each_n(const _Policy& __pol, _Iter __first, _Size __orig_n, _Fn __func)
{
  [[maybe_unused]] auto __dispatch =
    ::cuda::std::execution::__pstl_select_dispatch<::cuda::std::execution::__pstl_algorithm::__for_each_n, _Policy>();
  if constexpr (::cuda::std::execution::__pstl_can_dispatch<decltype(__dispatch)>)
  {
    return __dispatch(__pol, ::cuda::std::move(__first), __orig_n, ::cuda::std::move(__func));
  }
  else
  {
