...
#    include <cuda/std/__pstl/cuda/select_if.h>
...
remove_if([[maybe_unused]] const _Policy& __policy, _InputIterator __first, _InputIterator __last, _UnaryPred __pred)
{
  ...
  [[maybe_unused]] auto __dispatch =
    ::cuda::std::execution::__pstl_select_dispatch<::cuda::std::execution::__pstl_algorithm::__select_if, _Policy>();
  if constexpr (::cuda::std::execution::__pstl_can_dispatch<decltype(__dispatch)>)
  {
    const auto __count = ::cuda::std::distance(__first, __last);
    return __dispatch(__policy, __first, __count, __first, ::cuda::std::not_fn(::cuda::std::move(__pred)));
  }
  else
  {
