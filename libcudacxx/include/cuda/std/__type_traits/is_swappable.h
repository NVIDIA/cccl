...
template <class _Tp>
_CCCL_API auto __swap(_Tp& __lhs, _Tp& __rhs) -> decltype(swap(__lhs, __rhs));
_CCCL_API auto __swap(...) -> __hidden_friend_swap_found;
template <class _Tp>
...
template <class _Tp>
_CCCL_API auto __swap(_Tp& __lhs, _Tp& __rhs) -> decltype(swap(__lhs, __rhs));
_CCCL_API auto __swap(...) -> __no_adl_swap_found;
template <class _Tp>
...
struct __swappable_with
{
  ...
  _CCCL_API static decltype(swap(_CUDA_VSTD::declval<_LHS>(), _CUDA_VSTD::declval<_RHS>())) __test_swap(int);
  template <class, class>
  _CCCL_API static __nat __test_swap(long);
