...
#ifndef _CUDA_STD___TYPE_TRAITS_IS_TRIVIALLY_MOVE_ASSIGNABLE_H
#define _CUDA_STD___TYPE_TRAITS_IS_TRIVIALLY_MOVE_ASSIGNABLE_H
...
#endif // _CUDA_STD___TYPE_TRAITS_IS_TRIVIALLY_MOVE_ASSIGNABLE_H
