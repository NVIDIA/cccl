...
template <class _T1,
          class _T2,
          unsigned _T1_is_array_function_or_void = __is_convertible_imp::__is_array_function_or_void_v<_T1>,
          unsigned _T2_is_array_function_or_void = __is_convertible_imp::__is_array_function_or_void_v<_T2>>
inline constexpr bool __is_convertible_fallback_v = __is_convertible_imp::__is_convertible_test_v<_T1, _T2>;
...
template <class _T1, class _T2>
struct _CCCL_TYPE_VISIBILITY_DEFAULT is_convertible : bool_constant<is_convertible_v<_T1, _T2>>
{};
