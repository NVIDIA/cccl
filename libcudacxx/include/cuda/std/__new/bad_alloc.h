...
_CCCL_NORETURN inline _LIBCUDACXX_HIDE_FROM_ABI void __throw_bad_alloc()
{
#ifndef _LIBCUDACXX_NO_EXCEPTIONS
...
_CCCL_NORETURN inline _LIBCUDACXX_HIDE_FROM_ABI void __throw_bad_array_new_length()
{
#ifndef _LIBCUDACXX_NO_EXCEPTIONS
