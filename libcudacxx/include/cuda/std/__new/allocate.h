...
[[nodiscard]] _CCCL_HOST_DEVICE_API void* __cccl_operator_new(_Args... __args)
{
  return ::operator new(__args...);
}

template <class... _Args>
[[nodiscard]] _CCCL_HOST_DEVICE_API void*
__cccl_operator_new(size_t __size, align_val_t __align, [[maybe_unused]] _Args... __args)
{
#if _CCCL_CUDA_COMPILER(CLANG) && _CCCL_DEVICE_COMPILATION()
  void* __ret = ::cuda::std::aligned_alloc(static_cast<size_t>(__align), __size);
  if (__ret == nullptr)
  {
...
template <class... _Args>
_CCCL_HOST_DEVICE_API void __cccl_operator_delete(_Args... __args)
{
...
[[nodiscard]] _CCCL_HOST_DEVICE_API inline void* __cccl_allocate(size_t __size, size_t __align)
{
...
_CCCL_HOST_DEVICE_API inline void __cccl_deallocate(void* __ptr, size_t __size, size_t __align)
{
  if (__align > __STDCPP_DEFAULT_NEW_ALIGNMENT__)
  {
    const align_val_t __align_val = static_cast<align_val_t>(__align);
...
_CCCL_HOST_DEVICE_API inline void __cccl_deallocate_unsized(void* __ptr, size_t __align)
{
  if (__align > __STDCPP_DEFAULT_NEW_ALIGNMENT__)
  {
    const align_val_t __align_val = static_cast<align_val_t>(__align);
