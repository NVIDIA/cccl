...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD wchar_t* wcschr(wchar_t* __s, wchar_t __c)
{
  return __libcpp_wcschr(__s, __c);
}

inline _LIBCUDACXX_INLINE_VISIBILITY wchar_t* __libcpp_wcspbrk(const wchar_t* __s1, const wchar_t* __s2)
{
...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD wchar_t* wcspbrk(wchar_t* __s1, const wchar_t* __s2)
{
  return __libcpp_wcspbrk(__s1, __s2);
}
...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD wchar_t* wcsrchr(wchar_t* __s, wchar_t __c)
{
  return __libcpp_wcsrchr(__s, __c);
}

inline _LIBCUDACXX_INLINE_VISIBILITY wchar_t* __libcpp_wcsstr(const wchar_t* __s1, const wchar_t* __s2)
{
...
inline _LIBCUDACXX_INLINE_VISIBILITY _LIBCUDACXX_PREFERRED_OVERLOAD wchar_t* wcsstr(wchar_t* __s1, const wchar_t* __s2)
{
  return __libcpp_wcsstr(__s1, __s2);
}

inline _LIBCUDACXX_INLINE_VISIBILITY wchar_t* __libcpp_wmemchr(const wchar_t* __s, wchar_t __c, size_t __n)
{
...
extern "C" {
size_t
mbsnrtowcs(wchar_t* __restrict dst, const char** __restrict src, size_t nmc, size_t len, mbstate_t* __restrict ps);
size_t
wcsnrtombs(char* __restrict dst, const wchar_t** __restrict src, size_t nwc, size_t len, mbstate_t* __restrict ps);
} // extern "C++"
