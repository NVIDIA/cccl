...
private:
    ...
    class __proxy
    {
        ...
        _LIBCUDACXX_HIDE_FROM_ABI __proxy(char_type __c, streambuf_type* __s)
            : __keep_(__c), __sbuf_(__s) {}
        friend class istreambuf_iterator;
    public:
        _LIBCUDACXX_HIDE_FROM_ABI char_type operator*() const {return __keep_;}
    };
...
public:
    _LIBCUDACXX_HIDE_FROM_ABI constexpr istreambuf_iterator() noexcept : __sbuf_(0) {}
