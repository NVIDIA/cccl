...
public:
  ...
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_CONSTEXPR_AFTER_CXX17
  ...
  _LIBCUDACXX_HIDE_FROM_ABI constexpr explicit operator bool() const noexcept { return this->__has_val_; }

  _LIBCUDACXX_HIDE_FROM_ABI constexpr bool has_value() const noexcept { return this->__has_val_; }
