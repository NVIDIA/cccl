...
{
private:
    template <class _Xp> _LIBCUDACXX_HIDE_FROM_ABI static false_type __test(...);
    _LIBCUDACXX_SUPPRESS_DEPRECATED_PUSH
    template <class _Xp> _LIBCUDACXX_HIDE_FROM_ABI static true_type __test(typename _Xp::template rebind<_Up>* = 0);
