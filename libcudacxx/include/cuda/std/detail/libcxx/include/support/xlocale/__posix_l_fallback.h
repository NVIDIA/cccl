...
inline _LIBCUDACXX_INLINE_VISIBILITY size_t strxfrm_l(char* dest, const char* src, size_t n, locale_t)
{
...
inline _LIBCUDACXX_INLINE_VISIBILITY size_t wcsxfrm_l(wchar_t* dest, const wchar_t* src, size_t n, locale_t)
{
