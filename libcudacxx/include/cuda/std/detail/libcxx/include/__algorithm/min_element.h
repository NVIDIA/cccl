...
min_element(_ForwardIterator __first, _ForwardIterator __last, _Compare __comp)
{
  ...
  return _CUDA_VSTD::__min_element<__comp_ref_type<_Compare> >(_CUDA_VSTD::move(__first), _CUDA_VSTD::move(__last), __comp);
}

template <class _ForwardIterator>
_LIBCUDACXX_NODISCARD_EXT inline _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY
_LIBCUDACXX_CONSTEXPR_AFTER_CXX11 _ForwardIterator
