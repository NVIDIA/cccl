...
#include "ptx/instructions/barrier_cluster.h.fixed"
#include "ptx/instructions/cp_async_bulk.h.fixed"
#include "ptx/instructions/cp_async_bulk_commit_group.h.fixed"
#include "ptx/instructions/cp_async_bulk_tensor.h.fixed"
#include "ptx/instructions/cp_async_bulk_wait_group.h.fixed"
#include "ptx/instructions/cp_reduce_async_bulk.h.fixed"
#include "ptx/instructions/cp_reduce_async_bulk_tensor.h.fixed"
#include "ptx/instructions/fence.h"
#include "ptx/instructions/get_sreg.h.fixed"
#include "ptx/instructions/getctarank.h.fixed"
#include "ptx/instructions/mbarrier_arrive.h.fixed"
#include "ptx/instructions/mbarrier_init.h.fixed"
#include "ptx/instructions/mbarrier_wait.h.fixed"
#include "ptx/instructions/red_async.h.fixed"
#include "ptx/instructions/st_async.h.fixed"
#include "ptx/instructions/tensormap_cp_fenceproxy.h.fixed"
#include "ptx/instructions/tensormap_replace.h.fixed"
