...
#endif
{
    ...
    >* = nullptr>
    explicit _LIBCUDACXX_HIDE_FROM_ABI constexpr
    ...
    template<class _U1, class _U2, __enable_if_t<
            _CheckArgs::template __is_pair_constructible<_U1&, _U2&>::value
    >* = nullptr>
    _LIBCUDACXX_HOST _LIBCUDACXX_HIDE_FROM_ABI constexpr
...
template <size_t _Ip, class _T1, class _T2>
_LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 __tuple_element_t<_Ip, pair<_T1, _T2>>&
...
template <size_t _Ip, class _T1, class _T2>
_LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_CONSTEXPR_AFTER_CXX11 const __tuple_element_t<_Ip, pair<_T1, _T2>>&
