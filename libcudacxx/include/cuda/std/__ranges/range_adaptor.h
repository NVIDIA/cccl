...
template <class _Tp>
_CCCL_CONCEPT _RangeAdaptorClosure = derived_from<remove_cvref_t<_Tp>, __range_adaptor_closure<remove_cvref_t<_Tp>>>;

template <class _Tp, class _View, class _Closure>
_CCCL_CONCEPT __range_adaptor_can_pipe_invoke =
...
_CCCL_CONCEPT __range_adaptor_can_pipe_compose =
...
struct __range_adaptor_closure
{
  // NVRTC has issues constraining operator| with classical SFINAE and needs to go through trailing return type SFINAE
  ...
  operator|(_View&& __view, _Closure&& __closure) noexcept(is_nothrow_invocable_v<_Closure, _View>)
    _CCCL_TRAILING_REQUIRES(invoke_result_t<_Closure, _View>)(__range_adaptor_can_pipe_invoke<_Tp, _View, _Closure>)
  {
  ...
  _CCCL_NODISCARD_FRIEND _LIBCUDACXX_HIDE_FROM_ABI constexpr auto operator|(_Closure&& __c1, _OtherClosure&& __c2) //
    noexcept(is_nothrow_constructible_v<decay_t<_Closure>, _Closure>
      ...
      _CCCL_TRAILING_REQUIRES(__compose_return_t<_Closure, _OtherClosure>)(
  ...
  _CCCL_TEMPLATE(class _View, class _Closure)
  _CCCL_REQUIRES(__range_adaptor_can_pipe_invoke<_Tp, _View, _Closure>)
  ...
  _CCCL_REQUIRES(__range_adaptor_can_pipe_compose<_Tp, _Closure, _OtherClosure>)
  _CCCL_NODISCARD_FRIEND _LIBCUDACXX_HIDE_FROM_ABI constexpr auto operator|(_Closure&& __c1, _OtherClosure&& __c2) //
    noexcept(is_nothrow_constructible_v<decay_t<_Closure>, _Closure>
             && is_nothrow_constructible_v<decay_t<_OtherClosure>, _OtherClosure>)
  {
