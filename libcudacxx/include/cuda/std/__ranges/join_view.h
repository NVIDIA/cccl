...
public:
  ...
  private:
    ...
    struct __get_outer_emplace
    {
      ...
      _LIBCUDACXX_INLINE_VISIBILITY constexpr __get_outer_emplace(__iterator& __iter) noexcept
          : __iter_(__iter)
      {}

      _LIBCUDACXX_INLINE_VISIBILITY constexpr decltype(auto) operator()() const noexcept
      {
  ...
  public:
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr _Outer& __get_outer() noexcept
    {
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr const _Outer& __get_outer() const noexcept
    {
      if constexpr (forward_range<_Base>)
      {
        return __outer_;
    ...
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __iterator(_Parent& __parent)
  ...
  public:
    ...
    _LIBCUDACXX_HIDE_FROM_ABI __iterator() = default;
