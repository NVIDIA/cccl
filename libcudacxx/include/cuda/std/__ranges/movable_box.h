...
template <class _Tp>
_LIBCUDACXX_CONCEPT __movable_box_object = move_constructible<_Tp> && is_object_v<_Tp>;
...
template <class _Tp>
_LIBCUDACXX_CONCEPT __doesnt_need_empty_state =
...
template <class _Tp>
_LIBCUDACXX_CONCEPT __can_use_no_unique_address = (copy_constructible<_Tp> ? copyable<_Tp> : movable<_Tp>);
...
struct __mb_optional_destruct_base
{
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __mb_optional_destruct_base(in_place_t, _Args&&... __args) noexcept(
...
struct __mb_optional_destruct_base<_Tp, true>
{
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __mb_optional_destruct_base() noexcept(is_nothrow_default_constructible_v<_Tp>)
      : __val_(in_place)
  {}
...
struct __mb_optional_copy_assign : __mb_optional_destruct_base<_Tp>
{
  ...
  constexpr __mb_optional_copy_assign(const __mb_optional_copy_assign&) = default;
  constexpr __mb_optional_copy_assign(__mb_optional_copy_assign&&)      = default;

  constexpr __mb_optional_copy_assign& operator=(const __mb_optional_copy_assign&) = delete;
  constexpr __mb_optional_copy_assign& operator=(__mb_optional_copy_assign&&)      = default;
};
...
struct __mb_optional_copy_assign<_Tp, true> : __mb_optional_destruct_base<_Tp>
{
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __mb_optional_copy_assign&
...
struct __mb_optional_move_assign<_Tp, false> : __mb_optional_copy_assign<_Tp>
{
  ...
  constexpr __mb_optional_move_assign(const __mb_optional_move_assign&)            = default;
  constexpr __mb_optional_move_assign(__mb_optional_move_assign&&)                 = default;
  constexpr __mb_optional_move_assign& operator=(const __mb_optional_move_assign&) = default;

  _LIBCUDACXX_INLINE_VISIBILITY constexpr __mb_optional_move_assign&
...
struct __mb_optional_base
    ...
    , __sfinae_assign_base<copy_constructible<_Tp>, true>
{
...
struct __mb_holder
{
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __mb_holder(in_place_t, _Args&&... __args) noexcept(
    is_nothrow_constructible_v<_Tp, _Args...>)
...
struct __mb_holder_base
{
  ...
  _LIBCUDACXX_TEMPLATE(class... _Args)
  _LIBCUDACXX_REQUIRES(is_constructible_v<_Tp, _Args...>)
  _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __mb_holder_base(in_place_t, _Args&&... __args) noexcept(
    is_nothrow_constructible_v<_Tp, _Args...>)
...
struct __mb_holder_base<_Tp, true>
{
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __mb_holder_base() noexcept(is_nothrow_default_constructible_v<_Tp>)
      : __holder_(in_place)
  {}
...
struct __mb_copy_assign<_Tp, false> : __mb_holder_base<_Tp>
{
  ...
  constexpr __mb_copy_assign(const __mb_copy_assign&) = default;
  constexpr __mb_copy_assign(__mb_copy_assign&&)      = default;

  _LIBCUDACXX_INLINE_VISIBILITY _CCCL_CONSTEXPR_CXX20 __mb_copy_assign&
  operator=(const __mb_copy_assign& __other) noexcept
  {
  ...
  constexpr __mb_copy_assign& operator=(__mb_copy_assign&&) = default;
};
...
struct __mb_move_assign<_Tp, false> : __mb_copy_assign<_Tp>
{
  ...
  constexpr __mb_move_assign(const __mb_move_assign&)            = default;
  constexpr __mb_move_assign(__mb_move_assign&&)                 = default;
  constexpr __mb_move_assign& operator=(const __mb_move_assign&) = default;

  _LIBCUDACXX_INLINE_VISIBILITY _CCCL_CONSTEXPR_CXX20 __mb_move_assign&
...
struct __movable_box<_Tp, true> : __movable_box_base<_Tp>
{
  ...
  _LIBCUDACXX_TEMPLATE(class... _Args)
  _LIBCUDACXX_REQUIRES(is_constructible_v<_Tp, _Args...>)
  _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __movable_box(in_place_t, _Args&&... __args) noexcept(
    is_nothrow_constructible_v<_Tp, _Args...>)
      : __base(in_place, _CUDA_VSTD::forward<_Args>(__args)...)
  {}

  constexpr __movable_box() = default;
};
