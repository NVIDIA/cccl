...
struct _CCCL_DECLSPEC_EMPTY_BASES __compressed_box_storage
{
  ...
  _CCCL_HIDE_FROM_ABI constexpr __compressed_box_storage() noexcept = default;
...
{
  using __base = __compressed_box_base<_Index, _Tp>;
  ...
  {
    return this->__engaged_ = __engaged;
  }
};
...
__compressed_box_copy_base<_Index, _Tp, __smf_availability::__available> : __compressed_box_base<_Index, _Tp>
{
      ...
      : __base()
  {
    ...
    {
      __set_engaged(__other.__engaged());
      ::cuda::std::__construct_at(::cuda::std::addressof(this->__get()), __other.__get());
    }
  }
...
__compressed_box_move_base<_Index, _Tp, __smf_availability::__available> : __compressed_box_copy_base<_Index, _Tp>
{
      ...
      : __base()
  {
    ...
    {
      __set_engaged(__other.__engaged());
      ::cuda::std::__construct_at(::cuda::std::addressof(this->__get()), ::cuda::std::move(__other.__get()));
    }
  }
    ...
    : __compressed_box_move_base<_Index, _Tp>
{
  ...
  operator=(const __compressed_box_copy_assign_base& __other) noexcept(
    ...
    : __compressed_box_copy_assign_base<_Index, _Tp>
{
  ...
  operator=(__compressed_box_move_assign_base&& __other) noexcept(
