...
_LIBCUDACXX_INLINE_VAR constexpr bool __is_nothrow_comparable =
...
struct __db_destruct_base
{
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __db_destruct_base() noexcept {};

  template <class... _Args>
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __db_destruct_base(in_place_t, _Args&&... __args) noexcept(
    is_nothrow_constructible_v<_Tp, _Args...>)
      : __val_(_CUDA_VSTD::forward<_Args>(__args)...)
      , __engaged_(true)
  {}

  _LIBCUDACXX_INLINE_VISIBILITY _CCCL_CONSTEXPR_CXX20 ~__db_destruct_base() noexcept
  {
    if (__engaged_)
    {
      __val_.~_Tp();
...
{
  _LIBCUDACXX_DELEGATE_CONSTRUCTORS(__db_copy_base, __db_destruct_base, _Tp);
...
#  if _CCCL_STD_VER >= 2020
  __db_copy_base(const __db_copy_base&)
    requires is_trivially_copy_constructible_v<_Tp>
  = default;
#  endif // _CCCL_STD_VER >= 2020

  _LIBCUDACXX_INLINE_VISIBILITY constexpr __db_copy_base(const __db_copy_base& __other) noexcept(
...
#  endif
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __db_copy_base& operator=(const __db_copy_base& __other) noexcept(
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __db_copy_base&
...
public:
  _LIBCUDACXX_DELEGATE_CONSTRUCTORS(__defaultable_box, __db_copy_base, _Tp);

  __defaultable_box(const __defaultable_box&)            = default;
  __defaultable_box& operator=(const __defaultable_box&) = default;

#  if _CCCL_STD_VER >= 2020
  __defaultable_box(__defaultable_box&&)
    requires is_trivially_move_constructible_v<_Tp>
  = default;
#  endif // _CCCL_STD_VER >= 2020

  _LIBCUDACXX_INLINE_VISIBILITY constexpr __defaultable_box(__defaultable_box&& __other) noexcept(
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __defaultable_box(const __defaultable_box<_Up>& __other) noexcept(
    is_nothrow_copy_constructible_v<_Tp>)
      : __base()
  {
    if (__other)
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __defaultable_box(__defaultable_box<_Up>&& __other) noexcept(
    is_nothrow_copy_constructible_v<_Tp>)
      : __base()
  {
    if (__other)
...
#  endif // _CCCL_STD_VER >= 2020
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __defaultable_box& operator=(__defaultable_box&& __other) noexcept(
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __defaultable_box&
  ...
  _CCCL_NODISCARD _LIBCUDACXX_INLINE_VISIBILITY constexpr bool operator==(const __defaultable_box& __other) const
...
struct __db2_copy_base<_Tp, enable_if_t<copyable<_Tp>>>
{
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr __db2_copy_base&
...
public:
  _LIBCUDACXX_DELEGATE_CONSTRUCTORS(__defaultable_box, __db2_copy_base, _Tp);
  ...
  _LIBCUDACXX_INLINE_VISIBILITY _CCCL_CONSTEXPR_CXX20 __defaultable_box&
