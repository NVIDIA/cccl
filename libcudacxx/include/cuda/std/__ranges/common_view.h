...
//
//===----------------------------------------------------------------------===//
#ifndef _CUDA_STD___RANGES_COMMON_VIEW_H
#define _CUDA_STD___RANGES_COMMON_VIEW_H
...
struct __fn : __range_adaptor_closure<__fn>
{
  ...
  [[nodiscard]] _CCCL_API constexpr auto operator()(_Range&& __range) const
    noexcept(noexcept(::cuda::std::ranges::views::all(::cuda::std::forward<_Range>(__range)))) -> all_t<_Range>
  {
  ...
  _CCCL_REQUIRES((!common_range<_Range>) )
  [[nodiscard]] _CCCL_API constexpr auto operator()(_Range&& __range) const
    noexcept(noexcept(common_view{::cuda::std::forward<_Range>(__range)})) -> common_view<all_t<_Range>>
  {
...
#endif // _CUDA_STD___RANGES_COMMON_VIEW_H
