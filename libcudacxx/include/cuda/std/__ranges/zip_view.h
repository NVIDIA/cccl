...
struct __zv_functors
{
  ...
  {
    template <class... _Types>
    _CCCL_API constexpr __tuple_or_pair<invoke_result_t<decltype(::cuda::std::ranges::begin)&, _Types>...>
  ...
  _CCCL_API static constexpr auto __view_begin(_Tuple&& __tuple) noexcept(
  ...
  {
    template <class... _Types>
    _CCCL_API constexpr __tuple_or_pair<invoke_result_t<decltype(::cuda::std::ranges::end)&, _Types>...>
    operator()(_Types&&... __tuple_elements) const
  ...
  template <class _Tuple>
  _CCCL_API static constexpr auto __view_end(_Tuple&& __tuple) noexcept(
  ...
  struct __zip_size
  {
    ...
    _CCCL_API static constexpr auto __get_min(_Sizes&&... __tuple_sizes) noexcept
    {
    ...
    template <class... _Types>
    _CCCL_API constexpr auto operator()(_Types&&... __tuple_elements) const noexcept(noexcept(__zip_size::__get_min(
  ...
  template <class _Tuple>
  _CCCL_API static constexpr auto __view_size(_Tuple&& __tuple) noexcept(
  ...
  _CCCL_API static constexpr auto __iter_op_star(_Tuple&& __tuple) noexcept(
    noexcept(::cuda::std::apply(__zv_functors::__zip_op_star{}, ::cuda::std::forward<_Tuple>(__tuple))))
  {
    return ::cuda::std::apply(__zv_functors::__zip_op_star{}, ::cuda::std::forward<_Tuple>(__tuple));
  }
  ...
  struct __zip_op_increment
  {
    ...
    _CCCL_API constexpr void operator()(_Types&&... __tuple_elements) const
      noexcept(noexcept((::cuda::std::invoke(__op_increment{}, ::cuda::std::forward<_Types>(__tuple_elements)), ...)))
    {
      (::cuda::std::invoke(__op_increment{}, ::cuda::std::forward<_Types>(__tuple_elements)), ...);
    }
  };

  template <class _Tuple>
  _CCCL_API static constexpr void __iter_op_increment(_Tuple&& __tuple) noexcept(
    noexcept(::cuda::std::apply(__zv_functors::__zip_op_increment{}, ::cuda::std::forward<_Tuple>(__tuple))))
  {
    ::cuda::std::apply(__zv_functors::__zip_op_increment{}, ::cuda::std::forward<_Tuple>(__tuple));
  }
  ...
  struct __zip_op_decrement
  {
    ...
    template <class... _Types>
    _CCCL_API constexpr void operator()(_Types&&... __tuple_elements) const
      noexcept(noexcept((::cuda::std::invoke(__op_decrement{}, ::cuda::std::forward<_Types>(__tuple_elements)), ...)))
    {
      (::cuda::std::invoke(__op_decrement{}, ::cuda::std::forward<_Types>(__tuple_elements)), ...);
    }
  };

  template <class _Tuple>
  _CCCL_API static constexpr void __iter_op_decrement(_Tuple&& __tuple) noexcept(
    noexcept(::cuda::std::apply(__zv_functors::__zip_op_decrement{}, ::cuda::std::forward<_Tuple>(__tuple))))
  {
    ::cuda::std::apply(__zv_functors::__zip_op_decrement{}, ::cuda::std::forward<_Tuple>(__tuple));
  }
  ...
  struct __zip_op_pe
  {
    ...
    struct __op_pe
    {
      ...
      template <class _Iter>
      _CCCL_API constexpr void operator()(_Iter& __i) const noexcept(noexcept(__i += iter_difference_t<_Iter>(__x)))
      {
    ...
    template <class... _Types>
    _CCCL_API constexpr void operator()(_Types&&... __tuple_elements) const
      noexcept(noexcept((::cuda::std::invoke(__op_pe{__x}, ::cuda::std::forward<_Types>(__tuple_elements)), ...)))
    {
      (::cuda::std::invoke(__op_pe{__x}, ::cuda::std::forward<_Types>(__tuple_elements)), ...);
    }
  };

  template <class _Diff, class _Tuple>
  _CCCL_API static constexpr void __iter_op_pe(_Diff __x, _Tuple&& __tuple) noexcept(
    noexcept(::cuda::std::apply(__zv_functors::__zip_op_pe<_Diff>{__x}, ::cuda::std::forward<_Tuple>(__tuple))))
  {
    ::cuda::std::apply(__zv_functors::__zip_op_pe<_Diff>{__x}, ::cuda::std::forward<_Tuple>(__tuple));
  }
  ...
  struct __zip_op_me
  {
    ...
    template <class... _Types>
    _CCCL_API constexpr void operator()(_Types&&... __tuple_elements) const
      noexcept(noexcept((::cuda::std::invoke(__op_me{__x}, ::cuda::std::forward<_Types>(__tuple_elements)), ...)))
    {
      (::cuda::std::invoke(__op_me{__x}, ::cuda::std::forward<_Types>(__tuple_elements)), ...);
    }
  };

  template <class _Diff, class _Tuple>
  _CCCL_API static constexpr void __iter_op_me(_Diff __x, _Tuple&& __tuple) noexcept(
    noexcept(::cuda::std::apply(__zv_functors::__zip_op_me<_Diff>{__x}, ::cuda::std::forward<_Tuple>(__tuple))))
  {
    ::cuda::std::apply(__zv_functors::__zip_op_me<_Diff>{__x}, ::cuda::std::forward<_Tuple>(__tuple));
  }
  ...
  _CCCL_API static constexpr auto __iter_op_index(_Diff __n, _Tuple&& __tuple) noexcept(
    noexcept(::cuda::std::apply(__zv_functors::__zip_op_index<_Diff>{__n}, ::cuda::std::forward<_Tuple>(__tuple))))
  {
    return ::cuda::std::apply(__zv_functors::__zip_op_index<_Diff>{__n}, ::cuda::std::forward<_Tuple>(__tuple));
  }
  ...
  _CCCL_API static constexpr auto __iter_move(_Tuple&& __tuple) noexcept(
    noexcept(::cuda::std::apply(__zip_iter_move{}, ::cuda::std::forward<_Tuple>(__tuple))))
  {
    return ::cuda::std::apply(__zip_iter_move{}, ::cuda::std::forward<_Tuple>(__tuple));
  }

  template <class _Tuple1, class _Tuple2, size_t... _Indices>
  _CCCL_API static constexpr void
  __iter_swap(_Tuple1&& __tuple1, _Tuple2&& __tuple2, index_sequence<_Indices...>) noexcept(
    __all<noexcept(::cuda::std::ranges::iter_swap(
      ::cuda::std::get<_Indices>(::cuda::std::declval<_Tuple1>()),
      ::cuda::std::get<_Indices>(::cuda::std::declval<_Tuple2>())))...>::value)
  {
    (::cuda::std::ranges::iter_swap(::cuda::std::get<_Indices>(::cuda::std::forward<_Tuple1>(__tuple1)),
                                    ::cuda::std::get<_Indices>(::cuda::std::forward<_Tuple2>(__tuple2))),
     ...);
  }
  ...
  _CCCL_API static constexpr void __iter_swap(_Tuple1&& __tuple1, _Tuple2&& __tuple2) noexcept(noexcept(
    __zv_functors::__iter_swap(::cuda::std::forward<_Tuple1>(__tuple1),
                               ...
                               ::cuda::std::make_index_sequence<tuple_size<remove_cvref_t<_Tuple1>>::value>())))
  {
...
template <bool _Const, class... _Views>
_CCCL_CONCEPT __zip_all_bidirectional = (bidirectional_range<__maybe_const<_Const, _Views>> && ...);

template <bool _Const, class... _Views>
_CCCL_CONCEPT __zip_all_forward = (forward_range<__maybe_const<_Const, _Views>> && ...);
...
public:
  ...
  _CCCL_API constexpr __zip_iterator(__zip_iterator<!_OtherConst, _Views...> __i)
  ...
  _CCCL_API constexpr __zip_iterator& operator++()
  {
  ...
  _CCCL_TEMPLATE(bool _OtherConst = _Const)
  _CCCL_REQUIRES((!__zip_all_forward<_OtherConst, _Views...>) )
  ...
  _CCCL_TEMPLATE(bool _OtherConst = _Const)
  _CCCL_REQUIRES(__zip_all_forward<_OtherConst, _Views...>)
  _CCCL_API constexpr __zip_iterator operator++(int)
  {
    auto __tmp = *this;
    ++*this;
    return __tmp;
  ...
  _CCCL_TEMPLATE(bool _OtherConst = _Const)
  _CCCL_REQUIRES(__zip_all_bidirectional<_OtherConst, _Views...>)
  _CCCL_API constexpr __zip_iterator& operator--()
  {
  ...
  _CCCL_TEMPLATE(bool _OtherConst = _Const)
  _CCCL_REQUIRES(__zip_all_random_access<_OtherConst, _Views...>)
  _CCCL_API constexpr __zip_iterator& operator+=(difference_type __x)
  {
  ...
  friend _CCCL_API constexpr auto operator==(const __zip_iterator& __x, const __zip_iterator& __y)
    _CCCL_TRAILING_REQUIRES(bool)(__all_equality_comparable<_OtherConst>)
  {
  ...
  template <bool _OtherConst = _Const>
  friend _CCCL_API constexpr auto operator<(const __zip_iterator& __x, const __zip_iterator& __y)
    _CCCL_TRAILING_REQUIRES(bool)(__zip_all_random_access<_OtherConst, _Views...>)
  {
    return __x.__current_ < __y.__current_;
  }
  ...
  template <bool _OtherConst = _Const>
  friend _CCCL_API constexpr auto operator+(const __zip_iterator& __i, difference_type __n)
    _CCCL_TRAILING_REQUIRES(__zip_iterator)(__zip_all_random_access<_OtherConst, _Views...>)
  {
    auto __r = __i;
    __r += __n;
    return __r;
  ...
  template <bool _OtherConst = _Const>
  friend _CCCL_API constexpr auto operator+(difference_type __n, const __zip_iterator& __i)
    _CCCL_TRAILING_REQUIRES(__zip_iterator)(__zip_all_random_access<_OtherConst, _Views...>)
  {
    return __i + __n;
  }
  ...
  template <bool _OtherConst = _Const>
  friend _CCCL_API constexpr auto operator-(const __zip_iterator& __x, const __zip_iterator& __y)
    _CCCL_TRAILING_REQUIRES(difference_type)(__all_sized_sentinel<_OtherConst>)
  {
  ...
  static constexpr bool __all_nothrow_iter_movable =
    (noexcept(::cuda::std::ranges::iter_move(declval<const iterator_t<__maybe_const<_OtherConst, _Views>>&>())) && ...)
  ...
  friend _CCCL_API constexpr auto iter_move(const __zip_iterator& __i) noexcept(__all_nothrow_iter_movable<_Const2>)
  {
  ...
  iter_swap(const __zip_iterator& __l, const __zip_iterator& __r) noexcept(__all_noexcept_swappable<_OtherConst>)
    _CCCL_TRAILING_REQUIRES(void)(__all_indirectly_swappable<_OtherConst>)
  {
...
class __zip_sentinel
{
  ...
  template <bool _OtherConst>
  _CCCL_API static constexpr decltype(auto) __iter_current(__iterator<_OtherConst> const& __it)
  {
...
public:
  ...
  template <bool _OtherConst>
  friend _CCCL_API constexpr auto operator==(const __iterator<_OtherConst>& __x, const __zip_sentinel& __y)
    _CCCL_TRAILING_REQUIRES(bool)(__all_sentinel<_OtherConst>)
  {
...
#if _CCCL_STD_VER <= 2017
  template <bool _OtherConst>
  friend _CCCL_API constexpr auto operator==(const __zip_sentinel& __x, const __iterator<_OtherConst>& __y)
    _CCCL_TRAILING_REQUIRES(bool)(__all_sentinel<_OtherConst>)
  {
  ...
  template <bool _OtherConst>
  friend _CCCL_API constexpr auto operator-(const __iterator<_OtherConst>& __x, const __zip_sentinel& __y)
    _CCCL_TRAILING_REQUIRES(_OtherDiff<_OtherConst>)(__all_sized_sentinel<_OtherConst>)
  {
...
struct __fn
{
  ...
  _CCCL_API constexpr auto operator()(_Ranges&&... __rs) const
    noexcept(noexcept(zip_view<all_t<_Ranges>...>(::cuda::std::forward<_Ranges>(__rs)...)))
      -> zip_view<all_t<_Ranges>...>
  {
...
_LIBCUDACXX_BEGIN_NAMESPACE_STD
template <bool _Const, class... _Views>
struct _IsFancyPointer<::cuda::std::ranges::__msvc_ambiguous_war::__zip_iterator<_Const, _Views...>> : false_type
{};
_LIBCUDACXX_END_NAMESPACE_STD
