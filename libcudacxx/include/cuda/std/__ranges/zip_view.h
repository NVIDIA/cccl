...
_LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY auto __tuple_or_pair_test() -> pair<_Tp, _Up>;

template <class... _Types>
_LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY auto __tuple_or_pair_test()
...
struct __zv_functors
{
  ...
  {
    template <class... _Types>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __tuple_or_pair<
      invoke_result_t<decltype(_CUDA_VRANGES::begin)&, _Types>...>
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr auto __view_begin(_Tuple&& __tuple) noexcept(
  ...
  struct __zip_end
  {
    template <class... _Types>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __tuple_or_pair<
      invoke_result_t<decltype(_CUDA_VRANGES::end)&, _Types>...>
    operator()(_Types&&... __tuple_elements) const
  ...
  template <class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr auto __view_end(_Tuple&& __tuple) noexcept(
  ...
  struct __zip_size
  {
    ...
    __get_min(_Sizes&&... __tuple_sizes) noexcept
    {
    ...
    operator()(_Types&&... __tuple_elements) const noexcept(noexcept(
  ...
  template <class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr auto __view_size(_Tuple&& __tuple) noexcept(
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr bool
  ...
  struct __zip_op_star
  {
    struct __op_star
    {
      ...
      _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr decltype(auto) operator()(_Iter& __i) const
    ...
    template <class... _Types>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Types&&... __tuple_elements) const
  ...
  template <class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr auto
  __iter_op_star(_Tuple&& __tuple) noexcept(
  ...
  struct __zip_op_increment
  {
    ...
    {
      template <class _Iter>
      _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr void operator()(_Iter& __i) const
        noexcept(noexcept(++__i))
      {
        ++__i;
      }
    ...
    template <class... _Types>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr void operator()(_Types&&... __tuple_elements) const
  ...
  template <class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr void
  __iter_op_increment(_Tuple&& __tuple) noexcept(
  ...
  template <class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr void
  __iter_op_decrement(_Tuple&& __tuple) noexcept(
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr void
  __iter_op_pe(_Diff __x, _Tuple&& __tuple) noexcept(
  ...
  template <class _Diff, class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr void
  __iter_op_me(_Diff __x, _Tuple&& __tuple) noexcept(
  ...
  template <class _Diff, class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr auto
  __iter_op_index(_Diff __n, _Tuple&& __tuple) noexcept(
  ...
  struct __op_comp_abs
  {
    ...
    template <class _Diff>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr _Diff
    __abs(_Diff __t) noexcept(noexcept(__t < 0 ? -__t : __t))
    {
      return __t < 0 ? -__t : __t;
    }

    template <class _Diff>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr bool
    operator()(const _Diff& __x, const _Diff& __y) const
  ...
  struct __zip_iter_move
  {
    template <class... _Types>
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __tuple_or_pair<
      invoke_result_t<decltype(_CUDA_VRANGES::iter_move)&, _Types>...>
    operator()(_Types&&... __tuple_elements) const
  ...
  template <class _Tuple>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr auto __iter_move(_Tuple&& __tuple) noexcept(
  ...
  template <class _Tuple1, class _Tuple2, size_t... _Indices>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr void
  __iter_swap(_Tuple1&& __tuple1,
              _Tuple2&& __tuple2,
              index_sequence<_Indices...>) noexcept(__all_noexcept_swappable<_Tuple1, _Tuple2, _Indices...>)
  {
  ...
  template <class _Tuple1, class _Tuple2>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr void
  __iter_swap(_Tuple1&& __tuple1, _Tuple2&& __tuple2) noexcept(noexcept(__zv_functors::__iter_swap(
...
template <bool _Const, class... _Views>
_LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto __get_zip_view_iterator_tag()
{
...
public:
  _LIBCUDACXX_HIDE_FROM_ABI zip_view() = default;

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit zip_view(_Views... __views)
...
public:
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __zip_iterator(
  ...
  _LIBCUDACXX_HIDE_FROM_ABI __zip_iterator() = default;
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __zip_iterator(
    __zip_iterator<!_OtherConst, _Views...> __i)
      : __current_(_CUDA_VSTD::move(__i.__current_))
  {}

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator*() const
  {
    return __zv_functors::__iter_op_star(__current_);
  }

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __zip_iterator& operator++()
  {
  ...
  _LIBCUDACXX_TEMPLATE(bool _OtherConst = _Const)
  _LIBCUDACXX_REQUIRES(__zip_all_forward<_OtherConst, _Views...>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __zip_iterator operator++(int)
  {
    auto __tmp = *this;
    ++*this;
    return __tmp;
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __zip_iterator& operator+=(difference_type __x)
  {
  ...
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto
  operator==(const __zip_iterator& __x, const __zip_iterator& __y)
...
#  ifndef _LIBCUDACXX_HAS_NO_SPACESHIP_OPERATOR
  ...
  template <bool _OtherConst = _Const>
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto
  operator<=>(const __zip_iterator& __x, const __zip_iterator& __y) _LIBCUDACXX_TRAILING_REQUIRES(bool)(
...
#  endif // _LIBCUDACXX_HAS_NO_SPACESHIP_OPERATOR
  ...
  template <bool _OtherConst = _Const>
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto
  operator+(const __zip_iterator& __i, difference_type __n)
  ...
  template <bool _OtherConst = _Const>
  friend _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto
  operator+(difference_type __n, const __zip_iterator& __i)
    _LIBCUDACXX_TRAILING_REQUIRES(__zip_iterator)(__zip_all_random_access<_OtherConst, _Views...>)
  {
    return __i + __n;
  }
...
class __zip_sentinel
{
  ...
  template <bool _OtherConst>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr decltype(auto)
  __iter_current(__iterator<_OtherConst> const& __it)
  {
    return (__it.__current_);
  }

public:
  _LIBCUDACXX_HIDE_FROM_ABI __zip_sentinel() = default;

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __zip_sentinel(
  ...
  _LIBCUDACXX_TEMPLATE(bool _OtherConst = _Const)
  _LIBCUDACXX_REQUIRES(_OtherConst _LIBCUDACXX_AND __all_convertible<_OtherConst>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __zip_sentinel(
    __zip_sentinel<!_OtherConst, _Views...> __i)
...
template <class... _Views>
_LIBCUDACXX_INLINE_VAR constexpr bool enable_borrowed_range<zip_view<_Views...>> =
...
struct __fn
{
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()() const noexcept
  {
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Ranges&&... __rs) const
    noexcept(noexcept(zip_view<all_t<_Ranges>...>(_CUDA_VSTD::forward<_Ranges>(__rs)...)))
...
{
_LIBCUDACXX_CPO_ACCESSIBILITY auto zip = __zip::__fn{};
} // namespace __cpo
