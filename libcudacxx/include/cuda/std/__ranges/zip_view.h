...
struct __zv_functors
{
  ...
  {
    template <class... _Types>
    _CCCL_API constexpr __tuple_or_pair<invoke_result_t<decltype(_CUDA_VRANGES::begin)&, _Types>...>
  ...
  {
    template <class... _Types>
    _CCCL_API constexpr __tuple_or_pair<invoke_result_t<decltype(_CUDA_VRANGES::end)&, _Types>...>
    operator()(_Types&&... __tuple_elements) const
  ...
  struct __zip_size
  {
    ...
    template <class... _Types>
    _CCCL_API constexpr auto operator()(_Types&&... __tuple_elements) const noexcept(noexcept(
  ...
  {
    template <class... _Types>
    _CCCL_API constexpr __tuple_or_pair<invoke_result_t<decltype(_CUDA_VRANGES::iter_move)&, _Types>...>
    operator()(_Types&&... __tuple_elements) const
