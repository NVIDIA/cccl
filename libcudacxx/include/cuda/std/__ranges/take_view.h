...
public:
  ...
  public:
    ...
    _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __sentinel(sentinel_t<_Base> __end)
    ...
    _LIBCUDACXX_INLINE_VISIBILITY constexpr __sentinel(__sentinel<!_OtherConst> __s)
        : __end_(_CUDA_VSTD::move(__s.__end_))
    {}

    _LIBCUDACXX_INLINE_VISIBILITY constexpr sentinel_t<_Base> base() const
    {
      return __end_;
    }

    _LIBCUDACXX_INLINE_VISIBILITY friend constexpr bool operator==(const _Iter<_Const>& __lhs, const __sentinel& __rhs)
    {
      return __lhs.count() == 0 || __lhs.base() == __rhs.__end_;
    }
#  if _CCCL_STD_VER <= 2017
    _LIBCUDACXX_INLINE_VISIBILITY friend constexpr bool operator==(const __sentinel& __lhs, const _Iter<_Const>& __rhs)
    {
...
#  endif // _CCCL_STD_VER <= 2017
    ...
    _LIBCUDACXX_INLINE_VISIBILITY friend constexpr auto
...
#  if _CCCL_STD_VER >= 2020
  _LIBCUDACXX_HIDE_FROM_ABI take_view()
    requires default_initializable<_View>
  = default;
#  else // ^^^ C++20 ^^^ / vvv C++17 vvv
  _LIBCUDACXX_TEMPLATE(class _View2 = _View)
  _LIBCUDACXX_REQUIRES(default_initializable<_View2>)
  _LIBCUDACXX_INLINE_VISIBILITY constexpr take_view() noexcept(is_nothrow_default_constructible_v<_View2>) {}
#  endif // _CCCL_STD_VER <= 2017

  _LIBCUDACXX_INLINE_VISIBILITY constexpr take_view(_View __base, range_difference_t<_View> __count)
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr _View base() &&
  {
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr auto begin() const
  {
  ...
  _LIBCUDACXX_TEMPLATE(class _View2 = _View)
  _LIBCUDACXX_REQUIRES((!__simple_view<_View2>) )
  _LIBCUDACXX_INLINE_VISIBILITY constexpr auto end()
  {
    if constexpr (sized_range<_View>)
    {
      if constexpr (random_access_range<_View>)
  ...
  _LIBCUDACXX_TEMPLATE(class _View2 = _View)
  _LIBCUDACXX_REQUIRES(range<const _View2>)
  _LIBCUDACXX_INLINE_VISIBILITY constexpr auto end() const
  {
    if constexpr (sized_range<const _View>)
    {
      if constexpr (random_access_range<const _View>)
  ...
  _LIBCUDACXX_INLINE_VISIBILITY constexpr auto size()
  {
...
struct __fn
{
  ...
  _CCCL_NODISCARD _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Range&& __rng, _Np&& __n) const
  ...
  _CCCL_NODISCARD _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Range&& __range, _Np&& __n) const
    noexcept(noexcept(views::repeat(*__range.__value_,
  ...
  _CCCL_NODISCARD _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Np&& __n) const
