...
_CCCL_CONCEPT_FRAGMENT(__can_single_view_, requires(_Range&& __range)(typename(single_view<decay_t<_Range>>)));

template <class _Range>
_CCCL_CONCEPT __can_single_view = _CCCL_FRAGMENT(__can_single_view_, _Range);
