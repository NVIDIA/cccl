...
public:
  ...
  _CCCL_API constexpr _View base() const&
  {
    return __base_;
  }
...
{
  _CCCL_API static constexpr auto __get_iterator_category() noexcept
  {
    using _Result = decltype(::cuda::std::get<_Np>(*::cuda::std::declval<iterator_t<_Base>>()));
...
class __elements_view_iterator : public __elements_view_iterator_category_base<__maybe_const<_Const, _View>, _Np>
{
  ...
  _CCCL_API static constexpr decltype(auto) __get_element(const iterator_t<_Base>& __i)
  {
  ...
  _CCCL_API static constexpr auto __get_iterator_concept() noexcept
  {
...
public:
  ...
  _CCCL_API constexpr const iterator_t<_Base>& base() const& noexcept
  {
    return __current_;
  }

  _CCCL_API constexpr iterator_t<_Base> base() &&
  {
  ...
  friend _CCCL_API constexpr auto operator==(const __elements_view_iterator& __x, const __elements_view_iterator& __y)
  ...
  template <bool _Const2 = _Const>
  friend _CCCL_API constexpr auto operator+(const __elements_view_iterator& __x, difference_type __y)
  ...
  template <bool _Const2 = _Const>
  friend _CCCL_API constexpr auto operator+(difference_type __x, const __elements_view_iterator& __y)
    _CCCL_TRAILING_REQUIRES(__elements_view_iterator)(random_access_range<_Base2<_Const2>>)
  {
    return __y + __x;
  }
  ...
  friend _CCCL_API constexpr auto operator-(const __elements_view_iterator& __x, const __elements_view_iterator& __y)
    _CCCL_TRAILING_REQUIRES(difference_type)(
      sized_sentinel_for<iterator_t<_Base2<_Const2>>, iterator_t<_Base2<_Const2>>>)
  {
    return __x.__current_ - __y.__current_;
  }
};
...
private:
  ...
  _CCCL_API static constexpr decltype(auto) __get_current(const __elements_view_iterator<_View, _Np, _AnyConst>& __iter)
  {
...
public:
  ...
  _CCCL_API constexpr sentinel_t<_Base> base() const
  {
    return __end_;
  }
