...
#ifndef _CUDA_STD___RANGES_ELEMENTS_VIEW_H
#define _CUDA_STD___RANGES_ELEMENTS_VIEW_H
...
class elements_view : public view_interface<elements_view<_View, _Np>>
{
  ...
  using __iterator _CCCL_NODEBUG = __elements_view_iterator<_View, _Np, _Const>;

  template <bool _Const>
  using __sentinel _CCCL_NODEBUG = __elements_view_sentinel<_View, _Np, _Const>;
...
public:
  ...
  _CCCL_API constexpr elements_view() noexcept(is_nothrow_default_constructible_v<_View2>)
      : view_interface<elements_view<_View, _Np>>{}
  {}
#endif // !_CCCL_HAS_CONCEPTS()

  _CCCL_API constexpr explicit elements_view(_View __base) noexcept(is_nothrow_move_constructible_v<_View>)
      : view_interface<elements_view<_View, _Np>>{}
  ...
  [[nodiscard]] _CCCL_API constexpr _View base() const& noexcept(is_nothrow_copy_constructible_v<_View>)
  {
    return __base_;
  }
  ...
  {
    return __iterator</*_Const=*/false>{::cuda::std::ranges::begin(__base_)};
  }
  ...
  {
    return __iterator</*_Const=*/true>{::cuda::std::ranges::begin(__base_)};
  }
  ...
  [[nodiscard]] _CCCL_API constexpr auto end()
  {
    ...
    {
      return __iterator</*_Const=*/false>{::cuda::std::ranges::end(__base_)};
    }
    else
    {
      return __sentinel</*_Const=*/false>{::cuda::std::ranges::end(__base_)};
    }
    _CCCL_UNREACHABLE();
  }
  ...
  [[nodiscard]] _CCCL_API constexpr auto end() const
  {
    if constexpr (common_range<_View>)
    {
      return __iterator</*_Const=*/true>{::cuda::std::ranges::end(__base_)};
    }
    else
    {
      return __sentinel</*_Const=*/true>{::cuda::std::ranges::end(__base_)};
    }
    _CCCL_UNREACHABLE();
  }
...
{
  [[nodiscard]] _CCCL_API static constexpr auto __get_iterator_category() noexcept
  {
    using _Result _CCCL_NODEBUG = decltype(::cuda::std::get<_Np>(*::cuda::std::declval<iterator_t<_Base>>()));
    using _Cat _CCCL_NODEBUG    = typename iterator_traits<iterator_t<_Base>>::iterator_category;
...
class __elements_view_iterator : public __elements_view_iterator_category_base<__maybe_const<_Const, _View>, _Np>
{
  ...
  using _Base2 _CCCL_NODEBUG = __maybe_const<_OtherConst, _View>;

  iterator_t<_Base> __current_ = iterator_t<_Base>();

  [[nodiscard]] _CCCL_API static constexpr decltype(auto) __get_element(const iterator_t<_Base>& __i)
  {
    if constexpr (is_reference_v<range_reference_t<_Base>>)
    {
      return ::cuda::std::get<_Np>(*__i);
    }
    else
    {
      ...
      return _Element{::cuda::std::get<_Np>(*__i)};
#else // ^^^ _CCCL_COMPILER_MSVC ^^^ / vvv !_CCCL_COMPILER_MSVC vvv
      return static_cast<_Element>(::cuda::std::get<_Np>(*__i));
#endif // !_CCCL_COMPILER_MSVC
    }
    _CCCL_UNREACHABLE();
  }

  [[nodiscard]] _CCCL_API static constexpr auto __get_iterator_concept() noexcept
  {
...
public:
  ...
  _CCCL_REQUIRES(default_initializable<iterator_t<_Base2<_Const2>>>)
  _CCCL_API constexpr __elements_view_iterator() noexcept(
    is_nothrow_default_constructible_v<iterator_t<_Base2<_Const2>>>)
  {}
#endif // !_CCCL_HAS_CONCEPTS()

  _CCCL_API constexpr explicit __elements_view_iterator(iterator_t<_Base> __current) noexcept(
  ...
  _CCCL_API constexpr __elements_view_iterator(__elements_view_iterator<_View, _Np, !_Const2> __i)
  ...
  _CCCL_API constexpr __elements_view_iterator& operator++()
  {
    ++__current_;
    return *this;
  }
  ...
  _CCCL_TEMPLATE(bool _Const2 = _Const)
  _CCCL_REQUIRES((!forward_range<_Base2<_Const2>>) )
  ...
  _CCCL_TEMPLATE(bool _Const2 = _Const)
  _CCCL_REQUIRES(forward_range<_Base2<_Const2>>)
  _CCCL_API constexpr __elements_view_iterator operator++(int)
  {
    auto __temp = *this;
  ...
  _CCCL_TEMPLATE(bool _Const2 = _Const)
  _CCCL_REQUIRES(bidirectional_range<_Base2<_Const2>>)
  _CCCL_API constexpr __elements_view_iterator& operator--()
  {
    --__current_;
    return *this;
  ...
  _CCCL_TEMPLATE(bool _Const2 = _Const)
  _CCCL_REQUIRES(random_access_range<_Base2<_Const2>>)
  _CCCL_API constexpr __elements_view_iterator& operator+=(difference_type __n)
  {
    __current_ += __n;
    return *this;
  }
  ...
  [[nodiscard]] friend _CCCL_API constexpr auto
  operator==(const __elements_view_iterator& __x, const __elements_view_iterator& __y)
    _CCCL_TRAILING_REQUIRES(bool)(equality_comparable<iterator_t<_Base2<_Const2>>>)
  {
  ...
  [[nodiscard]] friend _CCCL_API constexpr auto
  operator<(const __elements_view_iterator& __x, const __elements_view_iterator& __y)
    _CCCL_TRAILING_REQUIRES(bool)(random_access_range<_Base2<_Const2>>)
  {
    return __x.__current_ < __y.__current_;
  }
...
#if _LIBCUDACXX_HAS_SPACESHIP_OPERATOR()
  [[nodiscard]]
  _CCCL_API friend constexpr auto operator<=>(const __elements_view_iterator& __x, const __elements_view_iterator& __y)
  ...
  template <bool _Const2 = _Const>
  [[nodiscard]] friend _CCCL_API constexpr auto operator+(const __elements_view_iterator& __x, difference_type __y)
    _CCCL_TRAILING_REQUIRES(__elements_view_iterator)(random_access_range<_Base2<_Const2>>)
  {
    return __elements_view_iterator{__x} += __y;
  }

  template <bool _Const2 = _Const>
  [[nodiscard]] friend _CCCL_API constexpr auto operator+(difference_type __x, const __elements_view_iterator& __y)
    _CCCL_TRAILING_REQUIRES(__elements_view_iterator)(random_access_range<_Base2<_Const2>>)
  {
    return __y + __x;
  }
  ...
  template <bool _Const2 = _Const>
  [[nodiscard]] friend _CCCL_API constexpr auto
  operator-(const __elements_view_iterator& __x, const __elements_view_iterator& __y) _CCCL_TRAILING_REQUIRES(
...
class __elements_view_sentinel
{
  ...
  [[nodiscard]] _CCCL_API static constexpr decltype(auto)
...
public:
  ...
  _CCCL_API constexpr explicit __elements_view_sentinel(sentinel_t<_Base> __end)
      : __end_{::cuda::std::move(__end)}
  {}

  _CCCL_TEMPLATE(bool _Const2 = _Const)
  _CCCL_REQUIRES(_Const2 _CCCL_AND convertible_to<sentinel_t<_View>, sentinel_t<_Base2<_Const2>>>)
  _CCCL_API constexpr __elements_view_sentinel(__elements_view_sentinel<_View, _Np, !_Const2> __other)
      : __end_{::cuda::std::move(__other.__end_)}
  {}
...
_CCCL_BEGIN_NAMESPACE_CPO(__elements)
...
#endif // _CUDA_STD___RANGES_ELEMENTS_VIEW_H
