...
_LIBCUDACXX_INLINE_VAR constexpr bool __returnable_element = is_reference_v<_Tp>;
...
#  else // ^^^ C++20 ^^^ / vvv C++17 vvv
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr elements_view() noexcept(
    is_nothrow_default_constructible_v<_View2>)
      : view_interface<elements_view<_View, _Np>>()
  {}
#  endif // _CCCL_STD_VER <= 2017

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit elements_view(_View __base) noexcept(
...
{
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr auto __get_iterator_category() noexcept
  {
...
class __elements_view_iterator : public __elements_view_iterator_category_base<__maybe_const<_Const, _View>, _Np>
{
  ...
  __get_element(const iterator_t<_Base>& __i)
  {
...
#  endif // !_CCCL_COMPILER_MSVC
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY static constexpr auto __get_iterator_concept() noexcept
  {
...
#  if _CCCL_STD_VER >= 2020
  __elements_view_iterator()
    requires default_initializable<iterator_t<_Base>>
  = default;
#  else // ^^^ C++20 ^^^ / vvv C++17 vvv
  _LIBCUDACXX_TEMPLATE(bool _Const2 = _Const)
  _LIBCUDACXX_REQUIRES(default_initializable<iterator_t<_Base2<_Const2>>>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __elements_view_iterator() noexcept(
    is_nothrow_default_constructible_v<iterator_t<_Base2<_Const2>>>)
  {}
#  endif // _CCCL_STD_VER <= 2017

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __elements_view_iterator(
    iterator_t<_Base> __current) noexcept(is_nothrow_move_constructible_v<iterator_t<_Base>>)
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __elements_view_iterator(
    __elements_view_iterator<_View, _Np, !_Const2> __i)
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __elements_view_iterator& operator++()
  {
    ++__current_;
    return *this;
  }
  ...
  _LIBCUDACXX_TEMPLATE(bool _Const2 = _Const)
  _LIBCUDACXX_REQUIRES(forward_range<_Base2<_Const2>>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __elements_view_iterator operator++(int)
  {
    auto temp = *this;
    ++__current_;
    return temp;
  ...
  _LIBCUDACXX_TEMPLATE(bool _Const2 = _Const)
  _LIBCUDACXX_REQUIRES(random_access_range<_Base2<_Const2>>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr decltype(auto) operator[](difference_type __n) const
  {
...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __elements_view_sentinel(
    sentinel_t<_Base> __end)
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __elements_view_sentinel(
    __elements_view_sentinel<_View, _Np, !_Const2> __other)
...
template <class _Tp, size_t _Np>
_LIBCUDACXX_INLINE_VAR constexpr bool enable_borrowed_range<elements_view<_Tp, _Np>> = enable_borrowed_range<_Tp>;
...
template <size_t _Np>
_LIBCUDACXX_INLINE_VAR constexpr auto elements = __elements::__fn<_Np>{};
#  else // ^^^ _CCCL_COMPILER_MSVC ^^^ / vvv !_CCCL_COMPILER_MSVC vvv
template <size_t _Np>
