...
public:
  ...
  _CCCL_API constexpr drop_while_view() noexcept(is_nothrow_default_constructible_v<_View2>
                                                 && is_nothrow_default_constructible_v<_Pred>)
      : view_interface<drop_while_view<_View, _Pred>>()
  {}
#endif // !_CCCL_HAS_CONCEPTS()

  _CCCL_API constexpr drop_while_view(_View __base, _Pred __pred)
      : view_interface<drop_while_view<_View, _Pred>>()
  ...
  _CCCL_API constexpr const _Pred& pred() const
  {
    return *__pred_;
  }
