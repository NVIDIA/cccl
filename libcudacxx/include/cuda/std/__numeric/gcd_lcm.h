...
template <class _Tp>
constexpr _CCCL_API _Tp __gcd(_Tp __m, _Tp __n)
{
...
constexpr _CCCL_API common_type_t<_Tp, _Up> gcd(_Tp __m, _Up __n)
{
...
template <class _Tp, class _Up>
constexpr _CCCL_API common_type_t<_Tp, _Up> lcm(_Tp __m, _Up __n)
{
  static_assert((_CCCL_TRAIT(is_integral, _Tp) && _CCCL_TRAIT(is_integral, _Up)),
