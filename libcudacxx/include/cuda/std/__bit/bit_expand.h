...
#ifndef _CUDA_STD___BIT_BIT_EXPAND_H
#define _CUDA_STD___BIT_BIT_EXPAND_H
...
[[nodiscard]] _CCCL_API constexpr _Tp bit_expand(_Tp __v, const _Tp __mask) noexcept
{
...
#endif // _CUDA_STD___BIT_BIT_EXPAND_H
