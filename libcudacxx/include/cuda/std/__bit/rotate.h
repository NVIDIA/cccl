...
{
  static_assert(__cccl_is_unsigned_integer_v<_Tp>, "__rotl requires unsigned");
...
{
  static_assert(__cccl_is_unsigned_integer_v<_Tp>, "__rotr requires unsigned");
  using __nlt = numeric_limits<_Tp>;
...
template <class _Tp>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI constexpr enable_if_t<__cccl_is_unsigned_integer_v<_Tp>, _Tp>
