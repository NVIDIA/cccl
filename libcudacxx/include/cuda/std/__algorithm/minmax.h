...
_CCCL_NODISCARD inline _LIBCUDACXX_HIDE_FROM_ABI _CCCL_CONSTEXPR_CXX14 pair<const _Tp&, const _Tp&>
...
template <class _Tp, class _Compare>
_CCCL_NODISCARD inline _LIBCUDACXX_HIDE_FROM_ABI _CCCL_CONSTEXPR_CXX14 pair<_Tp, _Tp>
...
template <class _Tp>
_CCCL_NODISCARD inline _LIBCUDACXX_HIDE_FROM_ABI _CCCL_CONSTEXPR_CXX14 pair<_Tp, _Tp> minmax(initializer_list<_Tp> __t)
{
