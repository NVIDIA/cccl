...
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI constexpr pair<_InputIterator1, _InputIterator2>
...
_CCCL_EXEC_CHECK_DISABLE
template <class _InputIterator1, class _InputIterator2, class _BinaryPredicate>
_CCCL_NODISCARD _LIBCUDACXX_HIDE_FROM_ABI constexpr pair<_InputIterator1, _InputIterator2> mismatch(
