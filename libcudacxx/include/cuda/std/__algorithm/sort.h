...
_LIBCUDACXX_HIDE_FROM_ABI constexpr unsigned
...
_LIBCUDACXX_HIDE_FROM_ABI void __sort5(
...
_LIBCUDACXX_HIDE_FROM_ABI void __cond_swap(_RandomAccessIterator __x, _RandomAccessIterator __y, _Compare __c)
{
...
_LIBCUDACXX_HIDE_FROM_ABI void __sort3_maybe_branchless(
...
template <class,
          ...
          class _RandomAccessIterator,
          enable_if_t<__use_branchless_sort<_Compare, _RandomAccessIterator>::value, int> = 0>
_LIBCUDACXX_HIDE_FROM_ABI void __sort4_maybe_branchless(
...
template <class _AlgPolicy,
          ...
          class _RandomAccessIterator,
          enable_if_t<__use_branchless_sort<_Compare, _RandomAccessIterator>::value, int> = 0>
_LIBCUDACXX_HIDE_FROM_ABI void __sort5_maybe_branchless(
  _RandomAccessIterator __x1,
  _RandomAccessIterator __x2,
  _RandomAccessIterator __x3,
  _RandomAccessIterator __x4,
...
_LIBCUDACXX_HIDE_FROM_ABI void __swap_bitmap_pos(
  _RandomAccessIterator __first, _RandomAccessIterator __last, uint64_t& __left_bitset, uint64_t& __right_bitset)
{
  ...
  {
    difference_type __tz_left  = __cccl_ctz(__left_bitset);
    __left_bitset              = __cccl_blsr(__left_bitset);
    difference_type __tz_right = __cccl_ctz(__right_bitset);
...
template <class _AlgPolicy,
          ...
          class _RandomAccessIterator,
          class _ValueType = typename iterator_traits<_RandomAccessIterator>::value_type>
_LIBCUDACXX_HIDE_FROM_ABI void __bitset_partition_partial_blocks(
...
template <class _AlgPolicy, class _RandomAccessIterator>
_LIBCUDACXX_HIDE_FROM_ABI void __swap_bitmap_pos_within(
  _RandomAccessIterator& __first, _RandomAccessIterator& __lm1, uint64_t& __left_bitset, uint64_t& __right_bitset)
{
  ...
  if (__left_bitset)
  {
    ...
    {
      difference_type __tz_left = __detail::__block_size - 1 - _CUDA_VSTD::__cccl_clz(__left_bitset);
  ...
  else if (__right_bitset)
  {
    ...
    {
      difference_type __tz_right = __detail::__block_size - 1 - _CUDA_VSTD::__cccl_clz(__right_bitset);
...
_LIBCUDACXX_HIDE_FROM_ABI _CUDA_VSTD::pair<_RandomAccessIterator, bool>
...
template <class _AlgPolicy, class _RandomAccessIterator, class _Compare>
_LIBCUDACXX_HIDE_FROM_ABI _RandomAccessIterator
...
_LIBCUDACXX_HIDE_FROM_ABI void __introsort(
  _RandomAccessIterator __first,
...
_LIBCUDACXX_HIDE_FROM_ABI _Number __log2i(_Number __n)
{
  if (__n == 0)
  {
    return 0;
  ...
  {
    return sizeof(unsigned) * CHAR_BIT - 1 - _CUDA_VSTD::__cccl_clz(static_cast<unsigned>(__n));
  }
  if (sizeof(__n) <= sizeof(unsigned long))
  {
    return sizeof(unsigned long) * CHAR_BIT - 1 - _CUDA_VSTD::__cccl_clz(static_cast<unsigned long>(__n));
  }
...
_LIBCUDACXX_HIDE_FROM_ABI void __sort(RandomAccessIterator first, RandomAccessIterator last, Comp comp)
{
...
_LIBCUDACXX_HIDE_FROM_ABI void __sort_dispatch(_Type* __first, _Type* __last, __less&)
{
  __less __comp{};
...
template <class _AlgPolicy, class _Type, enable_if_t<__sort_is_specialized_in_library<_Type>::value, int> = 0>
_LIBCUDACXX_HIDE_FROM_ABI void __sort_dispatch(_Type* __first, _Type* __last, less<_Type>&)
{
  __less __comp{};
  _CUDA_VSTD::__sort<__less&, _Type*>(__first, __last, __comp);
}
...
template <class _AlgPolicy, class _Type, enable_if_t<__sort_is_specialized_in_library<_Type>::value, int> = 0>
_LIBCUDACXX_HIDE_FROM_ABI void __sort_dispatch(_Type* __first, _Type* __last, less<>&)
{
  __less __comp{};
  _CUDA_VSTD::__sort<__less&, _Type*>(__first, __last, __comp);
}
...
_LIBCUDACXX_HIDE_FROM_ABI constexpr void sort(_RandomAccessIterator __first, _RandomAccessIterator __last, _Comp __comp)
{
  _CUDA_VSTD::__sort_impl<_ClassicAlgPolicy>(_CUDA_VSTD::move(__first), _CUDA_VSTD::move(__last), __comp);
}

template <class _RandomAccessIterator>
_LIBCUDACXX_HIDE_FROM_ABI constexpr void sort(_RandomAccessIterator __first, _RandomAccessIterator __last)
{
