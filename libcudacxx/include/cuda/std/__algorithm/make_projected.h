...
struct _ProjectedPred
{
  ...
  typename __invoke_of<
    _Pred&,
    decltype(_CUDA_VSTD::__invoke(_CUDA_VSTD::declval<_Proj&>(), _CUDA_VSTD::declval<_Tp>()))>::type constexpr _CCCL_API
  ...
  typename __invoke_of<
    ...
    decltype(_CUDA_VSTD::__invoke(_CUDA_VSTD::declval<_Proj&>(), _CUDA_VSTD::declval<_T2>()))>::type constexpr _CCCL_API
