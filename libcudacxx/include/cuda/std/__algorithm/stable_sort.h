...
_LIBCUDACXX_HIDE_FROM_ABI void __insertion_sort_move(
...
_LIBCUDACXX_HIDE_FROM_ABI void __merge_move_construct(
...
_LIBCUDACXX_HIDE_FROM_ABI void __merge_move_assign(
  _InputIterator1 __first1,
  _InputIterator1 __last1,
  _InputIterator2 __first2,
  _InputIterator2 __last2,
...
_LIBCUDACXX_HIDE_FROM_ABI void __stable_sort(
...
template <class _AlgPolicy, class _Compare, class _RandomAccessIterator>
_LIBCUDACXX_HIDE_FROM_ABI void __stable_sort_move(
