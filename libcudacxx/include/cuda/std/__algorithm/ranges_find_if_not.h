...
struct _Not_pred
{
  _LIBCUDACXX_INLINE_VISIBILITY constexpr _Not_pred(_Pred& __pred) noexcept
      : __pred_(__pred)
  {}
  ...
  template <class _Tp>
  _LIBCUDACXX_INLINE_VISIBILITY constexpr auto operator()(_Tp&& __e) const
  {
...
struct __fn
{
  ...
  _CCCL_NODISCARD _LIBCUDACXX_INLINE_VISIBILITY constexpr _Ip
  ...
  _CCCL_NODISCARD _LIBCUDACXX_INLINE_VISIBILITY constexpr borrowed_iterator_t<_Rp>
