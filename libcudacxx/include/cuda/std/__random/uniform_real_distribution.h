...
public:
  ...
  public:
    ...
    _LIBCUDACXX_HIDE_FROM_ABI explicit param_type(result_type __a = 0, result_type __b = 1) noexcept
        : __a_(__a)
        , __b_(__b)
    {}
...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI uniform_real_distribution() noexcept
      : uniform_real_distribution(0)
  {}
  _LIBCUDACXX_HIDE_FROM_ABI explicit uniform_real_distribution(result_type __a, result_type __b = 1) noexcept
      : __p_(param_type(__a, __b))
  {}
  _LIBCUDACXX_HIDE_FROM_ABI explicit uniform_real_distribution(const param_type& __p) noexcept
      : __p_(__p)
  {}
