...
public:
  ...
  _LIBCUDACXX_HIDE_FROM_ABI __independent_bits_engine(_Engine& __e, size_t __w) noexcept
      : __e_(__e)
      , __w_(__w)
  {
  ...
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI result_type operator()() noexcept
  {
    if constexpr (_Rp == 0)
    {
...
public:
  ...
  public:
    ...
    [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI result_type a() const noexcept
    {
      return __a_;
    }
    [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI result_type b() const noexcept
    {
      return __b_;
    }

    [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend bool operator==(const param_type& __x, const param_type& __y) noexcept
    {
...
public:
  ...
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI param_type param() const noexcept
  {
    return __p_;
  }
  _LIBCUDACXX_HIDE_FROM_ABI void param(const param_type& __p) noexcept
  {
    __p_ = __p;
  }

  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI result_type min() const noexcept
  {
    return a();
  }
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI result_type max() const noexcept
  {
    return b();
  }

  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend bool
