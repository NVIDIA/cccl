...
#ifndef _CUDA_STD___EXTREME_VALUE_DISTRIBUTION_H
#define _CUDA_STD___EXTREME_VALUE_DISTRIBUTION_H
...
public:
  ...
  operator>>(::std::basic_istream<_CharT, _Traits>& __is, extreme_value_distribution& __x)
  {
...
#endif // _CUDA_STD___EXTREME_VALUE_DISTRIBUTION_H
