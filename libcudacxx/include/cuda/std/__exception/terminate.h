...
[[noreturn]] _CCCL_API void __cccl_terminate() noexcept
{
...
_CCCL_API  terminate_handler set_terminate(terminate_handler __func) noexcept
{
  return __cccl_terminate_handler.exchange(__func);
}
_CCCL_API  terminate_handler get_terminate() noexcept
{
...
[[noreturn]] _CCCL_API void terminate() noexcept
{
  __cccl_terminate();
  _CCCL_UNREACHABLE();
}
