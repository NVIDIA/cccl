...
#  define _CCCL_TRY                                                                                     \
    if constexpr ([[maybe_unused]] ::cuda::std::__cccl_catch_any_lvalue __catch_any_lvalue_obj{}; true) \
    {
#  define _CCCL_CATCH(...)                                                       \
    }                                                                            \
    else if constexpr (false) for (__VA_ARGS__ = __catch_any_lvalue_obj; false;) \
    {
