...
struct __vl_destruct_base
{
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __vl_destruct_base() noexcept(
    is_nothrow_default_constructible_v<_Tp2>)
      : __first_()
      , __contains_{__variant_like_state::__holds_first}
  {}

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __vl_destruct_base(
    __variant_like_state __state) noexcept
      : __contains_{__state}
  {}

  template <class... _Types>
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __vl_destruct_base(
    __construct_first, _Types&&... _Args) noexcept(is_nothrow_constructible_v<_Tp, _Types...>)
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr explicit __vl_destruct_base(
    __construct_second, _Types&&... _Args) noexcept(is_nothrow_constructible_v<_Up, _Types...>)
      : __second_(_CUDA_VSTD::forward<_Types>(_Args)...)
      , __contains_{__variant_like_state::__holds_second}
  {}

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _CCCL_CONSTEXPR_CXX20 ~__vl_destruct_base()
  {
    __raw_clear();
  }

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _CCCL_CONSTEXPR_CXX20 void __raw_clear() noexcept
  {
    switch (__contains_)
    {
...
#  if defined(_CCCL_COMPILER_NVRTC) || (defined(_LIBCUDACXX_CUDACC_BELOW_11_3) && defined(_CCCL_COMPILER_CLANG))
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __variant_like(_Args&&... __args) noexcept(
...
#  if _CCCL_STD_VER >= 2020
  constexpr __variant_like(const __variant_like&)
    requires is_trivially_copy_constructible_v<_Tp> && is_trivially_copy_constructible_v<_Up>
  = default;
#  endif // _CCCL_STD_VER >= 2020

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _CCCL_CONSTEXPR_CXX20 __variant_like(
    const __variant_like& __other) noexcept(is_nothrow_copy_constructible_v<_Tp> && is_nothrow_copy_constructible_v<_Up>)
...
#  if _CCCL_STD_VER >= 2020
  constexpr __variant_like(__variant_like&&)
    requires is_trivially_move_constructible_v<_Tp> && is_trivially_move_constructible_v<_Up>
  = default;
#  endif // _CCCL_STD_VER >= 2020

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _CCCL_CONSTEXPR_CXX20 __variant_like(
    __variant_like&& __other) noexcept(is_nothrow_move_constructible_v<_Tp> && is_nothrow_move_constructible_v<_Up>)
      : __base{__other.__contains_}
  {
    switch (this->__contains_)
    {
...
#  if _CCCL_STD_VER >= 2020
  constexpr __variant_like& operator=(const __variant_like&)
...
#  endif // _CCCL_STD_VER >= 2020
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY _CCCL_CONSTEXPR_CXX20 __variant_like& operator=(
    const __variant_like& __other) noexcept(is_nothrow_copy_constructible_v<_Tp> && is_nothrow_copy_constructible_v<_Up>
...
#  if _CCCL_STD_VER >= 2020
  constexpr __variant_like& operator=(__variant_like&&)
    requires is_trivially_destructible_v<_Tp> && is_trivially_destructible_v<_Up>
...
#  endif // _CCCL_STD_VER >= 2020
  ...
  swap(__variant_like& __x,
       __variant_like& __y) noexcept(is_nothrow_move_constructible_v<_Tp2> && is_nothrow_move_constructible_v<_Up>
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr void __clear() noexcept
  {
    this->__raw_clear();
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr bool valueless_by_exception() const noexcept
  {
    return this->__contains_ == __variant_like_state::__nothing;
  }
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr bool __holds_first() const noexcept
  {
    return this->__contains_ == __variant_like_state::__holds_first;
  }
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr bool __holds_second() const noexcept
  {
