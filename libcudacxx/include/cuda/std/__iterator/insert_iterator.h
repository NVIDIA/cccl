...
public:
  ...
  _CCCL_API _CCCL_CONSTEXPR_CXX20 insert_iterator(_Container& __x, __insert_iterator_iter_t<_Container> __i)
      : container(_CUDA_VSTD::addressof(__x))
      , iter(__i)
  {}
  _CCCL_API _CCCL_CONSTEXPR_CXX20 insert_iterator& operator=(const typename _Container::value_type& __value)
  {
    iter = container->insert(iter, __value);
    ++iter;
    return *this;
  }
  _CCCL_API _CCCL_CONSTEXPR_CXX20 insert_iterator& operator=(typename _Container::value_type&& __value)
  {
    iter = container->insert(iter, _CUDA_VSTD::move(__value));
    ++iter;
    return *this;
  }
  _CCCL_API _CCCL_CONSTEXPR_CXX20 insert_iterator& operator*()
  {
    return *this;
  }
  _CCCL_API _CCCL_CONSTEXPR_CXX20 insert_iterator& operator++()
  ...
  _CCCL_API _CCCL_CONSTEXPR_CXX20 insert_iterator& operator++(int)
  {
    return *this;
  }
};
...
template <class _Container>
_CCCL_API _CCCL_CONSTEXPR_CXX20 insert_iterator<_Container>
