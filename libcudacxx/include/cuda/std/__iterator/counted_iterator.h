...
public:
  ...
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr iter_difference_t<_Iter> count() const noexcept
  {
    return __count_;
  }
  ...
  _CCCL_TEMPLATE(class _I2 = _Iter)
  _CCCL_REQUIRES(random_access_iterator<_I2>)
  _CCCL_NODISCARD_FRIEND _LIBCUDACXX_HIDE_FROM_ABI friend constexpr counted_iterator
  ...
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr iter_difference_t<_I2>
  ...
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI friend constexpr iter_difference_t<_Iter>
  ...
  _CCCL_TEMPLATE(class _I2 = _Iter)
  _CCCL_REQUIRES(random_access_iterator<_I2>)
  [[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr decltype(auto) operator[](iter_difference_t<_I2> __n) const
  {
  ...
  _CCCL_TEMPLATE(class _I2)
  _CCCL_REQUIRES(common_with<_I2, _Iter>)
  _CCCL_NODISCARD_FRIEND _LIBCUDACXX_HIDE_FROM_ABI friend constexpr strong_ordering
  operator<=>(const counted_iterator& __lhs, const counted_iterator<_I2>& __rhs) noexcept
  {
    return __rhs.__count_ <=> __lhs.__count_;
  }
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr decltype(auto) iter_move(const counted_iterator<_Iter>& __i) noexcept(
