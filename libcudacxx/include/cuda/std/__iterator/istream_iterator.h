...
public:
  ...
  _CCCL_API const _Tp& operator*() const
  {
    return __value_;
  }
  _CCCL_API const _Tp* operator->() const
  ...
  friend _CCCL_API bool operator==(const istream_iterator<_Up, _CharU, _TraitsU, _DistanceU>& __x,
                                   const istream_iterator<_Up, _CharU, _TraitsU, _DistanceU>& __y);

  friend _CCCL_API bool operator==(const istream_iterator& __i, default_sentinel_t)
  {
    return __i.__in_stream_ == nullptr;
  }
#if _CCCL_STD_VER < 2020
  friend _CCCL_API bool operator==(default_sentinel_t, const istream_iterator& __i)
  {
    return __i.__in_stream_ == nullptr;
  }
  friend _CCCL_API bool operator!=(const istream_iterator& __i, default_sentinel_t)
...
_CCCL_API bool operator==(const istream_iterator<_Tp, _CharT, _Traits, _Distance>& __x,
