...
class common_iterator
{
  struct __proxy
  {
    _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr const iter_value_t<_Iter>*
...
#  if _CCCL_STD_VER >= 2020
  _LIBCUDACXX_HIDE_FROM_ABI common_iterator()
    requires default_initializable<_Iter>
  = default;
#  else // ^^^ C++20 ^^^ / vvv C++17 vvv
  _LIBCUDACXX_TEMPLATE(class _I2 = _Iter)
  _LIBCUDACXX_REQUIRES(default_initializable<_I2>)
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr common_iterator() noexcept(
    is_nothrow_default_constructible_v<_I2>)
  {}
#  endif // _CCCL_STD_VER <= 2017

  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr common_iterator(_Iter __i) noexcept(
    is_nothrow_move_constructible_v<_Iter>)
      : __hold_(__construct_first{}, _CUDA_VSTD::move(__i))
  {}
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr common_iterator(_Sent __s) noexcept(
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr common_iterator(
    const common_iterator<_I2, _S2>& __other) noexcept(is_nothrow_constructible_v<_Iter, const _I2&>
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr common_iterator&
  operator=(const common_iterator<_I2, _S2>& __other)
  {
    __hold_ = __other.__get_hold();
    return *this;
  }
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr common_iterator& operator++()
  {
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr decltype(auto) operator++(int)
  {
    _LIBCUDACXX_ASSERT(__hold.__holds_first(), "Attempted to increment a non-dereferenceable common_iterator");
...
#  if _CCCL_STD_VER < 2020
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY friend constexpr auto
  operator==(const common_iterator& __x, const common_iterator& __y)
...
#  endif
  ...
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr __variant_like<_Iter, _Sent>& __get_hold() noexcept
  {
    return __hold_;
  }
  _LIBCUDACXX_HIDE_FROM_ABI _LIBCUDACXX_INLINE_VISIBILITY constexpr const __variant_like<_Iter, _Sent>&
  __get_hold() const noexcept
  {
    return __hold_;
  }
};
