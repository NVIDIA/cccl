...
public:
  ...
  [[nodiscard]] _CCCL_API friend constexpr month_day
  operator/(const chrono::month& __lhs, const chrono::day& __rhs) noexcept
  {
    return month_day{__lhs, __rhs};
  }

  [[nodiscard]] _CCCL_API friend constexpr month_day
  operator/(const chrono::day& __lhs, const chrono::month& __rhs) noexcept
  {
    return month_day{__rhs, __lhs};
  }

  [[nodiscard]] _CCCL_API friend constexpr month_day operator/(const chrono::month& __lhs, int __rhs) noexcept
  {
    return month_day{__lhs, chrono::day(__rhs)};
  }

  [[nodiscard]] _CCCL_API friend constexpr month_day operator/(int __lhs, const chrono::day& __rhs) noexcept
  {
    return month_day{chrono::month(__lhs), __rhs};
  }

  [[nodiscard]] _CCCL_API friend constexpr month_day operator/(const chrono::day& __lhs, int __rhs) noexcept
  {
...
public:
  ...
  [[nodiscard]] _CCCL_API friend constexpr month_day_last operator/(const chrono::month& __lhs, last_spec) noexcept
  {
    return month_day_last{__lhs};
  }

  [[nodiscard]] _CCCL_API friend constexpr month_day_last operator/(last_spec, const chrono::month& __rhs) noexcept
  {
    return month_day_last{__rhs};
  }

  [[nodiscard]] _CCCL_API friend constexpr month_day_last operator/(int __lhs, last_spec) noexcept
  {
    return month_day_last{chrono::month(__lhs)};
  }

  [[nodiscard]] _CCCL_API friend constexpr month_day_last operator/(last_spec, int __rhs) noexcept
  {
