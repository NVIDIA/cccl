...
public:
  ...
  // arithmetics
  [[nodiscard]] _CCCL_API friend constexpr month_weekday
  ...
  [[nodiscard]] _CCCL_API friend constexpr month_weekday
  operator/(int __lhs, const chrono::weekday_indexed& __rhs) noexcept
  {
  ...
  [[nodiscard]] _CCCL_API friend constexpr month_weekday
  operator/(const chrono::weekday_indexed& __lhs, int __rhs) noexcept
  {
...
public:
  ...
  // arithhmetics
  [[nodiscard]] _CCCL_API friend constexpr month_weekday_last
  ...
  [[nodiscard]] _CCCL_API friend constexpr month_weekday_last
  operator/(int __lhs, const chrono::weekday_last& __rhs) noexcept
  {
  ...
  [[nodiscard]] _CCCL_API friend constexpr month_weekday_last
  operator/(const chrono::weekday_last& __lhs, int __rhs) noexcept
  {
