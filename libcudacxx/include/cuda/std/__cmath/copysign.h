...
[[nodiscard]] _CCCL_API float copysign(float __x, float __y) noexcept
{
...
[[nodiscard]] _CCCL_API float copysignf(float __x, float __y) noexcept
{
#if defined(_CCCL_BUILTIN_COPYSIGNF)
  return _CCCL_BUILTIN_COPYSIGNF(__x, __y);
#else // ^^^ _CCCL_BUILTIN_COPYSIGNF ^^^ / vvv !_CCCL_BUILTIN_COPYSIGNF vvv
...
[[nodiscard]] _CCCL_API double copysign(double __x, double __y) noexcept
{
...
[[nodiscard]] _CCCL_API long double copysign(long double __x, long double __y) noexcept
{
...
[[nodiscard]] _CCCL_API long double copysignl(long double __x, long double __y) noexcept
{
#  if defined(_CCCL_BUILTIN_COPYSIGNL)
  return _CCCL_BUILTIN_COPYSIGNL(__x, __y);
#  else // ^^^ _CCCL_BUILTIN_COPYSIGNL ^^^ / vvv !_CCCL_BUILTIN_COPYSIGNL vvv
