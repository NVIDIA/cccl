...
[[nodiscard]] _CCCL_API float lgamma(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float lgammaf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_LGAMMAF)
  return _CCCL_BUILTIN_LGAMMAF(__x);
#else // ^^^ _CCCL_BUILTIN_LGAMMAF ^^^ / vvv !_CCCL_BUILTIN_LGAMMAF vvv
...
[[nodiscard]] _CCCL_API double lgamma(double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double lgamma(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double lgammal(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_LGAMMAL)
  return _CCCL_BUILTIN_LGAMMAL(__x);
#  else // ^^^ _CCCL_BUILTIN_LGAMMAL ^^^ / vvv !_CCCL_BUILTIN_LGAMMAL vvv
...
[[nodiscard]] _CCCL_API __half lgamma(__half __x) noexcept
{
...
[[nodiscard]] _CCCL_API __nv_bfloat16 lgamma(__nv_bfloat16 __x) noexcept
{
...
[[nodiscard]] _CCCL_API double lgamma(_Integer __x) noexcept
{
...
[[nodiscard]] _CCCL_API float tgamma(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float tgammaf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_TGAMMAF)
  return _CCCL_BUILTIN_TGAMMAF(__x);
#else // ^^^ _CCCL_BUILTIN_TGAMMAF ^^^ / vvv !_CCCL_BUILTIN_TGAMMAF vvv
...
[[nodiscard]] _CCCL_API double tgamma(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double tgamma(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double tgammal(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_TGAMMAL)
  return _CCCL_BUILTIN_TGAMMAL(__x);
#  else // ^^^ _CCCL_BUILTIN_TGAMMAL ^^^ / vvv !_CCCL_BUILTIN_TGAMMAL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half tgamma(__half __x) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 tgamma(__nv_bfloat16 __x) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double tgamma(_Integer __x) noexcept
{
