...
[[nodiscard]] _CCCL_API inline constexpr float scalbn(float __x, int __y) noexcept
{
...
[[nodiscard]] _CCCL_API inline constexpr float scalbnf(float __x, int __y) noexcept
{
#ifdef _CCCL_BUILTIN_IS_CONSTANT_EVALUATED
  if (_CUDA_VSTD::is_constant_evaluated())
  {
...
[[nodiscard]] _CCCL_API inline constexpr double scalbn(double __x, int __y) noexcept
{
#ifdef _CCCL_BUILTIN_IS_CONSTANT_EVALUATED
  if (_CUDA_VSTD::is_constant_evaluated())
  {
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API inline constexpr long double scalbn(long double __x, int __y) noexcept
{
#  ifdef _CCCL_BUILTIN_IS_CONSTANT_EVALUATED
  if (_CUDA_VSTD::is_constant_evaluated())
  {
...
[[nodiscard]] _CCCL_API inline constexpr long double scalbnl(long double __x, int __y) noexcept
{
#  ifdef _CCCL_BUILTIN_IS_CONSTANT_EVALUATED
  if (_CUDA_VSTD::is_constant_evaluated())
  {
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API inline constexpr double scalbn(_Integer __x, int __y) noexcept
{
#ifdef _CCCL_BUILTIN_IS_CONSTANT_EVALUATED
  if (_CUDA_VSTD::is_constant_evaluated())
  {
