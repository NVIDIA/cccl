...
template <class _Tp>
[[nodiscard]] _CCCL_API inline constexpr _Tp __frexp_impl(_Tp __x, int* __exp) noexcept
{
...
[[nodiscard]] _CCCL_API inline constexpr float frexpf(float __x, int* __exp) noexcept
{
  return _CUDA_VSTD::__frexp_impl(__x, __exp);
}

#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API inline constexpr long double frexpl(long double __x, int* __exp) noexcept
{
  return _CUDA_VSTD::__frexp_impl(__x, __exp);
}
#endif // _CCCL_HAS_LONG_DOUBLE()
...
[[nodiscard]] _CCCL_API inline constexpr conditional_t<is_integral_v<_Tp>, double, _Tp>
frexp(_Tp __x, int* __exp) noexcept
{
...
template <class _Tp>
[[nodiscard]] _CCCL_API inline constexpr _Tp __ldexp_impl(_Tp __x, int __exp) noexcept
{
  ...
  // Increase the exponent of __x by __exp
  return _CUDA_VSTD::__fp_set_exp(__x, _CUDA_VSTD::__fp_get_exp(__x) + __exp);
}

[[nodiscard]] _CCCL_API inline constexpr float ldexpf(float __x, int __exp) noexcept
{
  return _CUDA_VSTD::__ldexp_impl(__x, __exp);
}

#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API inline constexpr long double ldexpl(long double __x, int __exp) noexcept
{
  return _CUDA_VSTD::__ldexp_impl(__x, __exp);
}
#endif // _CCCL_HAS_LONG_DOUBLE()
...
template <class _Tp, enable_if_t<__is_extended_arithmetic_v<_Tp>, int> = 0>
[[nodiscard]] _CCCL_API inline constexpr conditional_t<is_integral_v<_Tp>, double, _Tp>
ldexp(_Tp __x, int __exp) noexcept
{
  if constexpr (is_integral_v<_Tp>)
  {
...
[[nodiscard]] _CCCL_API inline constexpr float scalbnf(float __x, int __exp) noexcept
{
  return _CUDA_VSTD::__ldexp_impl(__x, __exp);
}

#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API inline constexpr long double scalbnl(long double __x, int __exp) noexcept
{
  return _CUDA_VSTD::__ldexp_impl(__x, __exp);
}
#endif // _CCCL_HAS_LONG_DOUBLE()
...
template <class _Tp, enable_if_t<__is_extended_arithmetic_v<_Tp>, int> = 0>
[[nodiscard]] _CCCL_API inline constexpr conditional_t<is_integral_v<_Tp>, double, _Tp>
scalbn(_Tp __x, int __exp) noexcept
{
  if constexpr (is_integral_v<_Tp>)
  {
    return _CUDA_VSTD::__ldexp_impl(static_cast<double>(__x), __exp);
