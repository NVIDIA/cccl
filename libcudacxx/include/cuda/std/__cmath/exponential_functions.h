...
[[nodiscard]] _CCCL_API float exp(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float expf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_EXPF)
  return _CCCL_BUILTIN_EXPF(__x);
#else // ^^^ _CCCL_BUILTIN_EXPF ^^^ // vvv !_CCCL_BUILTIN_EXPF vvv
...
[[nodiscard]] _CCCL_API double exp(double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double exp(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double expl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_EXPL)
  return _CCCL_BUILTIN_EXPL(__x);
#  else // ^^^ _CCCL_BUILTIN_EXPL ^^^ // vvv !_CCCL_BUILTIN_EXPL vvv
...
[[nodiscard]] _CCCL_API __half exp(__half __x) noexcept
{
  {
...
[[nodiscard]] _CCCL_API __nv_bfloat16 exp(__nv_bfloat16 __x) noexcept
{
  NV_IF_ELSE_TARGET(
...
[[nodiscard]] _CCCL_API double exp(_Integer __x) noexcept
{
...
[[nodiscard]] _CCCL_API float frexp(float __x, int* __e) noexcept
{
...
[[nodiscard]] _CCCL_API float frexpf(float __x, int* __e) noexcept
{
#if defined(_CCCL_BUILTIN_FREXPF)
  return _CCCL_BUILTIN_FREXPF(__x, __e);
#else // ^^^ _CCCL_BUILTIN_FREXPF ^^^ // vvv !_CCCL_BUILTIN_FREXPF vvv
...
[[nodiscard]] _CCCL_API double frexp(double __x, int* __e) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double frexp(long double __x, int* __e) noexcept
{
...
[[nodiscard]] _CCCL_API long double frexpl(long double __x, int* __e) noexcept
{
#  if defined(_CCCL_BUILTIN_FREXPL)
  return _CCCL_BUILTIN_FREXPL(__x, __e);
#  else // ^^^ _CCCL_BUILTIN_FREXPL ^^^ // vvv !_CCCL_BUILTIN_FREXPL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half frexp(__half __x, int* __e) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 frexp(__nv_bfloat16 __x, int* __e) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double frexp(_Integer __x, int* __e) noexcept
{
...
[[nodiscard]] _CCCL_API float ldexp(float __x, int __e) noexcept
{
...
[[nodiscard]] _CCCL_API float ldexpf(float __x, int __e) noexcept
{
#if defined(_CCCL_BUILTIN_LDEXPF)
  return _CCCL_BUILTIN_LDEXPF(__x, __e);
#else // ^^^ _CCCL_BUILTIN_LDEXPF ^^^ // vvv !_CCCL_BUILTIN_LDEXPF vvv
...
[[nodiscard]] _CCCL_API double ldexp(double __x, int __e) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double ldexp(long double __x, int __e) noexcept
{
...
[[nodiscard]] _CCCL_API long double ldexpl(long double __x, int __e) noexcept
{
#  if defined(_CCCL_BUILTIN_LDEXPL)
  return _CCCL_BUILTIN_LDEXPL(__x, __e);
#  else // ^^^ _CCCL_BUILTIN_LDEXPL ^^^ // vvv !_CCCL_BUILTIN_LDEXPL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half ldexp(__half __x, int __e) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 ldexp(__nv_bfloat16 __x, int __e) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double ldexp(_Integer __x, int __e) noexcept
{
...
[[nodiscard]] _CCCL_API float exp2(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float exp2f(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_EXP2F)
  return _CCCL_BUILTIN_EXP2F(__x);
#else // ^^^ _CCCL_BUILTIN_EXP2F ^^^ // vvv !_CCCL_BUILTIN_EXP2F vvv
...
[[nodiscard]] _CCCL_API double exp2(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double exp2(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double exp2l(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_EXP2L)
  return _CCCL_BUILTIN_EXP2L(__x);
#  else // ^^^ _CCCL_BUILTIN_EXP2L ^^^ // vvv !_CCCL_BUILTIN_EXP2L vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half exp2(__half __x) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 exp2(__nv_bfloat16 __x) noexcept
{
  NV_IF_ELSE_TARGET(
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double exp2(_Integer __x) noexcept
{
...
[[nodiscard]] _CCCL_API float expm1(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float expm1f(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_EXPM1F)
  return _CCCL_BUILTIN_EXPM1F(__x);
#else // ^^^ _CCCL_BUILTIN_EXPM1F ^^^ // vvv !_CCCL_BUILTIN_EXPM1F vvv
...
[[nodiscard]] _CCCL_API double expm1(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double expm1(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double expm1l(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_EXPM1L)
  return _CCCL_BUILTIN_EXPM1L(__x);
#  else // ^^^ _CCCL_BUILTIN_EXPM1L ^^^ // vvv !_CCCL_BUILTIN_EXPM1L vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half expm1(__half __x) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 expm1(__nv_bfloat16 __x) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double expm1(_Integer __x) noexcept
{
...
[[nodiscard]] _CCCL_API float scalbln(float __x, long __y) noexcept
{
...
[[nodiscard]] _CCCL_API float scalblnf(float __x, long __y) noexcept
{
#if defined(_CCCL_BUILTIN_SCALBLNF)
  return _CCCL_BUILTIN_SCALBLNF(__x, __y);
#else // ^^^ _CCCL_BUILTIN_SCALBLNF ^^^ // vvv !_CCCL_BUILTIN_SCALBLNF vvv
...
[[nodiscard]] _CCCL_API double scalbln(double __x, long __y) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double scalbln(long double __x, long __y) noexcept
{
...
[[nodiscard]] _CCCL_API long double scalblnl(long double __x, long __y) noexcept
{
#  if defined(_CCCL_BUILTIN_SCALBLNL)
  return _CCCL_BUILTIN_SCALBLNL(__x, __y);
#  else // ^^^ _CCCL_BUILTIN_SCALBLNL ^^^ // vvv !_CCCL_BUILTIN_SCALBLNL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half scalbln(__half __x, long __y) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 scalbln(__nv_bfloat16 __x, long __y) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double scalbln(_Integer __x, long __y) noexcept
{
...
[[nodiscard]] _CCCL_API float scalbn(float __x, int __y) noexcept
{
...
[[nodiscard]] _CCCL_API float scalbnf(float __x, int __y) noexcept
{
#if defined(_CCCL_BUILTIN_SCALBNF)
  return _CCCL_BUILTIN_SCALBNF(__x, __y);
#else // ^^^ _CCCL_BUILTIN_SCALBNF ^^^ // vvv !_CCCL_BUILTIN_SCALBNF vvv
...
[[nodiscard]] _CCCL_API double scalbn(double __x, int __y) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double scalbn(long double __x, int __y) noexcept
{
...
[[nodiscard]] _CCCL_API long double scalbnl(long double __x, int __y) noexcept
{
#  if defined(_CCCL_BUILTIN_SCALBNL)
  return _CCCL_BUILTIN_SCALBNL(__x, __y);
#  else // ^^^ _CCCL_BUILTIN_SCALBNL ^^^ // vvv !_CCCL_BUILTIN_SCALBNL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half scalbn(__half __x, int __y) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 scalbn(__nv_bfloat16 __x, int __y) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double scalbn(_Integer __x, int __y) noexcept
{
...
[[nodiscard]] _CCCL_API float pow(float __x, float __y) noexcept
{
...
[[nodiscard]] _CCCL_API float powf(float __x, float __y) noexcept
{
#if defined(_CCCL_BUILTIN_POWF)
  return _CCCL_BUILTIN_POWF(__x, __y);
#else // ^^^ _CCCL_BUILTIN_POWF ^^^ // vvv !_CCCL_BUILTIN_POWF vvv
...
[[nodiscard]] _CCCL_API double pow(double __x, double __y) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double pow(long double __x, long double __y) noexcept
{
...
[[nodiscard]] _CCCL_API long double powl(long double __x, long double __y) noexcept
{
#  if defined(_CCCL_BUILTIN_POWL)
  return _CCCL_BUILTIN_POWL(__x, __y);
#  else // ^^^ _CCCL_BUILTIN_POWL ^^^ // vvv !_CCCL_BUILTIN_POWL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half pow(__half __x, __half __y) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 pow(__nv_bfloat16 __x, __nv_bfloat16 __y) noexcept
{
...
[[nodiscard]] _CCCL_API __promote_t<_A1, _A2> pow(_A1 __x, _A2 __y) noexcept
{
