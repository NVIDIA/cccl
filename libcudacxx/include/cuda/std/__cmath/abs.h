...
[[nodiscard]] _CCCL_API float fabs(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float fabsf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_FABSF)
  return _CCCL_BUILTIN_FABSF(__x);
#else // ^^^ _CCCL_BUILTIN_FABSF ^^^ / vvv !_CCCL_BUILTIN_FABSF vvv
...
[[nodiscard]] _CCCL_API double fabs(double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double fabs(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double fabsl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_FABSL)
  return _CCCL_BUILTIN_FABSL(__x);
#  else // ^^^ _CCCL_BUILTIN_FABSL ^^^ / vvv !_CCCL_BUILTIN_FABSL vvv
...
[[nodiscard]] _CCCL_API double fabs(_Tp __val) noexcept
{
...
[[nodiscard]] _CCCL_API float abs(float __val) noexcept
{
  return _CUDA_VSTD::fabsf(__val);
}

[[nodiscard]] _CCCL_API double abs(double __val) noexcept
{
  return _CUDA_VSTD::fabs(__val);
}

#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double abs(long double __val) noexcept
{
