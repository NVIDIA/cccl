...
template <class _Tp>
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool __isfinite_impl(_Tp __x) noexcept
{
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool isfinite(float __x) noexcept
{
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool isfinite(double __x) noexcept
{
#if defined(_CCCL_BUILTIN_ISFINITE)
  return _CCCL_BUILTIN_ISFINITE(__x);
#else // ^^^ _CCCL_BUILTIN_ISFINITE ^^^ / vvv !_CCCL_BUILTIN_ISFINITE vvv
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool isfinite(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_ISFINITE)
  return _CCCL_BUILTIN_ISFINITE(__x);
#  else
...
#if _CCCL_HAS_NVFP16()
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool isfinite(__half __x) noexcept
{
...
#if _CCCL_HAS_NVBF16()
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool isfinite(__nv_bfloat16 __x) noexcept
{
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool isfinite(__nv_fp8_e4m3 __x) noexcept
{
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool isfinite(__nv_fp8_e5m2 __x) noexcept
{
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool isfinite(__nv_fp8_e8m0 __x) noexcept
{
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool isfinite(__nv_fp6_e2m3) noexcept
{
  return true;
}
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool isfinite(__nv_fp6_e3m2) noexcept
{
  return true;
}
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool isfinite(__nv_fp4_e2m1) noexcept
{
  return true;
}
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI constexpr bool isfinite(_Tp) noexcept
{
  return true;
}
