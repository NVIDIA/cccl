...
[[nodiscard]] _CCCL_API float cosh(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float coshf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_COSHF)
  return _CCCL_BUILTIN_COSHF(__x);
#else // ^^^ _CCCL_BUILTIN_COSHF ^^^ / vvv !_CCCL_BUILTIN_COSHF vvv
...
[[nodiscard]] _CCCL_API double cosh(double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double cosh(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double coshl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_COSHL)
  return _CCCL_BUILTIN_COSHL(__x);
#  else // ^^^ _CCCL_BUILTIN_COSHL ^^^ / vvv !_CCCL_BUILTIN_COSHL vvv
...
[[nodiscard]] _CCCL_API __half cosh(__half __x) noexcept
{
...
[[nodiscard]] _CCCL_API __nv_bfloat16 cosh(__nv_bfloat16 __x) noexcept
{
...
[[nodiscard]] _CCCL_API double cosh(_Integer __x) noexcept
{
...
[[nodiscard]] _CCCL_API float sinh(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float sinhf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_SINHF)
  return _CCCL_BUILTIN_SINHF(__x);
#else // ^^^ _CCCL_BUILTIN_SINHF ^^^ / vvv !_CCCL_BUILTIN_SINHF vvv
...
[[nodiscard]] _CCCL_API double sinh(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double sinh(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double sinhl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_SINHL)
  return _CCCL_BUILTIN_SINHL(__x);
#  else // ^^^ _CCCL_BUILTIN_SINHL ^^^ / vvv !_CCCL_BUILTIN_SINHL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half sinh(__half __x) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 sinh(__nv_bfloat16 __x) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double sinh(_Integer __x) noexcept
{
...
[[nodiscard]] _CCCL_API float tanh(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float tanhf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_TANHF)
  return _CCCL_BUILTIN_TANHF(__x);
#else // ^^^ _CCCL_BUILTIN_TANHF ^^^ / vvv !_CCCL_BUILTIN_TANHF vvv
...
[[nodiscard]] _CCCL_API double tanh(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double tanh(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double tanhl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_TANHL)
  return _CCCL_BUILTIN_TANHL(__x);
#  else // ^^^ _CCCL_BUILTIN_TANHL ^^^ / vvv !_CCCL_BUILTIN_TANHL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half tanh(__half __x) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 tanh(__nv_bfloat16 __x) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double tanh(_Integer __x) noexcept
{
