...
[[nodiscard]] _CCCL_API inline _CCCL_CONSTEXPR_CMATH_TRAITS float logb(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API inline _CCCL_CONSTEXPR_CMATH_TRAITS float logbf(float __x) noexcept
{
#ifdef _CCCL_BUILTIN_IS_CONSTANT_EVALUATED
  if (_CUDA_VSTD::is_constant_evaluated())
  {
...
[[nodiscard]] _CCCL_API inline _CCCL_CONSTEXPR_CMATH_TRAITS double logb(double __x) noexcept
{
#ifdef _CCCL_BUILTIN_IS_CONSTANT_EVALUATED
  if (_CUDA_VSTD::is_constant_evaluated())
  {
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API inline _CCCL_CONSTEXPR_CMATH_TRAITS long double logb(long double __x) noexcept
{
#  ifdef _CCCL_BUILTIN_IS_CONSTANT_EVALUATED
  if (_CUDA_VSTD::is_constant_evaluated())
  {
...
[[nodiscard]] _CCCL_API inline _CCCL_CONSTEXPR_CMATH_TRAITS long double logbl(long double __x) noexcept
{
#  ifdef _CCCL_BUILTIN_IS_CONSTANT_EVALUATED
  if (_CUDA_VSTD::is_constant_evaluated())
  {
