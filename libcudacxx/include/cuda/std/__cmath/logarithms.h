...
[[nodiscard]] _CCCL_API float log(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float logf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_LOGF)
  return _CCCL_BUILTIN_LOGF(__x);
#else // ^^^ _CCCL_BUILTIN_LOGF ^^^ / vvv !_CCCL_BUILTIN_LOGF vvv
...
[[nodiscard]] _CCCL_API double log(double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double log(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double logl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_LOGL)
  return _CCCL_BUILTIN_LOGL(__x);
#  else // ^^^ _CCCL_BUILTIN_LOGL ^^^ / vvv !_CCCL_BUILTIN_LOGL vvv
...
[[nodiscard]] _CCCL_API __half log(__half __x) noexcept
{
...
[[nodiscard]] _CCCL_API __nv_bfloat16 log(__nv_bfloat16 __x) noexcept
{
  NV_IF_ELSE_TARGET(
...
[[nodiscard]] _CCCL_API double log(_Integer __x) noexcept
{
#if defined(_CCCL_BUILTIN_LOG)
...
[[nodiscard]] _CCCL_API float log10(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float log10f(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_LOG10F)
  return _CCCL_BUILTIN_LOG10F(__x);
#else // ^^^ _CCCL_BUILTIN_LOG10F ^^^ / vvv !_CCCL_BUILTIN_LOG10F vvv
...
[[nodiscard]] _CCCL_API double log10(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double log10(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double log10l(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_LOG10L)
  return _CCCL_BUILTIN_LOG10L(__x);
#  else // ^^^ _CCCL_BUILTIN_LOG10L ^^^ / vvv !_CCCL_BUILTIN_LOG10L vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half log10(__half __x) noexcept
{
  NV_IF_ELSE_TARGET(
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 log10(__nv_bfloat16 __x) noexcept
{
  NV_IF_ELSE_TARGET(
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double log10(_Integer __x) noexcept
{
#if defined(_CCCL_BUILTIN_LOG10)
...
[[nodiscard]] _CCCL_API int ilogb(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API int ilogbf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_ILOGBF)
  return _CCCL_BUILTIN_ILOGBF(__x);
#else // ^^^ _CCCL_BUILTIN_ILOGBF ^^^ / vvv !_CCCL_BUILTIN_ILOGBF vvv
...
[[nodiscard]] _CCCL_API int ilogb(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API int ilogb(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API int ilogbl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_ILOGBL)
  return _CCCL_BUILTIN_ILOGBL(__x);
#  else // ^^^ _CCCL_BUILTIN_ILOGBL ^^^ / vvv !_CCCL_BUILTIN_ILOGBL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API int ilogb(__half __x) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API int ilogb(__nv_bfloat16 __x) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API int ilogb(_Integer __x) noexcept
{
#if defined(_CCCL_BUILTIN_ILOGB)
...
[[nodiscard]] _CCCL_API float log1p(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float log1pf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_LOG1PF)
  return _CCCL_BUILTIN_LOG1PF(__x);
#else // ^^^ _CCCL_BUILTIN_LOG1PF ^^^ / vvv !_CCCL_BUILTIN_LOG1PF vvv
...
[[nodiscard]] _CCCL_API double log1p(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double log1p(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double log1pl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_LOG1PL)
  return _CCCL_BUILTIN_LOG1PL(__x);
#  else // ^^^ _CCCL_BUILTIN_LOG1PL ^^^ / vvv !_CCCL_BUILTIN_LOG1PL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half log1p(__half __x) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 log1p(__nv_bfloat16 __x) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double log1p(_Integer __x) noexcept
{
#if defined(_CCCL_BUILTIN_LOG1P)
...
[[nodiscard]] _CCCL_API float log2(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float log2f(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_LOG2F)
  return _CCCL_BUILTIN_LOG2F(__x);
#else // ^^^ _CCCL_BUILTIN_LOG2F ^^^ / vvv !_CCCL_BUILTIN_LOG2F vvv
...
[[nodiscard]] _CCCL_API double log2(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double log2(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double log2l(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_LOG2L)
  return _CCCL_BUILTIN_LOG2L(__x);
#  else // ^^^ _CCCL_BUILTIN_LOG2L ^^^ / vvv !_CCCL_BUILTIN_LOG2L vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half log2(__half __x) noexcept
{
  NV_IF_ELSE_TARGET(
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 log2(__nv_bfloat16 __x) noexcept
{
  NV_IF_ELSE_TARGET(
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double log2(_Integer __x) noexcept
{
#if defined(_CCCL_BUILTIN_LOG2)
...
[[nodiscard]] _CCCL_API float logb(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float logbf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_LOGBF)
  return _CCCL_BUILTIN_LOGBF(__x);
#else // ^^^ _CCCL_BUILTIN_LOGBF ^^^ / vvv !_CCCL_BUILTIN_LOGBF vvv
...
[[nodiscard]] _CCCL_API double logb(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double logb(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double logbl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_LOGBL)
  return _CCCL_BUILTIN_LOGBL(__x);
#  else // ^^^ _CCCL_BUILTIN_LOGBL ^^^ / vvv !_CCCL_BUILTIN_LOGBL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half logb(__half __x) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 logb(__nv_bfloat16 __x) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double logb(_Integer __x) noexcept
{
#if defined(_CCCL_BUILTIN_LOGB)
