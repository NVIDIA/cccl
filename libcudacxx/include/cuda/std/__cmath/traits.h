...
#elif _CCCL_CUDA_COMPILER_BELOW(11, 8)
  return !::__isinf(__x) && !::__isnan(__x);
#else // ^^^ _CCCL_CUDA_COMPILER_BELOW(11, 8) ^^^ / vvv !_CCCL_CUDA_COMPILER_BELOW(11, 8) vvv
  return ::isfinite(__x);
#endif // !_CCCL_CUDA_COMPILER_BELOW(11, 8)
}
...
#  endif // _CCCL_STD_VER <= 2017 || _CCCL_CUDA_COMPILER_VER < 1203000
}
#endif // _LIBCUDACXX_HAS_NVFP16
