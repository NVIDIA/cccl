...
[[nodiscard]] _CCCL_API float cos(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float cosf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_COSF)
  return _CCCL_BUILTIN_COSF(__x);
#else // ^^^ _CCCL_BUILTIN_COSF ^^^ / vvv !_CCCL_BUILTIN_COSF vvv
...
[[nodiscard]] _CCCL_API double cos(double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double cos(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double cosl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_COSL)
  return _CCCL_BUILTIN_COSL(__x);
#  else // ^^^ _CCCL_BUILTIN_COSL ^^^ / vvv !_CCCL_BUILTIN_COSL vvv
...
[[nodiscard]] _CCCL_API __half cos(__half __x) noexcept
{
...
[[nodiscard]] _CCCL_API __nv_bfloat16 cos(__nv_bfloat16 __x) noexcept
{
  NV_IF_ELSE_TARGET(
...
[[nodiscard]] _CCCL_API double cos(_Integer __x) noexcept
{
...
[[nodiscard]] _CCCL_API float sin(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float sinf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_SINF)
  return _CCCL_BUILTIN_SINF(__x);
#else // ^^^ _CCCL_BUILTIN_SINF ^^^ / vvv !_CCCL_BUILTIN_SINF vvv
...
[[nodiscard]] _CCCL_API double sin(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double sin(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double sinl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_SINL)
  return _CCCL_BUILTIN_SINL(__x);
#  else // ^^^ _CCCL_BUILTIN_SINL ^^^ / vvv !_CCCL_BUILTIN_SINL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half sin(__half __x) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 sin(__nv_bfloat16 __x) noexcept
{
  NV_IF_ELSE_TARGET(
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double sin(_Integer __x) noexcept
{
...
[[nodiscard]] _CCCL_API float tan(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float tanf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_TANF)
  return _CCCL_BUILTIN_TANF(__x);
#else // ^^^ _CCCL_BUILTIN_TANF ^^^ / vvv !_CCCL_BUILTIN_TANF vvv
...
[[nodiscard]] _CCCL_API double tan(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double tan(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double tanl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_TANL)
  return _CCCL_BUILTIN_TANL(__x);
#  else // ^^^ _CCCL_BUILTIN_TANL ^^^ / vvv !_CCCL_BUILTIN_TANL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half tan(__half __x) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 tan(__nv_bfloat16 __x) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double tan(_Integer __x) noexcept
{
