...
[[nodiscard]] _CCCL_API float sqrt(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float sqrtf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_SQRTF)
  return _CCCL_BUILTIN_SQRTF(__x);
#else // ^^^ _CCCL_BUILTIN_SQRTF ^^^ // vvv !_CCCL_BUILTIN_SQRTF vvv
...
[[nodiscard]] _CCCL_API double sqrt(double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double sqrt(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double sqrtl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_SQRTL)
  return _CCCL_BUILTIN_SQRTL(__x);
#  else // ^^^ _CCCL_BUILTIN_SQRTL ^^^ // vvv !_CCCL_BUILTIN_SQRTL vvv
...
[[nodiscard]] _CCCL_API __half sqrt(__half __x) noexcept
{
...
[[nodiscard]] _CCCL_API __nv_bfloat16 sqrt(__nv_bfloat16 __x) noexcept
{
  NV_IF_ELSE_TARGET(
...
[[nodiscard]] _CCCL_API double sqrt(_Integer __x) noexcept
{
...
[[nodiscard]] _CCCL_API float cbrt(float __x) noexcept
{
...
[[nodiscard]] _CCCL_API float cbrtf(float __x) noexcept
{
#if defined(_CCCL_BUILTIN_CBRTF)
  return _CCCL_BUILTIN_CBRTF(__x);
#else // ^^^ _CCCL_BUILTIN_CBRTF ^^^ // vvv !_CCCL_BUILTIN_CBRTF vvv
...
[[nodiscard]] _CCCL_API double cbrt(double __x) noexcept
{
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _CCCL_API long double cbrt(long double __x) noexcept
{
...
[[nodiscard]] _CCCL_API long double cbrtl(long double __x) noexcept
{
#  if defined(_CCCL_BUILTIN_CBRTL)
  return _CCCL_BUILTIN_CBRTL(__x);
#  else // ^^^ _CCCL_BUILTIN_CBRTL ^^^ // vvv !_CCCL_BUILTIN_CBRTL vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _CCCL_API __half cbrt(__half __x) noexcept
{
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _CCCL_API __nv_bfloat16 cbrt(__nv_bfloat16 __x) noexcept
{
...
template <class _Integer, enable_if_t<_CCCL_TRAIT(is_integral, _Integer), int> = 0>
[[nodiscard]] _CCCL_API double cbrt(_Integer __x) noexcept
{
