...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI float fmax(float __x, float __y) noexcept
{
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI float fmaxf(float __x, float __y) noexcept
{
#if defined(_CCCL_BUILTIN_FMAX)
  return _CCCL_BUILTIN_FMAXF(__x, __y);
#else // ^^^ _CCCL_BUILTIN_FMAX ^^^ / vvv !_CCCL_BUILTIN_FMAX vvv
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI double fmax(double __x, double __y) noexcept
{
#if defined(_CCCL_BUILTIN_FMAX)
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI long double fmax(long double __x, long double __y) noexcept
{
#  if defined(_CCCL_BUILTIN_FMAX)
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI long double fmaxl(long double __x, long double __y) noexcept
{
#  if defined(_CCCL_BUILTIN_FMAX)
  return _CCCL_BUILTIN_FMAXL(__x, __y);
#  else // ^^^ _CCCL_BUILTIN_FMAX ^^^ / vvv !_CCCL_BUILTIN_FMAX vvv
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI __half fmax(__half __x, __half __y) noexcept
{
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI __nv_bfloat16 fmax(__nv_bfloat16 __x, __nv_bfloat16 __y) noexcept
{
  NV_IF_ELSE_TARGET(NV_IS_DEVICE,
                    (return ::__hmax(__x, __y);),
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI __promote_t<_A1, _A2> fmax(_A1 __x, _A2 __y) noexcept
{
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI float fmin(float __x, float __y) noexcept
{
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI float fminf(float __x, float __y) noexcept
{
#if defined(_CCCL_BUILTIN_FMIN)
  return _CCCL_BUILTIN_FMINF(__x, __y);
#else // ^^^ _CCCL_BUILTIN_FMIN ^^^ / vvv !_CCCL_BUILTIN_FMIN vvv
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI double fmin(double __x, double __y) noexcept
{
#if defined(_CCCL_BUILTIN_FMIN)
...
#if _CCCL_HAS_LONG_DOUBLE()
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI long double fmin(long double __x, long double __y) noexcept
{
#  if defined(_CCCL_BUILTIN_FMIN)
...
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI long double fminl(long double __x, long double __y) noexcept
{
#  if defined(_CCCL_BUILTIN_FMIN)
  return _CCCL_BUILTIN_FMINL(__x, __y);
#  else // ^^^ _CCCL_BUILTIN_FMIN ^^^ / vvv !_CCCL_BUILTIN_FMIN vvv
...
#if _LIBCUDACXX_HAS_NVFP16()
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI __half fmin(__half __x, __half __y) noexcept
{
  NV_IF_ELSE_TARGET(NV_IS_DEVICE,
...
#if _LIBCUDACXX_HAS_NVBF16()
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI __nv_bfloat16 fmin(__nv_bfloat16 __x, __nv_bfloat16 __y) noexcept
{
  NV_IF_ELSE_TARGET(NV_IS_DEVICE,
                    (return ::__hmin(__x, __y);),
...
template <class _A1, class _A2, enable_if_t<_CCCL_TRAIT(is_arithmetic, _A1) && _CCCL_TRAIT(is_arithmetic, _A2), int> = 0>
[[nodiscard]] _LIBCUDACXX_HIDE_FROM_ABI __promote_t<_A1, _A2> fmin(_A1 __x, _A2 __y) noexcept
{
  using __result_type = __promote_t<_A1, _A2>;
  static_assert(!(_CCCL_TRAIT(is_same, _A1, __result_type) && _CCCL_TRAIT(is_same, _A2, __result_type)), "");
