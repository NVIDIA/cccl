...
public:
  _CCCL_API _CCCL_CONSTEXPR_CXX20 __mem_fn(type __f) noexcept
      : __f_(__f)
  {}

  // invoke
  template <class... _ArgTypes>
  _CCCL_API _CCCL_CONSTEXPR_CXX20 typename __invoke_return<type, _ArgTypes...>::type
...
_CCCL_API _CCCL_CONSTEXPR_CXX20 __mem_fn<_Rp _Tp::*> mem_fn(_Rp _Tp::* __pm) noexcept
{
