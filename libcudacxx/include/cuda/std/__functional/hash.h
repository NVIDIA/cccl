...
_CCCL_API _Size __loadword(const void* __p)
{
  _Size __r;
...
{
  _CCCL_API size_t operator()(_Tp __v) const noexcept
  {
    union
    {
      _Tp __t;
...
_CCCL_API size_t __hash_combine(size_t __lhs, size_t __rhs) noexcept
{
...
{
  _CCCL_API size_t operator()(bool __v) const noexcept
  {
...
{
  _CCCL_API size_t operator()(char __v) const noexcept
  {
    return static_cast<size_t>(__v);
  }
};
...
{
  _CCCL_API size_t operator()(signed char __v) const noexcept
  {
    return static_cast<size_t>(__v);
  }
};
...
{
  _CCCL_API size_t operator()(unsigned char __v) const noexcept
  {
    return static_cast<size_t>(__v);
  }
};
...
{
  _CCCL_API size_t operator()(char16_t __v) const noexcept
  {
    return static_cast<size_t>(__v);
  }
};
...
{
  _CCCL_API size_t operator()(char32_t __v) const noexcept
  {
    return static_cast<size_t>(__v);
  }
};
...
{
  _CCCL_API size_t operator()(wchar_t __v) const noexcept
  {
    return static_cast<size_t>(__v);
  }
};
...
{
  _CCCL_API size_t operator()(short __v) const noexcept
  {
    return static_cast<size_t>(__v);
  }
};
...
{
  _CCCL_API size_t operator()(unsigned short __v) const noexcept
  {
    return static_cast<size_t>(__v);
  }
};
...
{
  _CCCL_API size_t operator()(int __v) const noexcept
  {
    return static_cast<size_t>(__v);
  }
};
...
{
  _CCCL_API size_t operator()(unsigned int __v) const noexcept
  {
    return static_cast<size_t>(__v);
  }
};
...
{
  _CCCL_API size_t operator()(long __v) const noexcept
  {
    return static_cast<size_t>(__v);
  }
};
...
{
  _CCCL_API size_t operator()(unsigned long __v) const noexcept
  {
    return static_cast<size_t>(__v);
  }
};
...
{
  _CCCL_API size_t operator()(float __v) const noexcept
  {
...
{
  _CCCL_API size_t operator()(double __v) const noexcept
  {
    // -0.0 and 0.0 should return same hash
    if (__v == 0.0)
    {
...
{
  _CCCL_API size_t operator()(long double __v) const noexcept
  {
    // -0.0 and 0.0 should return same hash
    if (__v == 0.0L)
    {
...
{
  _CCCL_API size_t operator()(nullptr_t) const noexcept
  {
    return 662607004ull;
  }
};
