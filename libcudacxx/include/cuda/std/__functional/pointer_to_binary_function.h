...
public:
  _CCCL_API explicit pointer_to_binary_function(_Result (*__f)(_Arg1, _Arg2))
      : __f_(__f)
  {}
  _CCCL_API _Result operator()(_Arg1 __x, _Arg2 __y) const
  {
    return __f_(__x, __y);
  }
};
...
template <class _Arg1, class _Arg2, class _Result>
_LIBCUDACXX_DEPRECATED _CCCL_API pointer_to_binary_function<_Arg1, _Arg2, _Result> ptr_fun(_Result (*__f)(_Arg1, _Arg2))
{
