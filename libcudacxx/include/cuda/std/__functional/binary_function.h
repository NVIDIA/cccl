...
struct __binary_function_keep_layout_base
{
  ...
  using first_argument_type _LIBCUDACXX_DEPRECATED_TYPE_ALIAS_IN_CXX17  = _Arg1;
  using second_argument_type _LIBCUDACXX_DEPRECATED_TYPE_ALIAS_IN_CXX17 = _Arg2;
  using result_type _LIBCUDACXX_DEPRECATED_TYPE_ALIAS_IN_CXX17          = _Result;
#endif
};
