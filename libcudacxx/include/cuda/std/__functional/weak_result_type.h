    ...
    , public __maybe_derive_from_binary_function<_Tp>
{
  ...
  using result_type _CCCL_NODEBUG_ALIAS _LIBCUDACXX_DEPRECATED_TYPE_ALIAS_IN_CXX17 = typename _Tp::result_type;
#endif
};
...
{
#if _CCCL_STD_VER <= 2017 || defined(_LIBCUDACXX_ENABLE_CXX20_REMOVED_BINDER_TYPEDEFS)
  using result_type _CCCL_NODEBUG_ALIAS _LIBCUDACXX_DEPRECATED_TYPE_ALIAS_IN_CXX17 = _Rp;
#endif
};
