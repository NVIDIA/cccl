...
public:
  ...
  _CCCL_API _CCCL_CONSTEXPR_CXX20 reference_wrapper(_Up&& __u) noexcept(noexcept(__fun(declval<_Up>())))
  {
  ...
  // access
  _CCCL_API _CCCL_CONSTEXPR_CXX20 operator type&() const noexcept
  {
    return *__f_;
  }
  _CCCL_API _CCCL_CONSTEXPR_CXX20 type& get() const noexcept
  {
    return *__f_;
  }
  ...
  _CCCL_API _CCCL_CONSTEXPR_CXX20 typename __invoke_of<type&, _ArgTypes...>::type
...
template <class _Tp>
_CCCL_API _CCCL_CONSTEXPR_CXX20 reference_wrapper<_Tp> ref(_Tp& __t) noexcept
{
  return reference_wrapper<_Tp>(__t);
}

template <class _Tp>
_CCCL_API _CCCL_CONSTEXPR_CXX20 reference_wrapper<_Tp> ref(reference_wrapper<_Tp> __t) noexcept
{
  return __t;
}

template <class _Tp>
_CCCL_API _CCCL_CONSTEXPR_CXX20 reference_wrapper<const _Tp> cref(const _Tp& __t) noexcept
{
  return reference_wrapper<const _Tp>(__t);
}

template <class _Tp>
_CCCL_API _CCCL_CONSTEXPR_CXX20 reference_wrapper<const _Tp> cref(reference_wrapper<_Tp> __t) noexcept
{
  return __t;
}
