...
[[noreturn]] _CCCL_API void __throw_bad_function_call()
{
#  if _CCCL_HAS_EXCEPTIONS()
...
template <class _Fp>
_CCCL_API bool __not_null(_Fp const&)
{
  return true;
}

template <class _Fp>
_CCCL_API bool __not_null(_Fp* __ptr)
{
  return __ptr;
}

template <class _Ret, class _Class>
_CCCL_API bool __not_null(_Ret _Class::* __ptr)
{
  return __ptr;
}

template <class _Fp>
_CCCL_API bool __not_null(function<_Fp> const& __f)
{
  return !!__f;
}
...
_CCCL_API bool __not_null(_Rp (^__p)(_Args...))
{
  return __p;
}
#  endif
...
public:
  ...
  _CCCL_API explicit __default_alloc_func(_Target&& __f)
      : __f_(_CUDA_VSTD::move(__f))
  {}

  _CCCL_API explicit __default_alloc_func(const _Target& __f)
      : __f_(__f)
  {}
  ...
  _CCCL_API __default_alloc_func* __clone() const
  {
...
public:
  _CCCL_API explicit __func(_Fp&& __f)
      : __f_(_CUDA_VSTD::move(__f))
  {}

  _CCCL_API explicit __func(const _Fp& __f, const _Alloc& __a)
      : __f_(__f, __a)
  {}

  _CCCL_API explicit __func(const _Fp& __f, _Alloc&& __a)
      : __f_(__f, _CUDA_VSTD::move(__a))
  {}

  _CCCL_API explicit __func(_Fp&& __f, _Alloc&& __a)
...
public:
  _CCCL_API __value_func() noexcept
      : __f_(nullptr)
  {}

  template <class _Fp, class _Alloc>
  _CCCL_API __value_func(_Fp&& __f, const _Alloc& __a)
      : __f_(nullptr)
  {
    using __alloc_traits = allocator_traits<_Alloc>;
  ...
  _CCCL_API explicit __value_func(_Fp&& __f)
      : __value_func(_CUDA_VSTD::forward<_Fp>(__f), allocator<_Fp>())
  {}

  _CCCL_API __value_func(const __value_func& __f)
  {
    if (__f.__f_ == nullptr)
    {
      __f_ = nullptr;
  ...
  _CCCL_API __value_func(__value_func&& __f) noexcept
  {
    if (__f.__f_ == nullptr)
    {
      __f_ = nullptr;
  ...
  _CCCL_API __value_func& operator=(__value_func&& __f)
  {
    *this = nullptr;
    if (__f.__f_ == nullptr)
    {
  ...
  _CCCL_API __value_func& operator=(nullptr_t)
  {
    __func* __f = __f_;
    __f_        = nullptr;
    if ((void*) __f == &__buf_)
  ...
  _CCCL_API _Rp operator()(_ArgTypes&&... __args) const
  {
    if (__f_ == nullptr)
    {
  ...
  _CCCL_API void swap(__value_func& __f) noexcept
  {
    if (&__f == this)
    {
      return;
...
#  ifndef _CCCL_NO_RTTI
  _CCCL_API const type_info& target_type() const noexcept
  {
    if (__f_ == nullptr)
    {
      return typeid(void);
  ...
  _CCCL_API const _Tp* target() const noexcept
  {
    if (__f_ == nullptr)
    {
      return nullptr;
...
struct __policy
{
  ...
  // type.
  template <typename _Fun>
  _CCCL_API static const __policy* __create()
  {
    return __choose_policy<_Fun>(__use_small_storage<_Fun>());
  }

  _CCCL_API static const __policy* __create_empty()
  {
...
private:
  ...
  template <typename _Fun>
  _CCCL_API static const __policy* __choose_policy(/* is_small = */ false_type)
  {
    static const constexpr __policy __policy_ = {
      &__large_clone<_Fun>,
...
#  endif
  ...
  template <typename _Fun>
  _CCCL_API static const __policy* __choose_policy(/* is_small = */ true_type)
  {
    static const constexpr __policy __policy_ = {
      nullptr,
      nullptr,
...
struct __policy_invoker<_Rp(_ArgTypes...)>
{
  ...
  _CCCL_API __policy_invoker()
      : __call_(&__call_empty)
  {}

  // Creates an invoker that calls the given instance of __func.
  template <typename _Fun>
  _CCCL_API static __policy_invoker __create()
  {
    return __policy_invoker(&__call_impl<_Fun>);
  }

private:
  _CCCL_API explicit __policy_invoker(__Call __c)
      : __call_(__c)
  {}
...
public:
  _CCCL_API __policy_func()
      : __policy_(__policy::__create_empty())
  {}

  template <class _Fp, class _Alloc>
  _CCCL_API __policy_func(_Fp&& __f, const _Alloc& __a)
      : __policy_(__policy::__create_empty())
  {
  ...
  _CCCL_API explicit __policy_func(_Fp&& __f)
      : __policy_(__policy::__create_empty())
  {
  ...
  _CCCL_API __policy_func(const __policy_func& __f)
      : __buf_(__f.__buf_)
  ...
  _CCCL_API __policy_func(__policy_func&& __f)
      : __buf_(__f.__buf_)
      , __invoker_(__f.__invoker_)
      , __policy_(__f.__policy_)
  {
  ...
  _CCCL_API __policy_func& operator=(__policy_func&& __f)
  {
    *this          = nullptr;
    __buf_         = __f.__buf_;
    __invoker_     = __f.__invoker_;
  ...
  _CCCL_API __policy_func& operator=(nullptr_t)
  {
  ...
  _CCCL_API void swap(__policy_func& __f)
  {
...
public:
  _CCCL_API explicit __func(__block_type const& __f)
      : __f_(reinterpret_cast<__block_type>(__f ? _Block_copy(__f) : nullptr))
  {}

  // [TODO] add && to save on a retain

  _CCCL_API explicit __func(__block_type __f, const _Alloc& /* unused */)
      : __f_(reinterpret_cast<__block_type>(__f ? _Block_copy(__f) : nullptr))
  {}
...
public:
  ...
  _CCCL_API function() noexcept {}
  _CCCL_API function(nullptr_t) noexcept {}
...
template <class _Rp, class... _ArgTypes>
_CCCL_API bool operator==(const function<_Rp(_ArgTypes...)>& __f, nullptr_t) noexcept
{
  return !__f;
}

template <class _Rp, class... _ArgTypes>
_CCCL_API bool operator==(nullptr_t, const function<_Rp(_ArgTypes...)>& __f) noexcept
{
  return !__f;
}
...
template <class _Rp, class... _ArgTypes>
_CCCL_API void swap(function<_Rp(_ArgTypes...)>& __x, function<_Rp(_ArgTypes...)>& __y) noexcept
{
  return __x.swap(__y);
}
