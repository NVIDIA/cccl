...
_CCCL_API __nat __invoke(__any, _Args&&... __args);
...
struct __invokable_r
{
  ...
  _CCCL_API static decltype(_CUDA_VSTD::__invoke(_CUDA_VSTD::declval<_XFp>(), _CUDA_VSTD::declval<_XArgs>()...))
  __try_call(int);

  template <class _XFp, class... _XArgs>
  _CCCL_API static __nat __try_call(...);
...
struct __nothrow_invokable_r_imp<true, false, _Ret, _Fp, _Args...>
{
  ...
  template <class _Tp>
  _CCCL_API static void __test_noexcept(_Tp) noexcept;
