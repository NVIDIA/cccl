...
#define _CCCL_CONCEPT_REQUIREMENT_SWITCH_requires   _CCCL_PP_CASE(_REQUIRES)
#define _CCCL_CONCEPT_REQUIREMENT_SWITCH_noexcept   _CCCL_PP_CASE(_NOEXCEPT)
#define _CCCL_CONCEPT_REQUIREMENT_SWITCH_typename   _CCCL_PP_CASE(_TYPENAME)
#define _CCCL_CONCEPT_REQUIREMENT_SWITCH__Same_as   _CCCL_PP_CASE(_SAME_AS)
#define _CCCL_CONCEPT_REQUIREMENT_SWITCH__Satisfies _CCCL_PP_CASE(_SATISFIES)
...
#define _CCCL_CONCEPT_TRY_ADD_TYPENAME_SWITCH_typename     _CCCL_PP_CASE(_TYPENAME)
#define _CCCL_CONCEPT_TRY_ADD_TYPENAME_CASE__DEFAULT(...)  typename __VA_ARGS__
#define _CCCL_CONCEPT_TRY_ADD_TYPENAME_CASE__TYPENAME(...) __VA_ARGS__
...
#  define _CCCL_CONCEPT_REQUIREMENT_CASE__DEFAULT(_REQ)  _REQ
#  define _CCCL_CONCEPT_REQUIREMENT_CASE__REQUIRES(_REQ) requires _CCCL_CONCEPT_EAT_REQUIRES_(_REQ)
#  define _CCCL_CONCEPT_REQUIREMENT_CASE__NOEXCEPT(_REQ) _CCCL_PP_EXPAND({ _CCCL_CONCEPT_EAT_NOEXCEPT_(_REQ) } noexcept)
#  define _CCCL_CONCEPT_REQUIREMENT_CASE__TYPENAME(_REQ) \
    _CCCL_CONCEPT_TRY_ADD_TYPENAME_(_CCCL_CONCEPT_EAT_TYPENAME_(_REQ))
#  define _CCCL_CONCEPT_REQUIREMENT_CASE__SAME_AS(_REQ) \
    {_CCCL_CONCEPT_EAT_SAME_AS_(_REQ)}->_CCCL_CONCEPT_VSTD::same_as<_CCCL_CONCEPT_GET_TYPE_FROM_SAME_AS_(_REQ)>
#  define _CCCL_CONCEPT_REQUIREMENT_CASE__SATISFIES(_REQ) \
...
// The following macros handle the various special forms of requirements:
#  define _CCCL_CONCEPT_REQUIREMENT_CASE__DEFAULT(_REQ)  _CCCL_CONCEPT_IGNORE_RESULT_(_REQ)
#  define _CCCL_CONCEPT_REQUIREMENT_CASE__REQUIRES(_REQ) ::__cccl_requires<_CCCL_CONCEPT_EAT_REQUIRES_(_REQ)>
#  define _CCCL_CONCEPT_REQUIREMENT_CASE__NOEXCEPT(_REQ) _CCCL_CONCEPT_NOEXCEPT_REQUIREMENT_(_REQ)
#  define _CCCL_CONCEPT_REQUIREMENT_CASE__TYPENAME(_REQ) \
...
#  define _CCCL_REQUIRES_EXPR_TPARAM_DEFN_SWITCH_variadic    _CCCL_PP_CASE(_VARIADIC)
#  define _CCCL_REQUIRES_EXPR_TPARAM_DEFN_CASE__DEFAULT(_TY) class _TY
#  define _CCCL_REQUIRES_EXPR_TPARAM_DEFN_CASE__VARIADIC(_TY) \
...
#  define _CCCL_REQUIRES_EXPR_TPARAM_REF_SWITCH_variadic     _CCCL_PP_CASE(_VARIADIC)
#  define _CCCL_REQUIRES_EXPR_TPARAM_REF_CASE__DEFAULT(_TY)  _TY
#  define _CCCL_REQUIRES_EXPR_TPARAM_REF_CASE__VARIADIC(_TY) _CCCL_PP_CAT(_CCCL_REQUIRES_EXPR_EAT_VARIADIC_, _TY)...
...
#    define _CCCL_REQUIRES_EXPR_ID_IMPL_SWITCH_variadic     _CCCL_PP_CASE(_VARIADIC)
#    define _CCCL_REQUIRES_EXPR_ID_IMPL_CASE__DEFAULT(_TY)  _TY
#    define _CCCL_REQUIRES_EXPR_ID_IMPL_CASE__VARIADIC(_TY) _CCCL_PP_CAT(_CCCL_REQUIRES_EXPR_EAT_VARIADIC_, _TY)
