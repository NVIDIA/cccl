...
_CCCL_DEDUCTION_GUIDE_EXSPACE explicit mdspan(_ElementType*, _OtherIndexTypes...)
...
_CCCL_DEDUCTION_GUIDE_EXSPACE mdspan(_Pointer&&)
...
_CCCL_DEDUCTION_GUIDE_EXSPACE mdspan(_CArray&)
...
_CCCL_DEDUCTION_GUIDE_EXSPACE mdspan(_ElementType*, const array<_OtherIndexType, _Size>&)
  -> mdspan<_ElementType, dextents<size_t, _Size>>;

template <class _ElementType, class _OtherIndexType, size_t _Size>
_CCCL_DEDUCTION_GUIDE_EXSPACE mdspan(_ElementType*, span<_OtherIndexType, _Size>)
  -> mdspan<_ElementType, dextents<size_t, _Size>>;
...
_CCCL_DEDUCTION_GUIDE_EXSPACE mdspan(_ElementType*, const extents<_OtherIndexType, _ExtentsPack...>&)
  -> mdspan<_ElementType, extents<_OtherIndexType, _ExtentsPack...>>;

template <class _ElementType, class _MappingType>
_CCCL_DEDUCTION_GUIDE_EXSPACE mdspan(_ElementType*, const _MappingType&)
