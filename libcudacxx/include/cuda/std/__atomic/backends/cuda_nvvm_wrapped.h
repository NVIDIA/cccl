...
#  define __ATOMIC_SCOPES_SWITCH(scope, ...)        __ATOMIC_SWITCH(scope, __ATOMIC_SCOPE_CASES(__VA_ARGS__))
...
#  define __ATOMIC_NVVM_BUILTIN1(_order, intrinsic, scope, ...) \
    __ATOMIC_SCOPES_SWITCH(                                     \
      scope, __ATOMIC_NVVM_BUILTIN2, intrinsic, __ATOMIC_NVVM_WRAP(__ATOMIC_NVVM_UNWRAP(__VA_ARGS__), _order))
#  define __ATOMIC_NVVM_BUILTIN0(_order, intrinsic, order, orders, scope, ...) \
...
#  define __ATOMIC_NVVM_BUILTIN(intrinsic, order, orders, scope, ...) \
    __ATOMIC_ORDER_SWITCH(order, orders, __ATOMIC_NVVM_BUILTIN1, intrinsic, scope, __ATOMIC_NVVM_WRAP(__VA_ARGS__))
...
#  define __ATOMIC_NVVM_BUILTIN_SF(intrinsic, success, sorders, failure, forders, scope, ...) \
    __ATOMIC_ORDER_SWITCH(                                                                    \
      success, sorders, __ATOMIC_NVVM_BUILTIN0, intrinsic, failure, forders, scope, __ATOMIC_NVVM_WRAP(__VA_ARGS__))
...
{
  _NV_EVAL(__ATOMIC_NVVM_BUILTIN(__nv_atomic_load, __memorder, __ATOMIC_READ_CASES, __sco, __ptr, __dst));
}
...
{
  _NV_EVAL(__ATOMIC_NVVM_BUILTIN(__nv_atomic_store, __memorder, __ATOMIC_WRITE_CASES, __sco, __ptr, __val));
}
...
{
  _NV_EVAL(__ATOMIC_NVVM_BUILTIN_SF(
...
template <class _Type>
_CCCL_ARTIFICIAL static inline _CCCL_DEVICE void
__atomic_exchange_nvvm_dispatch(_Type* __ptr, _Type* __old, _Type* __new, int __memorder, int __sco)
{
  _NV_EVAL(
    __ATOMIC_NVVM_BUILTIN(__nv_atomic_exchange, __memorder, __ATOMIC_EXCHANGE_CASES, __sco, __ptr, __old, __new));
}
...
{
  _NV_EVAL(__ATOMIC_NVVM_BUILTIN(__nv_atomic_fetch_max, __memorder, __ATOMIC_EXCHANGE_CASES, __sco, __ptr, __op));
}
...
{
  _NV_EVAL(__ATOMIC_NVVM_BUILTIN(__nv_atomic_fetch_min, __memorder, __ATOMIC_EXCHANGE_CASES, __sco, __ptr, __op));
}
...
{
  _NV_EVAL(__ATOMIC_NVVM_BUILTIN(__nv_atomic_fetch_and, __memorder, __ATOMIC_EXCHANGE_CASES, __sco, __ptr, __op));
}
...
{
  _NV_EVAL(__ATOMIC_NVVM_BUILTIN(__nv_atomic_fetch_or, __memorder, __ATOMIC_EXCHANGE_CASES, __sco, __ptr, __op));
}
...
{
  _NV_EVAL(__ATOMIC_NVVM_BUILTIN(__nv_atomic_fetch_xor, __memorder, __ATOMIC_EXCHANGE_CASES, __sco, __ptr, __op));
}
...
{
  _NV_EVAL(__ATOMIC_NVVM_BUILTIN(__nv_atomic_fetch_add, __memorder, __ATOMIC_EXCHANGE_CASES, __sco, __ptr, __op));
}
