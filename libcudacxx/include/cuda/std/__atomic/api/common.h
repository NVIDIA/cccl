...
#define _LIBCUDACXX_ATOMIC_COMMON_IMPL(_CONST, _VOLATILE)                                                              \
  ...
  {                                                                                                                    \
    ::cuda::std::__atomic_store_dispatch(&__a, __d, __m, _Sco{});                                                      \
  }                                                                                                                    \
  ...
  {                                                                                                                    \
    return ::cuda::std::__atomic_load_dispatch(&__a, __m, _Sco{});                                                     \
  }                                                                                                                    \
  ...
  {                                                                                                                    \
    return ::cuda::std::__atomic_exchange_dispatch(&__a, __d, __m, _Sco{});                                            \
  }                                                                                                                    \
  _LIBCUDACXX_ATOMIC_MUTATING_CONSTRAINT()                                                                             \
  ...
  {                                                                                                                    \
    return ::cuda::std::__atomic_compare_exchange_weak_dispatch(&__a, &__e, __d, __s, __f, _Sco{});                    \
  }                                                                                                                    \
  _LIBCUDACXX_ATOMIC_MUTATING_CONSTRAINT()                                                                             \
  _CCCL_HOST_DEVICE_API inline bool compare_exchange_strong(                                                           \
    ...
    _CONST _VOLATILE noexcept _LIBCUDACXX_CHECK_EXCHANGE_MEMORY_ORDER(__s, __f)                                        \
  {                                                                                                                    \
    return ::cuda::std::__atomic_compare_exchange_strong_dispatch(&__a, &__e, __d, __s, __f, _Sco{});                  \
  }                                                                                                                    \
  _LIBCUDACXX_ATOMIC_MUTATING_CONSTRAINT()                                                                             \
  _CCCL_HOST_DEVICE_API inline bool compare_exchange_weak(                                                             \
  ...
  {                                                                                                                    \
    if (memory_order_acq_rel == __m)                                                                                   \
      return ::cuda::std::__atomic_compare_exchange_weak_dispatch(&__a, &__e, __d, __m, memory_order_acquire, _Sco{}); \
    else if (memory_order_release == __m)                                                                              \
      return ::cuda::std::__atomic_compare_exchange_weak_dispatch(&__a, &__e, __d, __m, memory_order_relaxed, _Sco{}); \
    else                                                                                                               \
      return ::cuda::std::__atomic_compare_exchange_weak_dispatch(&__a, &__e, __d, __m, __m, _Sco{});                  \
  }                                                                                                                    \
  _LIBCUDACXX_ATOMIC_MUTATING_CONSTRAINT()                                                                             \
  _CCCL_HOST_DEVICE_API inline bool compare_exchange_strong(                                                           \
    remove_cv_t<_Tp>& __e, remove_cv_t<_Tp> __d, memory_order __m = memory_order_seq_cst) _CONST _VOLATILE noexcept    \
  {                                                                                                                    \
    if (memory_order_acq_rel == __m)                                                                                   \
      return ::cuda::std::__atomic_compare_exchange_strong_dispatch(                                                   \
        &__a, &__e, __d, __m, memory_order_acquire, _Sco{});                                                           \
    else if (memory_order_release == __m)                                                                              \
      return ::cuda::std::__atomic_compare_exchange_strong_dispatch(                                                   \
        &__a, &__e, __d, __m, memory_order_relaxed, _Sco{});                                                           \
    else                                                                                                               \
      return ::cuda::std::__atomic_compare_exchange_strong_dispatch(&__a, &__e, __d, __m, __m, _Sco{});                \
  }                                                                                                                    \
  _CCCL_HOST_DEVICE_API inline void wait(remove_cv_t<_Tp> __v, memory_order __m = memory_order_seq_cst)                \
    const _VOLATILE noexcept                                                                                           \
  {                                                                                                                    \
    ::cuda::std::__atomic_wait(&__a, __v, __m, _Sco{});                                                                \
  }                                                                                                                    \
  ...
  {                                                                                                                    \
    ::cuda::std::__atomic_notify_one(&__a, _Sco{});                                                                    \
  }                                                                                                                    \
  _LIBCUDACXX_ATOMIC_MUTATING_CONSTRAINT()                                                                             \
  _CCCL_HOST_DEVICE_API inline void notify_all() _CONST _VOLATILE noexcept                                             \
  {                                                                                                                    \
    ::cuda::std::__atomic_notify_all(&__a, _Sco{});                                                                    \
  }
...
#define _LIBCUDACXX_ATOMIC_ARITHMETIC_IMPL(_CONST, _VOLATILE)                                               \
  ...
  {                                                                                                         \
    return ::cuda::std::__atomic_fetch_add_dispatch(&__a, __op, __m, _Sco{});                               \
  }                                                                                                         \
  _LIBCUDACXX_ATOMIC_MUTATING_CONSTRAINT()                                                                  \
  _CCCL_HOST_DEVICE_API inline remove_cv_t<_Tp> fetch_sub(                                                  \
    remove_cv_t<_Tp> __op, memory_order __m = memory_order_seq_cst) _CONST _VOLATILE noexcept               \
  {                                                                                                         \
    return ::cuda::std::__atomic_fetch_sub_dispatch(&__a, __op, __m, _Sco{});                               \
  }                                                                                                         \
  _LIBCUDACXX_ATOMIC_MUTATING_CONSTRAINT()                                                                  \
...
#define _LIBCUDACXX_ATOMIC_BITWISE_IMPL(_CONST, _VOLATILE)                                                  \
  ...
  _CCCL_HOST_DEVICE_API inline remove_cv_t<_Tp> fetch_and(                                                  \
    remove_cv_t<_Tp> __op, memory_order __m = memory_order_seq_cst) _CONST _VOLATILE noexcept               \
  {                                                                                                         \
    return ::cuda::std::__atomic_fetch_and_dispatch(&__a, __op, __m, _Sco{});                               \
  }                                                                                                         \
  _LIBCUDACXX_ATOMIC_MUTATING_CONSTRAINT()                                                                  \
  _CCCL_HOST_DEVICE_API inline remove_cv_t<_Tp> fetch_or(                                                   \
    remove_cv_t<_Tp> __op, memory_order __m = memory_order_seq_cst) _CONST _VOLATILE noexcept               \
  {                                                                                                         \
    return ::cuda::std::__atomic_fetch_or_dispatch(&__a, __op, __m, _Sco{});                                \
  }                                                                                                         \
  _LIBCUDACXX_ATOMIC_MUTATING_CONSTRAINT()                                                                  \
  _CCCL_HOST_DEVICE_API inline remove_cv_t<_Tp> fetch_xor(                                                  \
    remove_cv_t<_Tp> __op, memory_order __m = memory_order_seq_cst) _CONST _VOLATILE noexcept               \
  {                                                                                                         \
    return ::cuda::std::__atomic_fetch_xor_dispatch(&__a, __op, __m, _Sco{});                               \
  }                                                                                                         \
  _LIBCUDACXX_ATOMIC_MUTATING_CONSTRAINT()                                                                  \
  _CCCL_HOST_DEVICE_API inline remove_cv_t<_Tp> operator&=(remove_cv_t<_Tp> __op) _CONST _VOLATILE noexcept \
  {                                                                                                         \
