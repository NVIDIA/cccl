...
#define _LIBCUDACXX_ATOMIC_COMMON_IMPL(_CONST, _VOLATILE)                                                             \
  ...
  _CCCL_HOST_DEVICE_API inline void store(_Tp __d, memory_order __m = memory_order_seq_cst)                           \
    _CONST _VOLATILE noexcept _LIBCUDACXX_CHECK_STORE_MEMORY_ORDER(__m)                                               \
  {                                                                                                                   \
    __atomic_store_dispatch(&__a, __d, __m, _Sco{});                                                                  \
  }                                                                                                                   \
  _CCCL_HOST_DEVICE_API inline _Tp load(memory_order __m = memory_order_seq_cst)                                      \
    const _VOLATILE noexcept _LIBCUDACXX_CHECK_LOAD_MEMORY_ORDER(__m)                                                 \
  {                                                                                                                   \
    return __atomic_load_dispatch(&__a, __m, _Sco{});                                                                 \
  }                                                                                                                   \
  _CCCL_HOST_DEVICE_API inline operator _Tp() const _VOLATILE noexcept                                                \
  {                                                                                                                   \
    return load();                                                                                                    \
  }                                                                                                                   \
  _CCCL_HOST_DEVICE_API inline _Tp exchange(_Tp __d, memory_order __m = memory_order_seq_cst)                         \
    _CONST _VOLATILE noexcept                                                                                         \
  {                                                                                                                   \
    return __atomic_exchange_dispatch(&__a, __d, __m, _Sco{});                                                        \
  }                                                                                                                   \
  _CCCL_HOST_DEVICE_API inline bool compare_exchange_weak(_Tp& __e, _Tp __d, memory_order __s, memory_order __f)      \
  ...
  _CCCL_HOST_DEVICE_API inline bool compare_exchange_strong(_Tp& __e, _Tp __d, memory_order __s, memory_order __f)    \
    _CONST _VOLATILE noexcept _LIBCUDACXX_CHECK_EXCHANGE_MEMORY_ORDER(__s, __f)                                       \
  {                                                                                                                   \
    return __atomic_compare_exchange_strong_dispatch(&__a, &__e, __d, __s, __f, _Sco{});                              \
  }                                                                                                                   \
  _CCCL_HOST_DEVICE_API inline bool compare_exchange_weak(_Tp& __e, _Tp __d, memory_order __m = memory_order_seq_cst) \
    _CONST _VOLATILE noexcept                                                                                         \
  {                                                                                                                   \
  ...
  _CCCL_HOST_DEVICE_API inline bool compare_exchange_strong(                                                          \
    _Tp& __e, _Tp __d, memory_order __m = memory_order_seq_cst) _CONST _VOLATILE noexcept                             \
  {                                                                                                                   \
    if (memory_order_acq_rel == __m)                                                                                  \
  ...
  _CCCL_HOST_DEVICE_API inline void wait(_Tp __v, memory_order __m = memory_order_seq_cst) const _VOLATILE noexcept   \
  {                                                                                                                   \
...
#define _LIBCUDACXX_ATOMIC_ARITHMETIC_IMPL(_CONST, _VOLATILE)                                   \
  _CCCL_HOST_DEVICE_API inline _Tp fetch_add(_Tp __op, memory_order __m = memory_order_seq_cst) \
    _CONST _VOLATILE noexcept                                                                   \
  {                                                                                             \
    return __atomic_fetch_add_dispatch(&__a, __op, __m, _Sco{});                                \
  }                                                                                             \
  _CCCL_HOST_DEVICE_API inline _Tp fetch_sub(_Tp __op, memory_order __m = memory_order_seq_cst) \
    _CONST _VOLATILE noexcept                                                                   \
  {                                                                                             \
  ...
  _CCCL_HOST_DEVICE_API inline _Tp operator++() _CONST _VOLATILE noexcept                       \
  {                                                                                             \
  ...
  _CCCL_HOST_DEVICE_API inline _Tp operator+=(_Tp __op) _CONST _VOLATILE noexcept               \
  {                                                                                             \
...
#define _LIBCUDACXX_ATOMIC_BITWISE_IMPL(_CONST, _VOLATILE)                                      \
  _CCCL_HOST_DEVICE_API inline _Tp fetch_and(_Tp __op, memory_order __m = memory_order_seq_cst) \
    _CONST _VOLATILE noexcept                                                                   \
  {                                                                                             \
    return __atomic_fetch_and_dispatch(&__a, __op, __m, _Sco{});                                \
  }                                                                                             \
  _CCCL_HOST_DEVICE_API inline _Tp fetch_or(_Tp __op, memory_order __m = memory_order_seq_cst)  \
    _CONST _VOLATILE noexcept                                                                   \
  {                                                                                             \
    return __atomic_fetch_or_dispatch(&__a, __op, __m, _Sco{});                                 \
  }                                                                                             \
  _CCCL_HOST_DEVICE_API inline _Tp fetch_xor(_Tp __op, memory_order __m = memory_order_seq_cst) \
    _CONST _VOLATILE noexcept                                                                   \
  {                                                                                             \
...
#define _LIBCUDACXX_ATOMIC_MINMAX_IMPL(_CONST, _VOLATILE)                                       \
  _CCCL_HOST_DEVICE_API inline _Tp fetch_max(_Tp __op, memory_order __m = memory_order_seq_cst) \
    _CONST _VOLATILE noexcept                                                                   \
  {                                                                                             \
    return __atomic_fetch_max_dispatch(&__a, __op, __m, _Sco{});                                \
  }                                                                                             \
  _CCCL_HOST_DEVICE_API inline _Tp fetch_min(_Tp __op, memory_order __m = memory_order_seq_cst) \
    _CONST _VOLATILE noexcept                                                                   \
  {                                                                                             \
    return __atomic_fetch_min_dispatch(&__a, __op, __m, _Sco{});                                \
  }
...
#define _LIBCUDACXX_ATOMIC_POINTER_IMPL(_CONST, _VOLATILE)                                            \
  ...
  _CCCL_HOST_DEVICE_API inline _Tp operator+=(ptrdiff_t __op) _CONST _VOLATILE noexcept               \
  {                                                                                                   \
    return fetch_add(__op) + __op;                                                                    \
  }                                                                                                   \
  _CCCL_HOST_DEVICE_API inline _Tp operator-=(ptrdiff_t __op) _CONST _VOLATILE noexcept               \
