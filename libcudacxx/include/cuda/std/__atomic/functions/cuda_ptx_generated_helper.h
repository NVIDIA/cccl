...
using __atomic_cuda_deduce_bitwise =
  __type_switch<size_t,
                sizeof(_Type),
                __type_case<size_t, 1, __atomic_cuda_operand_deduction<uint8_t, __atomic_cuda_operand_b8>>,
                __type_case<size_t, 2, __atomic_cuda_operand_deduction<uint16_t, __atomic_cuda_operand_b16>>,
                __type_case<size_t, 4, __atomic_cuda_operand_deduction<uint32_t, __atomic_cuda_operand_b32>>,
                __type_case<size_t, 8, __atomic_cuda_operand_deduction<uint64_t, __atomic_cuda_operand_b64>>,
...
using __atomic_cuda_deduce_arithmetic = _If<
  ...
  _If<_CCCL_TRAIT(is_signed, _Type),
      __type_switch<size_t,
                    sizeof(_Type),
                    __type_case<size_t, 1, __atomic_cuda_operand_deduction<int8_t, __atomic_cuda_operand_s8>>,
                    __type_case<size_t, 2, __atomic_cuda_operand_deduction<int16_t, __atomic_cuda_operand_s16>>,
      ...
      __type_switch<size_t,
                    ...
                    __type_case<size_t, 2, __atomic_cuda_operand_deduction<uint16_t, __atomic_cuda_operand_u16>>,
                    __type_case<size_t, 4, __atomic_cuda_operand_deduction<uint32_t, __atomic_cuda_operand_u32>>,
