...
#ifndef _LIBCUDACXX___ATOMIC_WAIT_THREADING_SUPPORT_CUDA_H
#define _LIBCUDACXX___ATOMIC_WAIT_THREADING_SUPPORT_CUDA_H
...
#endif // _LIBCUDACXX___ATOMIC_WAIT_THREADING_SUPPORT_CUDA_H
