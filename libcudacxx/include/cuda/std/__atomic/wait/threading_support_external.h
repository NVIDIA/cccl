...
#ifndef _LIBCUDACXX___ATOMIC_WAIT_THREADING_SUPPORT_EXTERNAL_H
#define _LIBCUDACXX___ATOMIC_WAIT_THREADING_SUPPORT_EXTERNAL_H
...
#endif // _LIBCUDACXX___ATOMIC_WAIT_THREADING_SUPPORT_EXTERNAL_H
