...
template <>
[[nodiscard]] _CCCL_API inline complex<__nv_bfloat16> asinh(const complex<__nv_bfloat16>& __x) noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline complex<__half> asinh(const complex<__half>& __x) noexcept
{
