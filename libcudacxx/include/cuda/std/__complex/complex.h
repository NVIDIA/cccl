...
_CCCL_API inline _CCCL_CONSTEXPR_BASIC_MATH complex<_Tp>& operator*=(complex<_Tp>& __lhs, const complex<_Up>& __rhs)
{
...
template <class _Tp>
[[nodiscard]] _CCCL_API inline _CCCL_CONSTEXPR_BASIC_MATH complex<_Tp>
