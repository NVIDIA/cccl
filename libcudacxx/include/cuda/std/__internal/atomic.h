...
// Only power-of-two sizes up to 8 bytes map onto hardware atomics; other sizes take
// the small or locked storage path, also because aligning the storage to a
// non-power-of-two size is ill-formed.
