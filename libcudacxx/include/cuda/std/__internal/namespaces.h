...
// Namespace to avoid visibility fiasco
#  if _CCCL_CUDA_COMPILER(NVHPC)
#    define _CCCL_ARCH_VISIBILITY _CCCL_PP_SPLICE_WITH(_, CCCL, CCCL_VERSION, SM, NV_TARGET_SM_INTEGER_LIST, NVHPC)
#    define _CCCL_BEGIN_ARCH_VISIBILITY_NAMESPACE inline namespace _CCCL_ARCH_VISIBILITY {
#    define _CCCL_END_ARCH_VISIBILITY_NAMESPACE }
#  elif _CCCL_CUDA_COMPILATION()
#    define _CCCL_ARCH_VISIBILITY _CCCL_PP_SPLICE_WITH(_, CCCL, CCCL_VERSION, SM, __CUDA_ARCH_LIST__)
#    define _CCCL_BEGIN_ARCH_VISIBILITY_NAMESPACE inline namespace _CCCL_ARCH_VISIBILITY {
#    define _CCCL_END_ARCH_VISIBILITY_NAMESPACE }
#  else // ^^^ _CCCL_CUDA_COMPILATION() ^^^ / vvv !_CCCL_CUDA_COMPILATION() vvv
#    define _CCCL_ARCH_VISIBILITY
#   define _CCCL_BEGIN_ARCH_VISIBILITY_NAMESPACE
#   define _CCCL_END_ARCH_VISIBILITY_NAMESPACE
