...
public:
  ...
  [[nodiscard]] _CCCL_API size_t __write_request(size_t __code_units)
  {
    size_t __result =
  ...
  [[nodiscard]] _CCCL_API size_t __code_units_written() const noexcept
  {
...
class __fmt_output_buffer
{
  ...
  [[nodiscard]] _CCCL_API size_t __available() const
  {
    return __capacity_ - __size_;
  }

  _CCCL_API void __prepare_write(size_t __code_units)
  {
...
public:
  ...
  _CCCL_API void __buffer_flushed()
  {
    __size_ = 0;
  }

  _CCCL_API void __buffer_moved(_CharT* __ptr, size_t __capacity)
  {
    __ptr_      = __ptr;
    __capacity_ = __capacity;
  }
  ...
  _CCCL_API void push_back(_CharT __c)
  {
    ...
    _CCCL_ASSERT(__ptr_ != nullptr && __size_ < __capacity_ && __available() >= 1,
                 "attempted to write outside the buffer");
  ...
  [[nodiscard]] _CCCL_API size_t __capacity() const
  {
    return __capacity_;
  }
  [[nodiscard]] _CCCL_API size_t __size() const
  {
    return __size_;
  }
};
...
class __fmt_allocating_buffer : public __fmt_output_buffer<_CharT>
{
  ...
  _CCCL_API void __prepare_write(size_t __size_hint)
  {
    __grow_buffer(::cuda::std::max<size_t>(this->__capacity() + __size_hint, this->__capacity() * 1.6));
  }

  _CCCL_API static void __prepare_write(__fmt_output_buffer<_CharT>& __buffer, size_t __size_hint)
  {
...
public:
  ...
  [[nodiscard]] _CCCL_API basic_string_view<_CharT> __view()
  {
...
public:
  ...
  [[nodiscard]] _CCCL_API _OutIt __out_it() &&
  {
...
class __fmt_container_inserter_buffer : public __fmt_output_buffer<_CharT>
{
  ...
  _CCCL_API void __prepare_write()
  {
    __container_->insert(__container_->end(), __small_buffer_, __small_buffer_ + this->__size());
    this->__buffer_flushed();
  }

  _CCCL_API static void __prepare_write(__fmt_output_buffer<_CharT>& __buffer, [[maybe_unused]] size_t __size_hint)
  {
...
public:
  ...
  [[nodiscard]] _CCCL_API auto __out_it() &&
  {
    __container_->insert(__container_->end(), __small_buffer_, __small_buffer_ + this->__size());
