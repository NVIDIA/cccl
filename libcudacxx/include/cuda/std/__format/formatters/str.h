...
struct __fmt_formatter_str
{
  ...
  {
    typename _ParseCtx::iterator __result = __parser_.__parse(__ctx, _CUDA_VSTD::__fmt_spec_fields_str());
    _CUDA_VSTD::__fmt_process_display_type_str(__parser_.__type_);
    return __result;
  }
