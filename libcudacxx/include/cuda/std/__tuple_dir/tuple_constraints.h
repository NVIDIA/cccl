...
struct __tuple_constraints
{
  ...
  struct __comparison
  {
    static constexpr bool __equality_comparable         = (__is_equality_comparable_v<_Tp, _Up> && ...);
    static constexpr bool __nothrow_equality_comparable = (__is_nothrow_equality_comparable_v<_Tp, _Up> && ...);

    static constexpr bool __less_than_comparable         = (__is_less_than_comparable_v<_Tp, _Up> && ...);
    static constexpr bool __nothrow_less_than_comparable = (__is_nothrow_less_than_comparable_v<_Tp, _Up> && ...);
  };
};
