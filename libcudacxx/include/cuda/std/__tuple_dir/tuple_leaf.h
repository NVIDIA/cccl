...
_CCCL_CONCEPT __tuple_leaf_can_forward = _CCCL_REQUIRES_EXPR(
  (_Tp, _Up, _Current))(requires((!is_same_v<remove_cvref_t<_Tp>, _Current>) ), requires(is_constructible_v<_Up, _Tp>));
...
public:
  ...
  _CCCL_REQUIRES(__tuple_leaf_can_forward<_Tp, _Hp, __tuple_leaf>)
                                        ...
                                        __tuple_all_move_assignable_v<_Tp...>>
{
  ...
  _CCCL_API inline void swap(__tuple_impl& __t) noexcept(_Constraints::__nothrow_swappable)
  {
