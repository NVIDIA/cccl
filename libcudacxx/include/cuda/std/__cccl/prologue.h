...
_CCCL_DIAG_SUPPRESS(MSVC, 4100 4127 4180 4197 4296 4324 4455 4503 4522 4668 4800 4996)
...
_CCCL_DIAG_SUPPRESS(GCC, "-Wc++23-extensions")
#  endif // _CCCL_COMPILER(GCC, >=, 12)
#  if _CCCL_COMPILER(CLANG, >=, 17)
_CCCL_DIAG_SUPPRESS(CLANG, "-Wc++23-extensions")
#  else // ^^^ _CCCL_COMPILER(CLANG, >=, 17) ^^^ / vvv _CCCL_COMPILER(CLANG, <, 17) vvv
_CCCL_DIAG_SUPPRESS(CLANG, "-Wc++2b-extensions")
#  endif // ^^^ _CCCL_COMPILER(CLANG, <, 17) ^^^
_CCCL_DIAG_SUPPRESS(NVHPC, if_consteval_nonstandard)

_CCCL_DIAG_SUPPRESS(NV, 3215) // "if consteval" and "if not consteval" are not standard in this mode
#endif // _CCCL_HAS_IF_CONSTEVAL_IN_CXX20()

_CCCL_DIAG_SUPPRESS(NVHPC, is_constant_evaluated_in_nonconstexpr_context)

_CCCL_DIAG_SUPPRESS(NV, 3206) // "if consteval" and "if not consteval" are meaningless in a non-constexpr function
_CCCL_DIAG_SUPPRESS(NV, 3060) // call to __builtin_is_constant_evaluated appearing in a non-constexpr function always
                              // produces "false"
