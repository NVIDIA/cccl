...
#if _CCCL_CUDA_COMPILER && (defined(__CUDACC__) || defined(_NVHPC_CUDA))
...
#if _CCCL_CUDA_COMPILER_NVCC && _CCCL_PTX_ARCH >= 700 && !_CCCL_CUDACC_BELOW_11_7
...
#endif // _CCCL_CUDA_COMPILER_NVCC && _CCCL_PTX_ARCH >= 700 && !_CCCL_CUDACC_BELOW_11_7
