...
#  elif defined(__NVCC_DIAG_PRAGMA_SUPPORT__) || _CCCL_COMPILER_ICC
...
#    if _CCCL_COMPILER_MSVC_2017 // MSVC 2017 has issues with restoring the warning
...
#  if _CCCL_COMPILER_MSVC_2017 || _CCCL_COMPILER_NVRTC
