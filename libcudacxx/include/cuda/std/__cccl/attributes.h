...
#if _CCCL_HAS_ATTRIBUTE(__nodebug__) && _CCCL_CUDA_COMPILER_CLANG
...
#elif _CCCL_CUDACC_BELOW_11_3 || (_CCCL_HAS_CPP_ATTRIBUTE(no_unique_address) < 201803L)
...
#if _CCCL_HAS_CPP_ATTRIBUTE(nodiscard) || (_CCCL_COMPILER_MSVC && _CCCL_STD_VER >= 2017)
...
#if _CCCL_CUDACC_BELOW_11_3 || _CCCL_COMPILER_CLANG
...
#if _CCCL_COMPILER_MSVC // vvv _CCCL_COMPILER_MSVC vvv
