...
#if _CCCL_HAS_BUILTIN(__add_lvalue_reference) && _CCCL_CUDA_COMPILER_CLANG
...
// NVCC has issues with function pointers
#if _CCCL_HAS_BUILTIN(__add_pointer) && _CCCL_CUDA_COMPILER_CLANG
#  define _CCCL_BUILTIN_ADD_POINTER(...) __add_pointer(__VA_ARGS__)
#endif // _CCCL_HAS_BUILTIN(__add_pointer)

// NVCC has issues with function pointers
#if _CCCL_HAS_BUILTIN(__add_rvalue_reference) && _CCCL_CUDA_COMPILER_CLANG
...
#if _CCCL_HAS_BUILTIN(__builtin_assume_aligned) || (_CCCL_COMPILER_MSVC && _CCCL_MSVC_VERSION >= 1923) \
  || _CCCL_COMPILER_GCC
...
#if _CCCL_CHECK_BUILTIN(builtin_addressof) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 70000) \
  || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVHPC
...
#if _CCCL_CHECK_BUILTIN(builtin_bit_cast) || (_CCCL_COMPILER_MSVC && _CCCL_MSVC_VERSION > 1925)
...
#if (_CCCL_COMPILER_CLANG && _CCCL_CLANG_VERSION < 100000) || _CCCL_CUDACC_BELOW_11_7
#  undef _CCCL_BUILTIN_BIT_CAST
#endif // clang < 10 || nvcc < 11.7

#if _CCCL_HAS_BUILTIN(__builtin_COLUMN) || _CCCL_COMPILER_MSVC && _CCCL_MSVC_VERSION >= 1927
...
#if _CCCL_CHECK_BUILTIN(builtin_contant_p) || _CCCL_COMPILER_GCC
#  define _CCCL_BUILTIN_CONSTANT_P(...) __builtin_constant_p(__VA_ARGS__)
#endif // _CCCL_CHECK_BUILTIN(builtin_contant_p)

#if _CCCL_CHECK_BUILTIN(builtin_expect) || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_GCC
#  define _CCCL_BUILTIN_EXPECT(...) __builtin_expect(__VA_ARGS__)
#endif // _CCCL_CHECK_BUILTIN(builtin_expect)

#if _CCCL_HAS_BUILTIN(__builtin_FILE) || _CCCL_COMPILER_GCC || (_CCCL_COMPILER_MSVC && _CCCL_MSVC_VERSION >= 1927)
...
#if _CCCL_HAS_BUILTIN(__builtin_FUNCTION) || _CCCL_COMPILER_GCC || (_CCCL_COMPILER_MSVC && _CCCL_MSVC_VERSION >= 1927)
...
#if _CCCL_CHECK_BUILTIN(builtin_is_constant_evaluated) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 90000) \
  || (_CCCL_COMPILER_MSVC && _CCCL_MSVC_VERSION > 1924 && !_CCCL_CUDACC_BELOW_11_3)
...
#if _CCCL_STD_VER < 2014 && (_CCCL_CUDA_COMPILER_NVCC || _CCCL_COMPILER_NVRTC || _CCCL_COMPILER_NVHPC)
#  undef _CCCL_BUILTIN_IS_CONSTANT_EVALUATED
#endif // _CCCL_STD_VER < 2014 && _CCCL_CUDA_COMPILER_NVCC

#if (_CCCL_CHECK_BUILTIN(builtin_launder) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 70000))
...
// invalid return type
#if (_CCCL_COMPILER_CLANG && _CCCL_CLANG_VERSION < 100000) || _CCCL_CUDACC_BELOW_11_3
#  undef _CCCL_BUILTIN_LAUNDER
#endif // clang < 10 || nvcc < 11.3

#if _CCCL_HAS_BUILTIN(__builtin_LINE) || _CCCL_COMPILER_GCC || (_CCCL_COMPILER_MSVC && _CCCL_MSVC_VERSION >= 1927)
...
#if _CCCL_HAS_BUILTIN(__decay) && _CCCL_CUDA_COMPILER_CLANG
#  define _CCCL_BUILTIN_DECAY(...) __decay(__VA_ARGS__)
#endif // _CCCL_HAS_BUILTIN(__decay) && clang-cuda

#if _CCCL_CHECK_BUILTIN(has_nothrow_assign) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40300) \
  || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(has_nothrow_constructor) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40300) \
  || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(has_nothrow_copy) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40300) || _CCCL_COMPILER_MSVC \
  || _CCCL_COMPILER_NVRTC
#  define _CCCL_BUILTIN_HAS_NOTHROW_COPY(...) __has_nothrow_copy(__VA_ARGS__)
#endif // _CCCL_CHECK_BUILTIN(has_nothrow_copy) && gcc >= 4.3

#if _CCCL_CHECK_BUILTIN(has_trivial_constructor) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40300) \
  || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(has_trivial_destructor) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40300) \
  || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(has_unique_object_representations) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 70000)
...
#if _CCCL_CHECK_BUILTIN(has_virtual_destructor) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40300) \
  || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(is_aggregate) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 70000) \
  || (_CCCL_COMPILER_MSVC && _CCCL_MSVC_VERSION > 1914) || _CCCL_COMPILER_NVRTC
...
#if _CCCL_COMPILER_CLANG && _CCCL_CLANG_VERSION < 190000
#  undef _CCCL_BUILTIN_IS_ARRAY
#endif // clang < 19

#if _CCCL_CHECK_BUILTIN(is_assignable) || _CCCL_COMPILER_MSVC || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 90000)
#  define _CCCL_BUILTIN_IS_ASSIGNABLE(...) __is_assignable(__VA_ARGS__)
#endif // _CCCL_CHECK_BUILTIN(is_assignable) && gcc >= 9.0

#if _CCCL_CHECK_BUILTIN(is_base_of) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40300) || _CCCL_COMPILER_MSVC \
  || _CCCL_COMPILER_NVRTC
#  define _CCCL_BUILTIN_IS_BASE_OF(...) __is_base_of(__VA_ARGS__)
#endif // _CCCL_CHECK_BUILTIN(is_base_of) && gcc >= 4.3

#if _CCCL_CHECK_BUILTIN(is_class) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40300) || _CCCL_COMPILER_MSVC \
  || _CCCL_COMPILER_NVRTC
...
#if _CCCL_COMPILER_CLANG && _CCCL_CLANG_VERSION < 100000
...
#if _CCCL_CHECK_BUILTIN(is_literal_type) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40600) || _CCCL_COMPILER_MSVC \
  || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(is_nothrow_assignable) || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(is_nothrow_constructible) || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(is_nothrow_destructible) || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(is_pod) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40300) || _CCCL_COMPILER_MSVC \
  || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(is_polymorphic) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40300) || _CCCL_COMPILER_MSVC \
  || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(is_same) && !_CCCL_CUDA_COMPILER_NVCC
...
#if _CCCL_CHECK_BUILTIN(is_standard_layout) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40700) \
  || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(is_trivial) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40500) || _CCCL_COMPILER_MSVC \
  || _CCCL_COMPILER_NVRTC
#  define _CCCL_BUILTIN_IS_TRIVIAL(...) __is_trivial(__VA_ARGS__)
#endif // _CCCL_CHECK_BUILTIN(is_trivial) && gcc >= 4.5

#if _CCCL_CHECK_BUILTIN(is_trivially_assignable) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 50100) \
  || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(is_trivially_constructible) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 50100) \
  || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(is_trivially_copyable) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 50100) \
  || _CCCL_COMPILER_MSVC || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(is_trivially_destructible) || _CCCL_COMPILER_MSVC
...
#if _CCCL_CHECK_BUILTIN(is_union) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40300) || _CCCL_COMPILER_MSVC \
  || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CHECK_BUILTIN(make_integer_seq) || (_CCCL_COMPILER_MSVC && _CCCL_MSVC_VERSION >= 1923)
...
#elif _CCCL_HAS_BUILTIN(__remove_reference_t) && _CCCL_CUDA_COMPILER_CLANG
#  define _CCCL_BUILTIN_REMOVE_REFERENCE_T(...) __remove_reference_t(__VA_ARGS__)
#endif // _CCCL_HAS_BUILTIN(__remove_reference_t)

#if _CCCL_HAS_BUILTIN(__remove_volatile) && _CCCL_CUDA_COMPILER_CLANG
...
#if _CCCL_CUDACC_BELOW_12_2
#  undef _CCCL_BUILTIN_TYPE_PACK_ELEMENT
#endif // _CCCL_CUDACC_BELOW_12_2

#if _CCCL_CHECK_BUILTIN(underlying_type) || (_CCCL_COMPILER_GCC && _CCCL_GCC_VERSION >= 40700) || _CCCL_COMPILER_MSVC \
  || _CCCL_COMPILER_NVRTC
...
#  if _CCCL_MSVC_VERSION >= 1935 && !_CCCL_CUDACC_BELOW_12_3
...
#if !_CCCL_COMPILER_GCC && !_CCCL_COMPILER_NVRTC && !(_CCCL_COMPILER_MSVC && _CCCL_STD_VER < 2017)
