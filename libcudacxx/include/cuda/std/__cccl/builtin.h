...
#endif // _CCCL_CUDA_COMPILER_BEFORE(11, 2)
...
#if _CCCL_COMPILER(CLANG, <, 10) || _CCCL_CUDA_COMPILER_BEFORE(11, 7)
...
// invalid return type
#if _CCCL_COMPILER(CLANG, <, 10) || _CCCL_CUDA_COMPILER_BEFORE(11, 3)
...
#endif // _CCCL_CUDA_COMPILER_BEFORE(12, 2)
