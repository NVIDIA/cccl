...
#if _CCCL_COMPILER_GCC || _CCCL_COMPILER_NVHPC || _CCCL_COMPILER_ICC
...
#if !defined(_CCCL_NO_SYSTEM_HEADER) && !(_CCCL_COMPILER_MSVC && defined(_LIBCUDACXX_DISABLE_PRAGMA_MSVC_WARNING)) \
  && !_CCCL_COMPILER_NVRTC && !defined(_LIBCUDACXX_DISABLE_PRAGMA_GCC_SYSTEM_HEADER)
#  if _CCCL_COMPILER_GCC || _CCCL_COMPILER_NVHPC || _CCCL_COMPILER_ICC
