...
#  define _CCCL_PRAGMA_UNROLL(_N) \
    _CCCL_NV_DIAG_SUPPRESS(1675) _CCCL_PRAGMA(clang loop unroll_count(_N)) _CCCL_NV_DIAG_DEFAULT(1675)
#  define _CCCL_PRAGMA_UNROLL_FULL() \
    _CCCL_NV_DIAG_SUPPRESS(1675) _CCCL_PRAGMA(clang loop unroll(full)) _CCCL_NV_DIAG_DEFAULT(1675)
