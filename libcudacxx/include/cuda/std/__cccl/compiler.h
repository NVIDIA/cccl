...
#define _CCCL_CUDA_COMPILER_MAKE_VERSION(_MAJOR, _MINOR) ((_MAJOR) * 1000 + (_MINOR) * 10)
#define _CCCL_CUDA_COMPILER(...)                         _CCCL_VERSION_COMPARE(_CCCL_CUDA_COMPILER, _CCCL_CUDA_COMPILER_##__VA_ARGS__)
...
#  define _CCCL_CUDA_COMPILER_CLANG    _CCCL_CUDA_COMPILER_MAKE_VERSION(CUDA_VERSION / 1000, (CUDA_VERSION % 1000) / 10)
#  define _CCCL_CUDA_COMPILER__CURRENT _CCCL_CUDA_COMPILER_CLANG
#elif _CCCL_COMPILER(NVRTC)
#  define _CCCL_CUDA_COMPILER_NVRTC    _CCCL_CUDA_COMPILER_MAKE_VERSION(__CUDACC_VER_MAJOR__, __CUDACC_VER_MINOR__)
