...
#elif defined(__CUDA__) && _CCCL_COMPILER_CLANG
#  define _CCCL_CUDA_COMPILER_CLANG 1
#endif

// Shorthand to check whether there is a cuda compiler available
#if _CCCL_CUDA_COMPILER_NVCC || _CCCL_CUDA_COMPILER_NVHPC || _CCCL_CUDA_COMPILER_CLANG || _CCCL_COMPILER_NVRTC
...
#if _CCCL_CUDACC && _CCCL_CUDACC_VER < 1102000
#  define _CCCL_CUDACC_BELOW_11_2 1
#endif // _CCCL_CUDACC && _CCCL_CUDACC_VER < 1102000
#if _CCCL_CUDACC && _CCCL_CUDACC_VER < 1103000
#  define _CCCL_CUDACC_BELOW_11_3 1
#endif // _CCCL_CUDACC && _CCCL_CUDACC_VER < 1103000
#if _CCCL_CUDACC && _CCCL_CUDACC_VER < 1104000
#  define _CCCL_CUDACC_BELOW_11_4 1
#endif // _CCCL_CUDACC && _CCCL_CUDACC_VER < 1104000
#if _CCCL_CUDACC && _CCCL_CUDACC_VER < 1107000
#  define _CCCL_CUDACC_BELOW_11_7 1
#endif // _CCCL_CUDACC && _CCCL_CUDACC_VER < 1107000
#if _CCCL_CUDACC && _CCCL_CUDACC_VER < 1108000
#  define _CCCL_CUDACC_BELOW_11_8 1
#endif // _CCCL_CUDACC && _CCCL_CUDACC_VER < 1108000
#if _CCCL_CUDACC && _CCCL_CUDACC_VER < 1200000
#  define _CCCL_CUDACC_BELOW_12_0 1
#endif // _CCCL_CUDACC && _CCCL_CUDACC_VER < 1200000
#if _CCCL_CUDACC && _CCCL_CUDACC_VER < 1202000
#  define _CCCL_CUDACC_BELOW_12_2 1
#endif // _CCCL_CUDACC && _CCCL_CUDACC_VER < 1202000
#if _CCCL_CUDACC && _CCCL_CUDACC_VER < 1203000
#  define _CCCL_CUDACC_BELOW_12_3 1
#endif // _CCCL_CUDACC && _CCCL_CUDACC_VER < 1203000
#if _CCCL_CUDACC && _CCCL_CUDACC_VER < 1204000
#  define _CCCL_CUDACC_BELOW_12_4 1
#endif // _CCCL_CUDACC && _CCCL_CUDACC_VER < 1204000
#if _CCCL_CUDACC && _CCCL_CUDACC_VER < 1205000
#  define _CCCL_CUDACC_BELOW_12_5 1
#endif // _CCCL_CUDACC && _CCCL_CUDACC_VER < 1205000
