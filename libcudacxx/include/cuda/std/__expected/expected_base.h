...
union __expected_union_t
{
  ...
  _CCCL_EXEC_CHECK_DISABLE
  _CCCL_API _CCCL_CONSTEXPR_CXX20 ~__expected_union_t() {}
...
struct __expected_destruct<_Tp, _Err, false, false>
{
  ...
  _CCCL_EXEC_CHECK_DISABLE
  _CCCL_API _CCCL_CONSTEXPR_CXX20 ~__expected_destruct()
  {
    if (__has_val_)
    {
      __union_.__val_.~_Tp();
...
struct __expected_storage : __expected_destruct<_Tp, _Err>
{
  ...
  static _CCCL_API _CCCL_CONSTEXPR_CXX20 void __reinit_expected(_T1& __newval, _T2& __oldval, _Args&&... __args) noexcept
  {
  ...
  static _CCCL_API _CCCL_CONSTEXPR_CXX20 void __reinit_expected(_T1& __newval, _T2& __oldval, _Args&&... __args)
  {
  ...
  static _CCCL_API _CCCL_CONSTEXPR_CXX20 void
...
struct __expected_copy<_Tp, _Err, __smf_availability::__available> : __expected_storage<_Tp, _Err>
{
  ...
  _CCCL_API _CCCL_CONSTEXPR_CXX20 __expected_copy(const __expected_copy& __other) noexcept(
...
struct __expected_move<_Tp, _Err, __smf_availability::__available> : __expected_copy<_Tp, _Err>
{
  ...
  _CCCL_API _CCCL_CONSTEXPR_CXX20 __expected_move(__expected_move&& __other) noexcept(
...
struct __expected_copy_assign<_Tp, _Err, __smf_availability::__available> : __expected_move<_Tp, _Err>
{
  ...
  _CCCL_EXEC_CHECK_DISABLE
  _CCCL_API _CCCL_CONSTEXPR_CXX20 __expected_copy_assign& operator=(const __expected_copy_assign& __other) noexcept(
...
struct __expected_move_assign<_Tp, _Err, __smf_availability::__available> : __expected_copy_assign<_Tp, _Err>
{
  ...
  _CCCL_EXEC_CHECK_DISABLE
  _CCCL_API _CCCL_CONSTEXPR_CXX20 __expected_move_assign& operator=(__expected_move_assign&& __other) noexcept(
...
struct __expected_storage<void, _Err> : __expected_destruct<void, _Err>
{
  ...
  _CCCL_EXEC_CHECK_DISABLE
  static _CCCL_API _CCCL_CONSTEXPR_CXX20 void __swap_val_unex_impl(
