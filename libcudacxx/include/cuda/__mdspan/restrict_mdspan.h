...
_CCCL_DEDUCTION_GUIDE_EXSPACE explicit restrict_mdspan(_ElementType*, _OtherIndexTypes...)
...
_CCCL_DEDUCTION_GUIDE_EXSPACE restrict_mdspan(_Pointer&&)
...
_CCCL_DEDUCTION_GUIDE_EXSPACE restrict_mdspan(_CArray&)
...
_CCCL_DEDUCTION_GUIDE_EXSPACE restrict_mdspan(_ElementType*, const ::cuda::std::array<_OtherIndexType, _Size>&)
  -> restrict_mdspan<_ElementType, ::cuda::std::dextents<size_t, _Size>>;

template <class _ElementType, class _OtherIndexType, size_t _Size>
_CCCL_DEDUCTION_GUIDE_EXSPACE restrict_mdspan(_ElementType*, ::cuda::std::span<_OtherIndexType, _Size>)
  -> restrict_mdspan<_ElementType, ::cuda::std::dextents<size_t, _Size>>;
...
_CCCL_DEDUCTION_GUIDE_EXSPACE restrict_mdspan(_ElementType*, const _MappingType&)
