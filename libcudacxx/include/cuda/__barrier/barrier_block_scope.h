...
public:
  ...
  _CCCL_API barrier(_CUDA_VSTD::ptrdiff_t __expected,
  ...
  [[nodiscard]] _CCCL_API arrival_token arrive(_CUDA_VSTD::ptrdiff_t __update = 1)
  {
...
private:
  _CCCL_API bool __test_wait_sm_80([[maybe_unused]] arrival_token __token) const
  {
    int32_t __ready = 0;
    NV_DISPATCH_TARGET(
      NV_PROVIDES_SM_80,
  ...
  _CCCL_API bool __try_wait([[maybe_unused]] arrival_token __token) const
  {
    NV_DISPATCH_TARGET(
      NV_PROVIDES_SM_90,
      (
  ...
  // Document de drop > uint32_t for __nanosec on public for APIs
  _CCCL_API bool __try_wait(arrival_token __token, _CUDA_VSTD::chrono::nanoseconds __nanosec) const
  {
  ...
  _CCCL_API bool __test_wait_parity_sm_80([[maybe_unused]] bool __phase_parity) const
  {
    uint16_t __ready = 0;
    NV_DISPATCH_TARGET(
      NV_PROVIDES_SM_80,
  ...
  _CCCL_API bool __try_wait_parity(bool __phase_parity) const
  {
    NV_DISPATCH_TARGET(
      NV_PROVIDES_SM_90,
      (
  ...
  _CCCL_API bool __try_wait_parity(bool __phase_parity, _CUDA_VSTD::chrono::nanoseconds __nanosec) const
  {
    if (__nanosec.count() < 1)
    {
