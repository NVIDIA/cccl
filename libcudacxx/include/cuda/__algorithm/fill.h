...
_CCCL_HOST_API void __fill_bytes_impl(stream_ref __stream, _CUDA_VSTD::span<_DstTy, _DstSize> __dst, uint8_t __value)
{
...
_CCCL_HOST_API void fill_bytes(stream_ref __stream, _DstTy&& __dst, uint8_t __value)
{
