...
#  if _CCCL_CUDA_COMPILATION()
  ...
  {
    static_assert(__has_bottom_unit_or_level_v<block_level, _Hierarchy>, "_Hierarchy doesn't contain block level");
    static_assert(_Hierarchy::template has_level<grid_level>(), "_Hierarchy doesn't contain grid level");
