...
struct _Alloc_vtable
{
  ...
  _CCCL_HOST_DEVICE constexpr _Alloc_vtable(
    _AllocFn __alloc_fn_, _DeallocFn __dealloc_fn_, _EqualFn __equal_fn_) noexcept
...
struct _Async_alloc_vtable : public _Alloc_vtable
{
  ...
  _CCCL_HOST_DEVICE constexpr _Async_alloc_vtable(
...
struct _Resource_vtable_builder
{
    ...
    _CCCL_HOST_DEVICE static __property_value_t<_Property> _Get_property(void* __res) noexcept {
        return get_property(*static_cast<const _Resource *>(__res), _Property{});
    }

    template <class _Resource>
    _CCCL_HOST_DEVICE static void* _Alloc(void* __object, size_t __bytes, size_t __alignment) {
        return static_cast<_Resource *>(__object)->allocate(__bytes, __alignment);
    }

    template <class _Resource>
    _CCCL_HOST_DEVICE static void _Dealloc(void* __object, void* __ptr, size_t __bytes, size_t __alignment) {
        return static_cast<_Resource *>(__object)->deallocate(__ptr, __bytes, __alignment);
    }

    template <class _Resource>
    _CCCL_HOST_DEVICE static void* _Alloc_async(void* __object, size_t __bytes, size_t __alignment, ::cuda::stream_ref __stream) {
        return static_cast<_Resource *>(__object)->allocate_async(__bytes, __alignment, __stream);
    }

    template <class _Resource>
    _CCCL_HOST_DEVICE static void _Dealloc_async(void* __object, void* __ptr, size_t __bytes, size_t __alignment, ::cuda::stream_ref __stream) {
        return static_cast<_Resource *>(__object)->deallocate_async(__ptr, __bytes, __alignment, __stream);
    }

    template <class _Resource>
    _CCCL_HOST_DEVICE static bool _Equal(void* __left, void* __rhs) {
    ...
    _LIBCUDACXX_TEMPLATE(class _Resource, _AllocType _Alloc_type)
     ...
     _CCCL_HOST_DEVICE static constexpr _Alloc_vtable _Create() noexcept
    {
    ...
    _LIBCUDACXX_TEMPLATE(class _Resource, _AllocType _Alloc_type)
     ...
     _CCCL_HOST_DEVICE static constexpr _Async_alloc_vtable _Create() noexcept
    {
      return {&_Resource_vtable_builder::_Alloc<_Resource>,
              &_Resource_vtable_builder::_Dealloc<_Resource>,
              &_Resource_vtable_builder::_Equal<_Resource>,
...
struct _Property_vtable
{
  ...
  _CCCL_HOST_DEVICE constexpr _Property_vtable(_PropertyFn __property_fn_) noexcept
...
struct _Resource_vtable : public _Property_vtable<_Properties>...
{
  ...
  _CCCL_HOST_DEVICE constexpr _Resource_vtable(_PropertyFns... __property_fn_) noexcept
      : _Property_vtable<_Properties>(__property_fn_)...
  {}

  template <_AllocType _Alloc_type, class... _OtherProperties>
  _CCCL_HOST_DEVICE constexpr _Resource_vtable(basic_resource_ref<_Alloc_type, _OtherProperties...>& __ref) noexcept
      : _Property_vtable<_Properties>(__ref._Property_vtable<_Properties>::__property_fn)...
  {}

  template <class _Resource>
  _CCCL_HOST_DEVICE static constexpr _Resource_vtable _Create() noexcept
  {
...
struct _Alloc_base
{
  ...
  _CCCL_HOST_DEVICE _Alloc_base(void* __object_, const _Vtable* __static_vtabl_) noexcept
      : __object(__object_)
      , __static_vtable(__static_vtabl_)
  {}

  _CCCL_NODISCARD _CCCL_HOST_DEVICE void* allocate(size_t __bytes, size_t __alignment = alignof(_CUDA_VSTD::max_align_t))
  {
    return __static_vtable->__alloc_fn(__object, __bytes, __alignment);
  }

  _CCCL_HOST_DEVICE void deallocate(void* _Ptr, size_t __bytes, size_t __alignment = alignof(_CUDA_VSTD::max_align_t))
  {
...
struct _Async_alloc_base : public _Alloc_base<_Vtable>
{
  ...
  _CCCL_HOST_DEVICE _Async_alloc_base(void* __object_, const _Vtable* __static_vtabl_) noexcept
      : _Alloc_base<_Vtable>(__object_, __static_vtabl_)
  {}

  _CCCL_NODISCARD _CCCL_HOST_DEVICE void* allocate_async(size_t __bytes, size_t __alignment, ::cuda::stream_ref __stream)
  {
    return this->__static_vtable->__async_alloc_fn(this->__object, __bytes, __alignment, __stream);
  }

  _CCCL_NODISCARD _CCCL_HOST_DEVICE void* allocate_async(size_t __bytes, ::cuda::stream_ref __stream)
  {
    return this->__static_vtable->__async_alloc_fn(this->__object, __bytes, alignof(max_align_t), __stream);
  }

  _CCCL_HOST_DEVICE void deallocate_async(void* _Ptr, size_t __bytes, ::cuda::stream_ref __stream)
  {
    this->__static_vtable->__async_dealloc_fn(this->__object, _Ptr, __bytes, alignof(max_align_t), __stream);
  }

  _CCCL_HOST_DEVICE void deallocate_async(void* _Ptr, size_t __bytes, size_t __alignment, ::cuda::stream_ref __stream)
  {
...
_CCCL_GLOBAL_CONSTANT _Vtable_store<_Alloc_type> __alloc_vtable =
...
public:
  ...
  _CCCL_HOST_DEVICE basic_resource_ref(_Resource& __res) noexcept
  ...
  _CCCL_HOST_DEVICE basic_resource_ref(basic_resource_ref<_Alloc_type, _OtherProperties...> __ref) noexcept
  ...
  _CCCL_HOST_DEVICE basic_resource_ref(basic_resource_ref<_OtherAllocType, _OtherProperties...> __ref) noexcept
      : _Resource_ref_base<_Alloc_type>(__ref.__object, __ref.__static_vtable)
      , __vtable(__ref)
  {}
  ...
  _LIBCUDACXX_REQUIRES((sizeof...(_Properties) == sizeof...(_OtherProperties))
                         _LIBCUDACXX_AND __properties_match<_OtherProperties...>)
  _CCCL_NODISCARD _CCCL_HOST_DEVICE bool
  operator==(const basic_resource_ref<_Alloc_type, _OtherProperties...>& __rhs) const
  {
