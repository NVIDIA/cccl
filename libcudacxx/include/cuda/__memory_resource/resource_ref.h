...
public:
  ...
  _CCCL_NODISCARD_FRIEND friend bool operator==(const basic_resource_ref& __lhs, const basic_resource_ref& __rhs)
  {
  ...
  _CCCL_TEMPLATE(class _Property)
  _CCCL_REQUIRES(property_with_value<_Property> _CCCL_AND _CUDA_VSTD::__is_included_in_v<_Property, _Properties...>)
  _CCCL_NODISCARD_FRIEND friend __property_value_t<_Property>
  get_property(const basic_resource_ref& __res, _Property) noexcept
  {
