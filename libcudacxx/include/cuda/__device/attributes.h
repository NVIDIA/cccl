...
struct __dev_attr_impl
{
  ...
  [[nodiscard]] _CCCL_API type operator()(device_ref __dev) const
  {
    NV_IF_ELSE_TARGET(
      ...
      ({
        int __result;
        _CCCL_TRY_CUDA_API(::cudaDeviceGetAttribute, "Failed to query device attribute.", &__result, _Attr, __dev.get());
        return static_cast<type>(__result);
      }))
  }
};
...
_CCCL_GLOBAL_CONSTANT max_pitch_t max_pitch{};

// Maximum 1D texture width
using max_texture_1d_width_t = __dev_attr<::cudaDevAttrMaxTexture1DWidth>;
_CCCL_GLOBAL_CONSTANT max_texture_1d_width_t max_texture_1d_width{};
...
_CCCL_GLOBAL_CONSTANT max_texture_1d_linear_width_t max_texture_1d_linear_width{};

// Maximum mipmapped 1D texture width
using max_texture_1d_mipmapped_width_t = __dev_attr<::cudaDevAttrMaxTexture1DMipmappedWidth>;
_CCCL_GLOBAL_CONSTANT max_texture_1d_mipmapped_width_t max_texture_1d_mipmapped_width{};

// Maximum 2D texture width
using max_texture_2d_width_t = __dev_attr<::cudaDevAttrMaxTexture2DWidth>;
_CCCL_GLOBAL_CONSTANT max_texture_2d_width_t max_texture_2d_width{};

// Maximum 2D texture height
using max_texture_2d_height_t = __dev_attr<::cudaDevAttrMaxTexture2DHeight>;
_CCCL_GLOBAL_CONSTANT max_texture_2d_height_t max_texture_2d_height{};
...
_CCCL_GLOBAL_CONSTANT max_texture_2d_linear_width_t max_texture_2d_linear_width{};
...
_CCCL_GLOBAL_CONSTANT max_texture_2d_linear_height_t max_texture_2d_linear_height{};
...
_CCCL_GLOBAL_CONSTANT max_texture_2d_linear_pitch_t max_texture_2d_linear_pitch{};

// Maximum mipmapped 2D texture width
using max_texture_2d_mipmapped_width_t = __dev_attr<::cudaDevAttrMaxTexture2DMipmappedWidth>;
_CCCL_GLOBAL_CONSTANT max_texture_2d_mipmapped_width_t max_texture_2d_mipmapped_width{};

// Maximum mipmapped 2D texture height
using max_texture_2d_mipmapped_height_t = __dev_attr<::cudaDevAttrMaxTexture2DMipmappedHeight>;
_CCCL_GLOBAL_CONSTANT max_texture_2d_mipmapped_height_t max_texture_2d_mipmapped_height{};

// Maximum 3D texture width
using max_texture_3d_width_t = __dev_attr<::cudaDevAttrMaxTexture3DWidth>;
_CCCL_GLOBAL_CONSTANT max_texture_3d_width_t max_texture_3d_width{};

// Maximum 3D texture height
using max_texture_3d_height_t = __dev_attr<::cudaDevAttrMaxTexture3DHeight>;
_CCCL_GLOBAL_CONSTANT max_texture_3d_height_t max_texture_3d_height{};

// Maximum 3D texture depth
using max_texture_3d_depth_t = __dev_attr<::cudaDevAttrMaxTexture3DDepth>;
_CCCL_GLOBAL_CONSTANT max_texture_3d_depth_t max_texture_3d_depth{};
...
_CCCL_GLOBAL_CONSTANT max_texture_3d_width_alt_t max_texture_3d_width_alt{};
...
_CCCL_GLOBAL_CONSTANT max_texture_3d_height_alt_t max_texture_3d_height_alt{};
...
_CCCL_GLOBAL_CONSTANT texture_alignment_t texture_alignment{};

// Pitch alignment requirement for 2D texture references bound to pitched memory
using texture_pitch_alignment_t = __dev_attr<::cudaDevAttrTexturePitchAlignment>;
_CCCL_GLOBAL_CONSTANT texture_pitch_alignment_t texture_pitch_alignment{};
...
_CCCL_GLOBAL_CONSTANT gpu_overlap_t gpu_overlap{};

// Number of multiprocessors on the device
using multiprocessor_count_t = __dev_attr<::cudaDevAttrMultiProcessorCount>;
_CCCL_GLOBAL_CONSTANT multiprocessor_count_t multiprocessor_count{};
...
_CCCL_GLOBAL_CONSTANT kernel_exec_timeout_t kernel_exec_timeout{};
...
_CCCL_GLOBAL_CONSTANT integrated_t integrated{};
...
_CCCL_GLOBAL_CONSTANT concurrent_kernels_t concurrent_kernels{};
...
_CCCL_GLOBAL_CONSTANT unified_addressing_t unified_addressing{};

// Major compute capability version number
using compute_capability_major_t = __dev_attr<::cudaDevAttrComputeCapabilityMajor>;
_CCCL_GLOBAL_CONSTANT compute_capability_major_t compute_capability_major{};

// Minor compute capability version number
using compute_capability_minor_t = __dev_attr<::cudaDevAttrComputeCapabilityMinor>;
_CCCL_GLOBAL_CONSTANT compute_capability_minor_t compute_capability_minor{};
...
_CCCL_GLOBAL_CONSTANT stream_priorities_supported_t stream_priorities_supported{};
...
_CCCL_GLOBAL_CONSTANT global_l1_cache_supported_t global_l1_cache_supported{};
...
_CCCL_GLOBAL_CONSTANT local_l1_cache_supported_t local_l1_cache_supported{};
...
_CCCL_GLOBAL_CONSTANT max_shared_memory_per_multiprocessor_t max_shared_memory_per_multiprocessor{};
...
_CCCL_GLOBAL_CONSTANT host_native_atomic_supported_t host_native_atomic_supported{};
...
_CCCL_GLOBAL_CONSTANT single_to_double_precision_perf_ratio_t single_to_double_precision_perf_ratio{};
...
_CCCL_GLOBAL_CONSTANT pageable_memory_access_t pageable_memory_access{};
...
_CCCL_GLOBAL_CONSTANT concurrent_managed_access_t concurrent_managed_access{};
...
_CCCL_GLOBAL_CONSTANT compute_preemption_supported_t compute_preemption_supported{};
...
_CCCL_GLOBAL_CONSTANT can_use_host_pointer_for_registered_mem_t can_use_host_pointer_for_registered_mem{};
...
_CCCL_GLOBAL_CONSTANT cooperative_launch_t cooperative_launch{};
...
_CCCL_GLOBAL_CONSTANT can_flush_remote_writes_t can_flush_remote_writes{};
...
_CCCL_GLOBAL_CONSTANT host_register_supported_t host_register_supported{};
...
_CCCL_GLOBAL_CONSTANT pageable_memory_access_uses_host_page_tables_t pageable_memory_access_uses_host_page_tables{};
...
_CCCL_GLOBAL_CONSTANT direct_managed_mem_access_from_host_t direct_managed_mem_access_from_host{};
...
_CCCL_GLOBAL_CONSTANT max_shared_memory_per_block_optin_t max_shared_memory_per_block_optin{};
...
_CCCL_GLOBAL_CONSTANT max_blocks_per_multiprocessor_t max_blocks_per_multiprocessor{};

// Maximum L2 persisting lines capacity setting in bytes
using max_persisting_l2_cache_size_t = __dev_attr<::cudaDevAttrMaxPersistingL2CacheSize>;
_CCCL_GLOBAL_CONSTANT max_persisting_l2_cache_size_t max_persisting_l2_cache_size{};
...
_CCCL_GLOBAL_CONSTANT max_access_policy_window_size_t max_access_policy_window_size{};

// Shared memory reserved by CUDA driver per block in bytes
using reserved_shared_memory_per_block_t = __dev_attr<::cudaDevAttrReservedSharedMemoryPerBlock>;
_CCCL_GLOBAL_CONSTANT reserved_shared_memory_per_block_t reserved_shared_memory_per_block{};
...
_CCCL_GLOBAL_CONSTANT sparse_cuda_array_supported_t sparse_cuda_array_supported{};
...
_CCCL_GLOBAL_CONSTANT host_register_read_only_supported_t host_register_read_only_supported{};
...
_CCCL_GLOBAL_CONSTANT memory_pools_supported_t memory_pools_supported{};
...
_CCCL_GLOBAL_CONSTANT gpu_direct_rdma_supported_t gpu_direct_rdma_supported{};
...
_CCCL_GLOBAL_CONSTANT gpu_direct_rdma_writes_ordering_t gpu_direct_rdma_writes_ordering{};

// Bitmask of handle types supported with mempool based IPC
using memory_pool_supported_handle_types_t = __dev_attr<::cudaDevAttrMemoryPoolSupportedHandleTypes>;
_CCCL_GLOBAL_CONSTANT memory_pool_supported_handle_types_t memory_pool_supported_handle_types{};
...
_CCCL_GLOBAL_CONSTANT deferred_mapping_cuda_array_supported_t deferred_mapping_cuda_array_supported{};

// true if the device supports IPC Events, false otherwise.
using ipc_event_support_t = __dev_attr<::cudaDevAttrIpcEventSupport>;
_CCCL_GLOBAL_CONSTANT ipc_event_support_t ipc_event_support{};
...
_CCCL_GLOBAL_CONSTANT numa_config_t numa_config{};

// NUMA node ID of the GPU memory
using numa_id_t = __dev_attr<::cudaDevAttrNumaId>;
_CCCL_GLOBAL_CONSTANT numa_id_t numa_id{};
#  endif // _CCCL_CTK_AT_LEAST(12, 2)
...
_CCCL_GLOBAL_CONSTANT compute_capability_t compute_capability{};
} // namespace device_attributes
