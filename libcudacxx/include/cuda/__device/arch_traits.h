...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_60>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_61>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_70>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_75>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_80>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_86>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_89>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_90>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_90a>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_100>() noexcept
{
  auto __traits                                 = ::cuda::__common_arch_traits(arch_id::sm_90);
  __traits.max_shared_memory_per_multiprocessor = 228 * 1024;
  __traits.max_blocks_per_multiprocessor        = 32;
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_100a>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_103>() noexcept
{
  auto __traits                     = ::cuda::arch_traits<arch_id::sm_100>();
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_103a>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_110>() noexcept
{
  auto __traits                     = ::cuda::arch_traits<arch_id::sm_100>();
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_110a>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_120>() noexcept
{
...
template <>
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits<arch_id::sm_120a>() noexcept
{
...
[[nodiscard]] _CCCL_API inline constexpr arch_traits_t arch_traits_for(arch_id __id)
{
  switch (__id)
  {
    case arch_id::sm_60:
...
[[nodiscard]] _CCCL_HOST_API inline arch_traits_t __arch_traits_might_be_unknown(device_ref __device)
{
  const auto __cc = ::cuda::device_attributes::compute_capability(__device);

  if (::cuda::__is_known_compute_capability(__cc))
  {
    return ::cuda::arch_traits_for(::cuda::to_arch_id(__cc));
  }

  arch_traits_t __traits{};
  __traits.max_threads_per_block            = ::cuda::device_attributes::max_threads_per_block(__device);
  __traits.max_block_dim_x                  = ::cuda::device_attributes::max_block_dim_x(__device);
  __traits.max_block_dim_y                  = ::cuda::device_attributes::max_block_dim_y(__device);
  __traits.max_block_dim_z                  = ::cuda::device_attributes::max_block_dim_z(__device);
  __traits.max_grid_dim_x                   = ::cuda::device_attributes::max_grid_dim_x(__device);
  __traits.max_grid_dim_y                   = ::cuda::device_attributes::max_grid_dim_y(__device);
  __traits.max_grid_dim_z                   = ::cuda::device_attributes::max_grid_dim_z(__device);
  __traits.max_shared_memory_per_block      = ::cuda::device_attributes::max_shared_memory_per_block(__device);
  __traits.total_constant_memory            = ::cuda::device_attributes::total_constant_memory(__device);
  __traits.warp_size                        = ::cuda::device_attributes::warp_size(__device);
  __traits.max_resident_grids               = 128; // cannot be queried, hardcode 128
  __traits.gpu_overlap                      = ::cuda::device_attributes::gpu_overlap(__device);
  __traits.can_map_host_memory              = ::cuda::device_attributes::can_map_host_memory(__device);
  __traits.concurrent_kernels               = ::cuda::device_attributes::concurrent_kernels(__device);
  __traits.stream_priorities_supported      = ::cuda::device_attributes::stream_priorities_supported(__device);
  __traits.global_l1_cache_supported        = ::cuda::device_attributes::global_l1_cache_supported(__device);
  __traits.local_l1_cache_supported         = ::cuda::device_attributes::local_l1_cache_supported(__device);
  __traits.max_registers_per_block          = ::cuda::device_attributes::max_registers_per_block(__device);
  __traits.max_registers_per_multiprocessor = ::cuda::device_attributes::max_registers_per_multiprocessor(__device);
  __traits.max_registers_per_thread         = 255; // cannot be queried, hardcode 255
  __traits.arch_id                          = ::cuda::to_arch_id(__cc);
  __traits.compute_capability_major         = __cc.major();
  __traits.compute_capability_minor         = __cc.minor();
  __traits.compute_capability               = __cc;
  ...
  __traits.max_shared_memory_per_block_optin = ::cuda::device_attributes::max_shared_memory_per_block_optin(__device);
  __traits.cluster_supported                 = (__cc >= compute_capability{90});
  __traits.redux_intrinisic                  = (__cc >= compute_capability{80});
  __traits.elect_intrinsic                   = (__cc >= compute_capability{90});
  __traits.cp_async_supported                = (__cc >= compute_capability{80});
...
//! @brief Gets the type traits for the specified \c __device.
[[nodiscard]] _CCCL_HOST_API inline const arch_traits_t&
arch_traits_for(device_ref __device); // implemented in
...
//! @brief Returns the compute capability of the architecture that is currently being compiled.
[[nodiscard]] _CCCL_DEVICE_API constexpr ::cuda::compute_capability __current_arch_cc_constexpr() noexcept
{
  NV_IF_ELSE_TARGET(NV_IS_DEVICE, (return ::cuda::compute_capability{__CUDA_ARCH__ / 10};), (return {};))
}

//! @brief Returns the \c cuda::arch_id that is currently being compiled.
[[nodiscard]] _CCCL_DEVICE_API constexpr ::cuda::arch_id current_arch_id_static() noexcept
{
  const auto __cc = ::cuda::device::__current_arch_cc_constexpr();
...
//!
//! @note If the current architecture is unknown (too new/old), the compilation will fail.
template <bool _IsKnownArch = ::cuda::__is_known_compute_capability(::cuda::device::__current_arch_cc_constexpr())>
[[nodiscard]] _CCCL_DEVICE_API constexpr ::cuda::arch_traits_t current_arch_traits_static() noexcept
{
  static_assert(_IsKnownArch, "unknow architecture cannot be queried for arch_traits");
  return ::cuda::arch_traits_for(::cuda::device::current_arch_id_static());
}
#    endif // !_CCCL_CUDA_COMPILER(NVHPC)

//! @brief Returns the compute capability of the architecture that is currently being compiled.
[[nodiscard]] _CCCL_DEVICE_API inline ::cuda::compute_capability __current_arch_cc() noexcept
{
#    if _CCCL_CUDA_COMPILER(NVHPC)
  return ::cuda::compute_capability{__builtin_current_device_sm()};
#    else // ^^^ _CCCL_CUDA_COMPILER(NVHPC) ^^^ / vvv !_CCCL_CUDA_COMPILER(NVHPC) vvv
  return ::cuda::device::__current_arch_cc_constexpr();
#    endif // ^^^ !_CCCL_CUDA_COMPILER(NVHPC) ^^^
}

//! @brief Returns the \c cuda::arch_id that is currently being compiled.
[[nodiscard]] _CCCL_DEVICE_API inline ::cuda::arch_id current_arch_id() noexcept
{
#    if _CCCL_CUDA_COMPILER(NVHPC)
  return ::cuda::to_arch_id(::cuda::device::__current_arch_cc());
#    else // ^^^ _CCCL_CUDA_COMPILER(NVHPC) ^^^ / vvv !_CCCL_CUDA_COMPILER(NVHPC) vvv
  return ::cuda::device::current_arch_id_static();
#    endif // ^^^ !_CCCL_CUDA_COMPILER(NVHPC) ^^^
}

_CCCL_DEVICE_API ::cuda::arch_traits_t __unknown_architecture_cannot_be_queried_for_arch_traits();

//! @brief Returns the \c cuda::arch_trait_t of the architecture that is currently being compiled.
//!
//! @note If the current architecture is unknown (too new/old), the compilation will fail.
template <class _Dummy = void>
[[nodiscard]] _CCCL_DEVICE_API inline ::cuda::arch_traits_t current_arch_traits() noexcept
{
#    if _CCCL_CUDA_COMPILER(NVHPC)
  if (::cuda::__is_known_compute_capability(::cuda::device::__current_arch_cc()))
  {
    return ::cuda::arch_traits_for(::cuda::device::current_arch_id());
  }
  else
  {
    // Link non-existing function that should result in link error
    return ::cuda::device::__unknown_architecture_cannot_be_queried_for_arch_traits();
  }
#    else // ^^^ _CCCL_CUDA_COMPILER(NVHPC) ^^^ / vvv !_CCCL_CUDA_COMPILER(NVHPC) vvv
  return ::cuda::device::current_arch_traits_static();
#    endif // ^^^ !_CCCL_CUDA_COMPILER(NVHPC) ^^^
}
