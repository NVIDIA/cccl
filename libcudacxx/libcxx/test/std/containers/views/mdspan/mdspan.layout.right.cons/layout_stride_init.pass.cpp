...
int main(int, char**)
{
...

    {
        ...
        std::layout_right ::mapping<std::extents<index_t,dyn,dyn>> m( m_stride );
    ...
    // Constraint: is_constructible_v<extents_type, OtherExtents> is true
    {
        ...
        using mapping1_t = std::layout_right ::mapping<std::extents<index_t,16,16>>;
        using mappingd_t = std::layout_right ::mapping<std::dextents<index_t,2>>;
