...
: public TestExtents< TEST_TYPE >
{
    ...
    void test_extent()
    {
        ...
        {
            bool is_dynamic = base::static_sizes[r] == std::dynamic_extent;
...
int main(int, char**)
{
    test_extent< std::tuple_element_t< 0, extents_test_types > >();
    test_extent< std::tuple_element_t< 1, extents_test_types > >();
    test_extent< std::tuple_element_t< 2, extents_test_types > >();
    test_extent< std::tuple_element_t< 3, extents_test_types > >();
    test_extent< std::tuple_element_t< 4, extents_test_types > >();
    test_extent< std::tuple_element_t< 5, extents_test_types > >();
