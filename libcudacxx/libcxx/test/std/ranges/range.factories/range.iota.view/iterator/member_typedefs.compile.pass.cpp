...
#else
  bool operator==(const Decrementable&) const;
  bool operator!=(const Decrementable&) const;
...
#else
  bool operator==(const Incrementable&) const;
  bool operator!=(const Incrementable&) const;
...
#else
  bool operator==(const BigType&) const;
  bool operator!=(const BigType&) const;
...
#else
  bool operator==(const CharDifferenceType&) const;
  bool operator!=(const CharDifferenceType&) const;
