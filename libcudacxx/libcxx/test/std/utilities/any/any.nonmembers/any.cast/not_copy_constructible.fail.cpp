...
int main(int, char**) {
    ...
    // expected-error-re@any:* {{static_cast from '{{(__libcpp_remove_reference_t<no_copy>|no_copy)}}'{{.*}} to 'no_copy' uses deleted function}}
    ...
    // expected-error-re@any:* {{static_cast from '{{(__libcpp_remove_reference_t<const no_copy>|const no_copy)}}'{{.*}} to 'no_copy' uses deleted function}}
    ...
    // expected-error@any:* {{static_cast from '__libcpp_remove_reference_t<no_move &>' (aka 'no_move') to 'no_move' uses deleted function}}
