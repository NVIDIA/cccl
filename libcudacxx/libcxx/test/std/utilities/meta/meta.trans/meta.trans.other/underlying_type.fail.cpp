...
enum E1 { E1Zero, E1One, E1Two = sizeof(std::underlying_type<E1>::type) }; // expected-error@__type_traits/underlying_type.h:* {{cannot determine underlying type of incomplete enumeration type 'E1'}}
