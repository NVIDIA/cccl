...
//  iterators in the libc++ test suite
    static_assert(std::__libcpp_string_gets_noexcept_iterator<cpp17_output_iterator       <char *> >::value == expected, "");
    static_assert(std::__libcpp_string_gets_noexcept_iterator<cpp17_input_iterator        <char *> >::value == expected, "");
