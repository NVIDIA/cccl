...
C2H_TEST("cub::DeviceReduce::ArgMax accepts determinism requirements", "[reduce][env]")
{
  ...
  thrust::device_vector<float> expected_min{4.0f};
...
C2H_TEST("cub::DeviceReduce::TransformReduce accepts determinism requirements", "[reduce][env]")
{
  ...
  thrust::device_vector<float> expected{30.0f};
...
C2H_TEST("cub::DeviceReduce::ReduceByKey accepts determinism requirements", "[reduce][env]")
{
  ...
  auto keys_in     = thrust::device_vector<int>{1, 1, 2, 2, 2, 3, 3};
  auto values_in   = thrust::device_vector<float>{10.0f, 20.0f, 30.0f, 40.0f, 50.0f, 60.0f, 70.0f};
  auto unique_keys = thrust::device_vector<int>(3);
  auto aggregates  = thrust::device_vector<float>(3);
  auto num_runs    = thrust::device_vector<int>(1);
  ...
  thrust::device_vector<int> expected_keys{1, 2, 3};
  thrust::device_vector<float> expected_aggregates{30.0f, 120.0f, 130.0f};
  thrust::device_vector<int> expected_num_runs{3};
...
C2H_TEST("cub::DeviceReduce::ReduceByKey accepts stream", "[reduce][env]")
{
  ...
  auto keys_in     = thrust::device_vector<int>{0, 0, 1, 1, 2, 2, 2};
  auto values_in   = thrust::device_vector<float>{1.0f, 2.0f, 3.0f, 4.0f, 5.0f, 6.0f, 7.0f};
  auto unique_keys = thrust::device_vector<int>(3);
  auto aggregates  = thrust::device_vector<float>(3);
  auto num_runs    = thrust::device_vector<int>(1);
  ...
  thrust::device_vector<float> expected_aggregates{3.0f, 7.0f, 18.0f};
  thrust::device_vector<int> expected_num_runs{3};
