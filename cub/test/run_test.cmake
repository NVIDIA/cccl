...
elseif (MODE MATCHES "^compute-sanitizer-(.*)$")
  ...
  if (("${TEST}" MATCHES "/cub.+test.device_segmented_radix_sort" AND tool STREQUAL "racecheck") OR
      ...
      ("${TEST}" MATCHES "/cub.+test.device_scan_large_offsets" AND (tool STREQUAL "initcheck" OR tool STREQUAL "racecheck")) OR
      ("${TEST}" MATCHES "/cub.+test.device_scan_by_key_large_offsets" AND (tool STREQUAL "initcheck" OR tool STREQUAL "racecheck")))
