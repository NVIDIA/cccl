...
CUB_RUNTIME_FUNCTION static cudaError_t dispatch_segmented_topk_pairs(
  void* d_temp_storage,
...
DECLARE_LAUNCH_WRAPPER(dispatch_segmented_topk_pairs, segmented_topk_pairs);
