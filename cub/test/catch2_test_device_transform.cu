         ...
         offset_types)
{
  ...
  auto in_it              = cuda::make_counting_iterator(offset_t{0});
         ...
         offset_types)
{
  ...
  auto a_it               = cuda::make_counting_iterator(offset_t{0});
  auto b_it               = thrust::make_constant_iterator(offset_t{42});
  auto expected_result_it = cuda::make_counting_iterator(offset_t{42});
