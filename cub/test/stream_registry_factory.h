...
[[nodiscard]] _CCCL_API cuda::std::execution::prop<get_allowed_kernels_t, cuda::std::span<void*>>
...
CUB_RUNTIME_FUNCTION stream_registry_factory_state_t* get_stream_registry_factory_state()
{
