...
public:
  ...
  // Hints to discard modified cache lines of the used virtual shared memory.
  //
  // Needs to be followed by `__syncthreads()` if the function returns true and the virtual shared memory is
