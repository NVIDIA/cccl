...
{
CREATE_IKET_PUSH_POP_RANGE(LoadSmem);
CREATE_IKET_PUSH_POP_RANGE(StoreSmem);
CREATE_IKET_PUSH_POP_RANGE(LoadBulk);
CREATE_IKET_PUSH_POP_RANGE(BulkStore);
