...
template <class T>
inline constexpr bool reduce_and_exists<T, ::cuda::std::logical_and<>, decltype(__reduce_and_sync(0xFFFFFFFF, T{}))> =
  ::cuda::std::is_same_v<unsigned int, T>;

template <class T>
inline constexpr bool reduce_and_exists<T, ::cuda::std::logical_and<T>, decltype(__reduce_and_sync(0xFFFFFFFF, T{}))> =
  ::cuda::std::is_same_v<unsigned int, T>;
...
template <class T>
inline constexpr bool reduce_or_exists<T, ::cuda::std::logical_or<>, decltype(__reduce_or_sync(0xFFFFFFFF, T{}))> =
  ::cuda::std::is_same_v<unsigned int, T>;

template <class T>
inline constexpr bool reduce_or_exists<T, ::cuda::std::logical_or<T>, decltype(__reduce_or_sync(0xFFFFFFFF, T{}))> =
  ::cuda::std::is_same_v<unsigned int, T>;
