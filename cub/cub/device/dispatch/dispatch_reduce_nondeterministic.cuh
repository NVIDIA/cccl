...
template <typename InputIteratorT,
          ...
          typename PolicyHub    = detail::reduce::arch_policies_from_types<AccumT, OffsetT, ReductionOpT>,
  ...
  requires reduce_policy_hub<PolicyHub>
#endif
struct DispatchReduceNondeterministic
{
  ...
  InvokeAtomicKernel(AtomicKernelT atomic_kernel, reduce_arch_policy active_policy)
  {
...
// Log nondeterministic_device_reduce_atomic_kernel configuration
    ...
    KernelLauncherFactory launcher_factory = {})
  {
    ...
    const reduce_arch_policy active_policy = PolicyHub{}(ptx_version);
