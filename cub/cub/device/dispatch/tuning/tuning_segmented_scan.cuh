...
struct policy_hub
{
  ...
  static auto select_agent_policy(int) -> AgentSegmentedScanPolicy<
    Tuning::threads,
    Tuning::items,
    AccumT,
  ...
  template <typename Tuning>
  static auto select_agent_policy(long) -> typename DefaultPolicy::SegmentedScanPolicyT;
  ...
  struct Policy750 : ChainedPolicy<750, Policy750, Policy600>
  {
    ...
    template <typename Tuning,
              ...
              ::cuda::std::enable_if_t<sizeof(AccumT) == sizeof(::cuda::std::__accumulator_t<ScanOpT, IVT, IVT>)
                                       ...
                                       int> = 0>
    static auto select_agent_policy750(int) -> AgentSegmentedScanPolicy<
      Tuning::threads,
      Tuning::items,
      AccumT,
      Tuning::load_algorithm,
  ...
  {
    using SegmentedScanPolicyT = decltype(select_agent_policy<sm80_tuning<AccumT, is_primitive_op<ScanOpT>()>>(0));
  };
  ...
  {
    using SegmentedScanPolicyT = decltype(select_agent_policy<sm90_tuning<AccumT, is_primitive_op<ScanOpT>()>>(0));
  };
  ...
  struct Policy1000 : ChainedPolicy<1000, Policy1000, Policy900>
  {
    ...
    template <typename Tuning,
              ...
              ::cuda::std::enable_if_t<sizeof(AccumT) == sizeof(::cuda::std::__accumulator_t<ScanOpT, IVT, IVT>)
                                         && sizeof(IVT) == sizeof(OutputValueT),
                                       int> = 0>
    static auto select_agent_policy100(int) -> AgentSegmentedScanPolicy<
      Tuning::threads,
      Tuning::items,
      AccumT,
      Tuning::load_algorithm,
