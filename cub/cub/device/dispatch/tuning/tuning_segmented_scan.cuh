                      ...
                      decltype(StaticPolicyT::block_segmented_scan_policy_t::max_segments_per_block)>> : StaticPolicyT
{
  ...
  {
    return StaticPolicyT::block_segmented_scan_policy_t::block_threads;
  }

  CUB_RUNTIME_FUNCTION static constexpr int ItemsPerThread()
  {
    return StaticPolicyT::block_segmented_scan_policy_t::items_per_thread;
  }
  ...
  CUB_RUNTIME_FUNCTION constexpr auto to_policy() const -> block_segmented_scan_policy
  {
    using policy_t = typename StaticPolicyT::block_segmented_scan_policy_t;
    return block_segmented_scan_policy{
      policy_t::block_threads,
      policy_t::items_per_threads,
      policy_t::load_modifier,
      policy_t::block_load_algorithm,
      policy_t::block_store_algorithm,
      policy_t::block_scan_algorithm,
      policy_t::max_segments_per_block};
  }
};
                      ...
                      decltype(StaticPolicyT::warp_segmented_scan_policy_t::max_segments_per_warp)>> : StaticPolicyT
{
  ...
  CUB_RUNTIME_FUNCTION static constexpr int BlockThreads()
  {
    return StaticPolicyT::warp_segmented_scan_policy_t::block_threads;
  }

  CUB_RUNTIME_FUNCTION static constexpr int ItemsPerThread()
  {
    return StaticPolicyT::wapr_segmented_scan_policy_t::items_per_thread;
  }
  ...
  CUB_RUNTIME_FUNCTION constexpr auto to_policy() const -> warp_segmented_scan_policy
  {
    using policy_t = typename StaticPolicyT::warp_segmented_scan_policy_t;
    return warp_segmented_scan_policy{
      policy_t::block_threads,
      policy_t::items_per_thread,
      policy_t::load_modifier,
      policy_t::warp_load_algorithm,
      policy_t::warp_store_algorithm,
      policy_t::max_segments_per_warp};
  }
};
  ...
  ::cuda::std::void_t<decltype(StaticPolicyT::thread_segmented_scan_policy_t::load_modifier)>> : StaticPolicyT
{
  ...
  CUB_RUNTIME_FUNCTION static constexpr int BlockThreads()
  {
    return StaticPolicyT::thread_segmented_scan_policy_t::block_threads;
  }

  CUB_RUNTIME_FUNCTION static constexpr int ItemsPerThread()
  {
    return StaticPolicyT::thread_segmented_scan_policy_t::items_per_thread;
  }
  ...
  CUB_RUNTIME_FUNCTION constexpr auto to_policy() const -> thread_segmented_scan_policy
  {
    using policy_t = typename StaticPolicyT::thread_segmented_scan_policy_t;
    return thread_segmented_scan_policy{policy_t::BLOCK_THREADS, policy_t::ITEMS_PER_THREAD, policy_t::load_modifier};
  }
};
    ...
    : StaticPolicyT
{
  ...
  CUB_RUNTIME_FUNCTION constexpr auto BlockWorkerSegmentedScan() const
  {
    return make_block_segmented_scan_policy_wrapper(*this);
  }

  CUB_RUNTIME_FUNCTION constexpr auto WarpWorkerSegmentedScan() const
  {
    return make_warp_segmented_scan_policy_wrapper(*this);
  }

  CUB_RUNTIME_FUNCTION constexpr auto ThreadWorkerSegmentedScan() const
  {
    return make_thread_segmented_scan_policy_wrapper(*this);
  }
  ...
  CUB_RUNTIME_FUNCTION constexpr auto to_policy() const -> segmented_scan_policy
  {
    return segmented_scan_policy{BlockWorkerSegmentedScan().to_policy(),
                                 WarpWorkerSegmentedScan().to_policy(),
                                 ThreadWorkerSegmentedScan().to_policy()};
  }
};
...
public:
  ...
  {
    static constexpr int nominal_block_threads    = 128;
    static constexpr int nominal_items_per_thread = 9;
    static constexpr int max_segments_per_block   = 512;
    static constexpr int max_segments_per_warp    = 128;

    using block_compute_t = agent_block_segmented_scan_compute_t<AccumT, max_segments_per_block>;
    using warp_compute_t  = agent_warp_segmented_scan_compute_t<AccumT, max_segments_per_warp>;

    static constexpr auto block_scaled =
      detail::scale_mem_bound(nominal_block_threads, nominal_items_per_thread, int{sizeof(block_compute_t)});
    static constexpr auto warp_scaled =
      detail::scale_mem_bound(nominal_block_threads, nominal_items_per_thread, int{sizeof(warp_compute_t)});
    static constexpr auto thread_scaled =
      detail::scale_mem_bound(nominal_block_threads, nominal_items_per_thread, int{sizeof(AccumT)});
    ...
    using warp_segmented_scan_policy_t = agent_warp_segmented_scan_policy_t<
      warp_scaled.block_threads,
      warp_scaled.items_per_thread,
      WARP_LOAD_TRANSPOSE,
      LOAD_DEFAULT,
    ...
    using thread_segmented_scan_policy_t =
      agent_thread_segmented_scan_policy_t<thread_scaled.block_threads, thread_scaled.items_per_thread, LOAD_DEFAULT>;
  };
