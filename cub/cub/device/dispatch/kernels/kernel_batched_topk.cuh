...
private:
  ...
  static constexpr ::cuda::std::int64_t max_segment_size = ::cuda::argument::__traits<SegmentSizeParameterT>::max;
    ...
    LargeSegmentTileOffsetT* d_large_segments_tile_offsets)
{
  ...
  static_assert(agent_t::tile_size >= ::cuda::argument::__traits<SegmentSizeParameterT>::max,
