...
template <typename PolicySelectorT,
          ...
          typename AccumT>
CCCL_DETAIL_KERNEL_ATTRIBUTES __launch_bounds__(128) void DeviceScanInitKernel(
...
CCCL_DETAIL_KERNEL_ATTRIBUTES void DeviceCompactInitKernel(
...
__launch_bounds__(get_device_scan_launch_bounds<PolicySelector, InputIteratorT, OutputIteratorT, AccumT>(), 1)
  CCCL_DETAIL_KERNEL_ATTRIBUTES void DeviceScanKernel(
