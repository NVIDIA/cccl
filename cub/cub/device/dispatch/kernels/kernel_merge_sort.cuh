...
__launch_bounds__(
  ...
  CCCL_DETAIL_KERNEL_ATTRIBUTES void DeviceMergeSortBlockSortKernel(
...
CCCL_DETAIL_KERNEL_ATTRIBUTES void DeviceMergeSortPartitionKernel(
  _CCCL_GRID_CONSTANT const bool ping,
...
__launch_bounds__(
  merge_sort_vsmem_helper_t<policy_getter<PolicySelectorT, cuda::arch_id{CUB_PTX_ARCH / 10}>,
                            ...
                            KeyT,
                            ValueT>::policy.block_threads)
  CCCL_DETAIL_KERNEL_ATTRIBUTES void DeviceMergeSortMergeKernel(
    _CCCL_GRID_CONSTANT const bool ping,
    _CCCL_GRID_CONSTANT const KeyIteratorT keys_ping,
