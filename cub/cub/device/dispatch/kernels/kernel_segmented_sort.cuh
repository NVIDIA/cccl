...
__launch_bounds__(PolicySelector{}(::cuda::arch_id{CUB_PTX_ARCH / 10}).large_segment.block_threads)
  CCCL_DETAIL_KERNEL_ATTRIBUTES void DeviceSegmentedSortFallbackKernel(
...
__launch_bounds__(PolicySelector{}(::cuda::arch_id{CUB_PTX_ARCH / 10}).small_segment.block_threads)
  CCCL_DETAIL_KERNEL_ATTRIBUTES void DeviceSegmentedSortKernelSmall(
...
#endif // _CCCL_HAS_CONCEPTS()
__launch_bounds__(PolicySelector{}(::cuda::arch_id{CUB_PTX_ARCH / 10}).large_segment.block_threads)
  CCCL_DETAIL_KERNEL_ATTRIBUTES void DeviceSegmentedSortKernelLarge(
