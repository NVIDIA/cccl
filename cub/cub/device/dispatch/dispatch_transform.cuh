...
#if _CCCL_CUDA_COMPILER && _CCCL_CUDACC_VER < 1105000
...
#endif // _CCCL_CUDA_COMPILER && _CCCL_CUDACC_VER < 1105000
...
#if _CCCL_CUDACC_VER_MAJOR >= 12 && !_CCCL_CUDA_COMPILER_NVHPC
#  define _CUB_HAS_TRANSFORM_UBLKCP
#endif // _CCCL_CUDACC_VER_MAJOR >= 12 && !_CCCL_CUDA_COMPILER_NVHPC
