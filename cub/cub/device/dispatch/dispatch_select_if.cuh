...
struct partition_policy_adapter
{
  ...
  KernelLauncherFactory launcher_factory = {})
{
  ...
  using expected_policy_t =
    ::cuda::std::conditional_t<SelectionOpt == SelectImpl::Partition, PartitionPolicy, SelectPolicy>;
  using orig_policy_selector_t =
    ::cuda::std::execution::__query_result_or_t<TuningEnvT, expected_policy_t, default_policy_selector_t>;
  using policy_selector_t =
    ::cuda::std::conditional_t<SelectionOpt == SelectImpl::Partition,
                               partition_policy_adapter<orig_policy_selector_t>,
