...
public:
  ...
  Min(InputIteratorT d_in, OutputIteratorT d_out, NumItemsT num_items, EnvT env = {})
  {
    ...
    static_assert(!::cuda::std::execution::__queryable_with<EnvT, _CUDA_EXEC::determinism::__get_determinism_t>,
                  "Determinism should be used inside requires to have an effect.");
    using requirements_t =
      ::cuda::std::execution::__query_result_or_t<EnvT, _CUDA_EXEC::__get_requirements_t, ::cuda::std::execution::env<>>;
    ...
    using tuning_t =
      ::cuda::std::execution::__query_result_or_t<EnvT, _CUDA_EXEC::__get_tuning_t, ::cuda::std::execution::env<>>;
