...
// The baseline/device backends ignore determinism/tie-break, so require the defaults there to avoid a silently ignored
...
static_assert(selected_backend == topk_backend::cluster || selected_backend == topk_backend::automatic
              ...
              "at 0 (non-deterministic) for the baseline/device backends.");
