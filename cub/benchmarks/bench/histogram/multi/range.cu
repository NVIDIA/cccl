  ...
  if (bench_correctness_checks_enabled())
  {
    ...
    bench_check_cuda(
      (cub::DeviceHistogram::MultiHistogramRange<num_channels, num_active_channels>(
        ...
        cuda::execution::tune(
          bench_policy_selector<SampleT, LocalCounterT, num_channels, num_active_channels, false>{}))),
    ...
    bench_verify_histogram_range<num_channels, num_active_channels, SampleT, GlobalCounterT, OffsetT>(
