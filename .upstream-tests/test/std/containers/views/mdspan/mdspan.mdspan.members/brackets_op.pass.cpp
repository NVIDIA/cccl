...
struct is_bracket_op_avail< cuda::std::enable_if_t< cuda::std::is_same< decltype( cuda::std::declval<T>()(cuda::std::declval<OtherIndexTypes>()...) )
...
struct is_bracket_op_array_avail< T
                                , OtherIndexType
                                , N
                                , cuda::std::enable_if_t< cuda::std::is_same< decltype( cuda::std::declval<T>()(cuda::std::declval<cuda::std::array<OtherIndexType,N>>()) )
                                                                            , typename T::accessor_type::reference
                                                                            >::value
                                                        >
                                > : cuda::std::true_type {};
...
struct is_bracket_op_span_avail< T
                               , OtherIndexType
                               , N
                               , cuda::std::enable_if_t< cuda::std::is_same< decltype( cuda::std::declval<T>()(cuda::std::declval<cuda::std::span<OtherIndexType,N>>()) )
                                                                           , typename T::accessor_type::reference
                                                                           >::value
                                                       >
                               > : cuda::std::true_type {};
