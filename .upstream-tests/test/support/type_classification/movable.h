...
struct copy_with_mutable_parameter {
  ...
  __host__ __device__ copy_with_mutable_parameter&
...
struct const_move_assign_and_default_ops {
  ...
  __host__ __device__ const_move_assign_and_default_ops&
...
struct volatile_move_assign_and_default_ops {
  ...
  __host__ __device__ volatile_move_assign_and_default_ops&
