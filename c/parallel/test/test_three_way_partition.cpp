...
C2H_TEST("ThreeWayPartition works with iterators", "[three_way_partition]")
{
  ...
  REQUIRE(::cuda::std::cmp_equal(num_selected[0], std_result.num_items_in_first_part));
  REQUIRE(::cuda::std::cmp_equal(num_selected[1], std_result.num_items_in_second_part));
