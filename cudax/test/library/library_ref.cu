...
C2H_CCCLRT_TEST("Library reference", "[library_ref]")
{
  ...
  CUlibrary lib1 = ::cuda::__driver::__libraryLoadData(lib_src.c_str(), opts, opt_vals, 1, nullptr, nullptr, 0);
  CUlibrary lib2 = ::cuda::__driver::__libraryLoadData(lib_src.c_str(), opts, opt_vals, 1, nullptr, nullptr, 0);
