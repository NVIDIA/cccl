...
C2H_CCCLRT_TEST("Library reference", "[library_ref]")
{
  ...
  CUlibrary lib1 = _CCCL_TRY_DRIVER_API(__libraryLoadData(library_src, nullptr, nullptr, 0, nullptr, nullptr, 0));
  CUlibrary lib2 = _CCCL_TRY_DRIVER_API(__libraryLoadData(library_src, nullptr, nullptr, 0, nullptr, nullptr, 0));
  ...
  // Get kernel
  {
    ...
    CUkernel kernel_handle = _CCCL_TRY_DRIVER_API(__libraryGetKernel(lib1, kernel_name));
  ...
  // Get global symbol
  {
    ...
    // Test global_symbol_name
    {
      ...
      auto [global_symbol_ptr, global_symbol_size] = _CCCL_TRY_DRIVER_API(__libraryGetGlobal(lib1, global_symbol_name));
    ...
    // Test const_symbol_name
    {
      ...
      auto [const_symbol_ptr, const_symbol_size] = _CCCL_TRY_DRIVER_API(__libraryGetGlobal(lib1, const_symbol_name));
  ...
  // Get managed symbol
  {
    ...
    auto [managed_symbol_ptr,
          managed_symbol_size] = _CCCL_TRY_DRIVER_API(__libraryGetManaged(lib1, managed_symbol_name));
  ...
  _CCCL_ASSERT_DRIVER_API(__libraryUnload(lib1));
  _CCCL_ASSERT_DRIVER_API(__libraryUnload(lib2));
}
