...
C2H_CCCLRT_TEST("Library reference", "[library_ref]")
{
  ...
  CUlibrary lib2{};
  CUDAX_REQUIRE(cuLibraryLoadData(&lib2, library_src, nullptr, nullptr, 0, nullptr, nullptr, 0) == CUDA_SUCCESS);
  ...
  // Get kernel
  {
    ...
    CUDAX_REQUIRE(cuLibraryGetKernel(&kernel_handle, lib1, kernel_name) == CUDA_SUCCESS);
  ...
  // Get managed symbol
  {
    ...
    CUDAX_REQUIRE(
      cuLibraryGetManaged(&managed_symbol_ptr, &managed_symbol_size, lib1, managed_symbol_name) == CUDA_SUCCESS);
  ...
  CUDAX_REQUIRE(cuLibraryUnload(lib1) == CUDA_SUCCESS);
  CUDAX_REQUIRE(cuLibraryUnload(lib2) == CUDA_SUCCESS);
}
