...
C2H_CCCLRT_TEST("Library", "[library]")
{
  ...
  CUlibrary lib1_native =
    _CCCL_TRY_DRIVER_API(__libraryLoadData(library_src, nullptr, nullptr, 0, nullptr, nullptr, 0));
  ...
  // Get kernel
  {
    ...
    CUkernel kernel_handle = _CCCL_TRY_DRIVER_API(__libraryGetKernel(lib1_native, kernel_name));
  ...
  // Get global symbol
  {
    ...
    // Test global_symbol_name
    {
      ...
      const auto [global_symbol_ptr, global_symbol_size] =
        _CCCL_TRY_DRIVER_API(__libraryGetGlobal(lib1_native, global_symbol_name));
    ...
    // Test const_symbol_name
    {
      ...
      const auto [const_symbol_ptr, const_symbol_size] =
        _CCCL_TRY_DRIVER_API(__libraryGetGlobal(lib1_native, const_symbol_name));
  ...
  // Get managed symbol
  {
    ...
    auto [managed_symbol_ptr,
          managed_symbol_size] = _CCCL_TRY_DRIVER_API(__libraryGetManaged(lib1_native, managed_symbol_name));
