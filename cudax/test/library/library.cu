...
C2H_CCCLRT_TEST("Library", "[library]")
{
  ...
  CUDAX_REQUIRE(cuLibraryLoadData(&lib1_native, library_src, nullptr, nullptr, 0, nullptr, nullptr, 0) == CUDA_SUCCESS);

  CUlibrary lib2_native{};
  CUDAX_REQUIRE(cuLibraryLoadData(&lib2_native, library_src, nullptr, nullptr, 0, nullptr, nullptr, 0) == CUDA_SUCCESS);
  ...
  // Get kernel
  {
    ...
    CUDAX_REQUIRE(cuLibraryGetKernel(&kernel_handle, lib1_native, kernel_name) == CUDA_SUCCESS);
  ...
  // Get global symbol
  {
    ...
    // Test global_symbol_name
    {
      ...
      CUDAX_REQUIRE(
        cuLibraryGetGlobal(&global_symbol_ptr, &global_symbol_size, lib1_native, global_symbol_name) == CUDA_SUCCESS);
    ...
    // Test const_symbol_name
    {
      ...
      CUDAX_REQUIRE(
        cuLibraryGetGlobal(&const_symbol_ptr, &const_symbol_size, lib1_native, const_symbol_name) == CUDA_SUCCESS);
  ...
  // Get managed symbol
  {
    ...
    CUDAX_REQUIRE(
      cuLibraryGetManaged(&managed_symbol_ptr, &managed_symbol_size, lib1_native, managed_symbol_name) == CUDA_SUCCESS);
