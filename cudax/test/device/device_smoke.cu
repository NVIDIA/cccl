...
C2H_CCCLRT_TEST("Smoke", "[device]")
{
  ...
  SECTION("Attributes")
  {
    ...
    ::test_device_attribute<attributes::max_texture_1d_mipmapped_width,
    ...
    ::test_device_attribute<attributes::max_texture_2d_linear_height,
                            ::cudaDevAttrMaxTexture2DLinearHeight,
                            int>();
    ::test_device_attribute<attributes::max_texture_2d_linear_pitch, ::cudaDevAttrMaxTexture2DLinearPitch, int>();
    ::test_device_attribute<attributes::max_texture_2d_mipmapped_width,
                            ::cudaDevAttrMaxTexture2DMipmappedWidth,
                            int>();
    ::test_device_attribute<attributes::max_texture_2d_mipmapped_height,
    ...
    ::test_device_attribute<attributes::max_texture_1d_layered_width,
                            ::cudaDevAttrMaxTexture1DLayeredWidth,
                            int>();
    ::test_device_attribute<attributes::max_texture_1d_layered_layers,
                            ::cudaDevAttrMaxTexture1DLayeredLayers,
                            int>();
    ::test_device_attribute<attributes::max_texture_2d_layered_width,
                            ::cudaDevAttrMaxTexture2DLayeredWidth,
                            int>();
    ::test_device_attribute<attributes::max_texture_2d_layered_height,
                            ::cudaDevAttrMaxTexture2DLayeredHeight,
                            int>();
    ::test_device_attribute<attributes::max_texture_2d_layered_layers,
    ...
    ::test_device_attribute<attributes::max_surface_1d_layered_width,
                            ::cudaDevAttrMaxSurface1DLayeredWidth,
                            int>();
    ::test_device_attribute<attributes::max_surface_1d_layered_layers,
                            ::cudaDevAttrMaxSurface1DLayeredLayers,
                            int>();
    ::test_device_attribute<attributes::max_surface_2d_layered_width,
                            ::cudaDevAttrMaxSurface2DLayeredWidth,
                            int>();
    ::test_device_attribute<attributes::max_surface_2d_layered_height,
                            ::cudaDevAttrMaxSurface2DLayeredHeight,
                            int>();
    ::test_device_attribute<attributes::max_surface_2d_layered_layers,
    ...
    ::test_device_attribute<attributes::max_threads_per_multiprocessor,
    ...
    ::test_device_attribute<attributes::stream_priorities_supported,
    ...
    ::test_device_attribute<attributes::host_native_atomic_supported,
    ...
    ::test_device_attribute<attributes::compute_preemption_supported,
    ...
    ::test_device_attribute<attributes::max_shared_memory_per_block_optin,
                            ...
                            int>();
    ::test_device_attribute<attributes::max_blocks_per_multiprocessor,
    ...
    ::test_device_attribute<attributes::reserved_shared_memory_per_block,
                            ...
                            int>();
    ::test_device_attribute<attributes::sparse_cuda_array_supported,
    ...
    {
      STATIC_REQUIRE(
        ::cudaFlushGPUDirectRDMAWritesOptionHost == attributes::gpu_direct_rdma_flush_writes_options.host);
      STATIC_REQUIRE(
    ...
    SECTION("gpu_direct_rdma_writes_ordering")
    {
      ...
      STATIC_REQUIRE(
        ::cudaGPUDirectRDMAWritesOrderingOwner == attributes::gpu_direct_rdma_writes_ordering.owner);
      STATIC_REQUIRE(
