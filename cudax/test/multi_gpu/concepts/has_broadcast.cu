...
{
  STATIC_REQUIRE(cudax::mgmn::__has_broadcast<types::collective_communicator_model>);
  STATIC_REQUIRE(cudax::mgmn::__has_broadcast<types::collective_communicator_model, long*>);
  STATIC_REQUIRE(!cudax::mgmn::__has_broadcast<types::communicator_model>);

  STATIC_REQUIRE(!cudax::mgmn::__has_broadcast<broadcast_returns_int>);
}
