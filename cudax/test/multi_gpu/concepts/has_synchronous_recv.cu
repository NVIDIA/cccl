...
struct recv_sync_returns_int : types::synchronous_communicator_without_recv
{
  template <class Tp>
...
_CCCL_HOST_DEVICE_API constexpr bool test()
{
  ...
  static_assert(!cudax::__has_synchronous_recv<types::synchronous_communicator_without_recv>);
