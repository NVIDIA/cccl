...
public:
    ...
    GPUMemoryRAII(GPUMemoryRAII&& other) noexcept : ptr_(other.ptr_), size_(other.size_) {
        other.ptr_ = nullptr;
        other.size_ = 0;
    }
...
public:
    ...
    HostMemoryRAII(HostMemoryRAII&& other) noexcept : ptr_(other.ptr_), size_(other.size_) {
        other.ptr_ = nullptr;
        other.size_ = 0;
    }
...
public:
    ...
    RegularMemoryRAII(RegularMemoryRAII&& other) noexcept : ptr_(other.ptr_), size_(other.size_) {
        other.ptr_ = nullptr;
        other.size_ = 0;
    }
