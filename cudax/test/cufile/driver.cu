...
template <class Attr>
void test_attribute_range(const Attr& attr, const bool is_open)
{
...
{
  STATIC_REQUIRE(
    ::cuda::std::is_same_v<decltype(cuda::experimental::cufile_driver), cuda::experimental::cufile_driver_t>);
