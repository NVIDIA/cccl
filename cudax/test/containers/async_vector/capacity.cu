...
TEMPLATE_TEST_CASE("cudax::async_vector capacity",
                   ...
                   (cuda::std::tuple<cuda::mr::host_accessible, cuda::mr::device_accessible>) )
{
  ...
  SECTION("cudax::async_vector::empty")
  {
  ...
  SECTION("cudax::async_vector::size")
  {
  ...
  SECTION("cudax::async_vector::capacity")
  {
  ...
  SECTION("cudax::async_vector::max_size")
  {
