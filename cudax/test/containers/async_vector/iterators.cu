...
TEMPLATE_TEST_CASE("cudax::async_vector iterators",
                   ...
                   (cuda::std::tuple<cuda::mr::host_accessible, cuda::mr::device_accessible>) )
{
  ...
  SECTION("cudax::async_vector::begin/end properties")
  {
  ...
  SECTION("cudax::async_vector::begin/end no allocation")
  {
    Vector vec{env, 0};
  ...
  SECTION("cudax::async_vector::begin/end with allocation")
  {
  ...
  SECTION("cudax::async_vector::begin/end with allocation after clear")
  {
    Vector vec{env, 42, cudax::uninit}; // Note we do not care about the elements just the sizes
    auto* ptr = vec.data();
    vec.clear();
  ...
  SECTION("cudax::async_vector::rbegin/rend properties")
  {
  ...
  SECTION("cudax::async_vector::rbegin/rend no allocation")
  {
    Vector vec{env, 0};
  ...
  SECTION("cudax::async_vector::rbegin/rend with allocation")
  {
    Vector vec{env, 42, cudax::uninit}; // Note we do not care about the elements just the sizes
