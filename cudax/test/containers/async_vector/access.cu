...
TEMPLATE_TEST_CASE("cudax::async_vector access",
                   ...
                   (cuda::std::tuple<cuda::mr::host_accessible, cuda::mr::device_accessible>) )
{
  ...
  SECTION("cudax::async_vector::operator[]")
  {
  ...
  SECTION("cudax::async_vector::front")
  {
  ...
  SECTION("cudax::async_vector::back")
  {
  ...
  SECTION("cudax::async_vector::data")
  {
...
#  ifndef TEST_HAS_NO_EXCEPTIONS
  SECTION("cudax::async_vector access exceptions")
  { // at throws std::out_of_range
    {
      using vec = cudax::async_vector<int, 42>;
      try
      {
        vec too_small{};
