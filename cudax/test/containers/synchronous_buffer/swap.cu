...
TEMPLATE_TEST_CASE("cudax::synchronous_buffer swap",
                   ...
                   (cuda::std::tuple<cuda::mr::host_accessible, cuda::mr::device_accessible>) )
{
  ...
  Buffer vec_small{resource, 5, cudax::uninit};

  SECTION("Can swap synchronous_buffer")
  {
    Buffer vec_large{resource, 42, cudax::uninit};
  ...
  SECTION("Can swap synchronous_buffer without allocation")
  {
    Buffer vec_no_allocation{resource, 0, cudax::uninit};
