...
TEMPLATE_TEST_CASE("cudax::synchronous_buffer access",
                   ...
                   (cuda::std::tuple<cuda::mr::host_accessible, cuda::mr::device_accessible>) )
{
  ...
  SECTION("cudax::synchronous_buffer::get")
  {
    ...
    {
      Buffer buf{resource, {T(1), T(42), T(1337), T(0)}};
      auto& res = buf.get(2);
  ...
  SECTION("cudax::synchronous_buffer::data")
  {
