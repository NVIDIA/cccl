...
public:
    ...
    matrix(Ctx& ctx, size_t NROWS, size_t NCOLS, size_t BLOCKSIZE_ROWS, size_t BLOCKSIZE_COLS,
...
template <typename Ctx>
void DGEMM(Ctx& ctx, cublasOperation_t transa, cublasOperation_t transb, double alpha, matrix<double>& A, int A_row,
        int A_col, matrix<double>& B, int B_row, int B_col, double beta, matrix<double>& C, int C_row, int C_col) {
...
template <typename Ctx>
void PDGEMM(Ctx& ctx, cublasOperation_t transa, cublasOperation_t transb, double alpha, matrix<double>& A,
