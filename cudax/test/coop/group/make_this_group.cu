...
struct TestKernel
{
  ...
  {
    test_make_this_group<cudax::coop::this_thread>(cuda::gpu_thread, config);
    test_make_this_group<cudax::coop::this_warp>(cuda::warp, config);
    test_make_this_group<cudax::coop::this_block>(cuda::block, config);
    test_make_this_group<cudax::coop::this_cluster>(cuda::cluster, config);
    test_make_this_group<cudax::coop::this_grid>(cuda::grid, config);
  }
};
} // namespace
