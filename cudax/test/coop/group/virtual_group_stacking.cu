...
struct TestKernel1
{
  ...
  __device__ void operator()(Config config) const
  {
    ...
    const cudax::coop::virtual_group group1{cuda::gpu_thread, parent_group, cudax::coop::group_by<16>{}};
...
struct TestKernel2
{
  ...
  __device__ void operator()(Config config) const
  {
    ...
    const cudax::coop::virtual_group group1{cuda::gpu_thread, parent_group, cudax::coop::group_by<32>{}};
    ...
    const cudax::coop::virtual_group group3{cuda::gpu_thread, group2, cudax::coop::group_by<8>{}};
...
struct TestKernel3
{
  ...
  __device__ void operator()(Config config) const
  {
    ...
    const cudax::coop::virtual_group group1{cuda::warp, parent_group, cudax::coop::group_by<16>{}};
    ...
    const cudax::coop::virtual_group group2{cuda::warp, group1, cudax::coop::group_by<8>{}};
