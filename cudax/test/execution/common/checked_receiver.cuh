...
template <class... Values>
_CCCL_DEDUCTION_GUIDE_EXSPACE checked_value_receiver(Values...) -> checked_value_receiver<Values...>;
...
template <class Error>
_CCCL_DEDUCTION_GUIDE_EXSPACE checked_error_receiver(Error) -> checked_error_receiver<Error>;
