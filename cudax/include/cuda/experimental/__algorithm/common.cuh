...
_CCCL_CONCEPT __convertible_to_span = _CCCL_REQUIRES_EXPR((_Cont))(
  requires(_CUDA_VSTD::is_constructible_v<_CUDA_VSTD::span<typename _CUDA_VSTD::decay_t<_Cont>::value_type>, _Cont>));

template <typename _Cont>
_CCCL_CONCEPT __valid_1d_copy_fill_argument =
  _CUDA_VRANGES::contiguous_range<detail::__as_copy_arg_t<_Cont>> || __convertible_to_span<_Cont>;
