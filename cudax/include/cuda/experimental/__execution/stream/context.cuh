...
struct _CCCL_TYPE_VISIBILITY_DEFAULT stream_context : private __immovable
{
  ...
  struct _CCCL_TYPE_VISIBILITY_DEFAULT scheduler
  {
    ...
    _CCCL_API static constexpr auto query(get_forward_progress_guarantee_t) noexcept -> forward_progress_guarantee
    {
  ...
  struct _CCCL_TYPE_VISIBILITY_DEFAULT __sndr_t
  {
    ...
    _CCCL_API constexpr auto get_env() const noexcept -> const __attrs_t&
    {
      return __env_;
    }
