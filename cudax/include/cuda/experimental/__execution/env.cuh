...
public:
  ...
  static constexpr bool __is_compatible_env =
    _CUDA_VSTDEXEC::__queryable_with<_Env, get_memory_resource_t> //
    && _CUDA_VSTDEXEC::__queryable_with<_Env, get_stream_t>
    && _CUDA_VSTDEXEC::__queryable_with<_Env, execution::get_execution_policy_t>;
