...
struct __completion_tag
{
  ...
  _CCCL_API constexpr auto operator==(__completion_tag<_OtherDisposition>) const noexcept -> bool
  {
...
struct set_value_t : __completion_tag<__disposition::__value>
{
  ...
  _CCCL_API constexpr void operator()(_Rcvr&& __rcvr, _Ts&&... __ts) const noexcept
  {
...
struct set_error_t : __completion_tag<__disposition::__error>
{
  ...
  _CCCL_API constexpr void operator()(_Rcvr&& __rcvr, _Ey&& __e) const noexcept
  {
...
struct set_stopped_t : __completion_tag<__disposition::__stopped>
{
  ...
  _CCCL_API constexpr void operator()(_Rcvr&& __rcvr) const noexcept
  {
...
struct start_t
{
  ...
  _CCCL_API constexpr void operator()(_OpState& __opstate) const noexcept
  {
...
struct schedule_t
{
  _CCCL_EXEC_CHECK_DISABLE
  template <class _Sch>
  _CCCL_API constexpr auto operator()(_Sch&& __sch) const noexcept
  {
