...
_CCCL_CONCEPT work_submitter =
  graph_inserter<_Submitter> || _CUDA_VSTD::is_convertible_v<_Submitter, ::cuda::stream_ref>;
                           ...
                           _Args&&... __args)
{
                                            ...
                                            _CUDA_VSTD::decay_t<transformed_device_argument_t<_Args>>...>)
  {
    ...
    return __launch_impl(
      ...
      __combined,
      __kernel,
      device_transform(__stream_or_invalid(__submitter), _CUDA_VSTD::forward<_Args>(__args))...);
  }
  else
  {
                           ...
                           _ActArgs&&... __args)
{
  ...
  return __launch_impl<kernel_config<_Dimensions, _Config...>, _ExpArgs...>(
    ...
    __conf,
    device_transform(__stream_or_invalid(__submitter), _CUDA_VSTD::forward<_ActArgs>(__args))...);
}
