...
private:
  [[nodiscard]] _CCCL_HOST_API cudaError_t apply(cudaLaunchConfig_t& __config, void*) const noexcept
  {
...
private:
  [[nodiscard]] _CCCL_HOST_API cudaError_t apply(cudaLaunchConfig_t& __config, void* __kernel) const noexcept
  {
