...
_CCCL_GLOBAL_VARIABLE grid_level grid;
...
_CCCL_GLOBAL_VARIABLE cluster_level cluster;
...
_CCCL_GLOBAL_VARIABLE block_level block;
...
_CCCL_GLOBAL_VARIABLE thread_level thread;
