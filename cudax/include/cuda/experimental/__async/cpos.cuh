...
_CCCL_GLOBAL_CONSTANT struct set_value_t
{
  ...
  _CUDAX_HIDDEN_INLINE _CCCL_HOST_DEVICE auto operator()(_Rcvr&& __rcvr, _Ts&&... __ts) const noexcept
...
_CCCL_GLOBAL_CONSTANT struct set_error_t
{
  ...
  _CUDAX_HIDDEN_INLINE _CCCL_HOST_DEVICE auto operator()(_Rcvr&& __rcvr, _Ey&& __e) const noexcept
...
_CCCL_GLOBAL_CONSTANT struct set_stopped_t
{
  ...
  _CUDAX_HIDDEN_INLINE _CCCL_HOST_DEVICE auto
...
_CCCL_GLOBAL_CONSTANT struct connect_t
{
  ...
  _CUDAX_HIDDEN_INLINE _CCCL_HOST_DEVICE auto operator()(_Sndr&& __sndr, _Rcvr&& __rcvr) const
