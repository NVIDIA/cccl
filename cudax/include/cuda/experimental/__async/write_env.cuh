...
public:
  ...
  template <class _Sndr, class _Env>
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE constexpr auto operator()(_Sndr, _Env) const //
    -> __sndr_t<_Sndr, _Env>;
};
...
template <class _Sndr, class _Env>
_CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE constexpr auto write_env_t::operator()(_Sndr __sndr, _Env __env) const //
