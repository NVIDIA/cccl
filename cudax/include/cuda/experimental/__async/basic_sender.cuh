...
struct receiver_defaults
{
  ...
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE static auto set_value(__ignore, _Rcvr& __rcvr, _Args&&... __args) noexcept
  ...
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE static auto set_error(__ignore, _Rcvr& __rcvr, _Error&& __error) noexcept
  ...
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE static auto
  ...
  template <class _Rcvr>
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE static decltype(auto) get_env(__ignore, const _Rcvr& __rcvr) noexcept
  {
...
struct basic_receiver
{
  ...
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE void set_value(_Args&&... __args) noexcept
  {
  ...
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE decltype(auto) get_env() const noexcept
  {
...
struct __basic_opstate
{
  ...
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE void start() noexcept
  {
    __async::start(__op_);
  }
...
_CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE auto __make_opstate(_Sndr __sndr, _Rcvr __rcvr)
{
...
struct basic_sender<_Data, _Sndr>
{
  ...
  template <class _Rcvr>
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE auto connect(_Rcvr __rcvr) &&
  {
    return __make_opstate(static_cast<basic_sender&&>(*this), static_cast<_Rcvr&&>(__rcvr));
  }

  template <class _Rcvr>
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE auto connect(_Rcvr __rcvr) const&
  {
