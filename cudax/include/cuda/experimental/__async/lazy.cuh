...
struct __lazy_tupl<__mindices<>>
{
  ...
  _CUDAX_HIDDEN_INLINE _CCCL_HOST_DEVICE static auto __apply(_Fn&& __fn, _Self&&, _Us&&... __us) //
...
struct __lazy_tupl<__mindices<_Idx...>, _Ts...> : __detail::__lazy_box<_Idx, _Ts>...
{
  ...
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE __lazy_tupl() noexcept {}
  ...
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE _Ty* __get() noexcept
  {
    return reinterpret_cast<_Ty*>(this->__detail::__lazy_box<_Ny, _Ty>::__data_);
  }

  template <size_t _Ny, class... _Us>
  _CCCL_HOST_DEVICE _CUDAX_HIDDEN_INLINE __at<_Ny>& __emplace(_Us&&... __us) //
