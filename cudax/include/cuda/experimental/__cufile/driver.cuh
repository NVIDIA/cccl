...
{
  cufile_driver_t() noexcept = default;

public:
  [[nodiscard]] static cufile_driver_t __make_instance() noexcept
  {
  ...
  template <class _Attr>
  [[nodiscard]] typename _Attr::type attribute([[maybe_unused]] const _Attr& __attr) const
  {
  ...
  //! @throws cuda_error if a CUDA driver error occurs.
  template <class _Attr>
  [[nodiscard]] cufile_driver_attribute_range<_Attr> attribute_range([[maybe_unused]] const _Attr& __attr) const
  {
    static_assert(_Attr::__has_queryable_range, "Attribute does not have a queryable range");
  ...
  template <class _Attr>
  void set_attribute([[maybe_unused]] const _Attr& __attr, typename _Attr::type __value)
  {
...
inline cufile_driver_t cufile_driver = cufile_driver_t::__make_instance();
