...
#ifndef _CUDA_EXPERIMENTAL_COOP___ALGORITHM_INVOKE_ONE_CUH
#define _CUDA_EXPERIMENTAL_COOP___ALGORITHM_INVOKE_ONE_CUH
...
{
  if (::cuda::experimental::coop::__elect_one(__group))
  {
...
#endif // _CUDA_EXPERIMENTAL_COOP___ALGORITHM_INVOKE_ONE_CUH
