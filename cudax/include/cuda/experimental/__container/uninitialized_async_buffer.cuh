...
private:
  ...
  cccl_device_transform(::cuda::stream_ref, uninitialized_async_buffer& __self) noexcept
  ...
  template <class _Tp2 = _Tp>
  [[nodiscard]] _CCCL_HIDE_FROM_ABI friend auto
  cccl_device_transform(::cuda::stream_ref, const uninitialized_async_buffer& __self) noexcept
