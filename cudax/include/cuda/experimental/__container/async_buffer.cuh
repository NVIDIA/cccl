...
{
  async_buffer<_Tp, _FirstProperty, _RestProperties...> __res{
...
{
  auto __res = async_buffer<_Tp, _FirstProperty, _RestProperties...>{
    __stream, ::cuda::std::forward<_Resource>(__mr), __size, no_init};
...
{
  return async_buffer<_Tp, _FirstProperty, _RestProperties...>{
...
async_buffer<_Tp, _FirstProperty, _RestProperties...>
make_async_buffer(stream_ref __stream, _Resource&& __mr, _Iter __first, _Iter __last, const _Env& __env = {})
{
  return async_buffer<_Tp, _FirstProperty, _RestProperties...>{
