...
public:
  ...
  //! @brief Returns the \c async_resource_ref used to allocate the buffer
  ...
  _CCCL_NODISCARD _CCCL_HOST_DEVICE constexpr ::cuda::stream_ref get_stream() const noexcept
  {
    return __stream_;
  }
  ...
  _CCCL_HOST_DEVICE constexpr void swap(uninitialized_async_buffer& __other) noexcept
  {
