                            ...
                            _LayoutPolicy>
{
  ...
  [[nodiscard]] _CCCL_API value_type __access_single_element(reference __ref) const
  {
    value_type __value;
    ::cuda::__driver::__memcpyAsync(&__value, &__ref, sizeof(value_type), ::cudaStream_t{nullptr});
    return __value;
  }
...
public:
  ...
  _CCCL_HIDE_FROM_ABI device_mdarray(device_mdarray&&) noexcept = default;
