...
#ifndef __CUDAX__CONTAINERS_ASYNC_async_vector
#define __CUDAX__CONTAINERS_ASYNC_async_vector
...
//! @brief determines the cudaMemcpyKind needed to transfer memory pointed to by an iterator to a cudax::async_vector
...
//! .. warning::
//!
//!    ``async_vector`` stores a reference to the provided memory :ref:`memory resource
//!    <libcudacxx-extended-api-memory-resources-resource>`. It is the user's responsibility to ensure the lifetime of
//!    the resource exceeds the lifetime of the async_vector.
//!
//! @endrst
...
private:
  ...
  //! @brief Helper to check whether a async_vector matches but is not the same type
  ...
  {
    return const_cast<__resource_t&>(__buf_.get_resource());
  }
  ...
  _CCCL_HIDE_FROM_ABI static void __value_initialize_n(pointer __first, size_type __count)
  {
    _CCCL_IF_CONSTEXPR (__is_host_only)
    {
  ...
  //! @param __first Pointer to the first element to be initialized.
  //! @param __count The number of elements to be initialized.
  _CCCL_HIDE_FROM_ABI static void __fill_n(pointer __first, size_type __count, const _Tp& __value)
  {
    _CCCL_IF_CONSTEXPR (__is_host_only)
    {
  ...
  _CCCL_HIDE_FROM_ABI static pointer __remove_value(pointer __first, pointer __last, const _Tp& __value)
  {
    _CCCL_IF_CONSTEXPR (__is_host_only)
    {
  ...
  _CCCL_HIDE_FROM_ABI static pointer __remove_pred(pointer __first, pointer __last, _Predicate __pred)
  {
    _CCCL_IF_CONSTEXPR (__is_host_only)
    {
  ...
  _CCCL_HIDE_FROM_ABI static bool
  __equality(const_pointer __first1, const_pointer __last1, const_pointer __first2, const_pointer __last2)
  {
    _CCCL_IF_CONSTEXPR (__is_host_only)
    {
...
public:
  ...
  _CCCL_HIDE_FROM_ABI async_vector(const async_vector& __other)
      : __buf_(__other.get_resource(), __other.get_stream(), __other.__size_)
  ...
  _CCCL_HIDE_FROM_ABI async_vector& operator=(const async_vector& __other)
  {
    ...
    {
      __buffer_t __new_buf{__other.get_resource(), __other.get_stream(), __count};
  ...
  //! @endrst
  _CCCL_NODISCARD _CCCL_HIDE_FROM_ABI const __resource_t& get_resource() const noexcept
  {
  ...
  {
    return async_vector::__equality(
      __lhs.__unwrapped_begin(), __lhs.__unwrapped_end(), __rhs.__unwrapped_begin(), __rhs.__unwrapped_end());
  }
...
#endif //__CUDAX__CONTAINERS_ASYNC_async_vector
