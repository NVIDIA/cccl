...
{
[[nodiscard]] inline __shared_library& __nccl_lib()
{
...
{
  if constexpr (__abi_compatible<_R1, _R2>() && (sizeof...(_Args1) == sizeof...(_Args2)))
  {
    return (__abi_compatible<_Args1, _Args2>() && ...);
  }
  return false;
}
...
[[nodiscard]] _CCCL_HOST_API constexpr bool __abi_compatible() noexcept
{
  ...
  else if constexpr (::cuda::std::is_function_v<_RawTp> && ::cuda::std::is_function_v<_RawUp>)
  {
    ...
    return __abi_compatible_func(::cuda::std::decay_t<_RawTp>{}, ::cuda::std::decay_t<_RawUp>{});
  }
  else if constexpr (::cuda::std::is_enum_v<_RawTp> || ::cuda::std::is_enum_v<_RawUp>)
  {
    ...
    {
      return __abi_compatible<::cuda::std::underlying_type_t<_RawTp>, ::cuda::std::underlying_type_t<_RawUp>>();
    }
    else if constexpr (::cuda::std::is_enum_v<_RawTp>)
    {
      return __abi_compatible<::cuda::std::underlying_type_t<_RawTp>, _RawUp>();
    }
    else
    {
      return __abi_compatible<_RawTp, ::cuda::std::underlying_type_t<_RawUp>>();
    }
  }
  else if constexpr (::cuda::std::is_pointer_v<_RawTp> && ::cuda::std::is_pointer_v<_RawUp>)
  {
    ...
    return __abi_compatible<::cuda::std::remove_pointer_t<_RawTp>, ::cuda::std::remove_pointer_t<_RawUp>>();
  }
  else
  {
    return false;
...
_CCCL_CONCEPT __has_nccl_type_of = _CCCL_REQUIRES_EXPR((_Tp), )(
  (__nccl_type_of_v<_Tp>), //
  _Same_as(__ncclDataType_t) __nccl_type_of_v<_Tp>);
...
[[nodiscard]] _CCCL_HOST_API inline ::cuda::std::size_t __size_of(__ncclDataType_t __datatype)
{
  switch (__datatype)
  {
    ...
    case __ncclFloat16:
      ...
      _CCCL_THROW(::std::runtime_error, "Unsupported NCCL datatype: __ncclFloat16");
#endif // _CCCL_HAS_NVFP16()
    case __ncclFloat32:
      return sizeof(float);
    case __ncclFloat64:
    ...
    case __ncclBfloat16:
      ...
      _CCCL_THROW(::std::runtime_error, "Unsupported NCCL datatype: __ncclBfloat16");
#endif // _CCCL_HAS_NVBF16()
    case __ncclFloat8e4m3:
#if _CCCL_HAS_NVFP8()
      return sizeof(::__nv_fp8_e4m3);
#else // ^^^ _CCCL_HAS_NVFP8() ^^^ / vvv !_CCCL_HAS_NVFP8() vvv
      _CCCL_THROW(::std::runtime_error, "Unsupported NCCL datatype: __ncclFloat8e4m3");
#endif // _CCCL_HAS_NVFP8()
    case __ncclFloat8e5m2:
#if _CCCL_HAS_NVFP8()
      return sizeof(::__nv_fp8_e5m2);
#else // ^^^ _CCCL_HAS_NVFP8() ^^^ / vvv !_CCCL_HAS_NVFP8() vvv
      _CCCL_THROW(::std::runtime_error, "Unsupported NCCL datatype: __ncclFloat8e5m2");
#endif // _CCCL_HAS_NVFP8()
    case __ncclNumTypes:
      _CCCL_THROW(::std::runtime_error, "Unhandled NCCL datatype: __ncclNumTypes");
  }

  _CCCL_THROW(::std::runtime_error, "Unhandled NCCL datatype value");
}
...
template <class _Op>
inline constexpr __ncclRedOp_t __nccl_redop_of_v = ::cuda::experimental::__nccl::__nccl_redop_of<_Op>();

template <class _Op>
_CCCL_CONCEPT __has_nccl_redop = _CCCL_REQUIRES_EXPR((_Op), )(
  (__nccl_redop_of_v<_Op>), //
  _Same_as(__ncclRedOp_t) __nccl_redop_of_v<_Op>);

template <class _InputTp, class _OutputTp, class _Op>
_CCCL_CONCEPT __can_specialize_nccl_call = _CCCL_REQUIRES_EXPR((_InputTp, _OutputTp, _Op), )(
  requires(::cuda::std::same_as<::cuda::std::remove_cv_t<_InputTp>, ::cuda::std::remove_cv_t<_OutputTp>>),
  requires(__has_nccl_type_of<_InputTp>),
  requires(__has_nccl_redop<_Op>));
...
[[nodiscard]] _CCCL_HOST_API inline int __ncclCommCount(__ncclComm_t __comm)
{
  ...
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclCommCount");
  }
  return __count;
}
...
[[nodiscard]] _CCCL_HOST_API inline int __ncclCommUserRank(__ncclComm_t __comm)
{
  ...
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclCommUserRank");
  }
  return __rank;
}

[[nodiscard]] _CCCL_HOST_API inline __ncclResult_t __ncclCommGetAsyncError(__ncclComm_t __comm)
{
  static auto* const __fn =
    _CCCL_LOAD_NCCL_SYMBOL(ncclCommGetAsyncError, __ncclResult_t (*)(__ncclComm_t, __ncclResult_t*));

  __ncclResult_t __async_error{};

  if (const auto __ret = __fn(__comm, &__async_error); __ret != __ncclSuccess)
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclCommGetAsyncError");
  }
  return __async_error;
}

_CCCL_HOST_API inline void __ncclCommAbort(__ncclComm_t __comm)
{
  static auto* const __fn = _CCCL_LOAD_NCCL_SYMBOL(ncclCommAbort, __ncclResult_t (*)(__ncclComm_t));

  if (const auto __ret = __fn(__comm); __ret != __ncclSuccess)
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclCommAbort");
  }
}
...
[[nodiscard]] _CCCL_HOST_API inline ::cuda::device_ref __ncclCommCuDevice(__ncclComm_t __comm)
{
  ...
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclCommCuDevice");
  }
...
[[nodiscard]] _CCCL_HOST_API inline const char* __ncclGetLastError(__ncclComm_t __comm)
{
...
[[nodiscard]] _CCCL_HOST_API inline const char* __ncclGetErrorString(__ncclResult_t __result)
{
...
_CCCL_HOST_API inline void __ncclGroupStart()
{
  ...
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclGroupStart");
  }
}
...
_CCCL_HOST_API inline void __ncclGroupEnd()
{
  ...
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclGroupEnd");
  }
}

class __auto_nccl_group
{
public:
  _CCCL_HOST_API __auto_nccl_group()
  {
    ::cuda::experimental::__nccl::__ncclGroupStart();
  }

  __auto_nccl_group(const __auto_nccl_group&) = delete;
  void operator=(const __auto_nccl_group&)    = delete;
  __auto_nccl_group(__auto_nccl_group&&)      = delete;
  void operator=(__auto_nccl_group&&)         = delete;

  _CCCL_HOST_API ~__auto_nccl_group() noexcept(false)
  {
  ...
  ::cuda::stream_ref __stream)
{
  ...
  if (const auto __ret = __fn(__sendbuff, __recvbuff, __count, __datatype, __op, __comm, __stream.get());
      __ret != __ncclSuccess && __ret != __ncclInProgress)
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclAllReduce");
  }
}
  ...
  ::cuda::stream_ref __stream)
{
  ...
  if (const auto __ret = __fn(__sendbuff, __recvbuff, __sendcount, __datatype, __comm, __stream.get());
      __ret != __ncclSuccess && __ret != __ncclInProgress)
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclAllGather");
  }
}
  ...
  ::cuda::stream_ref __stream)
{
  ...
  if (const auto __ret = __fn(__sendbuff, __recvbuff, __count, __datatype, __root, __comm, __stream.get());
      __ret != __ncclSuccess && __ret != __ncclInProgress)
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclBroadcast");
  }
}
  ...
  ::cuda::stream_ref __stream)
{
  ...
  if (const auto __ret = __fn(__sendbuff, __recvbuff, __sendcount, __datatype, __root, __comm, __stream.get());
      __ret != __ncclSuccess && __ret != __ncclInProgress)
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclGather");
  }
}
  ...
  ::cuda::stream_ref __stream)
{
  ...
  if (const auto __ret = __fn(__sendbuff, __recvbuff, __count, __datatype, __comm, __stream.get());
      __ret != __ncclSuccess && __ret != __ncclInProgress)
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclAlltoAll");
  }
}
  ...
  ::cuda::stream_ref __stream)
{
  ...
  if (const auto __ret = __fn(__sendbuff, __count, __datatype, __peer, __comm, __stream.get());
      __ret != __ncclSuccess && __ret != __ncclInProgress)
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclSend");
  }
}
  ...
  ::cuda::stream_ref __stream)
{
  ...
  if (const auto __ret = __fn(__recvbuff, __count, __datatype, __peer, __comm, __stream.get());
      __ret != __ncclSuccess && __ret != __ncclInProgress)
  {
    _CCCL_THROW(::std::runtime_error, "Error in ncclRecv");
  }
}
  ...
  ::cuda::stream_ref __stream)
{
  ...
  // or some of them do.
  const auto _      = __auto_nccl_group{};
  ...
  ::cuda::stream_ref __stream)
{
  ...
  for (int __peer = 0; __peer < __size; ++__peer)
  {
    ...
    if (__peer == __rank)
    {
      ...
      {
        _CCCL_THROW(::std::runtime_error, "Mismatched self-copy count in ncclAlltoAllv");
      }
