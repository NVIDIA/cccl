...
_CCCL_NODISCARD _CUDAX_HOST_API inline constexpr size_t __buffer_align(size_t __align)
{
...
template <class _Tp>
_CCCL_NODISCARD _CUDAX_HOST_API inline constexpr bool __is_small(size_t __size, size_t __align) noexcept
{
...
_CCCL_NODISCARD _CUDAX_TRIVIAL_HOST_API bool __ptr_eq(_Tp* __lhs, _Up* __rhs) noexcept
{
  return static_cast<_Vp>(__lhs) == static_cast<_Vp>(__rhs);
}

_CCCL_NODISCARD _CUDAX_TRIVIAL_HOST_API constexpr bool __ptr_eq(detail::__ignore, detail::__ignore) noexcept
{
  return false;
}
