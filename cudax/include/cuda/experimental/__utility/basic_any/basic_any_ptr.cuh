...
struct _CCCL_TYPE_VISIBILITY_DEFAULT basic_any<_Interface*>
{
  ...
  _CUDAX_HOST_API auto operator=(basic_any const& __other) noexcept -> basic_any&
  {
    __convert_from(__other);
    return *this;
  }
  ...
  _CCCL_REQUIRES((!_CUDA_VSTD::same_as<_OtherInterface, _Interface>)
                   _CCCL_AND __any_convertible_to<basic_any<_OtherInterface*>, basic_any<_Interface*>>)
  _CUDAX_HOST_API auto operator=(basic_any<_OtherInterface*> const& __other) noexcept -> basic_any&
  {
    __convert_from(__other);
    return *this;
  }
  ...
  _CCCL_TEMPLATE(class _OtherInterface)
  _CCCL_REQUIRES(__any_convertible_to<basic_any<_OtherInterface>&, basic_any<_Interface&>>)
  _CUDAX_HOST_API auto operator=(basic_any<_OtherInterface>* __other) noexcept -> basic_any&
  {
    __convert_from(__other);
    return *this;
  }
  ...
  operator!=(basic_any const& __lhs, basic_any const& __rhs) noexcept -> bool
  {
    return !(__lhs == __rhs);
  }
