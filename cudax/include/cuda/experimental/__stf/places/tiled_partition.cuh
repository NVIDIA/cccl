...
public:
    ...
    tiled_mdspan_shape(const mdspan_shape_t& s, size_t part_id, size_t nparts)
            : part_id(part_id), nparts(nparts), original_shape(s) {}
...
public:
    ...
    static const tiled_mdspan_shape<tile_size, mdspan_shape_t> apply(
            const mdspan_shape_t& in, pos4 place_position, dim4 grid_dims) {
        // TODO assert 1D !
