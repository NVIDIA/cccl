...
struct current_place_desc
{
  ...
  current_place_desc(pos4 place_position, dim4 grid_dims)
      : place_position(mv(place_position))
      , grid_dims(mv(grid_dims))
  {}
...
public:
  ...
  __device__ void
  mark_access(pos4 data_coords, const shape_t& data_shape, partitioner_t /* anonymous */, int value = 1) const
  {
