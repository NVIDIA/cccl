...
public:
     ...
     */
    cached_block_allocator(block_allocator_untyped root_allocator_) : root_allocator(mv(root_allocator_)) {}
     ...
     */
    ::std::string to_string() const override { return "cached_block_allocator"; }
