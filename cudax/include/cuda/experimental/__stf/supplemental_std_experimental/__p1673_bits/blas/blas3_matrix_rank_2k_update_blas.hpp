...
void __symmetric_matrix_rank_2k_update_impl(__nvhpc_exec<__blas_exec_space>&& /* __exec */
        ,
        _ElementType_C __alpha, _ElementType_C __beta,
    ...
    __bl::__blas_syr2k<_ElementType_C>::__syr2k(&__uplo, &__trans, __A.extent(0), __A.extent(1), __alpha,
            __A.data_handle(), __ex::linalg::__get_leading_dim(__A), __B.data_handle(),
            __ex::linalg::__get_leading_dim(__B), __beta, __C.data_handle(), __ex::linalg::__get_leading_dim(__C));
}
