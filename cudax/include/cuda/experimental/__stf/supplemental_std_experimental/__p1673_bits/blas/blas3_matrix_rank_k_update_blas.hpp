...
template <class _Scalar, class _ElementType_A, class _SizeType_A, ::std::size_t _numRows_A, ::std::size_t _numCols_A,
        class _Layout_A, class _Accessor_A, class _ElementType_C, class _SizeType_C, ::std::size_t _numRows_C,
        ::std::size_t _numCols_C, class _Layout_C, class _Accessor_C>
void __symmetric_matrix_rank_k_update_impl(__nvhpc_exec<__blas_exec_space>&& /* __exec */
        ,
        _Scalar __alpha, _Scalar __beta,
    ...
    __bl::__blas_syrk<_ElementType_C>::__syrk(&__uplo, &__trans, __A.extent(0), __A.extent(1), __alpha,
            __A.data_handle(), __ex::linalg::__get_leading_dim(__A), __beta, __C.data_handle(),
