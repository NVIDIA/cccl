...
void __triangular_matrix_matrix_solve_impl(__nvhpc_exec<__blas_exec_space>&& /* __exec */
        ,
    ...
    __bl::__blas_trsm<_ElementType_B>::__trsm(&__side, &__uplo, &__trans, &__diag,
            __ex::linalg::__get_row_count(__B, __is_transposed), __ex::linalg::__get_col_count(__B, __is_transposed),
            __alpha, __A.data_handle(), __ex::linalg::__get_leading_dim(__A), __B.data_handle(),
