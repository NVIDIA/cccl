...
extern "C" void
saxpy_(const int* __n, const float* __a, const float* __x, const int* __inc_x, float* __y, const int* __inc_y);

extern "C" void
daxpy_(const int* __n, const double* __a, const double* __x, const int* __inc_x, double* __y, const int* __inc_y);

extern "C" void
caxpy_(const int* __n, const void* __a, const void* __x, const int* __inc_x, void* __y, const int* __inc_y);

extern "C" void
zaxpy_(const int* __n, const void* __a, const void* __x, const int* __inc_x, void* __y, const int* __inc_y);
...
extern "C" std::complex<float>
cdotu_(const int* __n, const void* __x, const int* __inc_x, const void* __y, const int* __inc_y);

extern "C" std::complex<double>
zdotu_(const int* __n, const void* __x, const int* __inc_x, const void* __y, const int* __inc_y);

extern "C" std::complex<float>
cdotc_(const int* __n, const void* __x, const int* __inc_x, const void* __y, const int* __inc_y);

extern "C" std::complex<double>
zdotc_(const int* __n, const void* __x, const int* __inc_x, const void* __y, const int* __inc_y);
#else
extern "C" void
cdotu_(void* __result, const int* __n, const void* __x, const int* __inc_x, const void* __y, const int* __inc_y);

extern "C" void
zdotu_(void* __result, const int* __n, const void* __x, const int* __inc_x, const void* __y, const int* __inc_y);

extern "C" void
cdotc_(void* __result, const int* __n, const void* __x, const int* __inc_x, const void* __y, const int* __inc_y);

extern "C" void
zdotc_(void* __result, const int* __n, const void* __x, const int* __inc_x, const void* __y, const int* __inc_y);
#endif
...
extern "C" void dgemm_(
  const char __trans_A[],
  const char __trans_B[],
  const int* __m,
  const int* __n,
  const int* __k,
  const double* __alpha,
...
{
  static void __copy(const int __n, const std::complex<float>* __X, int __inc_x, std::complex<float>* __y, int __inc_y)
  {
...
{
  static void __copy(const int __n, const std::complex<double>* __X, int __inc_x, std::complex<double>* __y, int __inc_y)
  {
...
struct __blas_axpy<std::complex<float>>
{
  static void __axpy(
    const int __n,
    const std::complex<float> __A,
    const std::complex<float>* __X,
    int __inc_x,
    std::complex<float>* __y,
    int __inc_y)
  {
...
struct __blas_axpy<std::complex<double>>
{
  static void __axpy(
    const int __n,
    const std::complex<double> __A,
    const std::complex<double>* __X,
    int __inc_x,
    std::complex<double>* __y,
    int __inc_y)
  {
...
struct __blas_dot_impl<std::complex<float>>
{
  ...
  __dot(int __n, const std::complex<float>* __X, int __inc_x, const std::complex<float>* __y, int __inc_y)
  {
#if defined(__powerpc__) || defined(__powerpc64__)
...
struct __blas_dot_impl<std::complex<double>>
{
  ...
  __dot(const int __n, const std::complex<double>* __X, int __inc_x, const std::complex<double>* __y, int __inc_y)
  {
#if defined(__powerpc__) || defined(__powerpc64__)
...
{
  static std::complex<float>
  __dotc(int __n, const std::complex<float>* __X, int __inc_x, const std::complex<float>* __y, int __inc_y)
  {
#if defined(__powerpc__) || defined(__powerpc64__)
...
{
  static std::complex<double>
  __dotc(const int __n, const std::complex<double>* __X, int __inc_x, const std::complex<double>* __y, int __inc_y)
  {
#if defined(__powerpc__) || defined(__powerpc64__)
...
{
  static void __scal(int __n, float __A, float* __X, int __inc_x)
  {
    sscal_(&__n, &__A, __X, &__inc_x);
  }
};
...
{
  static void __scal(int __n, double __A, double* __X, int __inc_x)
  {
    dscal_(&__n, &__A, __X, &__inc_x);
  }
};
...
{
  static float __nrm2(int __n, const float* __X, int __inc_x)
  {
    return snrm2_(&__n, __X, &__inc_x);
  }
};
...
{
  static double __nrm2(int __n, const double* __X, int __inc_x)
  {
    return dnrm2_(&__n, __X, &__inc_x);
  }
};
...
{
  static float __nrm2(int __n, const std::complex<float>* __X, int __inc_x)
  {
    return scnrm2_(&__n, __X, &__inc_x);
  }
};
...
{
  static double __nrm2(int __n, const std::complex<double>* __X, int __inc_x)
  {
    return dznrm2_(&__n, __X, &__inc_x);
  }
};
...
struct __blas_gemv<std::complex<float>>
{
  static void __gemv(
    ...
    const int __m,
    const int __n,
    const std::complex<float> __alpha,
    const std::complex<float>* __A,
    const int __lda,
    const std::complex<float>* __X,
    const int __inc_x,
    const std::complex<float> __beta,
    std::complex<float>* __y,
    const int __inc_y)
  {
...
struct __blas_gemv<std::complex<double>>
{
  static void __gemv(
    ...
    const int __m,
    const int __n,
    const std::complex<double> __alpha,
    const std::complex<double>* __A,
    const int __lda,
    const std::complex<double>* __X,
    const int __inc_x,
    const std::complex<double> __beta,
    std::complex<double>* __y,
    const int __inc_y)
  {
...
struct __blas_gemm<std::complex<double>>
{
  static void __gemm(
    ...
    const std::complex<double>* __A,
    const int __lda,
    const std::complex<double>* __B,
    const int __ldb,
    const std::complex<double> BETA,
    std::complex<double>* __C,
    const int __ldc)
  {
...
struct __blas_gemm<std::complex<float>>
{
  static void __gemm(
    ...
    const std::complex<float>* __A,
    const int __lda,
    const std::complex<float>* __B,
    const int __ldb,
    const std::complex<float> BETA,
    std::complex<float>* __C,
    const int __ldc)
  {
...
struct __blas_conj<std::complex<_Scalar>>
{
  ...
  static void __conj(const int __n, std::complex<_Scalar> const* __in, std::complex<_Scalar>* __out, const int __inc = 1)
  {
    _Scalar const alpha{-1};
...
{
  static void
  __copy(const char __trans, const int __m, const int __n, const _Scalar* __X, int __ldx, _Scalar* __y, int __ldy)
  {
    switch (__trans)
    {
      case 'N':
...
{
  static void __axpy(char __trans, int __m, int __n, _Scalar __A, const _Scalar* __X, int __ldx, _Scalar* __y, int __ldy)
  {
    switch (__trans)
    {
      case 'N':
