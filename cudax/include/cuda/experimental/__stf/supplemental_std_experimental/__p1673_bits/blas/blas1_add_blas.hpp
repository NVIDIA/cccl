                ...
                __ex::mdspan<_ElementType_z, __ex::extents<_SizeType_z, _ext_z...>, _Layout_z, _Accessor_z> __z)
{
  ...
  if (__is_use_1d_api)
  {
    ...
    __bl::__blas_axpy<_ElementType_z>::__axpy(
      __len, __beta, (__conj_y ? std::get<1>(__work_y).data_handle() : __y.data_handle()), 1, __z.data_handle(), 1);
  }
  else
  {
    __bl::__blas_axpy_2d<_ElementType_z>::__axpy(
      __op_y,
      ...
      __z.data_handle(),
      __ex::linalg::__get_leading_dim(__z));
  }
}
