...
#ifndef INCLUDE_EXPERIMENTAL___P1673_BITS_BLAS_BLAS3_MATRIX_PRODUCT_BLAS_HPP_
#define INCLUDE_EXPERIMENTAL___P1673_BITS_BLAS_BLAS3_MATRIX_PRODUCT_BLAS_HPP_
...
template <class _ElementType_A, class _SizeType_A, ::std::size_t _numRows_A, ::std::size_t _numCols_A, class _Layout_A,
        class _Accessor_A, class _ElementType_B, class _SizeType_B, ::std::size_t _numRows_B, ::std::size_t _numCols_B,
        class _Layout_B, class _Accessor_B, class _ElementType_C, class _SizeType_C, ::std::size_t _numRows_C,
        ::std::size_t _numCols_C, class _Layout_C, class _Accessor_C>
void __matrix_product_impl(__nvhpc_exec<__blas_exec_space>&& /* __exec */
        ,
    ...
    __STDBLAS_BACKEND_MESSAGE(matrix_product, BLAS);
#endif
    ...
    __bl::__blas_gemm<_ElementType_C>::__gemm(&__op_A, &__op_B, __ex::linalg::__get_row_count(__C, __is_transposed),
            __ex::linalg::__get_col_count(__C, __is_transposed), __ex::linalg::__get_row_count(__B, __is_transposed),
            __alpha, __A.data_handle(), __ex::linalg::__get_leading_dim<__A_t>(__A), __B.data_handle(),
