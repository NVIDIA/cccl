  ...
  bool __is_transposed)
{
  ...
  using __C_t =
    typename __ex::mdspan<_ElementType_C, __ex::extents<_SizeType_C, _numRows_C, _numCols_C>, _Layout_C, _Accessor_C>;

  __bl::__blas_gemm<_ElementType_C>::__gemm(
    &__op_A,
    &__op_B,
    __ex::linalg::__get_row_count(__C, __is_transposed),
    __ex::linalg::__get_col_count(__C, __is_transposed),
    __ex::linalg::__get_row_count(__B, __is_transposed),
    __alpha,
    __A.data_handle(),
    __ex::linalg::__get_leading_dim<__A_t>(__A),
    __B.data_handle(),
    __ex::linalg::__get_leading_dim<__B_t>(__B),
    __beta,
    __C.data_handle(),
