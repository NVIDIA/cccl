...
template <class _ElementType_A, class _SizeType_A, ::std::size_t _numRows_A, ::std::size_t _numCols_A, class _Layout_A,
        class _Accessor_A, class _ElementType_b, class _SizeType_b, ::std::size_t _ext_b, class _Layout_b,
        class _Accessor_b>
void __triangular_matrix_vector_solve_impl(__nvhpc_exec<__blas_exec_space>&& /* __exec */
        ,
        __ex::mdspan<_ElementType_A, __ex::extents<_SizeType_A, _numRows_A, _numCols_A>, _Layout_A, _Accessor_A> __A,
        char __op_A, char __uplo, char __diag,
