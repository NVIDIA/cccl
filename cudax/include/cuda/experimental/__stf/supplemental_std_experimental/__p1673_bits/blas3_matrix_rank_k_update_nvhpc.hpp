...
template <class _exec_space, class _Scalar, class _ElementType_A, class _SizeType_A, ::std::size_t _numRows_A,
        ::std::size_t _numCols_A, class _Layout_A, class _Accessor_A, class _ElementType_C, class _SizeType_C,
        ::std::size_t _numRows_C, ::std::size_t _numCols_C, class _Layout_C, class _Accessor_C, class _Triangle>
void symmetric_matrix_rank_k_update(__nvhpc_exec<_exec_space>&& __exec, _Scalar __alpha,
    ...
    if constexpr (__types_supported && __A_supported && __C_supported) {
        ...
        __symmetric_matrix_rank_k_update_impl(std::forward<__nvhpc_exec<_exec_space>>(__exec),
                _ElementType_C { __alpha * __my_alpha * __my_alpha }, _ElementType_C { __extract_scaling_factor(__C) },
                (__conj_A ? std::get<1>(__work_A) : __A), __C, __op_A, __ex::linalg::__get_fill_mode(__C, __t));
    } else {
...
template <class _exec_space, class _ElementType_A, class _SizeType_A, ::std::size_t _numRows_A,
        ::std::size_t _numCols_A, class _Layout_A, class _Accessor_A, class _ElementType_C, class _SizeType_C,
        ::std::size_t _numRows_C, ::std::size_t _numCols_C, class _Layout_C, class _Accessor_C, class _Triangle>
void symmetric_matrix_rank_k_update(__nvhpc_exec<_exec_space>&& __exec,
        __ex::mdspan<_ElementType_A, __ex::extents<_SizeType_A, _numRows_A, _numCols_A>, _Layout_A, _Accessor_A> __A,
        __ex::mdspan<_ElementType_C, __ex::extents<_SizeType_C, _numRows_C, _numCols_C>, _Layout_C, _Accessor_C> __C,
        _Triangle __t) {
