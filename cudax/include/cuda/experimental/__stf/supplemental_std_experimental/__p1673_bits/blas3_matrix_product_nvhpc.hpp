...
void __matrix_product_nvhpc(__nvhpc_exec<_exec_space>&& __exec,
    ...
    {
        __matrix_product_impl(std::forward<__nvhpc_exec<_exec_space>>(__exec), (__conj_B ? std::get<1>(__work_B) : __B),
                __op_B, (__conj_A ? std::get<1>(__work_A) : __A), __op_A, __C, __alpha, __beta,
                __is_operate_on_transposed);
    } else  // C is in column-major layout, compute C = A * B
    {
        __matrix_product_impl(std::forward<__nvhpc_exec<_exec_space>>(__exec), (__conj_A ? std::get<1>(__work_A) : __A),
                __op_A, (__conj_B ? std::get<1>(__work_B) : __B), __op_B, __C, __alpha, __beta,
                __is_operate_on_transposed);
    }
}
...
template <class _exec_space, class _ElementType_A, class _SizeType_A, ::std::size_t _numRows_A,
        ::std::size_t _numCols_A, class _Layout_A, class _Accessor_A, class _ElementType_B, class _SizeType_B,
        ::std::size_t _numRows_B, ::std::size_t _numCols_B, class _Layout_B, class _Accessor_B, class _ElementType_E,
        class _SizeType_E, ::std::size_t _numRows_E, ::std::size_t _numCols_E, class _Layout_E, class _Accessor_E,
        class _ElementType_C, class _SizeType_C, ::std::size_t _numRows_C, ::std::size_t _numCols_C, class _Layout_C,
        class _Accessor_C>
void matrix_product(__nvhpc_exec<_exec_space>&& __exec,
        __ex::mdspan<_ElementType_A, __ex::extents<_SizeType_A, _numRows_A, _numCols_A>, _Layout_A, _Accessor_A> __A,
        __ex::mdspan<_ElementType_B, __ex::extents<_SizeType_B, _numRows_B, _numCols_B>, _Layout_B, _Accessor_B> __B,
    ...
    constexpr bool __types_supported =
            (__stdblas_data_type<_ElementType_E> == __stdblas_data_type<_ElementType_C> &&
                    __gemm_data_types_supported<__base_exec>(__stdblas_data_type<_ElementType_A>,
...
void matrix_product(__nvhpc_exec<_exec_space>&& __exec,
    ...
    constexpr bool __types_supported = __gemm_data_types_supported<__base_exec>(__stdblas_data_type<_ElementType_A>,
            __stdblas_data_type<_ElementType_B>, __stdblas_output_data_type<_ElementType_C>);
    constexpr bool __A_supported = __input_supported<_Layout_A, _Accessor_A>();
    constexpr bool __B_supported = __input_supported<_Layout_B, _Accessor_B>();
    constexpr bool __C_supported = __output_supported<_Layout_C, _Accessor_C>();
