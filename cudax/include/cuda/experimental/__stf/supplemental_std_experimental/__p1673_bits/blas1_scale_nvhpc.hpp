...
template <class _exec_space, class _Scalar, class _ElementType, class _SizeType, ::std::size_t... _ext, class _Layout,
        class _Accessor>
void scale(__nvhpc_exec<_exec_space>&& __exec, const _Scalar __alpha,
