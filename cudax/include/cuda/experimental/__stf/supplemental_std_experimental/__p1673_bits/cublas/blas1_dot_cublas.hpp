...
auto __dot_impl(__nvhpc_exec<__cublas_exec_space<__nvhpc_sync>>&& /* __exec */
    ...
    __cb::__check_cublas_status(__cb::__cublas_dot(__cb::__get_cublas_handle(), __v1.extent(0), __v1.data_handle(),
                                        __v2.data_handle(), &__ret),
            "dot", "cublas_dot");
...
template <class _SyncType, class _ElementType1, class _SizeType1, ::std::size_t... _ext1, class _Layout1,
        class _Accessor1, class _ElementType2, class _SizeType2, ::std::size_t... _ext2, class _Layout2,
        class _Accessor2>
auto __dotc_impl(__nvhpc_exec<__cublas_exec_space<_SyncType>>&& /* __exec */
    ...
    //      could always convert __alpha to be consistent with _ElementType
    //      or could throw an exception if _Scalar and _ElementType don't match up
    __cb::__check_cublas_status(__cb::__cublas_dotc(__cb::__get_cublas_handle(), __v1.extent(0), __v1.data_handle(),
                                        __v2.data_handle(), &__ret),
            "dotc", "cublas_dotc");
