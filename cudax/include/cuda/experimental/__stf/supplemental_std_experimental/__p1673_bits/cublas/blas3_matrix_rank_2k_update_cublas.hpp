...
void __symmetric_matrix_rank_2k_update_impl(__nvhpc_exec<__cublas_exec_space<_SyncType>>&& __exec,
        ...
        char trans, char uplo) {
#ifdef STDBLAS_VERBOSE
    __STDBLAS_BACKEND_MESSAGE(matrix_rank_2k_update, cuBLAS);
#endif

    __cb::__check_cublas_status(
            __cb::__cublas_syr2k(__cb::__get_cublas_handle(), __cb::__to_cublas_fill_mode(uplo),
                    __cb::__op_to_cublas_op(trans), __A.extent(0), __A.extent(1), &__alpha, __A.data_handle(),
                    __ex::linalg::__get_leading_dim(__A), __B.data_handle(), __ex::linalg::__get_leading_dim(__B),
                    &__beta, __C.data_handle(), __ex::linalg::__get_leading_dim(__C)),
            "matrix_rank_2k_update", "cublas_syr2k");
