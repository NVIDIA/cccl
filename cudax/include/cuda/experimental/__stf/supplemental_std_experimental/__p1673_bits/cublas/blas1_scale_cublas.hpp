...
template <class _SyncType,
          ...
          class _Layout,
          class _Accessor>
void __scale_impl(__nvhpc_exec<__cublas_exec_space<_SyncType>>&& __exec,
                  ...
                  __ex::mdspan<_ElementType, __ex::extents<_SizeType, _ext...>, _Layout, _Accessor> __x)
{
  ...
  if (__x.rank() == 1 || !std::is_same_v<_Layout, __ex::layout_stride>)
  {
    ...
    __cb::__check_cublas_status(
      __cb::__cublas_scal(__cb::__get_cublas_handle(), __length, __alpha, __x.data_handle()), "scale", "cublas_scal");
  }
  else
  {
