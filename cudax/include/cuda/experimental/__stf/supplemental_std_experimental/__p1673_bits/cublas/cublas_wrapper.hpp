...
inline void
__check_cublas_status(cublasStatus_t __stat, std::string_view __function_name, std::string_view __cublas_api_name)
{
  if (__stat != CUBLAS_STATUS_SUCCESS)
  {
    throw std::system_error(
      __ex::make_error_code(__stat),
...
template <>
cublasStatus_t __cublas_copy(cublasHandle_t __handle, int __n, std::complex<float> const* __x, std::complex<float>* __y)
{
...
template <>
cublasStatus_t
__cublas_copy(cublasHandle_t __handle, int __n, std::complex<double> const* __x, std::complex<double>* __y)
{
...
cublasStatus_t
__cublas_axpy(cublasHandle_t __handle, int __n, _Scalar const* __alpha, _VectorValType const* __x, _VectorValType* __y);
...
cublasStatus_t __cublas_axpy(
  cublasHandle_t __handle,
  int __n,
  std::complex<float> const* __alpha,
  std::complex<float> const* __x,
...
cublasStatus_t __cublas_axpy(
  cublasHandle_t __handle,
  int __n,
  std::complex<double> const* __alpha,
  std::complex<double> const* __x,
  std::complex<double>* __y)
{
  return cublasZaxpy(
    __handle, __n, (cuDoubleComplex const*) __alpha, (cuDoubleComplex const*) __x, 1, (cuDoubleComplex*) __y, 1);
}
...
template <class _Scalar, class _VectorValType>
cublasStatus_t
__cublas_dot(cublasHandle_t __handle, int __n, _VectorValType const* __x, _VectorValType const* __y, _Scalar* __result);
...
cublasStatus_t __cublas_dot(
  ...
  int __n,
  std::complex<float> const* __x,
  std::complex<float> const* __y,
  std::complex<float>* __result)
{
...
cublasStatus_t __cublas_dot(
  ...
  int __n,
  std::complex<double> const* __x,
  std::complex<double> const* __y,
  std::complex<double>* __result)
{
  return cublasZdotu(__handle, __n, (cuDoubleComplex*) __x, 1, (cuDoubleComplex*) __y, 1, (cuDoubleComplex*) __result);
}
...
cublasStatus_t __cublas_dotc(
  ...
  std::complex<double>* __result)
{
  return cublasZdotc(__handle, __n, (cuDoubleComplex*) __x, 1, (cuDoubleComplex*) __y, 1, (cuDoubleComplex*) __result);
}
...
template <>
cublasStatus_t __cublas_scal(cublasHandle_t __handle, int __n, std::complex<float> __alpha, std::complex<float>* __data)
{
...
template <>
cublasStatus_t
__cublas_scal(cublasHandle_t __handle, int __n, std::complex<double> __alpha, std::complex<double>* __data)
{
...
template <>
cublasStatus_t
__cublas_conj(cublasHandle_t __handle, int __n, std::complex<float> const* __in, std::complex<float>* __out)
{
...
template <>
cublasStatus_t
__cublas_conj(cublasHandle_t __handle, int __n, std::complex<double> const* __in, std::complex<double>* __out)
{
...
cublasStatus_t __cublas_gemv(
  cublasHandle_t __handle,
  cublasOperation_t __trans,
  int __m,
  int __n,
  _Scalar const* __alpha,
  _MatrixValType const* __A,
  int __lda,
  _VectorValType const* __x,
  _Scalar const* __beta,
  _VectorValType* __y);
...
cublasStatus_t __cublas_gemv(
  ...
  int __n,
  std::complex<float> const* __alpha,
  std::complex<float> const* __A,
  int __lda,
  std::complex<float> const* __x,
  std::complex<float> const* __beta,
  std::complex<float>* __y)
{
  return cublasCgemv(
    __handle,
    ...
    __m,
    __n,
    (cuComplex const*) __alpha,
    (cuComplex const*) __A,
    __lda,
    (cuComplex const*) __x,
    1,
    (cuComplex const*) __beta,
    (cuComplex*) __y,
    1);
}
...
cublasStatus_t __cublas_gemv(
  ...
  int __n,
  std::complex<double> const* __alpha,
  std::complex<double> const* __A,
  int __lda,
  std::complex<double> const* __x,
  std::complex<double> const* __beta,
  std::complex<double>* __y)
{
  return cublasZgemv(
    __handle,
    ...
    __m,
    __n,
    (cuDoubleComplex const*) __alpha,
    (cuDoubleComplex const*) __A,
    __lda,
    (cuDoubleComplex const*) __x,
    1,
    (cuDoubleComplex const*) __beta,
    (cuDoubleComplex*) __y,
    1);
}
...
cublasStatus_t __cublas_trsv(
  cublasHandle_t __handle,
  cublasFillMode_t __uplo,
  cublasOperation_t __trans,
  cublasDiagType_t __diag,
  int __n,
  _MatrixValType const* __A,
  int __lda,
  _VectorValType* __x);
...
{
  return cublasZtrsv(__handle, __uplo, __trans, __diag, __n, (cuDoubleComplex*) __A, __lda, (cuDoubleComplex*) __x, 1);
}
...
cublasStatus_t __cublas_gemm(
  cublasHandle_t __handle,
  cublasOperation_t __trans_A,
  cublasOperation_t __trans_B,
  int __m,
  int __n,
  int __k,
  _Scalar const* __alpha,
  ...
  int __ldc)
{
  return cublasGemmEx(
    ...
    (void const*) __alpha,
    (void const*) __A,
    __cuda_data_type<_A_t>,
    __lda,
    (void const*) __B,
    __cuda_data_type<_B_t>,
    __ldb,
    (void const*) __beta,
    (void*) __C,
    __cuda_data_type<_C_t>,
    __ldc,
    __cublas_compute_type<_C_t>,
    CUBLAS_GEMM_DEFAULT);
}
...
cublasStatus_t __cublas_gemm(
  ...
  int __ldc)
{
  return cublasSgemm(__handle, __trans_A, __trans_B, __m, __n, __k, __alpha, __A, __lda, __B, __ldb, __beta, __C, __ldc);
}
...
cublasStatus_t __cublas_gemm(
  ...
  int __ldc)
{
  return cublasDgemm(__handle, __trans_A, __trans_B, __m, __n, __k, __alpha, __A, __lda, __B, __ldb, __beta, __C, __ldc);
}
...
cublasStatus_t __cublas_trsm(
  cublasHandle_t __handle,
  cublasSideMode_t __side,
  cublasFillMode_t __uplo,
  cublasOperation_t __trans,
  cublasDiagType_t __diag,
  int __m,
