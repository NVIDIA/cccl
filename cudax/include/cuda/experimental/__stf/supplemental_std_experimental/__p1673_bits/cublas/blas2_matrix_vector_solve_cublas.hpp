...
template <class _SyncType, class _ElementType_A, class _SizeType_A, ::std::size_t _numRows_A, ::std::size_t _numCols_A,
        class _Layout_A, class _Accessor_A, class _ElementType_b, class _SizeType_b, ::std::size_t _ext_b,
        class _Layout_b, class _Accessor_b>
void __triangular_matrix_vector_solve_impl(__nvhpc_exec<__cublas_exec_space<_SyncType>>&& __exec,
        __ex::mdspan<_ElementType_A, __ex::extents<_SizeType_A, _numRows_A, _numCols_A>, _Layout_A, _Accessor_A> __A,
        char op_A, char fillMode, char diag,
    ...
    __cb::__check_cublas_status(__cb::__cublas_trsv(__cb::__get_cublas_handle(), __cb::__to_cublas_fill_mode(fillMode),
                                        __cb::__op_to_cublas_op(op_A), __cb::__to_cublas_diag_type(diag), __A.extent(0),
                                        __A.data_handle(), __ex::linalg::__get_leading_dim(__A), b.data_handle()),
            "matrix_vector_solve", "cublas_trsv");
