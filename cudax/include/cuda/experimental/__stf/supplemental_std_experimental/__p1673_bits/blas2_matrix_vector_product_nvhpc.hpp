...
template <class _exec_space, class _ElementType_A, class _SizeType_A, ::std::size_t _numRows_A,
        ::std::size_t _numCols_A, class _Layout_A, class _Accessor_A, class _ElementType_x, class _SizeType_x,
        ::std::size_t _ext_x, class _Layout_x, class _Accessor_x, class _ElementType_y, class _SizeType_y,
        ::std::size_t _ext_y, class _Layout_y, class _Accessor_y>
inline void __matrix_vector_product_nvhpc(__nvhpc_exec<_exec_space>&& __exec,
    ...
    __matrix_vector_product_impl(std::forward<__nvhpc_exec<_exec_space>>(__exec),
            (__conj_A ? std::get<1>(__work_A) : __A), __op_A, (__conj_x ? std::get<1>(__work_x) : __x), __y, __beta);
}
...
template <class _exec_space, class _ElementType_A, class _SizeType_A, ::std::size_t _numRows_A,
        ...
        ::std::size_t _ext_x, class _Layout_x, class _Accessor_x, class _ElementType_y, class _SizeType_y,
        ::std::size_t _ext_y, class _Layout_y, class _Accessor_y>
void matrix_vector_product(__nvhpc_exec<_exec_space>&& __exec,
        __ex::mdspan<_ElementType_A, __ex::extents<_SizeType_A, _numRows_A, _numCols_A>, _Layout_A, _Accessor_A> __A,
        __ex::mdspan<_ElementType_x, __ex::extents<_SizeType_x, _ext_x>, _Layout_x, _Accessor_x> __x,
        __ex::mdspan<_ElementType_y, __ex::extents<_SizeType_y, _ext_y>, _Layout_y, _Accessor_y> __y) {
    constexpr bool __types_supported = __data_types_supported(__stdblas_data_type<_ElementType_A>,
            __stdblas_data_type<_ElementType_x>, __stdblas_output_data_type<_ElementType_y>);
    ...
    if constexpr (__types_supported && __A_supported && __x_supported && __y_supported) {
        __matrix_vector_product_nvhpc(
                std::forward<__nvhpc_exec<_exec_space>>(__exec), __A, __x, __y, _ElementType_y {});
    } else {
...
template <class _exec_space, class _ElementType_A, class _SizeType_A, ::std::size_t _numRows_A,
        ::std::size_t _numCols_A, class _Layout_A, class _Accessor_A, class _ElementType_x, class _SizeType_x,
        ::std::size_t _ext_x, class _Layout_x, class _Accessor_x, class _ElementType_y, class _SizeType_y,
        ::std::size_t _ext_y, class _Layout_y, class _Accessor_y, class _ElementType_z, class _SizeType_z,
        ::std::size_t _ext_z, class _Layout_z, class _Accessor_z>
void matrix_vector_product(__nvhpc_exec<_exec_space>&& __exec,
        __ex::mdspan<_ElementType_A, __ex::extents<_SizeType_A, _numRows_A, _numCols_A>, _Layout_A, _Accessor_A> __A,
        __ex::mdspan<_ElementType_x, __ex::extents<_SizeType_x, _ext_x>, _Layout_x, _Accessor_x> __x,
        __ex::mdspan<_ElementType_y, __ex::extents<_SizeType_y, _ext_y>, _Layout_y, _Accessor_y> __y,
    ...
    constexpr bool __types_supported =
            __data_types_supported(__stdblas_data_type<_ElementType_A>, __stdblas_data_type<_ElementType_x>,
    ...
    if constexpr (__types_supported && __A_supported && __x_supported && __y_supported && __z_supported) {
        ...
        __matrix_vector_product_nvhpc(
                std::forward<__nvhpc_exec<_exec_space>>(__exec), __A, __x, __z, _ElementType_y(1));
    } else {
#ifdef STDBLAS_VERBOSE
        __STDBLAS_COMPILE_TIME_FALLBACK_MESSAGE(matrix_vector_product);
#endif
