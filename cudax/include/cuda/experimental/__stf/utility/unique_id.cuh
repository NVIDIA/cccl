...
public:
    ...
    constexpr unique_numeral(unique_numeral&& other) noexcept : _value(::std::exchange(other._value, -1)) {}
    constexpr unique_numeral(const int val) noexcept : _value(val) {}
    ...
    bool operator==(const unique_numeral& other) const noexcept { return _value == other._value; }
