...
public:
     ...
     */
    slice_graph_interface(slice<T, dimensions> s) : base(mv(s)) {}
     ...
     * @param s either a slice or the shape of a slice
     */
    slice_graph_interface(shape_of<slice<T, dimensions>> s) : base(mv(s)) {}

    /// @brief Implementation of interface primitive
    void data_allocate(backend_ctx_untyped& bctx, block_allocator_untyped& custom_allocator,
    ...
    /// @brief Implementation of interface primitive
    void data_deallocate(backend_ctx_untyped& bctx, block_allocator_untyped& custom_allocator,
            const data_place& memory_node, instance_id_t instance_id, void* extra_args, event_list& prereqs) final {
    ...
    /// @brief Implementation of interface primitive
    cudaGraphNode_t graph_data_copy(cudaMemcpyKind kind, instance_id_t src_instance_id, instance_id_t dst_instance_id,
            cudaGraph_t graph, const cudaGraphNode_t* input_nodes, size_t input_cnt) override {
