...
public:
    stream_reduction_operator_untyped(bool is_commutative = true) : reduction_operator_base(is_commutative) {}

    virtual void stream_redux_op(logical_data_untyped& d, const data_place& inout_memory_node,
            instance_id_t inout_instance_id, const data_place& in_memory_node, instance_id_t in_instance_id,
            const exec_place& e, cudaStream_t s) = 0;

    virtual void stream_init_op(logical_data_untyped& d, const data_place& out_memory_node,
            instance_id_t out_instance_id, const exec_place& e, cudaStream_t s) = 0;

    void op_untyped(logical_data_untyped& d, const data_place& inout_memory_node, instance_id_t inout_instance_id,
            const data_place& in_memory_node, instance_id_t in_instance_id, const exec_place& ep,
    ...
    void init_op_untyped(logical_data_untyped& d, const data_place& out_memory_node, instance_id_t out_instance_id,
            const exec_place& ep, event_list& prereqs) override {
...
class stream_reduction_operator : public stream_reduction_operator_untyped {
    ...
    void stream_redux_op(logical_data_untyped& d, const data_place& /*unused*/, instance_id_t inout_instance_id,
            const data_place&, instance_id_t in_instance_id, const exec_place& e, cudaStream_t s) {
    ...
    void stream_init_op(logical_data_untyped& d, const data_place&, instance_id_t out_instance_id, const exec_place& e,
            cudaStream_t s) {
