...
#include "cudastf/__stf/internal/hashtable_linearprobing.h"
...
public:
    ...
    hashtable_stream_interface(hashtable h) : base(mv(h)) {}

    // Initialize from a shape of hashtable (start empty)
    hashtable_stream_interface(shape_t /*unused*/) : base(hashtable(nullptr)) {}

    void stream_data_copy(const data_place& dst_memory_node, instance_id_t dst_instance_id,
            const data_place& src_memory_node, instance_id_t src_instance_id, cudaStream_t s) override {
