...
#ifndef _CUDA_EXPERIMENTAL___MULTI_GPU_NCCL_THREAD_GROUP_H
#define _CUDA_EXPERIMENTAL___MULTI_GPU_NCCL_THREAD_GROUP_H
...
#endif // _CUDA_EXPERIMENTAL___THREAD_GROUP_NCCL_THREAD_GROUP_H
