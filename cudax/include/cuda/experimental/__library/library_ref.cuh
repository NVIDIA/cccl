  ...
  [[nodiscard]] bool has_kernel(const char* __name) const
  {
    ...
    switch (__status)
    {
      ...
      case ::CUDA_ERROR_NOT_FOUND:
        return false;
      default:
        ::cuda::__throw_cuda_error(static_cast<::cudaError_t>(__status), "Failed to get the kernel from library");
    }
  }
  ...
  [[nodiscard]] bool has_global(const char* __name, ::cuda::device_ref __device) const
  {
    ...
    switch (__status)
    {
      ...
      case ::CUDA_ERROR_NOT_FOUND:
        return false;
      default:
        ::cuda::__throw_cuda_error(static_cast<::cudaError_t>(__status), "Failed to get the global symbol from library");
    }
  }
    ...
    switch (__status)
    {
      ...
      default:
        ::cuda::__throw_cuda_error(
          static_cast<::cudaError_t>(__status), "Failed to get the managed symbol from library");
    }
  }
