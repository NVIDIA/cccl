...
$CUDA_VERSION = & nvcc --version 2>&1 | Select-String "Cuda compilation tools, release (\d+\.\d+)"
...
$BUILD_DIR = "$PWD\..\build\$env:CCCL_BUILD_INFIX"
[System.IO.Directory]::CreateDirectory("$BUILD_DIR")
$BUILD_DIR = (Resolve-Path -Path "$BUILD_DIR").Path # to absolute path
