...
_REQUIRED_PACKAGE_FILES = {
    ...
    "cuda/coop/_core/api/exchange.py",
    ...
    "cuda/coop/_core/api/shuffle.py",
    ...
    "cuda/coop/cutlass/_compiler/_layout.py",
    ...
    "cuda/coop/cutlass/_group_radix.py",
    "cuda/coop/cutlass/_group_radix.pyi",
    "cuda/coop/cutlass/_group_topk.py",
    ...
    "cuda/coop/cutlass/_lowering/_radix.py",
    "cuda/coop/cutlass/_lowering/_topk.py",
    ...
    "cuda/coop/numba_mlir/_group_merge_sort.py",
    "cuda/coop/numba_mlir/_group_merge_sort.pyi",
    "cuda/coop/numba_mlir/_group_radix.py",
    "cuda/coop/numba_mlir/_group_radix.pyi",
    "cuda/coop/numba_mlir/_group_reduce.py",
    "cuda/coop/numba_mlir/_group_reduce.pyi",
    "cuda/coop/numba_mlir/_group_scan.py",
    "cuda/coop/numba_mlir/_group_scan.pyi",
...
_REQUIRED_HEADER_FILES = {
    ...
    "cuda/coop/_headers/include/cuda/barrier",
    "cuda/coop/_headers/include/cuda/devices",
    "cuda/coop/_headers/include/cuda/experimental/coop/algorithm",
    "cuda/coop/_headers/include/cuda/experimental/coop/group",
    "cuda/coop/_headers/include/cuda/functional",
    "cuda/coop/_headers/include/cuda/hierarchy",
    "cuda/coop/_headers/include/thrust/detail/raw_pointer_cast.h",
    "cuda/coop/_headers/include/cuda/std/cstdint",
    "cuda/coop/_headers/include/cuda/std/functional",
    "cuda/coop/_headers/include/cuda/std/type_traits",
