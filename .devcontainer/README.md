...
8. Done! See [contributing guide](https://nvidia.github.io/cccl/unstable/contributors/index.html) for instructions on how to build and run tests.
...
2. Done. See [contributing guide](https://nvidia.github.io/cccl/unstable/contributors/index.html) for instructions on how to build and run tests.
