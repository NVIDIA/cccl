...
struct allocator_delete final
{
  ...
  {
    using traits = detail::allocator_traits<std::remove_cv_t<std::remove_reference_t<Allocator>>>;
...
_CCCL_HOST std::unique_ptr<
  ...
  allocator_delete<T,
                   typename detail::allocator_traits<
                     std::remove_cv_t<std::remove_reference_t<Allocator>>>::template rebind_traits<T>::allocator_type>>
allocate_unique(Allocator const& alloc, Args&&... args)
{
  using traits =
    typename detail::allocator_traits<std::remove_cv_t<std::remove_reference_t<Allocator>>>::template rebind_traits<T>;
...
_CCCL_HOST std::unique_ptr<
  ...
  uninitialized_allocator_delete<T,
                                 typename detail::allocator_traits<std::remove_cv_t<
                                   std::remove_reference_t<Allocator>>>::template rebind_traits<T>::allocator_type>>
