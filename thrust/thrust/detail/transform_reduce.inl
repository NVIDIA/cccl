...
#include __THRUST_HOST_SYSTEM_ALGORITH_HEADER_INCLUDE(detail / transform_reduce.h)
#include __THRUST_DEVICE_SYSTEM_ALGORITH_HEADER_INCLUDE(detail / transform_reduce.h)
