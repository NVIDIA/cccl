...
#include __THRUST_HOST_SYSTEM_ALGORITH_HEADER_INCLUDE(detail / temporary_buffer.h)
#include __THRUST_DEVICE_SYSTEM_ALGORITH_HEADER_INCLUDE(detail / temporary_buffer.h)
