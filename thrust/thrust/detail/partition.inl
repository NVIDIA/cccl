...
_CCCL_HOST_DEVICE ForwardIterator partition(
  ...
  Predicate pred)
{
  CCCL_DETAIL_NVTX_RANGE_SCOPE("thrust::partition");
...
_CCCL_HOST_DEVICE thrust::pair<OutputIterator1, OutputIterator2> partition_copy(
  ...
  Predicate pred)
{
  CCCL_DETAIL_NVTX_RANGE_SCOPE("thrust::partition_copy");
...
_CCCL_HOST_DEVICE ForwardIterator stable_partition(
  ...
  Predicate pred)
{
  CCCL_DETAIL_NVTX_RANGE_SCOPE("thrust::stable_partition");
...
_CCCL_HOST_DEVICE thrust::pair<OutputIterator1, OutputIterator2> stable_partition_copy(
  ...
  Predicate pred)
{
  CCCL_DETAIL_NVTX_RANGE_SCOPE("thrust::stable_partition_copy");
...
_CCCL_HOST_DEVICE ForwardIterator partition_point(
  ...
  Predicate pred)
{
  CCCL_DETAIL_NVTX_RANGE_SCOPE("thrust::partition_point");
...
_CCCL_HOST_DEVICE bool is_partitioned(
  ...
  Predicate pred)
{
  CCCL_DETAIL_NVTX_RANGE_SCOPE("thrust::is_partitioned");
