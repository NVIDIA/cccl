...
struct pointer_base
{
  ...
  using value_type =
    typename thrust::detail::eval_if<::cuda::std::is_void<typename ::cuda::std::remove_cvref<Element>::type>::value,
  ...
  using reference_type = typename thrust::detail::eval_if<
    ::cuda::std::is_void<typename ::cuda::std::remove_cvref<Element>::type>::value,
    thrust::detail::identity_<void>,
