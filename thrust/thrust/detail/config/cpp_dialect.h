...
// Check for the CUB opt-outs as well:
  ...
  && (defined(CUB_IGNORE_DEPRECATED_CPP_DIALECT) || defined(LIBCUDACXX_IGNORE_DEPRECATED_CPP_DIALECT))
#  define THRUST_IGNORE_DEPRECATED_CPP_DIALECT
#endif
#if !defined(THRUST_IGNORE_DEPRECATED_CPP_11) \
  && (defined(CUB_IGNORE_DEPRECATED_CPP_11) || defined(LIBCUDACXX_IGNORE_DEPRECATED_CPP_11))
#  define THRUST_IGNORE_DEPRECATED_CPP_11
#endif
#if !defined(THRUST_IGNORE_DEPRECATED_CPP_14) \
  && (defined(CUB_IGNORE_DEPRECATED_CPP_14) || defined(LIBCUDACXX_IGNORE_DEPRECATED_CPP_14))
