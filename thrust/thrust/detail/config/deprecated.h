...
#  define THRUST_DEPRECATED_TYPE_ALIAS
#  define THRUST_DEPRECATED_TYPE_ALIAS_BECAUSE(MSG)
#else
#  define THRUST_DEPRECATED                         _CCCL_DEPRECATED
#  define THRUST_DEPRECATED_BECAUSE(MSG)            _CCCL_DEPRECATED_BECAUSE(MSG)
#  define THRUST_DEPRECATED_TYPE_ALIAS              _CCCL_DEPRECATED_TYPE_ALIAS
#  define THRUST_DEPRECATED_TYPE_ALIAS_BECAUSE(MSG) _CCCL_DEPRECATED_TYPE_ALIAS_BECAUSE(MSG)
#endif
