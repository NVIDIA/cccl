...
#  if (defined(_CCCL_COMPILER_GCC) && (THRUST_GCC_VERSION >= 40800)) || defined(_CCCL_COMPILER_CLANG)
...
#    define THRUST_STATIC_ASSERT(B)                                         \
      ...
      THRUST_PP_CAT2(thrust_static_assert_typedef_, __LINE__) __attribute__((unused)) /**/
#  else
#    define THRUST_STATIC_ASSERT(B)                                         \
      typedef THRUST_NS_QUALIFIER::detail::static_assert_test<sizeof(       \
        THRUST_NS_QUALIFIER::detail::STATIC_ASSERTION_FAILURE<(bool) (B)>)> \
