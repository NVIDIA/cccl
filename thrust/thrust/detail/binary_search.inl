...
#include __THRUST_HOST_SYSTEM_ALGORITH_HEADER_INCLUDE(detail / binary_search.h)
#include __THRUST_DEVICE_SYSTEM_ALGORITH_HEADER_INCLUDE(detail / binary_search.h)
