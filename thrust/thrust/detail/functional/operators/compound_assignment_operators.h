...
template <typename T1, typename T2>
_CCCL_HOST_DEVICE
  actor< composite< transparent_binary_operator<multiplies_equal>, actor<T1>, typename as_actor<T2>::type > >
  operator*=(const actor<T1>& _1, const T2& _2)
{
...
template <typename T1, typename T2>
_CCCL_HOST_DEVICE
  actor< composite< transparent_binary_operator<divides_equal>, actor<T1>, typename as_actor<T2>::type > >
  operator/=(const actor<T1>& _1, const T2& _2)
{
...
template <typename T1, typename T2>
_CCCL_HOST_DEVICE
  actor< composite< transparent_binary_operator<modulus_equal>, actor<T1>, typename as_actor<T2>::type > >
  operator%=(const actor<T1>& _1, const T2& _2)
{
...
template <typename T1, typename T2>
_CCCL_HOST_DEVICE
  actor< composite< transparent_binary_operator<bit_and_equal>, actor<T1>, typename as_actor<T2>::type > >
  operator&=(const actor<T1>& _1, const T2& _2)
{
...
template <typename T1, typename T2>
_CCCL_HOST_DEVICE
  actor< composite< transparent_binary_operator<bit_xor_equal>, actor<T1>, typename as_actor<T2>::type > >
  operator^=(const actor<T1>& _1, const T2& _2)
{
...
template <typename T1, typename T2>
_CCCL_HOST_DEVICE
  actor< composite< transparent_binary_operator<bit_lshift_equal>, actor<T1>, typename as_actor<T2>::type > >
  operator<<=(const actor<T1>& _1, const T2& _2)
{
...
template <typename T1, typename T2>
_CCCL_HOST_DEVICE
  actor< composite< transparent_binary_operator<bit_rshift_equal>, actor<T1>, typename as_actor<T2>::type > >
  operator>>=(const actor<T1>& _1, const T2& _2)
{
