...
struct has_trivial_constructor
    : public integral_constant<bool,
                               is_pod<T>::value || ::cuda::std::is_trivially_constructible<T>::value>
{};

template <typename T>
struct has_trivial_copy_constructor
    : public integral_constant<bool,
                               is_pod<T>::value || ::cuda::std::is_trivially_copyable<T>::value>
{};
...
struct is_convertible
{
  static const bool value = (is_void<To>::value ||
                             (is_int_or_cref<To>::value && !is_void<From>::value));
}; // end is_convertible
...
struct or_<Condition, Conditions...>
    : public integral_constant<bool, Condition::value || or_<Conditions...>::value>
{}; // end or_
...
struct and_<Condition, Conditions...>
    : public integral_constant<bool, Condition::value && and_<Conditions...>::value>
{}; // end and_
...
struct make_unsigned_base
{
  ...
  typedef typename eval_if<is_const<T>::value && is_volatile<T>::value,
                           // add cv back
                           ...
                           eval_if<is_const<T>::value,
                                   ...
                                   eval_if<is_volatile<T>::value,
                                           ...
                                           // original type was neither cv, return the simple
                                           // unsigned result
...
template <typename T1, typename T2>
struct larger_type
    : thrust::detail::eval_if<(sizeof(T2) > sizeof(T1)),
...
template <typename Base, typename Derived>
struct is_base_of : integral_constant<bool, is_base_of_ns::impl<Base, Derived>::value>
{};
...
struct promoted_numerical_type<
  ...
  T2,
  typename enable_if<
    and_<typename is_floating_point<T1>::type, typename is_floating_point<T2>::type>::value>::type>
{
...
struct promoted_numerical_type<
  ...
  T2,
  typename enable_if<
    and_<typename is_integral<T1>::type, typename is_floating_point<T2>::type>::value>::type>
{
  typedef T2 type;
};
...
struct promoted_numerical_type<T1,
                               T2,
                               typename enable_if<and_<typename is_floating_point<T1>::type,
...
template <typename T1, typename T2>
struct has_promoted_numerical_type<
  T1,
  T2,
  ::cuda::std::__void_t<typename promoted_numerical_type<T1, T2>::type>> : public true_type
{};
...
template <typename T>
struct is_empty
    : integral_constant<bool, sizeof(is_empty_helper_base) == sizeof(is_empty_helper<T>)>
{};
