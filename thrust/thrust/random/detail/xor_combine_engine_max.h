...
struct xor_combine_engine_max_aux_2
{
  ...
  static const result_type value = thrust::detail::eval_if<
    ...
    thrust::detail::eval_if<
      ...
      // otherwise, case 4
      thrust::detail::identity_< thrust::detail::integral_constant<
        result_type,
...
struct xor_combine_engine_max
{
  ...
  static const result_type m1 =
    math::min< result_type,
               result_type(Engine1::max - Engine1::min),
               two_to_the_power<result_type, w - s1>::value - 1 >::value;

  static const result_type m2 =
    math::min< result_type,
               result_type(Engine2::max - Engine2::min),
               two_to_the_power<result_type, w - s2>::value - 1 >::value;
