  ...
  ScanOp scan_op)
{
  ...
  size_t tmp_size = 0;
  {
    // TODO(bgruber): we should call cub::DeviceScan::InclusiveScan with initialization directly in CCCL 4.0, which is a
    // breaking change. See https://github.com/NVIDIA/cccl/issues/3993 for details.
    THRUST_UNSIGNED_INDEX_TYPE_DISPATCH(
      status,
