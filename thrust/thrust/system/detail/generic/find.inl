...
find_if(thrust::execution_policy<DerivedPolicy>& exec, InputIterator first, InputIterator last, Predicate pred)
{
  ...
  using IteratorTuple = ::cuda::std::tuple<XfrmIterator, ::cuda::counting_iterator<difference_type, difference_type>>;
  using ZipIterator   = thrust::zip_iterator<IteratorTuple>;

  IteratorTuple iter_tuple =
    ::cuda::std::make_tuple(XfrmIterator(first, pred), ::cuda::counting_iterator<difference_type, difference_type>(0));
