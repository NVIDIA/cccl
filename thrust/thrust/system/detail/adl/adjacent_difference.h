...
#include __THRUST_HOST_SYSTEM_ALGORITH_HEADER_INCLUDE(adjacent_difference.h)
#include __THRUST_DEVICE_SYSTEM_ALGORITH_HEADER_INCLUDE(adjacent_difference.h)
