...
#include __THRUST_HOST_SYSTEM_ALGORITH_HEADER_INCLUDE(per_device_resource.h)
#include __THRUST_DEVICE_SYSTEM_ALGORITH_HEADER_INCLUDE(per_device_resource.h)
