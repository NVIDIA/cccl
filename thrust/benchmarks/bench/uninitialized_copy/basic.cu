...
static_assert(!::cuda::std::is_trivially_copyable_v<non_trivial>); // as required by the C++ standard
static_assert(!thrust::is_trivially_relocatable_v<non_trivial>); // thrust uses this check internally
