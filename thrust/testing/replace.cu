...
#if _CCCL_COMPILER_GCC && __GNUC__ == 12 && THRUST_DEVICE_SYSTEM == THRUST_DEVICE_SYSTEM_OMP && _CCCL_STD_VER == 2011
#  define THRUST_GCC12_OMP_MISCOMPILE
#endif

// New GCC, new miscompile. 13 + TBB this time.
#if _CCCL_COMPILER_GCC && __GNUC__ == 13 && THRUST_DEVICE_SYSTEM == THRUST_DEVICE_SYSTEM_TBB
