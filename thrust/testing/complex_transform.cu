...
{
  template <typename T>
  _CCCL_HOST_DEVICE thrust::complex<T> operator()(const thrust::complex<T>& x, const thrust::complex<T>& y)
  {
...
{
  template <typename T>
  _CCCL_HOST_DEVICE thrust::complex<T> operator()(const thrust::complex<T>& x)
  {
