...
{
  _CCCL_HOST_DEVICE my_allocator_with_custom_construct1() = default;
...
{
  _CCCL_HOST_DEVICE my_allocator_with_custom_construct2() = default;
...
struct my_allocator_with_custom_destroy
{
  ...
  _CCCL_HOST my_allocator_with_custom_destroy() = default;
...
struct my_minimal_allocator
{
  ...
  _CCCL_HOST my_minimal_allocator() = default;
