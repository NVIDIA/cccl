...
def make_segmented_reduce(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/segmented/segmented_reduce_object.py
            :language: python
...
def segmented_reduce(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/segmented/segmented_reduce_basic.py
            :language: python
            :start-after: # example-begin
