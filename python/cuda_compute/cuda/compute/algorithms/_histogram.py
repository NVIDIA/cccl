...
def make_histogram_even(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/histogram/histogram_object.py
          :language: python
...
def histogram_even(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/histogram/histogram_even_basic.py
            :language: python
            :start-after: # example-begin
