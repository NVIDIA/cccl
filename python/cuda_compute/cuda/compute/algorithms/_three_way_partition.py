...
def make_three_way_partition(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/partition/three_way_partition_object.py
            :language: python
...
def three_way_partition(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/partition/three_way_partition_basic.py
            :language: python
            :start-after: # example-begin
