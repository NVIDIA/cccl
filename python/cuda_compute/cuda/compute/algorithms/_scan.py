...
def make_exclusive_scan(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/scan/exclusive_scan_object.py
          :language: python
...
def exclusive_scan(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/scan/exclusive_scan_max.py
            :language: python
            :start-after: # example-begin
...
def make_inclusive_scan(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/scan/inclusive_scan_object.py
          :language: python
          :start-after: # example-begin
...
def inclusive_scan(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/scan/inclusive_scan_custom.py
            :language: python
            :start-after: # example-begin
