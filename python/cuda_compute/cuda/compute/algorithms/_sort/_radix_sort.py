...
def make_radix_sort(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/sort/radix_sort_object.py
          :language: python
...
def radix_sort(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/sort/radix_sort_basic.py
            :language: python
            :start-after: # example-begin
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/sort/radix_sort_buffer.py
            :language: python
            :start-after: # example-begin
