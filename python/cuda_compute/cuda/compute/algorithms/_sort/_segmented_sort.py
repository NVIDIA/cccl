...
def make_segmented_sort(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/sort/segmented_sort_object.py
            :language: python
...
def segmented_sort(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/sort/segmented_sort_basic.py
            :language: python
            :start-after: # example-begin
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/sort/segmented_sort_buffer.py
            :language: python
            :start-after: # example-begin
