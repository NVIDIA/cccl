...
def make_merge_sort(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/sort/merge_sort_object.py
          :language: python
...
def merge_sort(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/sort/merge_sort_basic.py
            :language: python
            :start-after: # example-begin
