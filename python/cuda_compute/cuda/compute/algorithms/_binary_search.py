...
def make_lower_bound(
    *,
    ...
    Example:
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/binary_search/lower_bound_object.py
            :language: python
...
def make_upper_bound(
    *,
    ...
    Example:
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/binary_search/upper_bound_object.py
            :language: python
            :start-after: # example-begin
...
def lower_bound(
    *,
    ...
    Example:
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/binary_search/lower_bound_basic.py
            :language: python
            :start-after: # example-begin
...
def upper_bound(
    *,
    ...
    Example:
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/binary_search/upper_bound_basic.py
            :language: python
            :start-after: # example-begin
