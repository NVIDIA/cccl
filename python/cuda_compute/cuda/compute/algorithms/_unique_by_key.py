...
def make_unique_by_key(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/unique/unique_by_key_object.py
          :language: python
...
def unique_by_key(
    *,
    ...
    Example:
        ...
        .. literalinclude:: ../../python/cuda_compute/tests/compute/examples/unique/unique_by_key_basic.py
            :language: python
            :start-after: # example-begin
