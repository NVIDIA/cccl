...
"""Current-hierarchy reduce example for cuda.coop.cutlass."""
...
def make_runner() -> tuple[Any, Any, Any, Any]:
    ...
    @cute.kernel
    def _thread_hierarchy_reduce_kernel(
        values: cute.Tensor,
    ...
    @cute.jit
    def _run_thread_hierarchy_reduce(
        values: cute.Tensor,
        block_sum_out: cute.Tensor,
        block_items_sum_out: cute.Tensor,
        warp_max_out: cute.Tensor,
    ):
        _thread_hierarchy_reduce_kernel(
            values,
            block_sum_out,
            block_items_sum_out,
            warp_max_out,
    ...
    return _run_thread_hierarchy_reduce, torch, from_dlpack, cutlass
...
def prepare_example() -> PreparedExample:
    ...
    run_thread_hierarchy_reduce, torch, from_dlpack, cutlass = make_runner()
...
def run_example() -> dict[str, Any]:
    """Run the current-hierarchy reduce example and validate the result."""
