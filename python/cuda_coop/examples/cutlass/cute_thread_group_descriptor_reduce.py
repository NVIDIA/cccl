...
"""ThreadGroup descriptor reduce example for cuda.coop.cutlass."""
...
def make_runner() -> tuple[Any, Any, Any, Any]:
    ...
    @cute.kernel
    def _thread_group_descriptor_reduce_kernel(
    ...
    @cute.jit
    def _run_thread_group_descriptor_reduce(
        values: cute.Tensor,
        block_sum_out: cute.Tensor,
        block_items_sum_out: cute.Tensor,
        warp_max_out: cute.Tensor,
    ):
        _thread_group_descriptor_reduce_kernel(
            values,
            block_sum_out,
            block_items_sum_out,
            warp_max_out,
    ...
    return _run_thread_group_descriptor_reduce, torch, from_dlpack, cutlass
...
def prepare_example() -> PreparedExample:
    ...
    run_thread_group_descriptor_reduce, torch, from_dlpack, cutlass = make_runner()
    ...
    def step() -> None:
        run_thread_group_descriptor_reduce(
            values_arg,
            block_sum_arg,
            block_items_sum_arg,
            warp_max_arg,
...
def run_example() -> dict[str, Any]:
    """Run the ThreadGroup descriptor reduce example and validate the result."""
