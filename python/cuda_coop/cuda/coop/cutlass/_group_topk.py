...
def _topk_temp_storage_context(
    ...
    *,
    ...
    from ._dsl import _provider as _provider_support
    ...
    with single_phase_transaction(
        context,
        snapshot_provider_session=_provider_support.snapshot_active_session_state,
        restore_provider_session=_provider_support.restore_active_session_state,
    ):
...
def _topk_keys(
    ...
    *,
    ...
    from ._dsl import _cub_topk_provider as provider
