...
from ._types import _CompareOperator as _CompareOperator
...
from ._types import _WarpMergeSortKeyT as _WarpMergeSortKeyT
...
def merge_sort_keys(
    ...
    *,
    ...
    """Sort one integral CUTLASS block register tensor into ``ThreadData``.
    ...
    i64, and u64 provider set. The qualified adapter returns flattened
...
def merge_sort_keys(
    ...
    *,
    ...
    oob_default: _IntegerValue,
    temp_storage: TempStorage | None = None,
    compare_op: _CompareOperator | None = None,
) -> ThreadData[Any]:
    """Partially sort an integral block register tensor into ``ThreadData``.
...
def merge_sort_keys(
    ...
    *,
    ...
    """Return one fully sorted integral CUTLASS block key per thread."""
...
def merge_sort_keys(
    ...
    *,
    ...
    """Return one partial-tile sorted integral CUTLASS block key per thread.
