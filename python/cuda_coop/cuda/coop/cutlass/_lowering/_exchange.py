...
from cutlass.base_dsl.typing import Int8, Int16, Int32, Int64
...
_RANK_TYPES = frozenset({Int8, Int16, Int32, Int64})
_VALID_FLAG_TYPES = INTEGER_VALUE_TYPES
    ...
    try:
        ...
        ffi(
            ...
            params_types=[
                ...
                *(
                    [rank_type] * value.items_per_thread
