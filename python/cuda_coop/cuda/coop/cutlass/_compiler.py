...
"""Direct CUTLASS trace-context registration for common-root activation."""
...
from cuda.coop._core.root_api import _compiler_scope
...
def trace_context(compiler: object, function_name: str) -> Iterator[None]:
    """Activate the CUTLASS backend while the compiler traces one function."""
...
def register_trace_context() -> None:
    ...
    if not callable(register):
        raise CutlassRuntimeDependencyError(
            ...
            missing_capabilities=("register_trace_context_factory",),
        )
