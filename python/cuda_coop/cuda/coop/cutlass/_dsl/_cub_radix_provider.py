...
from cuda.coop._core import AlgorithmSpec, GroupOperandKind, LaunchFacts
from cuda.coop._core.block import block_radix_rank_bins_per_thread
...
def _make_sort_request(
    *,
    ...
    from .. import _group_radix as _group_frontend

    plan = _group_frontend._make_group_radix_sort_plan(
        group=group,
        launch=launch,
        key_dtype=key_type,
...
def _make_rank_request(
    *,
    ...
    plan = _group_frontend._make_group_radix_rank_plan(
        group=group,
        launch=launch,
...
def provider_radix_sort_keys(
    *,
    ...
    resolved_end = _provider_support.validate_radix_bit_range(
        begin_bit,
        end_bit,
        key_type,
    )
    ...
    try:
        ...
        arguments = request.bind_ffi_arguments(
            {
                "keys": key_values,
                "begin_bit": _provider_support.as_int32(begin_bit),
                "end_bit": _provider_support.as_int32(resolved_end),
            },
    ...
    return _pack_result(
        ...
        result_type=_provider_support.thread_data_output_dtype(key_data, key_type)
    ...
    *,
    ...
    return (
        ...
        _pack_result(
            ...
            result_type=_provider_support.thread_data_output_dtype(
...
def provider_radix_rank(
    *,
    ...
    if exclusive_digit_prefix is not None:
        ...
        exclusive_digit_prefix = _provider_support.validate_thread_data_output(
