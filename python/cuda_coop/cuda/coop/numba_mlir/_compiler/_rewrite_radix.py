...
"""Radix payload inference, control validation, and rewrite finalization.
    ...
    def _validate_integer_runtime_controls(
        ...
        *,
        ...
        if op_name in {
            ...
            is_runtime_binding("valid_items")
        ):
            parameter, index = "valid_items", 1
        elif op_name == "adjacent_difference" and is_runtime_binding("valid_items"):
