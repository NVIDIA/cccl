        ...
        *,
        ...
        if has_valid or has_algorithm or custom_binary_op is not None:
            ...
            if normalized_op == "sum":
                ...
                from .._lowering._reduce import reduce
                ...
                from .._lowering._reduce import warp_reduce
                ...
                from .._lowering._reduce import block_reduce_builtin
                ...
                from .._lowering._reduce import warp_reduce_builtin
        ...
        from .._lowering._reduce import group_reduce
