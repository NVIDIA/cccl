...
"""Histogram provider lowering for Numba-CUDA-MLIR.

This module materializes the fused block provider after the planner resolves
portable dtype and output-capacity requirements.
"""
