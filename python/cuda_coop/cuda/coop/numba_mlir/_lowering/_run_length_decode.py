...
"""Run Length Decode provider lowering for Numba-CUDA-MLIR.

This module owns fused block-provider materialization.  Output-window and
optional-offset analysis are performed by whole-function planning.
"""
