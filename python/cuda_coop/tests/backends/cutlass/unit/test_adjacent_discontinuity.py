...
def test_group_comparison_calls_route_to_exact_cub_block_plans(
    ...
    import cuda.coop.cutlass._lowering._adjacent_difference as adjacent_provider
    import cuda.coop.cutlass._lowering._discontinuity as discontinuity_provider
...
def test_common_comparisons_reject_scalar_but_qualified_scalar_remains_available(
    ...
    assert portable_dispatch._common_root_operation_name() is None
    assert (
