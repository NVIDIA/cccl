...
def test_runtime_hook_initialization_requires_public_0_5_capabilities(monkeypatch):
    ...
    modules = {
        ...
        "cuda.coop.numba_mlir._single_phase_rewrites": planner_module,
        "cuda.coop.numba_mlir._group_rewrites": group_planner_module,
    }
...
def test_qualified_import_reports_a_missing_public_runtime():
    script = textwrap.dedent(
        ...
        try:
            ...
            assert "cuda-coop[numba-cuda-mlir]" in message
        else:
