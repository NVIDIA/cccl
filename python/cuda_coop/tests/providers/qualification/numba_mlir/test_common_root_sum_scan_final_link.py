...
@pytest.mark.evidence_for("group.reduce", backend="numba_mlir", evidence="link")
@pytest.mark.evidence_for("group.sum", backend="numba_mlir", evidence="link")
@pytest.mark.evidence_for("group.scan", backend="numba_mlir", evidence="link")
@pytest.mark.evidence_for("group.exclusive_sum", backend="numba_mlir", evidence="link")
@pytest.mark.evidence_for("group.inclusive_sum", backend="numba_mlir", evidence="link")
@pytest.mark.evidence_for("group.exclusive_scan", backend="numba_mlir", evidence="link")
@pytest.mark.evidence_for("group.inclusive_scan", backend="numba_mlir", evidence="link")
...
def test_common_root_reduce_sum_scan_provider_functions_are_eliminated(
