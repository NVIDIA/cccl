...
"""
Numba-based iterator base classes and core implementations.

This module contains the IteratorBase class and basic iterator implementations
that rely on Numba for JIT compilation of advance/dereference methods.
"""
