...
"""
cuda.coop._experimental.block_exchange
====================================
...
def make_exchange(
    ...
    :type dtype: :py:class:`cuda.coop._experimental._typing.DtypeType`
    :param threads_per_block: Number of threads in the block.
    :type threads_per_block: :py:class:`cuda.coop._experimental._typing.DimType`
    ...
    :returns: An :py:class:`cuda.coop._experimental._types.Invocable` object
