...
def BlockExchange(
    ...
    :param offset_dtype: Supplies the dtype for scatter ranks when using
        scatter block exchange types. Required for scatter exchanges.
    :type offset_dtype: :py:class:`cuda.coop._typing.DtypeType`, optional

    :param valid_flag_dtype: Supplies the dtype for validity flags when using
        :py:attr:`BlockExchangeType.ScatterToStripedFlagged`.
    :type valid_flag_dtype: :py:class:`cuda.coop._typing.DtypeType`, optional
