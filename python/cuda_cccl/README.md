...
same-version `cuda-compute` distribution, which in turn brings in the
same-version `cccl-headers` distribution.
...
This is a one-time migration. Subsequent upgrades within the three-wheel layout
