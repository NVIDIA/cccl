...
int main(int, char**)
{
    ...
    {
        ext2d_t e{64, 128};
        std::layout_left::mapping<ext2d_t> m0{  e };
        std::layout_left::mapping<ext2d_t> m { m0 };
...

    {
        ext2d_t e0{64, 128};
        ext2d_t e1{16,  32};
        std::layout_left::mapping<ext2d_t> m0{ e0 };
        std::layout_left::mapping<ext2d_t> m1{ e1 };
