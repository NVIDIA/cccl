...
void typed_test_default_ctor_left()
{
    typed_test_default_ctor< test_left_type< std::extents<size_t,10     >     > >();
    typed_test_default_ctor< test_left_type< std::extents<size_t,dyn    >, 10 > >();
    typed_test_default_ctor< test_left_type< std::extents<size_t,dyn, 10>,  5 > >();
    typed_test_default_ctor< test_left_type< std::extents<size_t,  5,dyn>, 10 > >();
    typed_test_default_ctor< test_left_type< std::extents<size_t,  5, 10>     > >();
}

void typed_test_compatible_left()
{
