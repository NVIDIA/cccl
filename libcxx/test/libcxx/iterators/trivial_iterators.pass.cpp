...
//  Iterator classification
    ...
    static_assert((!std::__is_cpp17_exactly_input_iterator<char *>::value), "" );
    ...
    static_assert(( std::__is_cpp17_exactly_input_iterator<input_iterator<char *> >::value), "" );
    ...
    static_assert((!std::__is_cpp17_exactly_input_iterator<forward_iterator<char *> >::value), "" );
    ...
    static_assert((!std::__is_cpp17_exactly_input_iterator<bidirectional_iterator<char *> >::value), "" );
    ...
    static_assert((!std::__is_cpp17_exactly_input_iterator<random_access_iterator<char *> >::value), "" );
    ...
    static_assert(( std::__is_cpp17_exactly_input_iterator<my_input_iterator<char *> >::value), "" );
